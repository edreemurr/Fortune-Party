...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Fortune Party", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("Fortune Party", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "1";
		app.meta["company"] = "Elliot Hollifield";
		app.meta["file"] = "Fortune Party";
		app.meta["name"] = "Fortune Party";
		...
		#elseif air
		app.window.title = "Fortune Party";
		#else
