...
HXLINE( 141)			HX_STACK_DO_THROW(err);
            		}
            	}
...
HXDLIN( 146)			HX_STACK_DO_THROW(::hscript::Error_obj::EInvalidChar(c));
            		}
            	}
...
HXLINE( 187)				HX_STACK_DO_THROW(err);
            			}
            		}
...
HXDLIN( 269)				 ::hscript::Expr e1 = _g->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXDLIN( 271)				 ::hscript::Expr _g5 = _g->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 271)				 ::hscript::Expr e2 = _g->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXDLIN( 272)				 ::hscript::Expr e3 = _g->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXLINE( 272)					return false;
            			...
            			break;
            			case (int)9: {
HXLINE( 270)				 ::hscript::Expr _g7 = _g->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 270)				 ::hscript::Expr e11 = _g->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 270)				 ::hscript::Expr e21 = _g->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXLINE( 270)					return this->isBlock(e11);
            			...
            			break;
            			case (int)10: {
HXLINE( 273)				 ::hscript::Expr _g8 = _g->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 273)				 ::hscript::Expr e4 = _g->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 273)				return this->isBlock(e4);
            			}
            			break;
            			case (int)11: {
HXLINE( 275)				::String _g9 = _g->_hx_getString(0);
HXDLIN( 275)				 ::hscript::Expr _g10 = _g->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 275)				 ::hscript::Expr e5 = _g->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXDLIN( 268)				 ::hscript::Expr e6 = _g->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 268)				return this->isBlock(e6);
            			}
            			break;
            			case (int)15: {
HXLINE( 276)				 ::hscript::Expr e7 = _g->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
...
HXLINE( 276)					return false;
            			...
            			break;
            			case (int)20: {
HXLINE( 277)				 ::hscript::Expr _g14 = _g->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 277)				::String _g15 = _g->_hx_getString(1);
HXDLIN( 277)				 ::hscript::CType _g16 = _g->_hx_getObject(2).StaticCast<  ::hscript::CType >();
HXDLIN( 277)				 ::hscript::Expr e8 = _g->_hx_getObject(3).StaticCast<  ::hscript::Expr >();
...
HXDLIN( 267)				return true;
            			...
            			break;
            			case (int)23: {
HXLINE( 267)				 ::hscript::Expr _g18 = _g->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 267)				::Array< ::Dynamic> _g19 = _g->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 267)				 ::hscript::Expr _g20 = _g->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 267)				return true;
            			}
            			break;
            			case (int)24: {
HXLINE( 274)				 ::hscript::Expr _g21 = _g->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 274)				 ::hscript::Expr e9 = _g->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
...
HXDLIN( 278)				 ::hscript::Expr e10 = _g->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXDLIN( 289)					 ::hscript::Expr _g3 = _g->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXLINE( 431)						 ::hscript::Expr e1 = this->parseExpr();
HXLINE( 432)						if (::hx::IsNull( e1 )) {
HXLINE( 433)							return this->makeUnop(op,e1);
            						}
HXLINE( 434)						 ::hscript::Expr _g = e1;
...
HXLINE( 438)									return ::hscript::Expr_obj::EConst(::hscript::Const_obj::CFloat(-(f)));
            								...
            								break;
            								default:{
HXLINE( 440)									return this->makeUnop(op,e1);
            								}
            							}
            						}
            						else {
...
HXLINE( 359)					 ::hscript::Expr e2 = this->parseExpr();
...
HXLINE( 363)								return this->parseExprNext(::hscript::Expr_obj::EParent(e2));
            							...
            							break;
            							case (int)10: {
HXLINE( 378)								 ::hscript::Expr _g2 = e2;
...
HXLINE( 367)									switch((int)(tk->_hx_getIndex())){
            										case (int)5: {
HXLINE( 369)											return this->parseExprNext(::hscript::Expr_obj::ECheckType(e2,t1));
            										}
            										break;
            										case (int)10: {
HXLINE( 371)											 ::hscript::Expr _g3 = e2;
...
HXLINE( 417)						 ::haxe::ds::GenericStack_hscript_Token _this1 = this->tokens;
HXDLIN( 417)						_this1->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this1->head);
            					}
            					else {
...
HXLINE( 404)											{
HXLINE( 404)												 ::haxe::ds::GenericStack_hscript_Token _this2 = this->tokens;
HXDLIN( 404)												_this2->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk2,_this2->head);
            											}
HXLINE( 405)											{
HXLINE( 405)												 ::haxe::ds::GenericStack_hscript_Token _this3 = this->tokens;
HXDLIN( 405)												_this3->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this3->head);
            											}
...
HXLINE( 412)										 ::haxe::ds::GenericStack_hscript_Token _this4 = this->tokens;
HXDLIN( 412)										_this4->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this4->head);
            									}
            								}
            								else {
HXLINE( 415)									 ::haxe::ds::GenericStack_hscript_Token _this5 = this->tokens;
HXDLIN( 415)									_this5->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this5->head);
            								}
            							}
            							break;
            							case (int)2: {
...
HXLINE( 392)									{
HXLINE( 392)										 ::haxe::ds::GenericStack_hscript_Token _this6 = this->tokens;
HXDLIN( 392)										_this6->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk21,_this6->head);
            									}
HXLINE( 393)									{
HXLINE( 393)										 ::haxe::ds::GenericStack_hscript_Token _this7 = this->tokens;
HXDLIN( 393)										_this7->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this7->head);
            									}
HXLINE( 394)									if (::hx::IsNotNull( tk21 )) {
...
HXLINE( 389)								return this->parseExprNext(::hscript::Expr_obj::EObject(::Array_obj< ::Dynamic>::__new(0)));
            							...
            							break;
            							default:{
HXLINE( 417)								 ::haxe::ds::GenericStack_hscript_Token _this8 = this->tokens;
HXDLIN( 417)								_this8->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this8->head);
            							}
            						}
            					}
...
HXLINE( 423)								_hx_tmp = ::hx::IsPointerEq( tk,::hscript::Token_obj::TEof_dyn() );
            							}
            							else {
...
HXLINE( 425)						{
HXLINE( 425)							 ::haxe::ds::GenericStack_hscript_Token _this9 = this->tokens;
HXDLIN( 425)							_this9->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this9->head);
            						}
            					}
            					_hx_goto_37:;
...
HXLINE( 449)								_hx_tmp1 = ::hx::IsPointerNotEq( tk,::hscript::Token_obj::TEof_dyn() );
            							}
            							else {
...
HXLINE( 450)						{
HXLINE( 450)							 ::haxe::ds::GenericStack_hscript_Token _this10 = this->tokens;
HXDLIN( 450)							_this10->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this10->head);
            						}
...
HXLINE( 456)						_hx_tmp2 = ::hx::IsNotNull( a1->__get(0).StaticCast<  ::hscript::Expr >() );
            					}
            					else {
HXLINE( 456)						_hx_tmp2 = false;
            					}
HXDLIN( 456)					if (_hx_tmp2) {
HXLINE( 457)						 ::hscript::Expr _g6 = a1->__get(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 457)						switch((int)(_g6->_hx_getIndex())){
            							case (int)10: {
HXLINE( 458)								 ::hscript::Expr _g7 = _g6->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 458)								 ::hscript::Expr _g8 = _g6->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXLINE( 459)								::String tmp = (HX_("__a_",fe,af,13,3f) + this->uid++);
HXLINE( 460)								 ::hscript::Expr e3 = ::hscript::Expr_obj::EBlock(::Array_obj< ::Dynamic>::__new(3)->init(0,::hscript::Expr_obj::EVar(tmp,null(),::hscript::Expr_obj::EArrayDecl(::Array_obj< ::Dynamic>::__new(0))))->init(1,this->mapCompr(tmp,a1->__get(0).StaticCast<  ::hscript::Expr >()))->init(2,::hscript::Expr_obj::EIdent(tmp)));
HXLINE( 465)								return this->parseExprNext(e3);
            							}
            							break;
            							case (int)11: {
HXLINE( 458)								::String _g9 = _g6->_hx_getString(0);
HXDLIN( 458)								 ::hscript::Expr _g10 = _g6->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 458)								 ::hscript::Expr _g11 = _g6->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXLINE( 459)								::String tmp1 = (HX_("__a_",fe,af,13,3f) + this->uid++);
HXLINE( 460)								 ::hscript::Expr e4 = ::hscript::Expr_obj::EBlock(::Array_obj< ::Dynamic>::__new(3)->init(0,::hscript::Expr_obj::EVar(tmp1,null(),::hscript::Expr_obj::EArrayDecl(::Array_obj< ::Dynamic>::__new(0))))->init(1,this->mapCompr(tmp1,a1->__get(0).StaticCast<  ::hscript::Expr >()))->init(2,::hscript::Expr_obj::EIdent(tmp1)));
HXLINE( 465)								return this->parseExprNext(e4);
            							}
            							break;
            							case (int)24: {
HXLINE( 458)								 ::hscript::Expr _g12 = _g6->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 458)								 ::hscript::Expr _g13 = _g6->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXLINE( 459)								::String tmp2 = (HX_("__a_",fe,af,13,3f) + this->uid++);
HXLINE( 460)								 ::hscript::Expr e5 = ::hscript::Expr_obj::EBlock(::Array_obj< ::Dynamic>::__new(3)->init(0,::hscript::Expr_obj::EVar(tmp2,null(),::hscript::Expr_obj::EArrayDecl(::Array_obj< ::Dynamic>::__new(0))))->init(1,this->mapCompr(tmp2,a1->__get(0).StaticCast<  ::hscript::Expr >()))->init(2,::hscript::Expr_obj::EIdent(tmp2)));
HXLINE( 465)								return this->parseExprNext(e5);
            							}
            							break;
            							default:{
            							}
...
HXLINE( 468)					return this->parseExprNext(::hscript::Expr_obj::EArrayDecl(a1));
            				}
            				break;
            				case (int)16: {
...
HXLINE( 471)						return ::hscript::Expr_obj::EMeta(id1,args,this->parseExpr());
            					}
            					else {
HXLINE( 473)						return this->unexpected(tk);
            					}
...
HXLINE( 506)			{
HXLINE( 506)				 ::haxe::ds::GenericStack_hscript_Token _this1 = this->tokens;
HXDLIN( 506)				_this1->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this1->head);
            			}
...
HXLINE( 512)								goto _hx_goto_42;
            							...
            							break;
            							default:{
HXLINE( 513)								 ::hscript::Token tk2 = _g;
HXLINE( 514)								this->unexpected(tk2);
            							}
            						}
            					}
            				}
...
HXLINE( 532)					 ::hscript::Expr e1 = _g->__get(0).StaticCast<  ::hscript::Expr >();
HXLINE( 523)					edef = ::hscript::Expr_obj::EBlock(::Array_obj< ::Dynamic>::__new(1)->init(0,this->mapCompr(tmp,e1)));
            				}
            				else {
...
HXDLIN( 530)				 ::hscript::Expr e11 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 530)				 ::hscript::Expr e21 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 530)				if (::hx::IsNull( e21 )) {
HXLINE( 523)					edef = ::hscript::Expr_obj::EIf(cond,this->mapCompr(tmp,e11),null());
            				}
            				else {
HXLINE( 523)					edef = ::hscript::Expr_obj::ECall(::hscript::Expr_obj::EField(::hscript::Expr_obj::EIdent(tmp),HX_("push",da,11,61,4a)),::Array_obj< ::Dynamic>::__new(1)->init(0,e));
            				}
            			...
            			break;
            			case (int)10: {
HXLINE( 526)				 ::hscript::Expr cond1 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 526)				 ::hscript::Expr e22 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXLINE( 523)				edef = ::hscript::Expr_obj::EWhile(cond1,this->mapCompr(tmp,e22));
            			}
            			break;
            			case (int)11: {
HXLINE( 524)				::String v = e->_hx_getString(0);
HXDLIN( 524)				 ::hscript::Expr it = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 524)				 ::hscript::Expr e23 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXLINE( 523)				edef = ::hscript::Expr_obj::EFor(v,it,this->mapCompr(tmp,e23));
            			}
            			break;
            			case (int)24: {
HXLINE( 528)				 ::hscript::Expr cond2 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 528)				 ::hscript::Expr e24 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXLINE( 523)				edef = ::hscript::Expr_obj::EDoWhile(cond2,this->mapCompr(tmp,e24));
            			}
            			break;
            			default:{
HXLINE( 523)				edef = ::hscript::Expr_obj::ECall(::hscript::Expr_obj::EField(::hscript::Expr_obj::EIdent(tmp),HX_("push",da,11,61,4a)),::Array_obj< ::Dynamic>::__new(1)->init(0,e));
...
HXLINE( 545)		 ::hscript::Expr _g = e;
HXDLIN( 545)		switch((int)(_g->_hx_getIndex())){
            			case (int)6: {
HXLINE( 546)				::String bop = _g->_hx_getString(0);
HXDLIN( 546)				 ::hscript::Expr e1 = _g->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 546)				 ::hscript::Expr e2 = _g->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 546)				return ::hscript::Expr_obj::EBinop(bop,this->makeUnop(op,e1),e2);
            			}
            			break;
            			case (int)22: {
HXLINE( 547)				 ::hscript::Expr e11 = _g->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 547)				 ::hscript::Expr e21 = _g->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 547)				 ::hscript::Expr e3 = _g->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 547)				return ::hscript::Expr_obj::ETernary(this->makeUnop(op,e11),e21,e3);
            			}
            			break;
            			default:{
...
HXLINE( 555)		 ::hscript::Expr _g = e;
HXDLIN( 555)		switch((int)(_g->_hx_getIndex())){
            			case (int)6: {
HXLINE( 556)				::String op2 = _g->_hx_getString(0);
HXDLIN( 556)				 ::hscript::Expr e2 = _g->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 556)				 ::hscript::Expr e3 = _g->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXLINE( 560)					return ::hscript::Expr_obj::EBinop(op,e1,e);
            			...
            			break;
            			case (int)22: {
HXLINE( 561)				 ::hscript::Expr e21 = _g->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 561)				 ::hscript::Expr e31 = _g->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 561)				 ::hscript::Expr e4 = _g->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXLINE( 562)				if (this->opRightAssoc->exists(op)) {
HXLINE( 563)					return ::hscript::Expr_obj::EBinop(op,e1,e);
            				}
            				else {
HXLINE( 565)					return ::hscript::Expr_obj::ETernary(this->makeBinop(op,e1,e21),e31,e4);
            				}
            			}
            			break;
            			default:{
...
HXLINE( 629)			 ::hscript::Expr e1 = this->parseExpr();
HXLINE( 630)			return ::hscript::Expr_obj::EFor(vname,eiter,e1);
...
HXLINE( 640)			if (::hx::IsNull( tk1 )) {
HXLINE( 642)				 ::haxe::ds::GenericStack_hscript_Token _this = this->tokens;
HXDLIN( 642)				_this->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk1,_this->head);
            			}
            			else {
...
HXLINE( 642)					 ::haxe::ds::GenericStack_hscript_Token _this1 = this->tokens;
HXDLIN( 642)					_this1->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk1,_this1->head);
            				}
            			}
...
HXLINE( 580)			 ::hscript::Expr e11 = this->parseExpr();
...
HXLINE( 591)				{
HXLINE( 591)					 ::haxe::ds::GenericStack_hscript_Token _this2 = this->tokens;
HXDLIN( 591)					_this2->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk2,_this2->head);
            				}
HXLINE( 592)				if (semic) {
HXLINE( 592)					 ::haxe::ds::GenericStack_hscript_Token _this3 = this->tokens;
HXDLIN( 592)					_this3->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,::hscript::Token_obj::TSemicolon_dyn(),_this3->head);
            				}
            			}
HXLINE( 594)			return ::hscript::Expr_obj::EIf(cond,e11,e2);
...
HXLINE( 648)			{
HXLINE( 648)				 ::haxe::ds::GenericStack_hscript_Token _this4 = this->tokens;
HXDLIN( 648)				_this4->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk4,_this4->head);
            			}
HXLINE( 649)			 ::hscript::Expr e3;
HXDLIN( 649)			if (::hx::IsPointerEq( tk4,::hscript::Token_obj::TSemicolon_dyn() )) {
HXLINE( 649)				e3 = null();
            			}
            			else {
HXLINE( 649)				e3 = this->parseExpr();
            			}
HXLINE( 650)			return ::hscript::Expr_obj::EReturn(e3);
HXLINE( 646)			goto _hx_goto_47;
            		}
            		if (  (_hx_switch_0==HX_("switch",f4,49,79,c5)) ){
HXLINE( 686)			 ::hscript::Expr e4 = this->parseExpr();
...
HXLINE( 696)									 ::hscript::Expr e5 = this->parseExpr();
HXLINE( 697)									( (::Array< ::Dynamic>)(c->__Field(HX_("values",e2,03,b7,4f),::hx::paccDynamic)) )->push(e5);
HXLINE( 698)									tk5 = this->token();
HXLINE( 699)									if (::hx::IsNull( tk5 )) {
...
HXLINE( 712)									{
HXLINE( 712)										 ::haxe::ds::GenericStack_hscript_Token _this5 = this->tokens;
HXDLIN( 712)										_this5->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk5,_this5->head);
            									}
HXLINE( 713)									if (::hx::IsNull( tk5 )) {
...
HXLINE( 734)									{
HXLINE( 734)										 ::haxe::ds::GenericStack_hscript_Token _this6 = this->tokens;
HXDLIN( 734)										_this6->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk5,_this6->head);
            									}
HXLINE( 735)									if (::hx::IsNull( tk5 )) {
...
HXLINE( 745)									def = exprs1->__get(0).StaticCast<  ::hscript::Expr >();
            								}
            								else {
...
HXLINE( 749)										def = ::hscript::Expr_obj::EBlock(exprs1);
            									}
            								}
...
HXLINE( 754)							goto _hx_goto_49;
            			...
            			_hx_goto_49:;
HXLINE( 757)			return ::hscript::Expr_obj::ESwitch(e4,cases,def);
HXLINE( 685)			goto _hx_goto_47;
            		}
            		if (  (_hx_switch_0==HX_("throw",26,5d,90,0f)) ){
HXLINE( 669)			 ::hscript::Expr e6 = this->parseExpr();
HXLINE( 670)			return ::hscript::Expr_obj::EThrow(e6);
HXLINE( 668)			goto _hx_goto_47;
            		}
            		if (  (_hx_switch_0==HX_("try",3b,69,58,00)) ){
HXLINE( 672)			 ::hscript::Expr e7 = this->parseExpr();
HXLINE( 673)			{
...
HXLINE( 684)			return ::hscript::Expr_obj::ETry(e7,vname1,t10,ec);
...
HXLINE( 603)			 ::hscript::Expr e8 = null();
HXLINE( 604)			if (__hxcpp_enum_eq(tk6,::hscript::Token_obj::TOp(HX_("=",3d,00,00,00)))) {
HXLINE( 605)				e8 = this->parseExpr();
            			}
            			else {
HXLINE( 607)				 ::haxe::ds::GenericStack_hscript_Token _this7 = this->tokens;
HXDLIN( 607)				_this7->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk6,_this7->head);
            			}
HXLINE( 608)			return ::hscript::Expr_obj::EVar(ident,t13,e8);
HXLINE( 595)			goto _hx_goto_47;
            		}
            		if (  (_hx_switch_0==HX_("while",b1,43,bd,c9)) ){
HXLINE( 610)			 ::hscript::Expr econd1 = this->parseExpr();
HXLINE( 611)			 ::hscript::Expr e9 = this->parseExpr();
HXLINE( 612)			return ::hscript::Expr_obj::EWhile(econd1,e9);
...
HXLINE( 819)						{
HXLINE( 819)							 ::haxe::ds::GenericStack_hscript_Token _this1 = this->tokens;
HXDLIN( 819)							_this1->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this1->head);
            						}
HXLINE( 820)						return e1;
            					}
            				}
...
HXLINE( 772)									 ::hscript::Expr eret1 = this->parseExpr();
HXLINE( 773)									return ::hscript::Expr_obj::EFunction(::Array_obj< ::Dynamic>::__new(1)->init(0, ::Dynamic(::hx::Anon_obj::Create(1)
            							...
            							break;
            							case (int)26: {
HXLINE( 774)								 ::hscript::Expr _hx_tmp1 = e1->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 774)								if ((_hx_tmp1->_hx_getIndex() == 1)) {
HXLINE( 774)									::String i2 = _hx_tmp1->_hx_getString(0);
HXDLIN( 774)									 ::hscript::CType t = e1->_hx_getObject(1).StaticCast<  ::hscript::CType >();
HXLINE( 775)									 ::hscript::Expr eret2 = this->parseExpr();
...
HXLINE( 784)							{
HXLINE( 784)								 ::haxe::ds::GenericStack_hscript_Token _this2 = this->tokens;
HXDLIN( 784)								_this2->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this2->head);
            							}
HXLINE( 785)							return e1;
            						}
HXLINE( 787)						return this->parseExprNext(::hscript::Expr_obj::EUnop(op1,false,e1));
            					}
...
HXLINE( 798)					 ::hscript::Expr e = ::hscript::Expr_obj::EBlock(::Array_obj< ::Dynamic>::__new(2)->init(0,::hscript::Expr_obj::EVar(tmp,null(),e1))->init(1,::hscript::Expr_obj::ETernary(::hscript::Expr_obj::EBinop(HX_("==",60,35,00,00),::hscript::Expr_obj::EIdent(tmp),::hscript::Expr_obj::EIdent(HX_("null",87,9e,0e,49))),::hscript::Expr_obj::EIdent(HX_("null",87,9e,0e,49)),::hscript::Expr_obj::EField(::hscript::Expr_obj::EIdent(tmp),field1))));
...
HXLINE( 812)					return this->parseExprNext(::hscript::Expr_obj::EArray(e1,e2));
            				...
            				break;
            				case (int)14: {
HXLINE( 814)					 ::hscript::Expr e21 = this->parseExpr();
HXLINE( 815)					{
...
HXLINE( 817)					return ::hscript::Expr_obj::ETernary(e1,e21,e3);
            				}
            				break;
            				default:{
HXLINE( 819)					{
HXLINE( 819)						 ::haxe::ds::GenericStack_hscript_Token _this3 = this->tokens;
HXDLIN( 819)						_this3->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this3->head);
            					}
HXLINE( 820)					return e1;
            				}
            			}
...
HXLINE( 928)						 ::haxe::ds::GenericStack_hscript_Token _this1 = this->tokens;
HXDLIN( 928)						_this1->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,t,_this1->head);
            					}
            					else {
...
HXLINE( 916)														{
HXLINE( 916)															 ::haxe::ds::GenericStack_hscript_Token _this2 = this->tokens;
HXDLIN( 916)															 ::hscript::Token item = ::hscript::Token_obj::TOp(op1.substr(1,null()));
HXDLIN( 916)															_this2->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,item,_this2->head);
            														}
...
HXLINE( 926)								 ::haxe::ds::GenericStack_hscript_Token _this3 = this->tokens;
HXDLIN( 926)								_this3->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,t,_this3->head);
            							}
            						}
            						else {
HXLINE( 928)							 ::haxe::ds::GenericStack_hscript_Token _this4 = this->tokens;
HXDLIN( 928)							_this4->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,t,_this4->head);
            						}
            					}
...
HXLINE( 941)									 ::hscript::Token t2 = _g;
HXDLIN( 941)									_gthis->unexpected(t2);
            								}
            							}
            						}
...
HXLINE( 935)					{
HXLINE( 935)						 ::haxe::ds::GenericStack_hscript_Token _this5 = this->tokens;
HXDLIN( 935)						_this5->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,b,_this5->head);
            					}
HXLINE( 936)					{
HXLINE( 936)						 ::haxe::ds::GenericStack_hscript_Token _this6 = this->tokens;
HXDLIN( 936)						_this6->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,a,_this6->head);
            					}
...
HXLINE( 976)							 ::hscript::Token t2 = _g;
HXDLIN( 976)							return this->unexpected(t2);
            						}
            						else {
...
HXLINE( 975)									return this->parseTypeNext(::hscript::CType_obj::CTParent(t1));
            								...
            								break;
            								case (int)10: {
HXLINE( 966)									::Array< ::Dynamic> args = ::Array_obj< ::Dynamic>::__new(1)->init(0,t1);
HXLINE( 968)									do {
HXLINE( 969)										args->push(this->parseType());
            									} while(this->maybe(::hscript::Token_obj::TComma_dyn()));
;
HXLINE( 972)									{
HXLINE( 972)										 ::hscript::Token t3 = this->token();
HXDLIN( 972)										if (::hx::IsPointerNotEq( t3,::hscript::Token_obj::TPClose_dyn() )) {
HXLINE( 972)											this->unexpected(t3);
            										}
            									}
HXLINE( 973)									return withReturn(args);
            								...
            								break;
            								default:{
HXLINE( 976)									 ::hscript::Token t4 = _g;
HXDLIN( 976)									return this->unexpected(t4);
            								}
            							}
            						}
            					}
...
HXLINE( 947)						switch((int)(a->_hx_getIndex())){
            							case (int)2: {
HXLINE( 948)								::String _g1 = a->_hx_getString(0);
HXLINE( 947)								if (::hx::IsNull( b )) {
HXLINE( 963)									 ::hscript::CType t5 = this->parseType();
HXLINE( 964)									 ::hscript::Token _g2 = this->token();
HXDLIN( 964)									if (::hx::IsNull( _g2 )) {
HXLINE( 976)										 ::hscript::Token t6 = _g2;
HXDLIN( 976)										return this->unexpected(t6);
            									}
            									else {
HXLINE( 964)										switch((int)(_g2->_hx_getIndex())){
            											case (int)5: {
HXLINE( 975)												return this->parseTypeNext(::hscript::CType_obj::CTParent(t5));
            											}
            											break;
            											case (int)10: {
HXLINE( 966)												::Array< ::Dynamic> args1 = ::Array_obj< ::Dynamic>::__new(1)->init(0,t5);
HXLINE( 968)												do {
HXLINE( 969)													args1->push(this->parseType());
            												} while(this->maybe(::hscript::Token_obj::TComma_dyn()));
;
HXLINE( 972)												{
HXLINE( 972)													 ::hscript::Token t7 = this->token();
HXDLIN( 972)													if (::hx::IsPointerNotEq( t7,::hscript::Token_obj::TPClose_dyn() )) {
HXLINE( 972)														this->unexpected(t7);
            													}
            												}
HXLINE( 973)												return withReturn(args1);
            											...
            											break;
            											default:{
HXLINE( 976)												 ::hscript::Token t8 = _g2;
HXDLIN( 976)												return this->unexpected(t8);
            											}
            										}
            									}
            								}
...
HXLINE( 950)										::Array< ::Dynamic> _g3 = ::Array_obj< ::Dynamic>::__new(0);
HXDLIN( 950)										{
HXLINE( 950)											int _g4 = 0;
HXDLIN( 950)											::Array< ::Dynamic> _g5 = this->parseFunctionArgs();
HXDLIN( 950)											while((_g4 < _g5->length)){
HXLINE( 950)												 ::Dynamic arg = _g5->__get(_g4);
HXDLIN( 950)												_g4 = (_g4 + 1);
HXLINE( 951)												{
HXLINE( 951)													 ::hscript::Expr _g6 = arg->__Field(HX_("value",71,7f,b8,31),::hx::paccDynamic);
HXLINE( 952)													if (::hx::IsNotNull( _g6 )) {
HXLINE( 953)														 ::hscript::Expr v1 = _g6;
HXLINE( 954)														if (!(this->resumeErrors)) {
HXLINE( 954)															HX_STACK_DO_THROW(::hscript::Error_obj::ECustom(HX_("Default values not allowed in function types",28,46,7a,e6)));
            														}
            													}
            												}
...
HXDLIN( 957)												_g3->push(::hscript::CType_obj::CTNamed( ::Dynamic(arg->__Field(HX_("name",4b,72,ff,48),::hx::paccDynamic)),_hx_tmp));
            											}
            										}
HXLINE( 950)										::Array< ::Dynamic> args2 = _g3;
HXLINE( 960)										return withReturn(args2);
            									}
            									else {
HXLINE( 963)										 ::hscript::CType t9 = this->parseType();
HXLINE( 964)										 ::hscript::Token _g7 = this->token();
HXDLIN( 964)										if (::hx::IsNull( _g7 )) {
HXLINE( 976)											 ::hscript::Token t10 = _g7;
HXDLIN( 976)											return this->unexpected(t10);
            										}
            										else {
HXLINE( 964)											switch((int)(_g7->_hx_getIndex())){
            												case (int)5: {
HXLINE( 975)													return this->parseTypeNext(::hscript::CType_obj::CTParent(t9));
            												}
            												break;
            												case (int)10: {
HXLINE( 966)													::Array< ::Dynamic> args3 = ::Array_obj< ::Dynamic>::__new(1)->init(0,t9);
HXLINE( 968)													do {
HXLINE( 969)														args3->push(this->parseType());
            													} while(this->maybe(::hscript::Token_obj::TComma_dyn()));
;
HXLINE( 972)													{
HXLINE( 972)														 ::hscript::Token t11 = this->token();
HXDLIN( 972)														if (::hx::IsPointerNotEq( t11,::hscript::Token_obj::TPClose_dyn() )) {
HXLINE( 972)															this->unexpected(t11);
            														}
            													}
HXLINE( 973)													return withReturn(args3);
            												...
            												break;
            												default:{
HXLINE( 976)													 ::hscript::Token t12 = _g7;
HXDLIN( 976)													return this->unexpected(t12);
            												}
            											}
            										}
            									}
            							...
            							break;
            							case (int)5: {
HXLINE( 950)								::Array< ::Dynamic> _g8 = ::Array_obj< ::Dynamic>::__new(0);
HXDLIN( 950)								{
HXLINE( 950)									int _g9 = 0;
HXDLIN( 950)									::Array< ::Dynamic> _g10 = this->parseFunctionArgs();
HXDLIN( 950)									while((_g9 < _g10->length)){
HXLINE( 950)										 ::Dynamic arg1 = _g10->__get(_g9);
HXDLIN( 950)										_g9 = (_g9 + 1);
HXLINE( 951)										{
HXLINE( 951)											 ::hscript::Expr _g11 = arg1->__Field(HX_("value",71,7f,b8,31),::hx::paccDynamic);
HXLINE( 952)											if (::hx::IsNotNull( _g11 )) {
HXLINE( 953)												 ::hscript::Expr v2 = _g11;
HXLINE( 954)												if (!(this->resumeErrors)) {
HXLINE( 954)													HX_STACK_DO_THROW(::hscript::Error_obj::ECustom(HX_("Default values not allowed in function types",28,46,7a,e6)));
            												}
            											}
            										}
HXLINE( 957)										 ::hscript::CType _hx_tmp1;
HXDLIN( 957)										if (( (bool)(arg1->__Field(HX_("opt",33,9c,54,00),::hx::paccDynamic)) )) {
HXLINE( 957)											_hx_tmp1 = ::hscript::CType_obj::CTOpt( ::Dynamic(arg1->__Field(HX_("t",74,00,00,00),::hx::paccDynamic)));
            										}
            										else {
HXLINE( 957)											_hx_tmp1 = arg1->__Field(HX_("t",74,00,00,00),::hx::paccDynamic);
            										}
HXDLIN( 957)										_g8->push(::hscript::CType_obj::CTNamed( ::Dynamic(arg1->__Field(HX_("name",4b,72,ff,48),::hx::paccDynamic)),_hx_tmp1));
            									}
            								}
HXLINE( 950)								::Array< ::Dynamic> args4 = _g8;
HXLINE( 960)								return withReturn(args4);
            							}
            							break;
            							default:{
HXLINE( 963)								 ::hscript::CType t13 = this->parseType();
HXLINE( 964)								 ::hscript::Token _g12 = this->token();
HXDLIN( 964)								if (::hx::IsNull( _g12 )) {
HXLINE( 976)									 ::hscript::Token t14 = _g12;
HXDLIN( 976)									return this->unexpected(t14);
            								}
            								else {
HXLINE( 964)									switch((int)(_g12->_hx_getIndex())){
            										case (int)5: {
HXLINE( 975)											return this->parseTypeNext(::hscript::CType_obj::CTParent(t13));
            										}
            										break;
            										case (int)10: {
HXLINE( 966)											::Array< ::Dynamic> args5 = ::Array_obj< ::Dynamic>::__new(1)->init(0,t13);
HXLINE( 968)											do {
HXLINE( 969)												args5->push(this->parseType());
            											} while(this->maybe(::hscript::Token_obj::TComma_dyn()));
;
HXLINE( 972)											{
HXLINE( 972)												 ::hscript::Token t15 = this->token();
HXDLIN( 972)												if (::hx::IsPointerNotEq( t15,::hscript::Token_obj::TPClose_dyn() )) {
HXLINE( 972)													this->unexpected(t15);
            												}
            											}
HXLINE( 973)											return withReturn(args5);
            										}
            										break;
            										default:{
HXLINE( 976)											 ::hscript::Token t16 = _g12;
HXDLIN( 976)											return this->unexpected(t16);
            										}
            									}
            								}
            							}
...
HXLINE( 984)							switch((int)(t->_hx_getIndex())){
            								case (int)2: {
HXLINE( 992)									::String _g13 = t->_hx_getString(0);
HXDLIN( 992)									if ((_g13 == HX_("var",e7,de,59,00))) {
HXLINE( 987)										::String name = this->getIdent();
HXLINE( 988)										{
HXLINE( 988)											 ::hscript::Token t17 = this->token();
HXDLIN( 988)											if (::hx::IsPointerNotEq( t17,::hscript::Token_obj::TDoubleDot_dyn() )) {
HXLINE( 988)												this->unexpected(t17);
            											}
            										}
...
HXLINE( 991)										{
HXLINE( 991)											 ::hscript::Token t18 = this->token();
HXDLIN( 991)											if (::hx::IsPointerNotEq( t18,::hscript::Token_obj::TSemicolon_dyn() )) {
HXLINE( 991)												this->unexpected(t18);
            											}
            										}
            									}
            									else {
HXLINE( 992)										::String name1 = _g13;
HXDLIN( 992)										{
HXLINE( 993)											{
HXLINE( 993)												 ::hscript::Token t19 = this->token();
HXDLIN( 993)												if (::hx::IsPointerNotEq( t19,::hscript::Token_obj::TDoubleDot_dyn() )) {
HXLINE( 993)													this->unexpected(t19);
            												}
            											}
...
HXLINE(1020)					{
HXLINE(1020)						 ::haxe::ds::GenericStack_hscript_Token _this1 = this->tokens;
HXDLIN(1020)						_this1->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this1->head);
            					}
...
HXLINE(1024)				{
HXLINE(1024)					 ::haxe::ds::GenericStack_hscript_Token _this2 = this->tokens;
HXDLIN(1024)					_this2->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this2->head);
            				}
HXLINE(1025)				return t;
            			}
            		}
...
HXLINE(1083)					{
HXLINE(1083)						 ::haxe::ds::GenericStack_hscript_Token _this1 = this->tokens;
HXDLIN(1083)						_this1->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this1->head);
            					}
HXLINE(1084)					goto _hx_goto_78;
            				}
            			}
...
HXLINE(1092)				HX_STACK_DO_THROW(::hscript::Error_obj::EInvalidOp(HX_("Unsupported class type parameters",9d,ae,a3,50)));
            			}
            		}
...
HXDLIN(1149)							goto _hx_goto_85;
            						...
            						/* default */{
HXLINE(1151)							{
HXLINE(1151)								 ::haxe::ds::GenericStack_hscript_Token _this1 = this->tokens;
HXDLIN(1151)								_this1->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,t,_this1->head);
            							}
HXLINE(1152)							goto _hx_goto_84;
            						}
            						_hx_goto_85:;
...
HXLINE(1151)						{
HXLINE(1151)							 ::haxe::ds::GenericStack_hscript_Token _this2 = this->tokens;
HXDLIN(1151)							_this2->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,t,_this2->head);
            						}
HXLINE(1152)						goto _hx_goto_84;
            					}
            				}
...
HXLINE(1122)					{
HXLINE(1122)						 ::haxe::ds::GenericStack_hscript_Token _this3 = this->tokens;
HXDLIN(1122)						_this3->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,t2,_this3->head);
            					}
HXLINE(1123)					goto _hx_goto_87;
            				}
HXLINE(1125)				t2 = this->token();
HXLINE(1126)				if (::hx::IsNull( t2 )) {
...
HXLINE(1280)					HX_STACK_DO_THROW(::hscript::Error_obj::EUnterminatedString_dyn());
            				}
...
HXLINE(1307)												HX_STACK_DO_THROW(::hscript::Error_obj::EUnterminatedString_dyn());
            											}
            										}
...
HXLINE(1401)										{
HXLINE(1401)											 ::haxe::ds::GenericStack_hscript_Token _this1 = this->tokens;
HXDLIN(1401)											_this1->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,::hscript::Token_obj::TOp(HX_("...",ee,0f,23,00)),_this1->head);
            										}
...
HXLINE(1392)									 ::haxe::ds::GenericStack_hscript_Token _this2 = this->tokens;
HXDLIN(1392)									_this2->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this2->head);
            								}
            								else {
...
HXLINE(1392)												 ::haxe::ds::GenericStack_hscript_Token _this3 = this->tokens;
HXDLIN(1392)												_this3->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this3->head);
            											}
            										}
            										break;
            										case (int)3: {
...
HXLINE(1389)													 ::haxe::ds::GenericStack_hscript_Token _this4 = this->tokens;
HXDLIN(1389)													_this4->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this4->head);
            												}
            												else {
...
HXLINE(1389)															 ::haxe::ds::GenericStack_hscript_Token _this5 = this->tokens;
HXDLIN(1389)															_this5->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this5->head);
            														}
            													}
            													else {
HXLINE(1389)														 ::haxe::ds::GenericStack_hscript_Token _this6 = this->tokens;
HXDLIN(1389)														_this6->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this6->head);
            													}
            												}
            											}
            											else {
HXLINE(1392)												 ::haxe::ds::GenericStack_hscript_Token _this7 = this->tokens;
HXDLIN(1392)												_this7->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this7->head);
            											}
            										}
            										break;
            										default:{
HXLINE(1392)											 ::haxe::ds::GenericStack_hscript_Token _this8 = this->tokens;
HXDLIN(1392)											_this8->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this8->head);
            										}
            									}
            								}
...
HXLINE(1578)				return this->evalPreproCond(e1);
            			...
            			break;
            			case (int)6: {
HXLINE(1581)				 ::hscript::Expr _g = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN(1581)				 ::hscript::Expr _g1 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN(1581)				::String _hx_switch_0 = e->_hx_getString(0);
            				if (  (_hx_switch_0==HX_("&&",40,21,00,00)) ){
HXLINE(1579)					 ::hscript::Expr e11 = _g;
HXDLIN(1579)					 ::hscript::Expr e2 = _g1;
...
HXLINE(1581)					 ::hscript::Expr e12 = _g;
HXDLIN(1581)					 ::hscript::Expr e21 = _g1;
...
HXLINE(1584)							HX_STACK_DO_THROW(err);
            						}
            					}
HXLINE(1585)					return false;
            			...
            			break;
            			case (int)7: {
HXLINE(1575)				bool _g2 = e->_hx_getBool(1);
HXDLIN(1575)				if ((e->_hx_getString(0) == HX_("!",21,00,00,00))) {
HXLINE(1575)					 ::hscript::Expr e3 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXLINE(1576)					return !(this->evalPreproCond(e3));
            				}
            				else {
HXLINE(1584)					{
HXLINE(1584)						 ::hscript::Error err1 = ::hscript::Error_obj::EInvalidPreprocessor((HX_("Can't eval ",01,17,bf,09) + ::Type_obj::enumConstructor(e)));
HXDLIN(1584)						int pmin1 = (this->readPos + this->offset);
HXDLIN(1584)						int pmax1 = (this->readPos + this->offset);
HXDLIN(1584)						if (!(this->resumeErrors)) {
HXLINE(1584)							HX_STACK_DO_THROW(err1);
            						}
            					}
HXLINE(1585)					return false;
            				}
            			...
            			default:{
HXLINE(1584)				{
HXLINE(1584)					 ::hscript::Error err2 = ::hscript::Error_obj::EInvalidPreprocessor((HX_("Can't eval ",01,17,bf,09) + ::Type_obj::enumConstructor(e)));
HXDLIN(1584)					int pmin2 = (this->readPos + this->offset);
HXDLIN(1584)					int pmax2 = (this->readPos + this->offset);
HXDLIN(1584)					if (!(this->resumeErrors)) {
HXLINE(1584)						HX_STACK_DO_THROW(err2);
            					}
            				}
HXLINE(1585)				return false;
            			}
...
HXLINE(1629)					HX_STACK_DO_THROW(::hscript::Error_obj::EInvalidPreprocessor(HX_("Unclosed",e5,94,4a,ea)));
            				}
            			}
...
HXLINE(1660)							HX_STACK_DO_THROW(::hscript::Error_obj::EUnterminatedComment_dyn());
            						}
...
HXLINE(1667)						HX_STACK_DO_THROW(::hscript::Error_obj::EUnterminatedComment_dyn());
            					}
