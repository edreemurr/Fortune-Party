...
::hscript::CType CType_obj::CTNamed(::String n, ::hscript::CType t)
{
	return ::hx::CreateEnum< CType_obj >(HX_("CTNamed",48,63,ca,a1),5,2)->_hx_init(0,n)->_hx_init(1,t);
}

::hscript::CType CType_obj::CTOpt( ::hscript::CType t)
{
...
::hx::Static(__mClass) = ::hx::_hx_RegisterClass(HX_("hscript.CType",62,7a,53,e9), ::hx::TCanCast< CType_obj >,CType_obj_sStaticFields,0,
