...
HX_LOCAL_STACK_FRAME(_hx_pos_4f421a3440b44d31_64_draw,"flixel.FlxSubState","draw",0xafc56fc1,"flixel.FlxSubState.draw","flixel/FlxSubState.hx",64,0xd8a3e54e)
HX_LOCAL_STACK_FRAME(_hx_pos_4f421a3440b44d31_84_destroy,"flixel.FlxSubState","destroy",0xc08a1d5d,"flixel.FlxSubState.destroy","flixel/FlxSubState.hx",84,0xd8a3e54e)
HX_LOCAL_STACK_FRAME(_hx_pos_4f421a3440b44d31_97_close,"flixel.FlxSubState","close",0x85a9195b,"flixel.FlxSubState.close","flixel/FlxSubState.hx",97,0xd8a3e54e)
HX_LOCAL_STACK_FRAME(_hx_pos_4f421a3440b44d31_104_get_bgColor,"flixel.FlxSubState","get_bgColor",0x02e53f58,"flixel.FlxSubState.get_bgColor","flixel/FlxSubState.hx",104,0xd8a3e54e)
HX_LOCAL_STACK_FRAME(_hx_pos_4f421a3440b44d31_109_set_bgColor,"flixel.FlxSubState","set_bgColor",0x0d524664,"flixel.FlxSubState.set_bgColor","flixel/FlxSubState.hx",109,0xd8a3e54e)
namespace flixel{
...
HXLINE(  58)			this->_bgSprite =  ::flixel::_hx_system::FlxBGSprite_obj::__alloc( HX_CTX );
            		}
HXLINE(  60)		this->set_bgColor(bgColor);
            	}
...
void FlxSubState_obj::draw(){
            	HX_STACKFRAME(&_hx_pos_4f421a3440b44d31_64_draw)
HXLINE(  66)		if (::flixel::FlxG_obj::renderBlit) {
HXLINE(  68)			int _g = 0;
HXDLIN(  68)			::Array< ::Dynamic> _g1 = this->getCamerasLegacy();
HXDLIN(  68)			while((_g < _g1->length)){
HXLINE(  68)				 ::flixel::FlxCamera camera = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();
HXDLIN(  68)				_g = (_g + 1);
HXLINE(  70)				camera->fill(this->_bgColor,null(),null(),null());
            			}
            		}
            		else {
HXLINE(  75)			bool _hx_tmp;
HXDLIN(  75)			if (::hx::IsNotNull( this->_bgSprite )) {
HXLINE(  75)				_hx_tmp = this->_bgSprite->visible;
            			}
            			else {
HXLINE(  75)				_hx_tmp = false;
            			}
HXDLIN(  75)			if (_hx_tmp) {
HXLINE(  76)				this->_bgSprite->draw();
            			}
            		}
...
void FlxSubState_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_4f421a3440b44d31_84_destroy)
HXLINE(  85)		this->super::destroy();
HXLINE(  86)		this->closeCallback = null();
HXLINE(  87)		this->openCallback = null();
HXLINE(  88)		this->_parentState = null();
HXLINE(  89)		this->_bgSprite = ( ( ::flixel::_hx_system::FlxBGSprite)(::flixel::util::FlxDestroyUtil_obj::destroy(this->_bgSprite)) );
            	}


void FlxSubState_obj::close(){
            	HX_STACKFRAME(&_hx_pos_4f421a3440b44d31_97_close)
HXDLIN(  97)		bool _hx_tmp;
HXDLIN(  97)		if (::hx::IsNotNull( this->_parentState )) {
HXDLIN(  97)			_hx_tmp = ::hx::IsInstanceEq( this->_parentState->subState,::hx::ObjectPtr<OBJ_>(this) );
            		}
            		else {
HXDLIN(  97)			_hx_tmp = false;
            		}
HXDLIN(  97)		if (_hx_tmp) {
HXLINE(  98)			this->_parentState->closeSubState();
            		}
            	}
...
int FlxSubState_obj::get_bgColor(){
            	HX_STACKFRAME(&_hx_pos_4f421a3440b44d31_104_get_bgColor)
HXDLIN( 104)		return this->_bgColor;
            	}


int FlxSubState_obj::set_bgColor(int value){
            	HX_STACKFRAME(&_hx_pos_4f421a3440b44d31_109_set_bgColor)
HXLINE( 110)		bool _hx_tmp;
HXDLIN( 110)		if (::flixel::FlxG_obj::renderTile) {
HXLINE( 110)			_hx_tmp = ::hx::IsNotNull( this->_bgSprite );
            		}
            		else {
HXLINE( 110)			_hx_tmp = false;
            		}
HXDLIN( 110)		if (_hx_tmp) {
HXLINE( 112)			this->_bgSprite->set_alpha((( (Float)(((value >> 24) & 255)) ) / ( (Float)(255) )));
HXLINE( 113)			this->_bgSprite->set_visible((this->_bgSprite->alpha > 0));
HXLINE( 114)			this->_bgSprite->set_color((value & 16777215));
            		}
HXLINE( 117)		return (this->_bgColor = value);
            	}
