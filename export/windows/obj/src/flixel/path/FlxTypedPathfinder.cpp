...
HXLINE( 406)			int tile = ( ( ::flixel::path::FlxTypedPathfinderData)(data) )->startIndex;
HXDLIN( 406)			 ::Dynamic _this = ( ( ::flixel::path::FlxTypedPathfinderData)(data) )->map;
HXDLIN( 406)			int _hx_tmp1;
HXDLIN( 406)			bool _hx_tmp2;
HXDLIN( 406)			if ((tile >= 0)) {
HXLINE( 406)				_hx_tmp2 = (tile < ( ( ::flixel::tile::FlxBaseTilemap)(_this) )->_data->length);
            			}
            			else {
HXLINE( 406)				_hx_tmp2 = false;
            			}
HXDLIN( 406)			if (_hx_tmp2) {
HXLINE( 406)				_hx_tmp1 = ( ( ::flixel::tile::FlxBaseTilemap)(_this) )->_data->__get(tile);
            			}
            			else {
HXLINE( 406)				_hx_tmp1 = -1;
            			}
HXLINE( 405)			_hx_tmp = (Dynamic( ( ( ::flixel::tile::FlxBaseTilemap)(_this) )->_tileObjects->__get(_hx_tmp1)).StaticCast<  ::flixel::FlxObject >()->allowCollisions == 0);
            		}
            		else {
HXDLIN( 405)			_hx_tmp = false;
            		}
HXDLIN( 405)		if (_hx_tmp) {
HXLINE( 407)			int tile1 = ( ( ::flixel::path::FlxTypedPathfinderData)(data) )->endIndex;
HXDLIN( 407)			 ::Dynamic _this1 = ( ( ::flixel::path::FlxTypedPathfinderData)(data) )->map;
HXDLIN( 407)			int _hx_tmp3;
HXDLIN( 407)			bool _hx_tmp4;
HXDLIN( 407)			if ((tile1 >= 0)) {
HXLINE( 407)				_hx_tmp4 = (tile1 < ( ( ::flixel::tile::FlxBaseTilemap)(_this1) )->_data->length);
            			}
            			else {
HXLINE( 407)				_hx_tmp4 = false;
            			}
HXDLIN( 407)			if (_hx_tmp4) {
HXLINE( 407)				_hx_tmp3 = ( ( ::flixel::tile::FlxBaseTilemap)(_this1) )->_data->__get(tile1);
            			}
            			else {
HXLINE( 407)				_hx_tmp3 = -1;
            			}
HXDLIN( 407)			return (Dynamic( ( ( ::flixel::tile::FlxBaseTilemap)(_this1) )->_tileObjects->__get(_hx_tmp3)).StaticCast<  ::flixel::FlxObject >()->allowCollisions == 0);
            		}
            		else {
