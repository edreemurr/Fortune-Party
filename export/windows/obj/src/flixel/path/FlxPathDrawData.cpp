...
HX_DEFINE_STACK_FRAME(_hx_pos_f056212be7ec3995_452_new,"flixel.path.FlxPathDrawData","new",0xd929d100,"flixel.path.FlxPathDrawData.new","flixel/path/FlxBasePath.hx",452,0xefb220ed)
namespace flixel{
namespace path{
...
HXLINE( 461)		this->endSize = 5;
HXLINE( 460)		this->startSize = 5;
HXLINE( 459)		this->nodeSize = 3;
HXLINE( 458)		this->lineSize = 1;
HXLINE( 457)		this->endColor = -65536;
HXLINE( 456)		this->startColor = -16744448;
HXLINE( 455)		this->nodeColor = -1;
HXLINE( 454)		this->lineColor = -1;
HXLINE( 452)		if (::hx::IsNotNull( lineColor )) {
HXDLIN( 452)			this->lineColor = ( (int)(lineColor) );
            		}
HXDLIN( 452)		if (::hx::IsNotNull( nodeColor )) {
HXDLIN( 452)			this->nodeColor = ( (int)(nodeColor) );
            		}
HXDLIN( 452)		if (::hx::IsNotNull( startColor )) {
HXDLIN( 452)			this->startColor = ( (int)(startColor) );
            		}
HXDLIN( 452)		if (::hx::IsNotNull( endColor )) {
HXDLIN( 452)			this->endColor = ( (int)(endColor) );
            		}
HXDLIN( 452)		if (::hx::IsNotNull( lineSize )) {
HXDLIN( 452)			this->lineSize = ( (int)(lineSize) );
            		}
HXDLIN( 452)		if (::hx::IsNotNull( nodeSize )) {
HXDLIN( 452)			this->nodeSize = ( (int)(nodeSize) );
            		}
HXDLIN( 452)		if (::hx::IsNotNull( startSize )) {
HXDLIN( 452)			this->startSize = ( (int)(startSize) );
            		}
HXDLIN( 452)		if (::hx::IsNotNull( endSize )) {
HXDLIN( 452)			this->endSize = ( (int)(endSize) );
            		}
            	}
