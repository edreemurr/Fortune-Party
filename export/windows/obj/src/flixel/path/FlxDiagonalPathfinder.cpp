...
HXDLIN( 499)		 ::flixel::tile::FlxBaseTilemap _this = ( ( ::flixel::tile::FlxBaseTilemap)(data->map) );
HXDLIN( 499)		int _hx_tmp;
HXDLIN( 499)		bool _hx_tmp1;
HXDLIN( 499)		if ((to >= 0)) {
HXDLIN( 499)			_hx_tmp1 = (to < _this->_data->length);
            		}
            		else {
HXDLIN( 499)			_hx_tmp1 = false;
            		}
HXDLIN( 499)		if (_hx_tmp1) {
HXDLIN( 499)			_hx_tmp = _this->_data->__get(to);
            		}
            		else {
HXDLIN( 499)			_hx_tmp = -1;
            		}
HXDLIN( 499)		return (Dynamic( _this->_tileObjects->__get(_hx_tmp)).StaticCast<  ::flixel::FlxObject >()->allowCollisions == 0);
            	}
