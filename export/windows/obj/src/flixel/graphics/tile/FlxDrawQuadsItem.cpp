...
HX_LOCAL_STACK_FRAME(_hx_pos_6d98322fc3998392_145_setParameterValue,"flixel.graphics.tile.FlxDrawQuadsItem","setParameterValue",0x1b657834,"flixel.graphics.tile.FlxDrawQuadsItem.setParameterValue","flixel/graphics/tile/FlxDrawQuadsItem.hx",145,0x0f089c65)
...
HXDLIN( 119)		if (::hx::IsNull( this->shader )) {
HXLINE( 119)			_hx_tmp = ::hx::IsNull( this->graphics->shader );
            		}
            		else {
HXLINE( 119)			_hx_tmp = false;
            		}
HXDLIN( 119)		if (_hx_tmp) {
HXLINE( 120)			HX_STACK_DO_THROW(HX_("Attempted to render an invalid FlxDrawItem, did you destroy a cached sprite?",7d,cf,f1,6f));
            		}
HXLINE( 122)		 ::flixel::graphics::tile::FlxGraphicsShader shader;
HXDLIN( 122)		if (::hx::IsNotNull( this->shader )) {
HXLINE( 122)			shader = this->shader;
            		}
            		else {
HXLINE( 122)			shader = this->graphics->shader;
            		}
HXLINE( 123)		shader->bitmap->input = this->graphics->bitmap;
HXLINE( 124)		 ::Dynamic _hx_tmp1;
HXDLIN( 124)		bool _hx_tmp2;
HXDLIN( 124)		if (!(camera->antialiasing)) {
HXLINE( 124)			_hx_tmp2 = this->antialiasing;
            		}
            		else {
HXLINE( 124)			_hx_tmp2 = true;
            		}
HXDLIN( 124)		if (_hx_tmp2) {
HXLINE( 124)			_hx_tmp1 = 4;
            		}
            		else {
HXLINE( 124)			_hx_tmp1 = 5;
            		}
HXDLIN( 124)		shader->bitmap->filter = _hx_tmp1;
HXLINE( 125)		shader->alpha->value = this->alphas;
HXLINE( 127)		bool _hx_tmp3;
HXDLIN( 127)		if (!(this->colored)) {
HXLINE( 127)			_hx_tmp3 = this->hasColorOffsets;
            		}
            		else {
HXLINE( 127)			_hx_tmp3 = true;
            		}
HXDLIN( 127)		if (_hx_tmp3) {
HXLINE( 129)			shader->colorMultiplier->value = this->colorMultipliers;
HXLINE( 130)			shader->colorOffset->value = this->colorOffsets;
            		}
HXLINE( 133)		{
HXLINE( 133)			 ::openfl::display::ShaderParameter_Bool parameter = shader->hasTransform;
HXDLIN( 133)			if (::hx::IsNull( parameter->value )) {
HXLINE( 133)				parameter->value = ::Array_obj< bool >::__new(0);
            			}
HXDLIN( 133)			parameter->value[0] = true;
            		}
HXLINE( 134)		{
HXLINE( 134)			 ::openfl::display::ShaderParameter_Bool parameter1 = shader->hasColorTransform;
HXDLIN( 134)			bool value;
HXDLIN( 134)			if (!(this->colored)) {
HXLINE( 134)				value = this->hasColorOffsets;
            			}
            			else {
HXLINE( 134)				value = true;
            			}
HXDLIN( 134)			if (::hx::IsNull( parameter1->value )) {
HXLINE( 134)				parameter1->value = ::Array_obj< bool >::__new(0);
            			}
HXDLIN( 134)			parameter1->value[0] = value;
            		}
HXLINE( 137)		camera->canvas->get_graphics()->overrideBlendMode(this->blend);
HXLINE( 139)		camera->canvas->get_graphics()->beginShaderFill(shader,null());
HXLINE( 140)		camera->canvas->get_graphics()->drawQuads(this->rects,null(),this->transforms);
HXLINE( 141)		this->super::render(camera);
            	}


void FlxDrawQuadsItem_obj::setParameterValue( ::openfl::display::ShaderParameter_Bool parameter,bool value){
            	HX_STACKFRAME(&_hx_pos_6d98322fc3998392_145_setParameterValue)
HXLINE( 146)		if (::hx::IsNull( parameter->value )) {
HXLINE( 147)			parameter->value = ::Array_obj< bool >::__new(0);
            		}
HXLINE( 148)		parameter->value[0] = value;
            	}
