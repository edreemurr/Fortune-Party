...
HX_DEFINE_DYNAMIC_FUNC2(FlxNode_obj,canPlace,return )
 ...
 ::flixel::graphics::frames::FlxTileFrames FlxNode_obj::getTileFrames( ::flixel::math::FlxBasePoint tileSize, ::flixel::math::FlxBasePoint tileSpacing, ::flixel::math::FlxBasePoint tileBorder){
...
HXDLIN( 122)		 ::flixel::graphics::frames::FlxFrame frame = ( ( ::flixel::graphics::frames::FlxFrame)(_this->framesByName->get(this->key)) );
...
HXDLIN( 143)		 ::flixel::graphics::frames::FlxFrame frame = ( ( ::flixel::graphics::frames::FlxFrame)(_this->framesByName->get(this->key)) );
