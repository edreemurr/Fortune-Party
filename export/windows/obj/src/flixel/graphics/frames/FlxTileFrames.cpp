...
HXDLIN( 517)		if (point1->_weak) {
HXLINE( 517)			point1->put();
            		}
...
HXDLIN( 517)		if (border->_weak) {
HXLINE( 517)			border->put();
            		}
...
HXLINE( 527)		 ::flixel::math::FlxRect _this = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN( 527)		_this->x = ( (Float)(0) );
HXDLIN( 527)		_this->y = ( (Float)(0) );
HXDLIN( 527)		_this->width = ( (Float)(0) );
HXDLIN( 527)		_this->height = ( (Float)(0) );
HXDLIN( 527)		 ::flixel::math::FlxRect rect = _this;
HXDLIN( 527)		rect->_inPool = false;
HXDLIN( 527)		 ::flixel::math::FlxRect _this1 = rect;
HXDLIN( 527)		 ::flixel::math::FlxRect Rect = this->region;
HXDLIN( 527)		_this1->x = Rect->x;
HXDLIN( 527)		_this1->y = Rect->y;
HXDLIN( 527)		_this1->width = Rect->width;
HXDLIN( 527)		_this1->height = Rect->height;
...
HXDLIN( 527)		tileFrames->region = _this1;
...
HXDLIN(  94)		if (tileSize->_weak) {
HXLINE(  94)			tileSize->put();
            		}
