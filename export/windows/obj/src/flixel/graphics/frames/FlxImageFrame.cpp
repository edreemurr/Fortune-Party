...
HXDLIN( 219)				result3 = (::Math_obj::abs((border->y - point->y)) <= ((Float)0.0000001));
            			}
            			else {
...
HXLINE( 205)					 ::flixel::math::FlxBasePoint point2 = imageFrame->border;
HXDLIN( 205)					bool result3;
HXDLIN( 205)					if ((::Math_obj::abs((frameBorder->x - point2->x)) <= ((Float)0.0000001))) {
HXLINE( 205)						result3 = (::Math_obj::abs((frameBorder->y - point2->y)) <= ((Float)0.0000001));
            					}
            					else {
