...
HXLINE(  63)		int total = (this->tileSprite->get_numFrames() + empties);
...
HXDLIN(  82)			this->makeGraphic(_hx_tmp3,::Std_obj::_hx_int(this->get_height()),0,true,null());
            		}
            		else {
...
HXLINE( 157)		 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(tileWidth,tileHeight);
