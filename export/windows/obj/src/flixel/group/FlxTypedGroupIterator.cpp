...
HX_DEFINE_STACK_FRAME(_hx_pos_a2c5aad29e94c731_942_new,"flixel.group.FlxTypedGroupIterator","new",0xa7153fe6,"flixel.group.FlxTypedGroupIterator.new","flixel/group/FlxGroup.hx",942,0x1e89d58e)
HX_LOCAL_STACK_FRAME(_hx_pos_a2c5aad29e94c731_951_next,"flixel.group.FlxTypedGroupIterator","next",0x8b82aaad,"flixel.group.FlxTypedGroupIterator.next","flixel/group/FlxGroup.hx",951,0x1e89d58e)
HX_LOCAL_STACK_FRAME(_hx_pos_a2c5aad29e94c731_955_hasNext,"flixel.group.FlxTypedGroupIterator","hasNext",0x559d4ff3,"flixel.group.FlxTypedGroupIterator.hasNext","flixel/group/FlxGroup.hx",955,0x1e89d58e)
namespace flixel{
namespace group{

void FlxTypedGroupIterator_obj::__construct(::cpp::VirtualArray groupMembers, ::Dynamic filter){
            	HX_STACKFRAME(&_hx_pos_a2c5aad29e94c731_942_new)
HXLINE( 943)		this->_groupMembers = groupMembers;
HXLINE( 944)		this->_filter = filter;
HXLINE( 945)		this->_cursor = 0;
HXLINE( 946)		this->_length = this->_groupMembers->get_length();
            	}
...
bool FlxTypedGroupIterator_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic FlxTypedGroupIterator_obj::next(){
            	HX_STACKFRAME(&_hx_pos_a2c5aad29e94c731_951_next)
HXDLIN( 951)		if (this->hasNext()) {
HXDLIN( 951)			return this->_groupMembers->__get(this->_cursor++);
            		}
            		else {
HXDLIN( 951)			return null();
            		}
HXDLIN( 951)		return null();
            	}
...
bool FlxTypedGroupIterator_obj::hasNext(){
            	HX_STACKFRAME(&_hx_pos_a2c5aad29e94c731_955_hasNext)
HXLINE( 956)		while(true){
HXLINE( 956)			bool _hx_tmp;
HXDLIN( 956)			if ((this->_cursor < this->_length)) {
HXLINE( 956)				if (::hx::IsNotNull( this->_groupMembers->__get(this->_cursor) )) {
HXLINE( 956)					if (::hx::IsNotNull( this->_filter )) {
HXLINE( 956)						_hx_tmp = !(( (bool)(this->_filter(this->_groupMembers->__get(this->_cursor))) ));
            					}
            					else {
...
HXLINE( 956)				goto _hx_goto_2;
            			}
HXLINE( 958)			this->_cursor++;
            		}
            		_hx_goto_2:;
HXLINE( 960)		return (this->_cursor < this->_length);
            	}
