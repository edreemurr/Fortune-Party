...
HXDLIN(  25)		return this->keyManager->checkStatusUnsafe(keyCode,this->status);
            	}
...
HXLINE(  32)					_hx_tmp = this->keyManager->checkStatusUnsafe(( (int)(key->ID) ),this->status);
            				}
            				else {
...
HXLINE(  44)					_hx_tmp = this->keyManager->checkStatusUnsafe(( (int)(key->ID) ),this->status);
            				}
            				else {
