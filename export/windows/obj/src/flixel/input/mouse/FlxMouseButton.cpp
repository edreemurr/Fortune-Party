...
HXDLIN(  37)				Float y = ( (Float)(::flixel::FlxG_obj::mouse->viewY) );
HXDLIN(  37)				this1->set_x(( (Float)(::flixel::FlxG_obj::mouse->viewX) ));
...
HXDLIN(  43)				 ::flixel::math::FlxBasePoint this2 = this->justPressedPosition;
HXDLIN(  43)				 ::flixel::math::FlxBasePoint p = null();
HXDLIN(  43)				if (::hx::IsNull( p )) {
HXLINE(  43)					 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN(  43)					point->_inPool = false;
HXDLIN(  43)					p = point;
            				}
HXDLIN(  43)				Float y1 = this2->y;
HXDLIN(  43)				p->set_x(this2->x);
HXDLIN(  43)				p->set_y(y1);
HXDLIN(  43)				 ::flixel::math::FlxBasePoint _hx_tmp2 = ::flixel::FlxG_obj::mouse->getViewPosition(null(),null());
HXDLIN(  43)				_hx_tmp->push( ::flixel::input::FlxSwipe_obj::__alloc( HX_CTX ,_hx_tmp1,p,_hx_tmp2,this->justPressedTimeInTicks));
            			}
            		}
            	}
