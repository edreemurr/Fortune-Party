...
HX_LOCAL_STACK_FRAME(_hx_pos_92ec9d1968218ffd_145_fromString,"flixel.input.gamepad._FlxGamepadInputID.FlxGamepadInputID_Impl_","fromString",0xff2eba07,"flixel.input.gamepad._FlxGamepadInputID.FlxGamepadInputID_Impl_.fromString","flixel/input/gamepad/FlxGamepadInputID.hx",145,0x292d23ae)
HX_LOCAL_STACK_FRAME(_hx_pos_92ec9d1968218ffd_153_toString,"flixel.input.gamepad._FlxGamepadInputID.FlxGamepadInputID_Impl_","toString",0xe73bb9d8,"flixel.input.gamepad._FlxGamepadInputID.FlxGamepadInputID_Impl_.toString","flixel/input/gamepad/FlxGamepadInputID.hx",153,0x292d23ae)
...
HX_LOCAL_STACK_FRAME(_hx_pos_92ec9d1968218ffd_135_boot,"flixel.input.gamepad._FlxGamepadInputID.FlxGamepadInputID_Impl_","boot",0xe219675e,"flixel.input.gamepad._FlxGamepadInputID.FlxGamepadInputID_Impl_.boot","flixel/input/gamepad/FlxGamepadInputID.hx",135,0x292d23ae)
HX_LOCAL_STACK_FRAME(_hx_pos_92ec9d1968218ffd_141_boot,"flixel.input.gamepad._FlxGamepadInputID.FlxGamepadInputID_Impl_","boot",0xe219675e,"flixel.input.gamepad._FlxGamepadInputID.FlxGamepadInputID_Impl_.boot","flixel/input/gamepad/FlxGamepadInputID.hx",141,0x292d23ae)
namespace flixel{
namespace input{
namespace gamepad{
...
int FlxGamepadInputID_Impl__obj::ACCEPT;

int FlxGamepadInputID_Impl__obj::CANCEL;

int FlxGamepadInputID_Impl__obj::fromString(::String s){
            	HX_STACKFRAME(&_hx_pos_92ec9d1968218ffd_145_fromString)
HXLINE( 146)		s = s.toUpperCase();
HXLINE( 147)		if (::flixel::input::gamepad::_FlxGamepadInputID::FlxGamepadInputID_Impl__obj::fromStringMap->exists(s)) {
HXLINE( 147)			return ::flixel::input::gamepad::_FlxGamepadInputID::FlxGamepadInputID_Impl__obj::fromStringMap->get_int(s);
            		}
            		else {
HXLINE( 147)			return -1;
            		}
...
::String FlxGamepadInputID_Impl__obj::toString(int this1){
            	HX_STACKFRAME(&_hx_pos_92ec9d1968218ffd_153_toString)
HXDLIN( 153)		return ::flixel::input::gamepad::_FlxGamepadInputID::FlxGamepadInputID_Impl__obj::toStringMap->get_string(this1);
            	}
...
static ::hx::StaticInfo FlxGamepadInputID_Impl__obj_sStaticStorageInfo[] = {
	...
	{::hx::fsInt,(void *) &FlxGamepadInputID_Impl__obj::ACCEPT,HX_("ACCEPT",08,3f,89,bd)},
	{::hx::fsInt,(void *) &FlxGamepadInputID_Impl__obj::CANCEL,HX_("CANCEL",7a,99,b6,6a)},
	{ ::hx::fsUnknown, 0, null()}
};
#endif
...
static void FlxGamepadInputID_Impl__obj_sMarkStatics(HX_MARK_PARAMS) {
	...
	HX_MARK_MEMBER_NAME(FlxGamepadInputID_Impl__obj::ACCEPT,"ACCEPT");
	HX_MARK_MEMBER_NAME(FlxGamepadInputID_Impl__obj::CANCEL,"CANCEL");
};
...
static void FlxGamepadInputID_Impl__obj_sVisitStatics(HX_VISIT_PARAMS) {
	...
	HX_VISIT_MEMBER_NAME(FlxGamepadInputID_Impl__obj::ACCEPT,"ACCEPT");
	HX_VISIT_MEMBER_NAME(FlxGamepadInputID_Impl__obj::CANCEL,"CANCEL");
};
...
HXDLIN(  54)			_g->set(HX_("ACCEPT",08,3f,89,bd),42);
HXDLIN(  54)			_g->set(HX_("CANCEL",7a,99,b6,6a),43);
HXDLIN(  54)			return _g;
            		}
...
HXDLIN(  54)			_g->set(42,HX_("ACCEPT",08,3f,89,bd));
HXDLIN(  54)			_g->set(43,HX_("CANCEL",7a,99,b6,6a));
HXDLIN(  54)			return _g;
            		}
            		HX_END_LOCAL_FUNC0(return)
...
{
            	HX_STACKFRAME(&_hx_pos_92ec9d1968218ffd_135_boot)
HXDLIN( 135)		ACCEPT = 42;
            	}
{
            	HX_STACKFRAME(&_hx_pos_92ec9d1968218ffd_141_boot)
HXDLIN( 141)		CANCEL = 43;
            	}
}
