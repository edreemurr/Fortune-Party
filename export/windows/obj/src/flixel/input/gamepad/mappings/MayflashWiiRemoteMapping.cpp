...
HX_LOCAL_STACK_FRAME(_hx_pos_b96995a19667a299_28_getID,"flixel.input.gamepad.mappings.MayflashWiiRemoteMapping","getID",0x3c1a43a5,"flixel.input.gamepad.mappings.MayflashWiiRemoteMapping.getID","flixel/input/gamepad/mappings/MayflashWiiRemoteMapping.hx",28,0xb7763ebe)
HX_LOCAL_STACK_FRAME(_hx_pos_b96995a19667a299_38_getIDClassicController,"flixel.input.gamepad.mappings.MayflashWiiRemoteMapping","getIDClassicController",0xdc580be9,"flixel.input.gamepad.mappings.MayflashWiiRemoteMapping.getIDClassicController","flixel/input/gamepad/mappings/MayflashWiiRemoteMapping.hx",38,0xb7763ebe)
HX_LOCAL_STACK_FRAME(_hx_pos_b96995a19667a299_69_getIDNunchuk,"flixel.input.gamepad.mappings.MayflashWiiRemoteMapping","getIDNunchuk",0xf7a650dd,"flixel.input.gamepad.mappings.MayflashWiiRemoteMapping.getIDNunchuk","flixel/input/gamepad/mappings/MayflashWiiRemoteMapping.hx",69,0xb7763ebe)
...
HX_LOCAL_STACK_FRAME(_hx_pos_b96995a19667a299_263_getMappedInput,"flixel.input.gamepad.mappings.MayflashWiiRemoteMapping","getMappedInput",0xae90e22d,"flixel.input.gamepad.mappings.MayflashWiiRemoteMapping.getMappedInput","flixel/input/gamepad/mappings/MayflashWiiRemoteMapping.hx",263,0xb7763ebe)
HX_LOCAL_STACK_FRAME(_hx_pos_b96995a19667a299_267_getInputLabel,"flixel.input.gamepad.mappings.MayflashWiiRemoteMapping","getInputLabel",0x116cb774,"flixel.input.gamepad.mappings.MayflashWiiRemoteMapping.getInputLabel","flixel/input/gamepad/mappings/MayflashWiiRemoteMapping.hx",267,0xb7763ebe)
namespace flixel{
namespace input{
namespace gamepad{
namespace mappings{
...
int MayflashWiiRemoteMapping_obj::getID( ::Dynamic _tmp_rawID){
            	HX_STACKFRAME(&_hx_pos_b96995a19667a299_28_getID)
HXDLIN(  28)		int rawID = ( (int)(_tmp_rawID) );
HXDLIN(  28)		switch((int)(this->attachment->_hx_getIndex())){
            			case (int)0: {
HXLINE(  31)				return this->getIDNunchuk(rawID);
            			}
            			break;
            			case (int)1: {
HXLINE(  30)				return this->getIDClassicController(rawID);
            			}
            			break;
            			case (int)2: {
HXLINE(  32)				return this->getIDDefault(rawID);
            			}
            			break;
            		}
...
int MayflashWiiRemoteMapping_obj::getIDClassicController(int rawID){
            	HX_STACKFRAME(&_hx_pos_b96995a19667a299_38_getIDClassicController)
HXDLIN(  38)		switch((int)(rawID)){
            			case (int)4: {
HXLINE(  51)				return 11;
            			}
            			break;
...
int MayflashWiiRemoteMapping_obj::getIDNunchuk(int rawID){
            	HX_STACKFRAME(&_hx_pos_b96995a19667a299_69_getIDNunchuk)
...
HXDLIN(  84)				if (::hx::IsEq( id,::flixel::input::gamepad::id::_MayflashWiiRemoteID::MayflashWiiRemoteID_Impl__obj::LEFT_ANALOG_STICK->rawUp )) {
HXLINE(  84)					return 34;
            				}
            				else {
HXLINE(  85)					int id1 = rawID;
HXDLIN(  85)					if (::hx::IsEq( id1,::flixel::input::gamepad::id::_MayflashWiiRemoteID::MayflashWiiRemoteID_Impl__obj::LEFT_ANALOG_STICK->rawDown )) {
HXLINE(  85)						return 36;
            					}
            					else {
HXLINE(  86)						int id2 = rawID;
HXDLIN(  86)						if (::hx::IsEq( id2,::flixel::input::gamepad::id::_MayflashWiiRemoteID::MayflashWiiRemoteID_Impl__obj::LEFT_ANALOG_STICK->rawLeft )) {
HXLINE(  86)							return 37;
            						}
            						else {
HXLINE(  87)							int id3 = rawID;
HXDLIN(  87)							if (::hx::IsEq( id3,::flixel::input::gamepad::id::_MayflashWiiRemoteID::MayflashWiiRemoteID_Impl__obj::LEFT_ANALOG_STICK->rawRight )) {
HXLINE(  87)								return 35;
            							}
            							else {
HXLINE(  88)								return -1;
...
HXLINE( 258)		return this->super::set_attachment(attachment);
 ...
 ::flixel::input::gamepad::FlxGamepadMappedInput MayflashWiiRemoteMapping_obj::getMappedInput(int id){
            	HX_STACKFRAME(&_hx_pos_b96995a19667a299_263_getMappedInput)
HXDLIN( 263)		return ::flixel::input::gamepad::FlxGamepadMappedInput_obj::MAYFLASH_WII(this->getRawID(id));
            	}


::String MayflashWiiRemoteMapping_obj::getInputLabel(int id){
            	HX_STACKFRAME(&_hx_pos_b96995a19667a299_267_getInputLabel)
HXLINE( 268)		::String label = ::flixel::input::gamepad::mappings::WiiRemoteMapping_obj::getWiiInputLabel(id,this->attachment);
HXLINE( 269)		if (::hx::IsNull( label )) {
HXLINE( 270)			return this->super::getInputLabel(id);
            		}
HXLINE( 272)		return label;
            	}
