...
HX_DEFINE_STACK_FRAME(_hx_pos_605e85deecbe4d03_213_new,"flixel.effects.FlxFlicker","new",0x4bc826b6,"flixel.effects.FlxFlicker.new","flixel/effects/FlxFlicker.hx",213,0x4fa53f38)
...
HX_LOCAL_STACK_FRAME(_hx_pos_605e85deecbe4d03_151_pause,"flixel.effects.FlxFlicker","pause",0x0f4eeecc,"flixel.effects.FlxFlicker.pause","flixel/effects/FlxFlicker.hx",151,0x4fa53f38)
HX_LOCAL_STACK_FRAME(_hx_pos_605e85deecbe4d03_162_resume,"flixel.effects.FlxFlicker","resume",0x6ec22d17,"flixel.effects.FlxFlicker.resume","flixel/effects/FlxFlicker.hx",162,0x4fa53f38)
HX_LOCAL_STACK_FRAME(_hx_pos_605e85deecbe4d03_173_stop,"flixel.effects.FlxFlicker","stop",0x06b324ec,"flixel.effects.FlxFlicker.stop","flixel/effects/FlxFlicker.hx",173,0x4fa53f38)
HX_LOCAL_STACK_FRAME(_hx_pos_605e85deecbe4d03_183_release,"flixel.effects.FlxFlicker","release",0x68babf1d,"flixel.effects.FlxFlicker.release","flixel/effects/FlxFlicker.hx",183,0x4fa53f38)
HX_LOCAL_STACK_FRAME(_hx_pos_605e85deecbe4d03_192_flickerProgress,"flixel.effects.FlxFlicker","flickerProgress",0x5258c61b,"flixel.effects.FlxFlicker.flickerProgress","flixel/effects/FlxFlicker.hx",192,0x4fa53f38)
...
void FlxFlicker_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_605e85deecbe4d03_213_new)
            	}
...
void FlxFlicker_obj::pause(){
            	HX_STACKFRAME(&_hx_pos_605e85deecbe4d03_151_pause)
HXLINE( 152)		if (::hx::IsNull( this->timer )) {
HXLINE( 153)			return;
            		}
HXLINE( 155)		this->timer->active = false;
            	}


HX_DEFINE_DYNAMIC_FUNC0(FlxFlicker_obj,pause,(void))

void FlxFlicker_obj::resume(){
            	HX_STACKFRAME(&_hx_pos_605e85deecbe4d03_162_resume)
HXLINE( 163)		if (::hx::IsNull( this->timer )) {
HXLINE( 164)			return;
            		}
HXLINE( 166)		this->timer->active = true;
            	}


HX_DEFINE_DYNAMIC_FUNC0(FlxFlicker_obj,resume,(void))

void FlxFlicker_obj::stop(){
            	HX_STACKFRAME(&_hx_pos_605e85deecbe4d03_173_stop)
HXLINE( 174)		this->timer->cancel();
HXLINE( 175)		this->object->set_visible(true);
HXLINE( 176)		this->release();
            	}
...
void FlxFlicker_obj::release(){
            	HX_STACKFRAME(&_hx_pos_605e85deecbe4d03_183_release)
HXLINE( 184)		::flixel::effects::FlxFlicker_obj::_boundObjects->remove(this->object);
HXLINE( 185)		::flixel::effects::FlxFlicker_obj::_pool->put(::hx::ObjectPtr<OBJ_>(this));
            	}
...
void FlxFlicker_obj::flickerProgress( ::flixel::util::FlxTimer timer){
            	HX_STACKFRAME(&_hx_pos_605e85deecbe4d03_192_flickerProgress)
HXLINE( 193)		this->object->set_visible(!(this->object->visible));
HXLINE( 195)		if (::hx::IsNotNull( this->progressCallback )) {
HXLINE( 196)			this->progressCallback(::hx::ObjectPtr<OBJ_>(this));
            		}
HXLINE( 198)		bool _hx_tmp;
HXDLIN( 198)		if ((timer->loops > 0)) {
HXLINE( 198)			_hx_tmp = ((timer->loops - timer->_loopsCounter) == 0);
            		}
            		else {
HXLINE( 198)			_hx_tmp = false;
            		}
HXDLIN( 198)		if (_hx_tmp) {
HXLINE( 200)			this->object->set_visible(this->endVisibility);
HXLINE( 201)			if (::hx::IsNotNull( this->completionCallback )) {
HXLINE( 202)				this->completionCallback(::hx::ObjectPtr<OBJ_>(this));
            			}
HXLINE( 204)			if (::hx::IsInstanceEq( this->timer,timer )) {
HXLINE( 205)				this->release();
            			}
            		}
            	}
