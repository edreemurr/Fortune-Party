...
HXDLIN( 286)		 ::flixel::util::LabelValuePair _this = ::flixel::util::LabelValuePair_obj::_pool->get().StaticCast<  ::flixel::util::LabelValuePair >();
HXDLIN( 286)		_this->label = HX_("variables",b7,e2,62,82);
HXDLIN( 286)		_this->value = value;
HXLINE( 287)		 ::Dynamic value1 = this->extensions;
HXDLIN( 287)		 ::flixel::util::LabelValuePair _this1 = ::flixel::util::LabelValuePair_obj::_pool->get().StaticCast<  ::flixel::util::LabelValuePair >();
