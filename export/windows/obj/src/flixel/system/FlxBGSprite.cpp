...
HX_LOCAL_STACK_FRAME(_hx_pos_cd150b1d3fa70035_24_draw,"flixel.system.FlxBGSprite","draw",0x1cf08403,"flixel.system.FlxBGSprite.draw","flixel/system/FlxBGSprite.hx",24,0xa9844f6f)
namespace flixel{
...
HXLINE(  14)		this->makeGraphic(1,1,-1,true,::flixel::FlxG_obj::bitmap->getUniqueKey(HX_("bg_graphic_",b1,39,19,0d)));
HXLINE(  15)		{
HXLINE(  15)			 ::flixel::math::FlxBasePoint this1 = this->scrollFactor;
...
void FlxBGSprite_obj::draw(){
            	HX_STACKFRAME(&_hx_pos_cd150b1d3fa70035_24_draw)
HXDLIN(  24)		int _g = 0;
HXDLIN(  24)		::Array< ::Dynamic> _g1 = this->getCamerasLegacy();
HXDLIN(  24)		while((_g < _g1->length)){
HXDLIN(  24)			 ::flixel::FlxCamera camera = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();
HXDLIN(  24)			_g = (_g + 1);
HXLINE(  26)			bool _hx_tmp;
HXDLIN(  26)			if (camera->visible) {
HXLINE(  26)				_hx_tmp = !(camera->exists);
            			}
            			else {
...
HXLINE(  31)			this->_matrix->identity();
HXLINE(  32)			this->_matrix->scale((( (Float)(camera->width) ) - (camera->viewMarginX * ( (Float)(2) ))),(( (Float)(camera->height) ) - (camera->viewMarginY * ( (Float)(2) ))));
HXLINE(  33)			this->_matrix->translate(camera->viewMarginX,camera->viewMarginY);
HXLINE(  34)			camera->drawPixels(this->frame,null(),this->_matrix,this->colorTransform,null(),null(),null());
            		}
            	}
