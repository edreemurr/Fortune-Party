...
HX_LOCAL_STACK_FRAME(_hx_pos_a4ce3a91bdd58bc5_283_getBitmapData,"flixel.system.FlxAssets","getBitmapData",0x17128189,"flixel.system.FlxAssets.getBitmapData","flixel/system/FlxAssets.hx",283,0xd3ac1356)
HX_LOCAL_STACK_FRAME(_hx_pos_a4ce3a91bdd58bc5_294_getBitmapFromClass,"flixel.system.FlxAssets","getBitmapFromClass",0x223d9eaf,"flixel.system.FlxAssets.getBitmapFromClass","flixel/system/FlxAssets.hx",294,0xd3ac1356)
HX_LOCAL_STACK_FRAME(_hx_pos_a4ce3a91bdd58bc5_308_resolveBitmapData,"flixel.system.FlxAssets","resolveBitmapData",0x02df705f,"flixel.system.FlxAssets.resolveBitmapData","flixel/system/FlxAssets.hx",308,0xd3ac1356)
HX_LOCAL_STACK_FRAME(_hx_pos_a4ce3a91bdd58bc5_337_resolveKey,"flixel.system.FlxAssets","resolveKey",0xd790f639,"flixel.system.FlxAssets.resolveKey","flixel/system/FlxAssets.hx",337,0xd3ac1356)
HX_LOCAL_STACK_FRAME(_hx_pos_a4ce3a91bdd58bc5_367_getSound,"flixel.system.FlxAssets","getSound",0x306e52ff,"flixel.system.FlxAssets.getSound","flixel/system/FlxAssets.hx",367,0xd3ac1356)
HX_LOCAL_STACK_FRAME(_hx_pos_a4ce3a91bdd58bc5_380_getSoundAddExtension,"flixel.system.FlxAssets","getSoundAddExtension",0xecd556bd,"flixel.system.FlxAssets.getSoundAddExtension","flixel/system/FlxAssets.hx",380,0xd3ac1356)
HX_LOCAL_STACK_FRAME(_hx_pos_a4ce3a91bdd58bc5_388_getVirtualInputFrames,"flixel.system.FlxAssets","getVirtualInputFrames",0xfe1716d5,"flixel.system.FlxAssets.getVirtualInputFrames","flixel/system/FlxAssets.hx",388,0xd3ac1356)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(FlxAssets_obj,drawLogo,(void))
 ...
 ::openfl::display::BitmapData FlxAssets_obj::getBitmapData(::String id){
            	HX_STACKFRAME(&_hx_pos_a4ce3a91bdd58bc5_283_getBitmapData)
HXDLIN( 283)		 ::flixel::_hx_system::debug::log::LogStyle logStyle = null();
HXDLIN( 283)		return ( ( ::openfl::display::BitmapData)(::flixel::FlxG_obj::assets->getAsset(id,HX_("image",5b,1f,69,bd),false,logStyle)) );
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(FlxAssets_obj,getBitmapData,return )
 ...
 ::openfl::display::BitmapData FlxAssets_obj::getBitmapFromClass(::hx::Class source){
            	HX_STACKFRAME(&_hx_pos_a4ce3a91bdd58bc5_294_getBitmapFromClass)
HXDLIN( 294)		return ( ( ::openfl::display::BitmapData)(::Type_obj::createInstance(source,::cpp::VirtualArray_obj::__new(0))) );
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(FlxAssets_obj,getBitmapFromClass,return )
 ...
 ::openfl::display::BitmapData FlxAssets_obj::resolveBitmapData( ::Dynamic graphic){
            	HX_STACKFRAME(&_hx_pos_a4ce3a91bdd58bc5_308_resolveBitmapData)
HXLINE( 309)		if (::Std_obj::isOfType(graphic,::hx::ClassOf< ::openfl::display::BitmapData >())) {
HXLINE( 311)			return ( ( ::openfl::display::BitmapData)(graphic) );
            		}
            		else {
HXLINE( 313)			if (::Std_obj::isOfType(graphic,::hx::ClassOf< ::hx::Class >())) {
HXLINE( 315)				return ( ( ::openfl::display::BitmapData)(::Type_obj::createInstance(graphic,::cpp::VirtualArray_obj::__new(0))) );
            			}
            			else {
HXLINE( 317)				if (::Std_obj::isOfType(graphic,::hx::ClassOf< ::String >())) {
HXLINE( 319)					 ::flixel::_hx_system::debug::log::LogStyle logStyle = null();
HXDLIN( 319)					return ( ( ::openfl::display::BitmapData)(::flixel::FlxG_obj::assets->getAsset(( (::String)(graphic) ),HX_("image",5b,1f,69,bd),false,logStyle)) );
            				}
            			}
            		}
...
::String FlxAssets_obj::resolveKey( ::Dynamic graphic,::String key){
            	HX_STACKFRAME(&_hx_pos_a4ce3a91bdd58bc5_337_resolveKey)
HXLINE( 338)		if (::hx::IsNotNull( key )) {
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(FlxAssets_obj,resolveKey,return )
 ...
 ::openfl::media::Sound FlxAssets_obj::getSound(::String id){
            	HX_STACKFRAME(&_hx_pos_a4ce3a91bdd58bc5_367_getSound)
HXDLIN( 367)		return ::flixel::_hx_system::FlxAssets_obj::getSoundAddExtension(id,null());
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(FlxAssets_obj,getSound,return )
 ...
 ::openfl::media::Sound FlxAssets_obj::getSoundAddExtension(::String id,::hx::Null< bool >  __o_useCache){
            	...
            	HX_STACKFRAME(&_hx_pos_a4ce3a91bdd58bc5_380_getSoundAddExtension)
HXLINE( 381)		bool _hx_tmp;
HXDLIN( 381)		bool _hx_tmp1;
HXDLIN( 381)		if (!(::StringTools_obj::endsWith(id,HX_(".mp3",02,e8,ba,1e)))) {
HXLINE( 381)			_hx_tmp1 = !(::StringTools_obj::endsWith(id,HX_(".ogg",e1,64,bc,1e)));
            		}
            		else {
HXLINE( 381)			_hx_tmp1 = false;
            		}
HXDLIN( 381)		if (_hx_tmp1) {
HXLINE( 381)			_hx_tmp = !(::StringTools_obj::endsWith(id,HX_(".wav",be,71,c2,1e)));
            		}
            		else {
HXLINE( 381)			_hx_tmp = false;
            		}
HXDLIN( 381)		if (_hx_tmp) {
HXLINE( 382)			id = (id + (HX_(".",2e,00,00,00) + ::flixel::_hx_system::FlxAssets_obj::defaultSoundExtension));
            		}
HXLINE( 384)		return ( ( ::openfl::media::Sound)(::flixel::FlxG_obj::assets->getAssetUnsafe(id,HX_("sound",cf,8c,cc,80),useCache)) );
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(FlxAssets_obj,getSoundAddExtension,return )
 ...
 ::flixel::graphics::frames::FlxAtlasFrames FlxAssets_obj::getVirtualInputFrames(){
            	HX_GC_STACKFRAME(&_hx_pos_a4ce3a91bdd58bc5_388_getVirtualInputFrames)
HXLINE( 389)		 ::flixel::_hx_system::GraphicVirtualInput bitmapData =  ::flixel::_hx_system::GraphicVirtualInput_obj::__alloc( HX_CTX ,0,0,null(),null());
HXLINE( 394)		 ::flixel::graphics::FlxGraphic graphic = ::flixel::graphics::FlxGraphic_obj::fromBitmapData(bitmapData,null(),null(),null());
HXLINE( 395)		return ::flixel::graphics::frames::FlxAtlasFrames_obj::fromSpriteSheetPacker(graphic,::Std_obj::string( ::flixel::_hx_system::VirtualInputData_obj::__alloc( HX_CTX ,null())));
            	}
