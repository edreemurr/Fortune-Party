...
HX_LOCAL_STACK_FRAME(_hx_pos_c713eb0ccb2ced4e_97_set_horizontalAlign,"flixel.system.scaleModes.BaseScaleMode","set_horizontalAlign",0x8b3e18b7,"flixel.system.scaleModes.BaseScaleMode.set_horizontalAlign","flixel/system/scaleModes/BaseScaleMode.hx",97,0x5a3188fe)
HX_LOCAL_STACK_FRAME(_hx_pos_c713eb0ccb2ced4e_108_set_verticalAlign,"flixel.system.scaleModes.BaseScaleMode","set_verticalAlign",0x71923e65,"flixel.system.scaleModes.BaseScaleMode.set_verticalAlign","flixel/system/scaleModes/BaseScaleMode.hx",108,0x5a3188fe)
namespace flixel{
...
HXDLIN(  45)		 ::flixel::math::FlxBasePoint this1 = this->gameSize;
HXDLIN(  45)		this1->set_x(( (Float)(Width) ));
HXDLIN(  45)		this1->set_y(( (Float)(Height) ));
            	}
...
HXDLIN(  50)		 ::flixel::math::FlxBasePoint this1 = this->deviceSize;
HXDLIN(  50)		this1->set_x(( (Float)(Width) ));
HXDLIN(  50)		this1->set_y(( (Float)(Height) ));
            	}
...
HXLINE(  55)		this->scale->set_x((this->gameSize->x / ( (Float)(::flixel::FlxG_obj::width) )));
HXLINE(  56)		this->scale->set_y((this->gameSize->y / ( (Float)(::flixel::FlxG_obj::height) )));
...
HXDLIN(  63)		 ::flixel::math::FlxBasePoint this1 = this->offset;
HXDLIN(  63)		Float x;
...
HXDLIN(  63)				x = ( (Float)(0) );
            			...
            			break;
            			case (int)1: {
HXDLIN(  63)				x = ( (Float)(::Math_obj::ceil(((this->deviceSize->x - this->gameSize->x) * ((Float)0.5)))) );
            			}
            			break;
            			case (int)2: {
HXDLIN(  63)				x = (this->deviceSize->x - this->gameSize->x);
            			}
            			break;
            		}
HXDLIN(  63)		this1->set_x(x);
            	}
...
HXDLIN(  76)		 ::flixel::math::FlxBasePoint this1 = this->offset;
HXDLIN(  76)		Float y;
...
HXDLIN(  76)				y = ( (Float)(0) );
            			...
            			break;
            			case (int)1: {
HXDLIN(  76)				y = ( (Float)(::Math_obj::ceil(((this->deviceSize->y - this->gameSize->y) * ((Float)0.5)))) );
            			}
            			break;
            			case (int)2: {
HXDLIN(  76)				y = (this->deviceSize->y - this->gameSize->y);
            			}
            			break;
            		}
...
HX_DEFINE_DYNAMIC_FUNC0(BaseScaleMode_obj,updateGamePosition,(void))
 ...
 ::flixel::util::FlxHorizontalAlign BaseScaleMode_obj::set_horizontalAlign( ::flixel::util::FlxHorizontalAlign value){
            	HX_STACKFRAME(&_hx_pos_c713eb0ccb2ced4e_97_set_horizontalAlign)
HXLINE(  98)		this->horizontalAlign = value;
HXLINE(  99)		if (::hx::IsNotNull( this->offset )) {
HXLINE( 101)			this->updateOffsetX();
HXLINE( 102)			this->updateGamePosition();
            		}
...
HX_DEFINE_DYNAMIC_FUNC1(BaseScaleMode_obj,set_horizontalAlign,return )
 ...
 ::flixel::util::FlxVerticalAlign BaseScaleMode_obj::set_verticalAlign( ::flixel::util::FlxVerticalAlign value){
            	HX_STACKFRAME(&_hx_pos_c713eb0ccb2ced4e_108_set_verticalAlign)
HXLINE( 109)		this->verticalAlign = value;
HXLINE( 110)		if (::hx::IsNotNull( this->offset )) {
HXLINE( 112)			this->updateOffsetY();
HXLINE( 113)			this->updateGamePosition();
            		}
