...
HXLINE(  96)			if (( (bool)(::flixel::FlxG_obj::assets->exists(str,null())) )) {
HXLINE(  97)				::String text = ( (::String)(::flixel::FlxG_obj::assets->getAssetUnsafe(str,HX_("text",ad,cc,f9,4c),true)) );
HXDLIN(  97)				 ::Dynamic _hx_tmp;
HXDLIN(  97)				if (::hx::IsNotNull( text )) {
HXLINE(  97)					_hx_tmp =  ::haxe::format::JsonParser_obj::__alloc( HX_CTX ,text)->doParse();
            				}
            				else {
HXLINE(  97)					_hx_tmp = null();
            				}
HXDLIN(  97)				return _hx_tmp;
            			}
HXLINE(  99)			 ::flixel::_hx_system::frontEnds::AssetFrontEnd _this = ::flixel::FlxG_obj::assets;
HXDLIN(  99)			return  ::haxe::format::JsonParser_obj::__alloc( HX_CTX ,str)->doParse();
            		}
...
HXDLIN( 107)		::String text = ( (::String)(::flixel::FlxG_obj::assets->getAssetUnsafe(path,HX_("text",ad,cc,f9,4c),true)) );
HXDLIN( 107)		 ::Dynamic _hx_tmp;
HXDLIN( 107)		if (::hx::IsNotNull( text )) {
HXDLIN( 107)			_hx_tmp =  ::haxe::format::JsonParser_obj::__alloc( HX_CTX ,text)->doParse();
            		}
            		else {
HXDLIN( 107)			_hx_tmp = null();
            		}
HXDLIN( 107)		return _hx_tmp;
            	}
