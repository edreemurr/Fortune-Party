...
HXLINE(  69)			if (( (bool)(::flixel::FlxG_obj::assets->exists(str,null())) )) {
HXLINE(  70)				::String text = ( (::String)(::flixel::FlxG_obj::assets->getAssetUnsafe(str,HX_("text",ad,cc,f9,4c),true)) );
HXDLIN(  70)				 ::Xml _hx_tmp;
HXDLIN(  70)				if (::hx::IsNotNull( text )) {
HXLINE(  70)					_hx_tmp = ::Xml_obj::parse(text);
            				}
            				else {
HXLINE(  70)					_hx_tmp = null();
            				}
HXDLIN(  70)				return _hx_tmp;
            			}
HXLINE(  72)			 ::flixel::_hx_system::frontEnds::AssetFrontEnd _this = ::flixel::FlxG_obj::assets;
HXDLIN(  72)			return ::Xml_obj::parse(str);
            		}
...
HXDLIN(  80)		::String text = ( (::String)(::flixel::FlxG_obj::assets->getAssetUnsafe(path,HX_("text",ad,cc,f9,4c),true)) );
HXDLIN(  80)		if (::hx::IsNotNull( text )) {
HXDLIN(  80)			return ::Xml_obj::parse(text);
            		}
            		else {
...
HXDLIN(  85)		 ::flixel::_hx_system::frontEnds::AssetFrontEnd _this = ::flixel::FlxG_obj::assets;
