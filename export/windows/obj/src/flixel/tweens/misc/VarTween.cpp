...
HX_LOCAL_STACK_FRAME(_hx_pos_a4370a0a6fec63c7_66_initializeVars,"flixel.tweens.misc.VarTween","initializeVars",0x0a5a5e18,"flixel.tweens.misc.VarTween.initializeVars","flixel/tweens/misc/VarTween.hx",66,0x836bddcb)
HX_LOCAL_STACK_FRAME(_hx_pos_a4370a0a6fec63c7_96_setStartValues,"flixel.tweens.misc.VarTween","setStartValues",0x27dd8a5e,"flixel.tweens.misc.VarTween.setStartValues","flixel/tweens/misc/VarTween.hx",96,0x836bddcb)
HX_LOCAL_STACK_FRAME(_hx_pos_a4370a0a6fec63c7_111_destroy,"flixel.tweens.misc.VarTween","destroy",0xef76787e,"flixel.tweens.misc.VarTween.destroy","flixel/tweens/misc/VarTween.hx",111,0x836bddcb)
HX_LOCAL_STACK_FRAME(_hx_pos_a4370a0a6fec63c7_119_isTweenOf,"flixel.tweens.misc.VarTween","isTweenOf",0x7afc521c,"flixel.tweens.misc.VarTween.isTweenOf","flixel/tweens/misc/VarTween.hx",119,0x836bddcb)
namespace flixel{
namespace tweens{
namespace misc{
...
HXLINE(  59)			if (this->active) {
HXLINE(  60)				int _g = 0;
HXDLIN(  60)				::Array< ::Dynamic> _g1 = this->_propertyInfos;
HXDLIN(  60)				while((_g < _g1->length)){
HXLINE(  60)					 ::Dynamic info = _g1->__get(_g);
HXDLIN(  60)					_g = (_g + 1);
HXLINE(  61)					::Reflect_obj::setProperty( ::Dynamic(info->__Field(HX_("object",bf,7e,3f,15),::hx::paccDynamic)),( (::String)(info->__Field(HX_("field",ba,94,93,00),::hx::paccDynamic)) ), ::Dynamic((info->__Field(HX_("startValue",af,57,cf,4d),::hx::paccDynamic) + (( (Float)(info->__Field(HX_("range",bd,a5,1f,e4),::hx::paccDynamic)) ) * this->scale))));
            				}
            			}
            		}
            	}
...
void VarTween_obj::initializeVars(){
            	HX_STACKFRAME(&_hx_pos_a4370a0a6fec63c7_66_initializeVars)
HXLINE(  67)		::Array< ::String > fieldPaths;
HXLINE(  68)		if (::Reflect_obj::isObject(this->_properties)) {
HXLINE(  69)			fieldPaths = ::Reflect_obj::fields(this->_properties);
            		}
            		else {
HXLINE(  71)			HX_STACK_DO_THROW(HX_("Unsupported properties container - use an object containing key/value pairs.",0b,19,89,5b));
            		}
HXLINE(  73)		{
HXLINE(  73)			int _g = 0;
HXDLIN(  73)			while((_g < fieldPaths->length)){
HXLINE(  73)				::String fieldPath = fieldPaths->__get(_g);
HXDLIN(  73)				_g = (_g + 1);
HXLINE(  75)				 ::Dynamic target = this->_object;
HXLINE(  76)				::Array< ::String > path = fieldPath.split(HX_(".",2e,00,00,00));
HXLINE(  77)				::String field = ( (::String)(path->pop()) );
HXLINE(  78)				{
HXLINE(  78)					int _g1 = 0;
HXDLIN(  78)					while((_g1 < path->length)){
HXLINE(  78)						::String component = path->__get(_g1);
HXDLIN(  78)						_g1 = (_g1 + 1);
HXLINE(  80)						target = ::Reflect_obj::getProperty(target,component);
HXLINE(  81)						if (!(::Reflect_obj::isObject(target))) {
HXLINE(  82)							HX_STACK_DO_THROW(((((HX_("The object does not have the property \"",5c,e6,6d,12) + component) + HX_("\" in \"",e5,cf,af,4a)) + fieldPath) + HX_("\"",22,00,00,00)));
            						}
            					}
            				}
HXLINE(  85)				::Array< ::Dynamic> _hx_tmp = this->_propertyInfos;
HXLINE(  88)				Float _hx_tmp1 = ::Math_obj::NaN;
HXLINE(  85)				_hx_tmp->push( ::Dynamic(::hx::Anon_obj::Create(4)
...
void VarTween_obj::setStartValues(){
            	HX_STACKFRAME(&_hx_pos_a4370a0a6fec63c7_96_setStartValues)
HXDLIN(  96)		int _g = 0;
HXDLIN(  96)		::Array< ::Dynamic> _g1 = this->_propertyInfos;
HXDLIN(  96)		while((_g < _g1->length)){
HXDLIN(  96)			 ::Dynamic info = _g1->__get(_g);
HXDLIN(  96)			_g = (_g + 1);
HXLINE(  98)			if (::hx::IsNull( ::Reflect_obj::getProperty( ::Dynamic(info->__Field(HX_("object",bf,7e,3f,15),::hx::paccDynamic)),( (::String)(info->__Field(HX_("field",ba,94,93,00),::hx::paccDynamic)) )) )) {
HXLINE(  99)				HX_STACK_DO_THROW( ::Dynamic(((HX_("The object does not have the property \"",5c,e6,6d,12) + info->__Field(HX_("field",ba,94,93,00),::hx::paccDynamic)) + HX_("\"",22,00,00,00))));
            			}
HXLINE( 101)			 ::Dynamic value = ::Reflect_obj::getProperty( ::Dynamic(info->__Field(HX_("object",bf,7e,3f,15),::hx::paccDynamic)),( (::String)(info->__Field(HX_("field",ba,94,93,00),::hx::paccDynamic)) ));
HXLINE( 102)			if (::Math_obj::isNaN(( (Float)(value) ))) {
HXLINE( 103)				HX_STACK_DO_THROW( ::Dynamic(((HX_("The property \"",06,e3,80,a4) + info->__Field(HX_("field",ba,94,93,00),::hx::paccDynamic)) + HX_("\" is not numeric.",66,4f,2a,cf))));
            			}
HXLINE( 105)			info->__SetField(HX_("startValue",af,57,cf,4d),value,::hx::paccDynamic);
HXLINE( 106)			info->__SetField(HX_("range",bd,a5,1f,e4),(( (Float)(info->__Field(HX_("range",bd,a5,1f,e4),::hx::paccDynamic)) ) - ( (Float)(value) )),::hx::paccDynamic);
            		}
            	}
...
void VarTween_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_a4370a0a6fec63c7_111_destroy)
HXLINE( 112)		this->super::destroy();
HXLINE( 113)		this->_object = null();
HXLINE( 114)		this->_properties = null();
HXLINE( 115)		this->_propertyInfos = null();
            	}


bool VarTween_obj::isTweenOf( ::Dynamic object,::String field){
            	HX_STACKFRAME(&_hx_pos_a4370a0a6fec63c7_119_isTweenOf)
HXLINE( 120)		bool _hx_tmp;
HXDLIN( 120)		if (::hx::IsEq( object,this->_object )) {
HXLINE( 120)			_hx_tmp = ::hx::IsNull( field );
            		}
            		else {
...
HXLINE( 123)		{
HXLINE( 123)			int _g = 0;
HXDLIN( 123)			::Array< ::Dynamic> _g1 = this->_propertyInfos;
HXDLIN( 123)			while((_g < _g1->length)){
HXLINE( 123)				 ::Dynamic property = _g1->__get(_g);
HXDLIN( 123)				_g = (_g + 1);
HXLINE( 125)				bool _hx_tmp1;
HXDLIN( 125)				if (::hx::IsEq( object,property->__Field(HX_("object",bf,7e,3f,15),::hx::paccDynamic) )) {
HXLINE( 125)					if (::hx::IsNotEq( field,property->__Field(HX_("field",ba,94,93,00),::hx::paccDynamic) )) {
HXLINE( 125)						_hx_tmp1 = ::hx::IsNull( field );
            					}
            					else {
