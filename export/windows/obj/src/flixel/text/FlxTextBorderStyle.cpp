...
::flixel::text::FlxTextBorderStyle FlxTextBorderStyle_obj::SHADOW_XY(Float offsetX,Float offsetY)
{
	return ::hx::CreateEnum< FlxTextBorderStyle_obj >(HX_("SHADOW_XY",40,9b,1e,f0),2,2)->_hx_init(0,offsetX)->_hx_init(1,offsetY);
}
...
bool FlxTextBorderStyle_obj::__GetStatic(const ::String &inName, ::Dynamic &outValue, ::hx::PropertyAccess inCallProp)
{
	...
	if (inName==HX_("SHADOW_XY",40,9b,1e,f0)) { outValue = FlxTextBorderStyle_obj::SHADOW_XY_dyn(); return true; }
...
int FlxTextBorderStyle_obj::__FindIndex(::String inName)
{
	...
	if (inName==HX_("OUTLINE",62,eb,91,61)) return 3;
	if (inName==HX_("OUTLINE_FAST",d9,37,1b,3f)) return 4;
	if (inName==HX_("SHADOW",e0,73,a3,cf)) return 1;
	if (inName==HX_("SHADOW_XY",40,9b,1e,f0)) return 2;
	return super::__FindIndex(inName);
}

STATIC_HX_DEFINE_DYNAMIC_FUNC2(FlxTextBorderStyle_obj,SHADOW_XY,return)
...
::hx::Val FlxTextBorderStyle_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	if (inName==HX_("SHADOW_XY",40,9b,1e,f0)) return SHADOW_XY_dyn();
...
OUTLINE = ::hx::CreateConstEnum< FlxTextBorderStyle_obj >(HX_("OUTLINE",62,eb,91,61),3);
OUTLINE_FAST = ::hx::CreateConstEnum< FlxTextBorderStyle_obj >(HX_("OUTLINE_FAST",d9,37,1b,3f),4);
