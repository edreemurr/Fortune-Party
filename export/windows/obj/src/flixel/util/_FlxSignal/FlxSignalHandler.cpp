...
HX_DEFINE_STACK_FRAME(_hx_pos_d696dc5400e6ca39_83_new,"flixel.util._FlxSignal.FlxSignalHandler","new",0x24d8c59b,"flixel.util._FlxSignal.FlxSignalHandler.new","flixel/util/FlxSignal.hx",83,0x3c758c5e)
HX_LOCAL_STACK_FRAME(_hx_pos_d696dc5400e6ca39_96_destroy,"flixel.util._FlxSignal.FlxSignalHandler","destroy",0xffcddbb5,"flixel.util._FlxSignal.FlxSignalHandler.destroy","flixel/util/FlxSignal.hx",96,0x3c758c5e)
namespace flixel{
namespace util{
namespace _FlxSignal{

void FlxSignalHandler_obj::__construct( ::Dynamic listener,bool dispatchOnce){
            	HX_STACKFRAME(&_hx_pos_d696dc5400e6ca39_83_new)
HXLINE(  86)		this->dispatchOnce = false;
HXLINE(  90)		this->listener = listener;
HXLINE(  91)		this->dispatchOnce = dispatchOnce;
            	}
...
void FlxSignalHandler_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_d696dc5400e6ca39_96_destroy)
HXDLIN(  96)		this->listener = null();
            	}
