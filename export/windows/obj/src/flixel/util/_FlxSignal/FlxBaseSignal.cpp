...
HX_DEFINE_STACK_FRAME(_hx_pos_06997c0c7386deb2_100_new,"flixel.util._FlxSignal.FlxBaseSignal","new",0x2468c304,"flixel.util._FlxSignal.FlxBaseSignal.new","flixel/util/FlxSignal.hx",100,0x3c758c5e)
...
void FlxBaseSignal_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_06997c0c7386deb2_100_new)
HXLINE( 109)		this->processingListeners = false;
HXLINE( 113)		this->handlers = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 114)		this->pendingRemove = ::Array_obj< ::Dynamic>::__new(0);
            	}
...
void FlxBaseSignal_obj::add( ::Dynamic listener){
            	HX_STACKFRAME(&_hx_pos_06997c0c7386deb2_119_add)
HXDLIN( 119)		if (::hx::IsNotNull( listener )) {
HXLINE( 120)			this->registerListener(listener,false);
            		}
            	}
...
void FlxBaseSignal_obj::addOnce( ::Dynamic listener){
            	HX_STACKFRAME(&_hx_pos_06997c0c7386deb2_125_addOnce)
HXDLIN( 125)		if (::hx::IsNotNull( listener )) {
HXLINE( 126)			this->registerListener(listener,true);
            		}
            	}
...
void FlxBaseSignal_obj::remove( ::Dynamic listener){
            	HX_STACKFRAME(&_hx_pos_06997c0c7386deb2_131_remove)
HXDLIN( 131)		if (::hx::IsNotNull( listener )) {
