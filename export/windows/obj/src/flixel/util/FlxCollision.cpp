...
HXLINE( 289)			{
HXLINE( 289)				if (start->_weak) {
HXLINE( 289)					start->put();
            				}
HXDLIN( 289)				if (end->_weak) {
HXLINE( 289)					end->put();
            				}
...
HXLINE( 295)			{
HXLINE( 295)				if (start->_weak) {
HXLINE( 295)					start->put();
            				}
HXDLIN( 295)				if (end->_weak) {
HXLINE( 295)					end->put();
            				}
...
HXDLIN( 300)		if (start->_weak) {
HXLINE( 300)			start->put();
            		}
