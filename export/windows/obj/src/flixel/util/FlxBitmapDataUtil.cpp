...
HXLINE(  92)			_hx_tmp11 = (sourceRect->height <= 0);
            		}
            		else {
...
HXDLIN( 124)					int _g3 = height;
HXDLIN( 124)					while((_g2 < _g3)){
HXLINE( 124)						_g2 = (_g2 + 1);
HXDLIN( 124)						int j = (_g2 - 1);
...
HXDLIN( 215)											if ((diff3 >= 0)) {
HXLINE( 215)												Alpha1 = diff3;
            											}
            											else {
HXLINE( 215)												Alpha1 = (256 + diff3);
            											}
HXDLIN( 215)											int color5 = ::flixel::util::_FlxColor::FlxColor_Impl__obj::_new(null());
HXDLIN( 215)											{
HXLINE( 215)												color5 = (color5 & -16711681);
HXDLIN( 215)												color5 = (color5 | 16711680);
            											}
HXDLIN( 215)											{
HXLINE( 215)												color5 = (color5 & -65281);
HXDLIN( 215)												color5 = (color5 | 65280);
            											}
HXDLIN( 215)											{
HXLINE( 215)												color5 = (color5 & -256);
HXDLIN( 215)												color5 = (color5 | 255);
            											}
HXDLIN( 215)											{
HXLINE( 215)												color5 = (color5 & 16777215);
HXDLIN( 215)												int color6;
HXDLIN( 215)												if ((Alpha1 > 255)) {
HXLINE( 215)													color6 = 255;
            												}
            												else {
HXLINE( 215)													if ((Alpha1 < 0)) {
HXLINE( 215)														color6 = 0;
            													}
            													else {
...
HXDLIN( 215)												color5 = (color5 | (color6 << 24));
            											}
...
HXLINE( 300)						 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(x,y);
...
STATIC_HX_DEFINE_DYNAMIC_FUNC5(FlxBitmapDataUtil_obj,replaceColor,return )
 ...
 ::openfl::display::BitmapData FlxBitmapDataUtil_obj::addSpacesAndBorders( ::openfl::display::BitmapData bitmapData, ::flixel::math::FlxBasePoint frameSize, ::flixel::math::FlxBasePoint spacing, ::flixel::math::FlxBasePoint border, ::flixel::math::FlxRect region){
...
HXDLIN( 330)			 ::flixel::math::FlxRect _this = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
...
HXDLIN( 376)					int _g3 = numVerticalFrames;
HXDLIN( 376)					while((_g2 < _g3)){
HXLINE( 376)						_g2 = (_g2 + 1);
HXDLIN( 376)						int j = (_g2 - 1);
...
HXLINE( 426)				{
HXLINE( 426)					int _g4 = 0;
HXDLIN( 426)					int _g5 = borderX;
HXDLIN( 426)					while((_g4 < _g5)){
HXLINE( 426)						_g4 = (_g4 + 1);
HXDLIN( 426)						int j1 = (_g4 - 1);
HXLINE( 428)						tempPoint->x = ((tempRect->x + j1) + 1);
...
HXLINE( 435)		{
HXLINE( 435)			int _g6 = 0;
HXDLIN( 435)			int _g7 = verticalFrames;
HXDLIN( 435)			while((_g6 < _g7)){
HXLINE( 435)				_g6 = (_g6 + 1);
HXDLIN( 435)				int i1 = (_g6 - 1);
HXLINE( 437)				tempRect->y = ( (Float)(((i1 * ((frameHeight + (2 * borderY)) + spaceY)) + borderY)) );
HXLINE( 439)				{
HXLINE( 439)					int _g8 = 0;
HXDLIN( 439)					int _g9 = borderY;
HXDLIN( 439)					while((_g8 < _g9)){
HXLINE( 439)						_g8 = (_g8 + 1);
HXDLIN( 439)						int j2 = (_g8 - 1);
HXLINE( 441)						tempPoint->y = ((tempRect->y - ( (Float)(j2) )) - ( (Float)(1) ));
...
HXDLIN( 445)				tempRect2->y = (tempRect2->y + (frameHeight - 1));
HXLINE( 447)				{
HXLINE( 447)					int _g10 = 0;
HXDLIN( 447)					int _g11 = borderY;
HXDLIN( 447)					while((_g10 < _g11)){
HXLINE( 447)						_g10 = (_g10 + 1);
HXDLIN( 447)						int j3 = (_g10 - 1);
HXLINE( 449)						tempPoint->y = ((tempRect->y + j3) + 1);
