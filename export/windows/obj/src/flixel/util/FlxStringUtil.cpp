...
HXLINE( 571)			 ::flixel::_hx_system::debug::log::LogStyle logStyle = null();
HXDLIN( 571)			tempBitmapData = ( ( ::openfl::display::BitmapData)(::flixel::FlxG_obj::assets->getAsset(( (::String)(ImageFile) ),HX_("image",5b,1f,69,bd),false,logStyle)) );
            		}
            		else {
