...
HXLINE( 324)		if (Point1->_weak) {
HXLINE( 324)			Point1->put();
            		}
HXLINE( 325)		if (Point2->_weak) {
HXLINE( 325)			Point2->put();
            		}
...
HXLINE( 343)		if (Point->_weak) {
HXLINE( 343)			Point->put();
            		}
...
HXLINE( 375)			if (origin->_weak) {
HXLINE( 375)				origin->put();
            			}
...
HXLINE( 415)		if (origin->_weak) {
HXLINE( 415)			origin->put();
            		}
