...
HXLINE(  72)			Float dx = ((Source->x + Source->origin->x) - ( (Float)(::flixel::FlxG_obj::mouse->viewX) ));
HXDLIN(  72)			Float dy = ((Source->y + Source->origin->y) - ( (Float)(::flixel::FlxG_obj::mouse->viewY) ));
