...
HXLINE(  19)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("Fortune Party",07,5b,55,99),::ApplicationMain_obj::create_dyn());
...
HXLINE(  39)		app->meta->set(HX_("company",3d,15,69,83),HX_("Elliot Hollifield",2f,fe,49,60));
HXLINE(  40)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("Fortune Party",07,5b,55,99));
HXLINE(  41)		app->meta->set(HX_("name",4b,72,ff,48),HX_("Fortune Party",07,5b,55,99));
...
HXLINE(  49)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("Fortune Party",07,5b,55,99))
