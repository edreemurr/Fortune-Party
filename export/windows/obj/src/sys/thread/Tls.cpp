...
HX_DEFINE_STACK_FRAME(_hx_pos_609bc848841cc887_34_new,"sys.thread.Tls","new",0xc6b2daea,"sys.thread.Tls.new","C:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/thread/Tls.hx",34,0x0fcbe140)
HX_LOCAL_STACK_FRAME(_hx_pos_609bc848841cc887_38_get_value,"sys.thread.Tls","get_value",0x0e3669d2,"sys.thread.Tls.get_value","C:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/thread/Tls.hx",38,0x0fcbe140)
HX_LOCAL_STACK_FRAME(_hx_pos_609bc848841cc887_41_set_value,"sys.thread.Tls","set_value",0xf18755de,"sys.thread.Tls.set_value","C:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/thread/Tls.hx",41,0x0fcbe140)
HX_LOCAL_STACK_FRAME(_hx_pos_609bc848841cc887_27_boot,"sys.thread.Tls","boot",0x0de5b268,"sys.thread.Tls.boot","C:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/thread/Tls.hx",27,0x0fcbe140)
namespace sys{
namespace thread{

void Tls_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_609bc848841cc887_34_new)
...
bool Tls_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic Tls_obj::get_value(){
            	HX_STACKFRAME(&_hx_pos_609bc848841cc887_38_get_value)
...
HX_DEFINE_DYNAMIC_FUNC0(Tls_obj,get_value,return )
 ...
 ::Dynamic Tls_obj::set_value( ::Dynamic v){
            	HX_STACKFRAME(&_hx_pos_609bc848841cc887_41_set_value)
...
{
{
            	HX_STACKFRAME(&_hx_pos_609bc848841cc887_27_boot)
