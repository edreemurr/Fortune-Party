...
HXLINE(  76)		 ::Dynamic data;
HXDLIN(  76)		 ::Dynamic manifest;
HXDLIN(  76)		 ::Dynamic bundle;
HXLINE(  78)		{
HXLINE(  78)			::String v = (::ManifestResources_obj::rootPath + HX_("manifest/default.json",95,ea,cc,42));
HXDLIN(  78)			::lime::utils::Assets_obj::libraryPaths->set(HX_("default",c1,d8,c3,9b),v);
            		}
HXLINE(  76)		 ::lime::utils::AssetLibrary library = ::lime::utils::Assets_obj::getLibrary(HX_("default",c1,d8,c3,9b));
HXLINE(  82)		if (::hx::IsNotNull( library )) {
HXLINE(  82)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE(  83)			::ManifestResources_obj::preloadLibraryNames->push(HX_("default",c1,d8,c3,9b));
            		}
            	}
