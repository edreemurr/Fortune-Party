...
HX_DEFINE_STACK_FRAME(_hx_pos_cbeb021ed190252c_311_new,"openfl.net.NetConnection","new",0x5c5dd97e,"openfl.net.NetConnection.new","openfl/net/NetConnection.hx",311,0x3b599834)
HX_LOCAL_STACK_FRAME(_hx_pos_cbeb021ed190252c_512_connect,"openfl.net.NetConnection","connect",0x1fc82c08,"openfl.net.NetConnection.connect","openfl/net/NetConnection.hx",512,0x3b599834)
...
void NetConnection_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_cbeb021ed190252c_311_new)
HXDLIN( 311)		super::__construct(null());
            	}
...
void NetConnection_obj::connect(::String command, ::Dynamic p1, ::Dynamic p2, ::Dynamic p3, ::Dynamic p4, ::Dynamic p5){
            	HX_GC_STACKFRAME(&_hx_pos_cbeb021ed190252c_512_connect)
HXLINE( 513)		if (::hx::IsNotNull( command )) {
HXLINE( 515)			HX_STACK_DO_THROW(HX_("Error: Can only connect in \"HTTP streaming\" mode",fe,f3,67,57));
            		}
HXLINE( 518)		this->dispatchEvent( ::openfl::events::NetStatusEvent_obj::__alloc( HX_CTX ,HX_("netStatus",6f,4f,ec,46),false,true, ::Dynamic(::hx::Anon_obj::Create(1)
