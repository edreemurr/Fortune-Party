...
HX_LOCAL_STACK_FRAME(_hx_pos_1b14c676d7ad0011_871_setProperty,"openfl.net.SharedObject","setProperty",0xd13889dc,"openfl.net.SharedObject.setProperty","openfl/net/SharedObject.hx",871,0x31b7bda9)
HX_LOCAL_STACK_FRAME(_hx_pos_1b14c676d7ad0011_1009_get_size,"openfl.net.SharedObject","get_size",0x91348765,"openfl.net.SharedObject.get_size","openfl/net/SharedObject.hx",1009,0x31b7bda9)
...
HX_LOCAL_STACK_FRAME(_hx_pos_1b14c676d7ad0011_1000_application_onExit,"openfl.net.SharedObject","application_onExit",0x83beab07,"openfl.net.SharedObject.application_onExit","openfl/net/SharedObject.hx",1000,0x31b7bda9)
...
void SharedObject_obj::setProperty(::String propertyName, ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_1b14c676d7ad0011_871_setProperty)
HXDLIN( 871)		if (::hx::IsNotNull( this->data )) {
HXLINE( 873)			::Reflect_obj::setField(this->data,propertyName,value);
            		}
            	}
...
int SharedObject_obj::get_size(){
            	HX_STACKFRAME(&_hx_pos_1b14c676d7ad0011_1009_get_size)
HXDLIN(1009)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE(1011)			::String d = ::haxe::Serializer_obj::run(this->data);
HXLINE(1012)			return ::haxe::io::Bytes_obj::ofString(d,null())->length;
            		} catch( ::Dynamic _hx_e) {
            			if (_hx_e.IsClass<  ::Dynamic >() ){
            				HX_STACK_BEGIN_CATCH
            				 ::Dynamic _g = _hx_e;
...
void SharedObject_obj::application_onExit(int _){
            	HX_STACKFRAME(&_hx_pos_1b14c676d7ad0011_1000_application_onExit)
HXDLIN(1000)		 ::Dynamic sharedObject = ::openfl::net::SharedObject_obj::_hx___sharedObjects->iterator();
HXDLIN(1000)		while(( (bool)(sharedObject->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXDLIN(1000)			 ::openfl::net::SharedObject sharedObject1 = ( ( ::openfl::net::SharedObject)(sharedObject->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE(1002)			sharedObject1->flush(null());
            		}
            	}
