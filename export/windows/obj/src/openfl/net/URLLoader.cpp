...
HXLINE( 317)			 ::lime::net::_HTTPRequest_String httpRequest1 =  ::lime::net::_HTTPRequest_String_obj::__alloc( HX_CTX ,null());
HXLINE( 318)			this->_hx___prepareRequest(httpRequest1,request);
HXLINE( 320)			httpRequest1->load(null())->onProgress(this->httpRequest_onProgress_dyn())->onError(this->httpRequest_onError_dyn())->onComplete( ::Dynamic(new _hx_Closure_1(_gthis)));
            		}
            	}
...
HXLINE( 402)			int _g1 = 0;
HXDLIN( 402)			::Array< ::Dynamic> _g2 = request->requestHeaders;
HXDLIN( 402)			while((_g1 < _g2->length)){
HXLINE( 402)				 ::openfl::net::URLRequestHeader header = _g2->__get(_g1).StaticCast<  ::openfl::net::URLRequestHeader >();
HXDLIN( 402)				_g1 = (_g1 + 1);
HXLINE( 404)				::Array< ::Dynamic> _hx_tmp1 = ( (::Array< ::Dynamic>)(this->_hx___httpRequest->__Field(HX_("headers",46,52,08,63),::hx::paccDynamic)) );
HXDLIN( 404)				_hx_tmp1->push( ::lime::net::HTTPRequestHeader_obj::__alloc( HX_CTX ,header->name,header->value));
            			}
            		}
...
HXLINE( 454)			 ::openfl::events::IOErrorEvent event1 =  ::openfl::events::IOErrorEvent_obj::__alloc( HX_CTX ,HX_("ioError",02,fe,41,76),null(),null(),null(),null());
HXLINE( 455)			event1->text = ::Std_obj::string(error);
HXLINE( 456)			this->dispatchEvent(event1);
            		}
            	}
