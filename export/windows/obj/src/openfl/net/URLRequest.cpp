...
HX_DEFINE_STACK_FRAME(_hx_pos_d7a2132659cec934_51_new,"openfl.net.URLRequest","new",0xe13767c1,"openfl.net.URLRequest.new","openfl/net/URLRequest.hx",51,0xe997cd0d)
namespace openfl{
namespace net{

void URLRequest_obj::__construct(::String url){
            	HX_STACKFRAME(&_hx_pos_d7a2132659cec934_51_new)
HXLINE( 252)		this->withCredentials = false;
HXLINE( 371)		if (::hx::IsNotNull( url )) {
HXLINE( 373)			this->url = url;
            		}
HXLINE( 376)		this->contentType = null();
HXLINE( 377)		this->followRedirects = ::openfl::net::URLRequestDefaults_obj::followRedirects;
HXLINE( 379)		if ((::openfl::net::URLRequestDefaults_obj::idleTimeout > 0)) {
HXLINE( 381)			this->idleTimeout = ::openfl::net::URLRequestDefaults_obj::idleTimeout;
            		}
            		else {
HXLINE( 388)			this->idleTimeout = ( (Float)(30000) );
            		}
HXLINE( 392)		this->manageCookies = ::openfl::net::URLRequestDefaults_obj::manageCookies;
HXLINE( 393)		this->method = HX_("GET",76,1c,36,00);
HXLINE( 394)		this->requestHeaders = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 395)		this->userAgent = ::openfl::net::URLRequestDefaults_obj::userAgent;
            	}
...
static ::hx::StorageInfo URLRequest_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsBool,(int)offsetof(URLRequest_obj,withCredentials),HX_("withCredentials",56,86,c4,ca)},
