...
HXLINE( 791)				::String cPath4 = this->_hx___canonicalize(cPath3,segs->__get(i));
HXDLIN( 791)				cPath3 = (cPath3 + (cPath4 + this->_hx___sep));
            			}
            		}
...
HXLINE( 985)			HX_STACK_DO_THROW(e);
            		}
...
HXLINE(1119)			HX_STACK_DO_THROW(e);
            		}
            		HX_END_LOCAL_FUNC1((void))
...
HXLINE(1194)			HX_STACK_DO_THROW(e);
            		}
            		HX_END_LOCAL_FUNC1((void))
...
HXLINE(1308)			HX_STACK_DO_THROW(e);
            		}
            		HX_END_LOCAL_FUNC1((void))
...
HXLINE(1336)			{
HXLINE(1336)				int _g1 = 0;
HXDLIN(1336)				while((_g1 < directories->length)){
HXLINE(1336)					::String directory = directories->__get(_g1);
HXDLIN(1336)					_g1 = (_g1 + 1);
...
HXLINE(1425)			int _g2 = 0;
HXDLIN(1425)			int _g3 = refPath->length;
HXDLIN(1425)			while((_g2 < _g3)){
HXLINE(1425)				_g2 = (_g2 + 1);
HXDLIN(1425)				int j1 = (_g2 - 1);
HXLINE(1427)				::String thisSeg1 = thisPath->__get(j1);
HXLINE(1428)				::String refSeg1 = refPath->__get(j1);
HXLINE(1430)				if ((thisSeg1 == refSeg1)) {
...
HXLINE(1451)				relatives->push(refSeg1);
            			}
            			_hx_goto_38:;
            		}
HXLINE(1455)		::String relativePath = HX_("",00,00,00,00);
HXLINE(1457)		{
HXLINE(1457)			int _g4 = 0;
HXDLIN(1457)			int _g5 = relatives->length;
HXDLIN(1457)			while((_g4 < _g5)){
HXLINE(1457)				_g4 = (_g4 + 1);
HXDLIN(1457)				int k = (_g4 - 1);
...
HXLINE(1583)			HX_STACK_DO_THROW(e);
            		}
            		HX_END_LOCAL_FUNC1((void))
