...
HX_DEFINE_STACK_FRAME(_hx_pos_c5f39c48023aa9de_261_new,"openfl.text.TextFormat","new",0xfdb2c999,"openfl.text.TextFormat.new","openfl/text/TextFormat.hx",261,0xd3329397)
HX_LOCAL_STACK_FRAME(_hx_pos_c5f39c48023aa9de_279_clone,"openfl.text.TextFormat","clone",0x965d8cd6,"openfl.text.TextFormat.clone","openfl/text/TextFormat.hx",279,0xd3329397)
HX_LOCAL_STACK_FRAME(_hx_pos_c5f39c48023aa9de_303___merge,"openfl.text.TextFormat","__merge",0x0ccb8551,"openfl.text.TextFormat.__merge","openfl/text/TextFormat.hx",303,0xd3329397)
HX_LOCAL_STACK_FRAME(_hx_pos_c5f39c48023aa9de_331___toCacheKey,"openfl.text.TextFormat","__toCacheKey",0xeadfa3df,"openfl.text.TextFormat.__toCacheKey","openfl/text/TextFormat.hx",331,0xd3329397)
HX_LOCAL_STACK_FRAME(_hx_pos_c5f39c48023aa9de_57_boot,"openfl.text.TextFormat","boot",0xf6d69cd9,"openfl.text.TextFormat.boot","openfl/text/TextFormat.hx",57,0xd3329397)
namespace openfl{
namespace text{
...
void TextFormat_obj::__construct(::String font, ::Dynamic size, ::Dynamic color, ::Dynamic bold, ::Dynamic italic, ::Dynamic underline,::String url,::String target, ::Dynamic align, ::Dynamic leftMargin, ::Dynamic rightMargin, ::Dynamic indent, ::Dynamic leading){
            	HX_STACKFRAME(&_hx_pos_c5f39c48023aa9de_261_new)
HXLINE( 262)		this->font = font;
HXLINE( 263)		this->size = size;
HXLINE( 264)		this->color = color;
HXLINE( 265)		this->bold = bold;
HXLINE( 266)		this->italic = italic;
HXLINE( 267)		this->underline = underline;
HXLINE( 268)		this->url = url;
HXLINE( 269)		this->target = target;
HXLINE( 270)		this->align = align;
HXLINE( 271)		this->leftMargin = leftMargin;
HXLINE( 272)		this->rightMargin = rightMargin;
HXLINE( 273)		this->indent = indent;
HXLINE( 274)		this->leading = leading;
            	}
...
bool TextFormat_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::text::TextFormat TextFormat_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_c5f39c48023aa9de_279_clone)
HXLINE( 280)		 ::openfl::text::TextFormat newFormat =  ::openfl::text::TextFormat_obj::__alloc( HX_CTX ,this->font,this->size,this->color,this->bold,this->italic,this->underline,this->url,this->target,null(),null(),null(),null(),null());
HXLINE( 282)		newFormat->align = this->align;
HXLINE( 283)		newFormat->leftMargin = this->leftMargin;
HXLINE( 284)		newFormat->rightMargin = this->rightMargin;
HXLINE( 285)		newFormat->indent = this->indent;
HXLINE( 286)		newFormat->leading = this->leading;
HXLINE( 288)		newFormat->blockIndent = this->blockIndent;
HXLINE( 289)		newFormat->bullet = this->bullet;
HXLINE( 290)		newFormat->kerning = this->kerning;
HXLINE( 291)		newFormat->letterSpacing = this->letterSpacing;
HXLINE( 292)		newFormat->tabStops = this->tabStops;
HXLINE( 294)		newFormat->_hx___ascent = this->_hx___ascent;
HXLINE( 295)		newFormat->_hx___descent = this->_hx___descent;
HXLINE( 297)		newFormat->_hx___cacheKey = this->_hx___toCacheKey();
HXLINE( 299)		return newFormat;
            	}
...
void TextFormat_obj::_hx___merge( ::openfl::text::TextFormat format){
            	HX_STACKFRAME(&_hx_pos_c5f39c48023aa9de_303___merge)
HXLINE( 304)		if (::hx::IsNotNull( format->font )) {
HXLINE( 304)			this->font = format->font;
            		}
HXLINE( 305)		if (::hx::IsNotNull( format->size )) {
HXLINE( 305)			this->size = format->size;
            		}
HXLINE( 306)		if (::hx::IsNotNull( format->color )) {
HXLINE( 306)			this->color = format->color;
            		}
HXLINE( 307)		if (::hx::IsNotNull( format->bold )) {
HXLINE( 307)			this->bold = format->bold;
            		}
HXLINE( 308)		if (::hx::IsNotNull( format->italic )) {
HXLINE( 308)			this->italic = format->italic;
            		}
HXLINE( 309)		if (::hx::IsNotNull( format->underline )) {
HXLINE( 309)			this->underline = format->underline;
            		}
HXLINE( 310)		if (::hx::IsNotNull( format->url )) {
HXLINE( 310)			this->url = format->url;
            		}
HXLINE( 311)		if (::hx::IsNotNull( format->target )) {
HXLINE( 311)			this->target = format->target;
            		}
HXLINE( 312)		if (::hx::IsNotNull( format->align )) {
HXLINE( 312)			this->align = format->align;
            		}
HXLINE( 313)		if (::hx::IsNotNull( format->leftMargin )) {
HXLINE( 313)			this->leftMargin = format->leftMargin;
            		}
HXLINE( 314)		if (::hx::IsNotNull( format->rightMargin )) {
HXLINE( 314)			this->rightMargin = format->rightMargin;
            		}
HXLINE( 315)		if (::hx::IsNotNull( format->indent )) {
HXLINE( 315)			this->indent = format->indent;
            		}
HXLINE( 316)		if (::hx::IsNotNull( format->leading )) {
HXLINE( 316)			this->leading = format->leading;
            		}
HXLINE( 317)		if (::hx::IsNotNull( format->blockIndent )) {
HXLINE( 317)			this->blockIndent = format->blockIndent;
            		}
HXLINE( 318)		if (::hx::IsNotNull( format->bullet )) {
HXLINE( 318)			this->bullet = format->bullet;
            		}
HXLINE( 319)		if (::hx::IsNotNull( format->kerning )) {
HXLINE( 319)			this->kerning = format->kerning;
            		}
HXLINE( 320)		if (::hx::IsNotNull( format->letterSpacing )) {
HXLINE( 320)			this->letterSpacing = format->letterSpacing;
            		}
HXLINE( 321)		if (::hx::IsNotNull( format->tabStops )) {
HXLINE( 321)			this->tabStops = format->tabStops;
            		}
HXLINE( 323)		if (::hx::IsNotNull( format->_hx___ascent )) {
HXLINE( 323)			this->_hx___ascent = format->_hx___ascent;
            		}
HXLINE( 324)		if (::hx::IsNotNull( format->_hx___descent )) {
HXLINE( 324)			this->_hx___descent = format->_hx___descent;
            		}
HXLINE( 326)		this->_hx___toCacheKey();
            	}
...
::String TextFormat_obj::_hx___toCacheKey(){
            	HX_STACKFRAME(&_hx_pos_c5f39c48023aa9de_331___toCacheKey)
HXDLIN( 331)		::String _hx_tmp = ((HX_("",00,00,00,00) + this->font) + this->size);
HXDLIN( 331)		::String _hx_tmp1 = (_hx_tmp + ::Std_obj::string(this->bold));
HXDLIN( 331)		return (this->_hx___cacheKey = (_hx_tmp1 + ::Std_obj::string(this->italic)));
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_c5f39c48023aa9de_57_boot)
