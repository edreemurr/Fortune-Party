...
HX_DEFINE_STACK_FRAME(_hx_pos_ccdf12459bd3b0e0_27_new,"openfl.text._internal.TextLayout","new",0xa41075de,"openfl.text._internal.TextLayout.new","openfl/text/_internal/TextLayout.hx",27,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_ccdf12459bd3b0e0_93___create,"openfl.text._internal.TextLayout","__create",0xba8383de,"openfl.text._internal.TextLayout.__create","openfl/text/_internal/TextLayout.hx",93,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_ccdf12459bd3b0e0_105___position,"openfl.text._internal.TextLayout","__position",0xa4593a0b,"openfl.text._internal.TextLayout.__position","openfl/text/_internal/TextLayout.hx",105,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_ccdf12459bd3b0e0_203_get_positions,"openfl.text._internal.TextLayout","get_positions",0x810b767f,"openfl.text._internal.TextLayout.get_positions","openfl/text/_internal/TextLayout.hx",203,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_ccdf12459bd3b0e0_215_get_direction,"openfl.text._internal.TextLayout","get_direction",0xc0f9e514,"openfl.text._internal.TextLayout.get_direction","openfl/text/_internal/TextLayout.hx",215,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_ccdf12459bd3b0e0_219_set_direction,"openfl.text._internal.TextLayout","set_direction",0x05ffc720,"openfl.text._internal.TextLayout.set_direction","openfl/text/_internal/TextLayout.hx",219,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_ccdf12459bd3b0e0_229_set_font,"openfl.text._internal.TextLayout","set_font",0x081d248e,"openfl.text._internal.TextLayout.set_font","openfl/text/_internal/TextLayout.hx",229,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_ccdf12459bd3b0e0_240_get_glyphs,"openfl.text._internal.TextLayout","get_glyphs",0xd5068f52,"openfl.text._internal.TextLayout.get_glyphs","openfl/text/_internal/TextLayout.hx",240,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_ccdf12459bd3b0e0_253_get_language,"openfl.text._internal.TextLayout","get_language",0xd7d8ef23,"openfl.text._internal.TextLayout.get_language","openfl/text/_internal/TextLayout.hx",253,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_ccdf12459bd3b0e0_257_set_language,"openfl.text._internal.TextLayout","set_language",0xecd21297,"openfl.text._internal.TextLayout.set_language","openfl/text/_internal/TextLayout.hx",257,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_ccdf12459bd3b0e0_268_get_script,"openfl.text._internal.TextLayout","get_script",0x6e0de416,"openfl.text._internal.TextLayout.get_script","openfl/text/_internal/TextLayout.hx",268,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_ccdf12459bd3b0e0_272_set_script,"openfl.text._internal.TextLayout","set_script",0x718b828a,"openfl.text._internal.TextLayout.set_script","openfl/text/_internal/TextLayout.hx",272,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_ccdf12459bd3b0e0_282_set_size,"openfl.text._internal.TextLayout","set_size",0x10b06780,"openfl.text._internal.TextLayout.set_size","openfl/text/_internal/TextLayout.hx",282,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_ccdf12459bd3b0e0_291_set_text,"openfl.text._internal.TextLayout","set_text",0x1156936c,"openfl.text._internal.TextLayout.set_text","openfl/text/_internal/TextLayout.hx",291,0xf9c6f251)
...
HX_LOCAL_STACK_FRAME(_hx_pos_ccdf12459bd3b0e0_48_boot,"openfl.text._internal.TextLayout","boot",0xe26facf4,"openfl.text._internal.TextLayout.boot","openfl/text/_internal/TextLayout.hx",48,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_ccdf12459bd3b0e0_49_boot,"openfl.text._internal.TextLayout","boot",0xe26facf4,"openfl.text._internal.TextLayout.boot","openfl/text/_internal/TextLayout.hx",49,0xf9c6f251)
namespace openfl{
namespace text{
namespace _internal{
...
void TextLayout_obj::__construct(::String __o_text, ::lime::text::Font font,::hx::Null< int >  __o_size,::hx::Null< int >  __o_direction,::String __o_script,::String __o_language){
            	...
            	HX_STACKFRAME(&_hx_pos_ccdf12459bd3b0e0_27_new)
HXLINE(  74)		this->_hx___hbFontSize = -1;
HXLINE(  59)		this->letterSpacing = ((Float)0);
HXLINE(  79)		this->set_text(text);
HXLINE(  80)		this->set_font(font);
HXLINE(  81)		this->set_size(size);
HXLINE(  82)		this->_hx___direction = direction;
HXLINE(  83)		this->_hx___script = script;
HXLINE(  84)		this->_hx___language = language;
HXLINE(  86)		this->positions = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(  87)		this->_hx___dirty = true;
HXLINE(  89)		this->_hx___create(this->_hx___direction,this->_hx___script,this->_hx___language);
            	}
...
void TextLayout_obj::_hx___create(int direction,::String script,::String language){
            	HX_STACKFRAME(&_hx_pos_ccdf12459bd3b0e0_93___create)
HXLINE(  94)		if ((language.length != 4)) {
HXLINE(  94)			return;
            		}
HXLINE(  97)		this->_hx___hbBuffer = ::lime::text::harfbuzz::_HBBuffer::HBBuffer_Impl__obj::_new();
HXLINE(  98)		{
HXLINE(  98)			 ::Dynamic this1 = this->_hx___hbBuffer;
HXDLIN(  98)			int value;
HXDLIN(  98)			switch((int)(direction)){
            				case (int)4: {
HXLINE(  98)					value = 4;
            				}
            				break;
...
HXDLIN(  98)			::lime::_internal::backend::native::NativeCFFI_obj::lime_hb_buffer_set_direction(::hx::DynamicPtr(this1),value);
            		}
HXLINE(  99)		{
HXLINE(  99)			int value1 = (int)1517910393;
HXDLIN(  99)			::lime::_internal::backend::native::NativeCFFI_obj::lime_hb_buffer_set_script(::hx::DynamicPtr(this->_hx___hbBuffer),value1);
            		}
HXLINE( 100)		{
HXLINE( 100)			 ::Dynamic this2 = this->_hx___hbBuffer;
HXDLIN( 100)			 ::Dynamic value2 = ::lime::text::harfbuzz::_HBLanguage::HBLanguage_Impl__obj::_new(language);
HXDLIN( 100)			::lime::_internal::backend::native::NativeCFFI_obj::lime_hb_buffer_set_language(::hx::DynamicPtr(this2),::hx::DynamicPtr(value2));
            		}
            	}
...
void TextLayout_obj::_hx___position(){
            	HX_GC_STACKFRAME(&_hx_pos_ccdf12459bd3b0e0_105___position)
HXLINE( 106)		this->positions = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 109)		bool _hx_tmp;
HXDLIN( 109)		bool _hx_tmp1;
HXDLIN( 109)		bool _hx_tmp2;
HXDLIN( 109)		if (::hx::IsNotNull( this->text )) {
HXLINE( 109)			_hx_tmp2 = (this->text != HX_("",00,00,00,00));
            		}
            		else {
HXLINE( 109)			_hx_tmp2 = false;
            		}
HXDLIN( 109)		if (_hx_tmp2) {
HXLINE( 109)			_hx_tmp1 = ::hx::IsNotNull( this->font );
            		}
            		else {
HXLINE( 109)			_hx_tmp1 = false;
            		}
HXDLIN( 109)		if (_hx_tmp1) {
HXLINE( 109)			_hx_tmp = ::hx::IsNotNull( this->font->src );
            		}
            		else {
HXLINE( 109)			_hx_tmp = false;
            		}
HXDLIN( 109)		if (_hx_tmp) {
HXLINE( 111)			if (::hx::IsNull( this->_hx___buffer )) {
HXLINE( 113)				this->_hx___buffer = ::haxe::io::Bytes_obj::alloc((this->text.length * 5));
            			}
HXLINE( 119)			bool _hx_tmp3;
HXDLIN( 119)			if (::hx::IsInstanceEq( this->_hx___font,this->font )) {
HXLINE( 119)				_hx_tmp3 = (this->_hx___hbFontSize != this->size);
            			}
            			else {
HXLINE( 119)				_hx_tmp3 = true;
            			}
HXDLIN( 119)			if (_hx_tmp3) {
HXLINE( 121)				this->_hx___font = this->font;
HXLINE( 123)				this->font->_hx___setSize(this->size,null());
HXLINE( 124)				this->_hx___hbFont = ::lime::text::harfbuzz::_HBFTFont::HBFTFont_Impl__obj::_new(this->font);
HXLINE( 125)				this->_hx___hbFontSize = this->size;
HXLINE( 127)				if (this->autoHint) {
HXLINE( 132)					::lime::_internal::backend::native::NativeCFFI_obj::lime_hb_ft_font_set_load_flags(::hx::DynamicPtr(this->_hx___hbFont),0);
            				}
            			}
            			else {
HXLINE( 141)				this->font->_hx___setSize(this->size,null());
            			}
HXLINE( 144)			if (::hx::IsNull( this->_hx___hbBuffer )) {
HXLINE( 146)				this->_hx___hbBuffer = ::lime::text::harfbuzz::_HBBuffer::HBBuffer_Impl__obj::_new();
            			}
            			else {
HXLINE( 150)				::lime::text::harfbuzz::_HBBuffer::HBBuffer_Impl__obj::reset(this->_hx___hbBuffer);
            			}
HXLINE( 153)			{
HXLINE( 153)				 ::Dynamic this1 = this->_hx___hbBuffer;
HXDLIN( 153)				int value;
HXDLIN( 153)				switch((int)(this->get_direction())){
            					case (int)4: {
HXLINE( 153)						value = 4;
            					}
            					break;
...
HXDLIN( 153)				::lime::_internal::backend::native::NativeCFFI_obj::lime_hb_buffer_set_direction(::hx::DynamicPtr(this1),value);
            			}
HXLINE( 154)			{
HXLINE( 154)				 ::Dynamic this2 = this->_hx___hbBuffer;
HXDLIN( 154)				::String this3 = this->get_script();
HXDLIN( 154)				int value1 = (int)1517910393;
HXDLIN( 154)				::lime::_internal::backend::native::NativeCFFI_obj::lime_hb_buffer_set_script(::hx::DynamicPtr(this2),value1);
            			}
HXLINE( 155)			{
HXLINE( 155)				 ::Dynamic this4 = this->_hx___hbBuffer;
HXDLIN( 155)				 ::Dynamic value2 = ::lime::text::harfbuzz::_HBLanguage::HBLanguage_Impl__obj::_new(this->get_language());
HXDLIN( 155)				::lime::_internal::backend::native::NativeCFFI_obj::lime_hb_buffer_set_language(::hx::DynamicPtr(this4),::hx::DynamicPtr(value2));
            			}
HXLINE( 156)			{
HXLINE( 156)				int value3 = 2;
HXDLIN( 156)				::lime::_internal::backend::native::NativeCFFI_obj::lime_hb_buffer_set_cluster_level(::hx::DynamicPtr(this->_hx___hbBuffer),value3);
            			}
HXLINE( 164)			 ::Dynamic _hx_tmp4 = this->_hx___hbBuffer;
HXDLIN( 164)			Float _hx_tmp5 = (uintptr_t)this->text.wc_str();
HXDLIN( 164)			::lime::text::harfbuzz::_HBBuffer::HBBuffer_Impl__obj::addUTF16(_hx_tmp4,_hx_tmp5,this->text.length,0,-1);
HXLINE( 167)			::lime::text::harfbuzz::HB_obj::shape(this->_hx___hbFont,this->_hx___hbBuffer,null());
HXLINE( 169)			::Array< ::Dynamic> _info = ::lime::text::harfbuzz::_HBBuffer::HBBuffer_Impl__obj::getGlyphInfo(this->_hx___hbBuffer);
HXLINE( 170)			::Array< ::Dynamic> _positions = ::lime::text::harfbuzz::_HBBuffer::HBBuffer_Impl__obj::getGlyphPositions(this->_hx___hbBuffer);
HXLINE( 172)			bool _hx_tmp6;
HXDLIN( 172)			if (::hx::IsNotNull( _info )) {
HXLINE( 172)				_hx_tmp6 = ::hx::IsNotNull( _positions );
            			}
            			else {
HXLINE( 172)				_hx_tmp6 = false;
            			}
HXDLIN( 172)			if (_hx_tmp6) {
HXLINE( 174)				 ::lime::text::harfbuzz::HBGlyphInfo info;
HXLINE( 175)				 ::lime::text::harfbuzz::HBGlyphPosition position;
HXLINE( 176)				int lastCluster = -1;
HXLINE( 178)				int length = ::Std_obj::_hx_int(::Math_obj::min(( (Float)(_info->length) ),( (Float)(_positions->length) )));
HXLINE( 180)				{
HXLINE( 180)					int _g = 0;
HXDLIN( 180)					int _g1 = length;
HXDLIN( 180)					while((_g < _g1)){
HXLINE( 180)						_g = (_g + 1);
HXDLIN( 180)						int i = (_g - 1);
HXLINE( 182)						info = _info->__get(i).StaticCast<  ::lime::text::harfbuzz::HBGlyphInfo >();
HXLINE( 183)						position = _positions->__get(i).StaticCast<  ::lime::text::harfbuzz::HBGlyphPosition >();
HXLINE( 185)						{
HXLINE( 185)							int _g2 = (lastCluster + 1);
HXDLIN( 185)							int _g3 = info->cluster;
HXDLIN( 185)							while((_g2 < _g3)){
HXLINE( 185)								_g2 = (_g2 + 1);
HXDLIN( 185)								int j = (_g2 - 1);
HXLINE( 189)								::Array< ::Dynamic> _hx_tmp7 = this->get_positions();
HXDLIN( 189)								 ::lime::math::Vector2 _hx_tmp8 =  ::lime::math::Vector2_obj::__alloc( HX_CTX ,0,0);
HXDLIN( 189)								_hx_tmp7->push( ::openfl::text::_internal::GlyphPosition_obj::__alloc( HX_CTX ,0,_hx_tmp8, ::lime::math::Vector2_obj::__alloc( HX_CTX ,0,0)));
            							}
            						}
HXLINE( 192)						::Array< ::Dynamic> _hx_tmp9 = this->get_positions();
HXDLIN( 192)						int info1 = info->codepoint;
HXDLIN( 192)						 ::lime::math::Vector2 _hx_tmp10 =  ::lime::math::Vector2_obj::__alloc( HX_CTX ,((( (Float)(position->xAdvance) ) / ( (Float)(64) )) + this->letterSpacing),(( (Float)(position->yAdvance) ) / ( (Float)(64) )));
HXDLIN( 192)						_hx_tmp9->push( ::openfl::text::_internal::GlyphPosition_obj::__alloc( HX_CTX ,info1,_hx_tmp10, ::lime::math::Vector2_obj::__alloc( HX_CTX ,(( (Float)(position->xOffset) ) / ( (Float)(64) )),(( (Float)(position->yOffset) ) / ( (Float)(64) )))));
HXLINE( 194)						lastCluster = info->cluster;
            					}
            				}
            			}
            		}
...
::Array< ::Dynamic> TextLayout_obj::get_positions(){
            	HX_STACKFRAME(&_hx_pos_ccdf12459bd3b0e0_203_get_positions)
HXLINE( 204)		if (this->_hx___dirty) {
HXLINE( 206)			this->_hx___dirty = false;
HXLINE( 207)			this->_hx___position();
            		}
...
int TextLayout_obj::get_direction(){
            	HX_STACKFRAME(&_hx_pos_ccdf12459bd3b0e0_215_get_direction)
HXDLIN( 215)		return this->_hx___direction;
            	}
...
int TextLayout_obj::set_direction(int value){
            	HX_STACKFRAME(&_hx_pos_ccdf12459bd3b0e0_219_set_direction)
HXLINE( 220)		if ((value == this->_hx___direction)) {
HXLINE( 220)			return value;
            		}
HXLINE( 222)		this->_hx___direction = value;
...
HX_DEFINE_DYNAMIC_FUNC1(TextLayout_obj,set_direction,return )
 ...
 ::lime::text::Font TextLayout_obj::set_font( ::lime::text::Font value){
            	HX_STACKFRAME(&_hx_pos_ccdf12459bd3b0e0_229_set_font)
HXLINE( 230)		if (::hx::IsInstanceEq( value,this->font )) {
HXLINE( 230)			return value;
            		}
HXLINE( 232)		this->font = value;
HXLINE( 233)		this->_hx___dirty = true;
...
::Array< int > TextLayout_obj::get_glyphs(){
            	HX_STACKFRAME(&_hx_pos_ccdf12459bd3b0e0_240_get_glyphs)
HXLINE( 241)		::Array< int > glyphs = ::Array_obj< int >::__new(0);
HXLINE( 243)		{
HXLINE( 243)			int _g = 0;
HXDLIN( 243)			::Array< ::Dynamic> _g1 = this->get_positions();
HXDLIN( 243)			while((_g < _g1->length)){
HXLINE( 243)				 ::openfl::text::_internal::GlyphPosition position = _g1->__get(_g).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXDLIN( 243)				_g = (_g + 1);
HXLINE( 245)				glyphs->push(position->glyph);
            			}
            		}
HXLINE( 248)		return glyphs;
            	}
...
::String TextLayout_obj::get_language(){
            	HX_STACKFRAME(&_hx_pos_ccdf12459bd3b0e0_253_get_language)
HXDLIN( 253)		return this->_hx___language;
            	}
...
::String TextLayout_obj::set_language(::String value){
            	HX_STACKFRAME(&_hx_pos_ccdf12459bd3b0e0_257_set_language)
HXLINE( 258)		if ((value == this->_hx___language)) {
HXLINE( 258)			return value;
            		}
HXLINE( 260)		this->_hx___language = value;
...
::String TextLayout_obj::get_script(){
            	HX_STACKFRAME(&_hx_pos_ccdf12459bd3b0e0_268_get_script)
HXDLIN( 268)		return this->_hx___script;
            	}
...
::String TextLayout_obj::set_script(::String value){
            	HX_STACKFRAME(&_hx_pos_ccdf12459bd3b0e0_272_set_script)
HXLINE( 273)		if ((value == this->_hx___script)) {
HXLINE( 273)			return value;
            		}
HXLINE( 275)		this->_hx___script = value;
...
int TextLayout_obj::set_size(int value){
            	HX_STACKFRAME(&_hx_pos_ccdf12459bd3b0e0_282_set_size)
HXLINE( 283)		if ((value == this->size)) {
HXLINE( 283)			return value;
            		}
HXLINE( 285)		this->size = value;
HXLINE( 286)		this->_hx___dirty = true;
...
::String TextLayout_obj::set_text(::String value){
            	HX_STACKFRAME(&_hx_pos_ccdf12459bd3b0e0_291_set_text)
HXLINE( 292)		if ((value == this->text)) {
HXLINE( 292)			return value;
            		}
HXLINE( 294)		this->text = value;
HXLINE( 295)		this->_hx___dirty = true;
...
void TextLayout_obj::__Mark(HX_MARK_PARAMS)
{
	...
	HX_MARK_MEMBER_NAME(_hx___hbFontSize,"__hbFontSize");
	HX_MARK_END_CLASS();
}
...
void TextLayout_obj::__Visit(HX_VISIT_PARAMS)
{
	...
	HX_VISIT_MEMBER_NAME(_hx___hbFontSize,"__hbFontSize");
}
...
::hx::Val TextLayout_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	case 11:
		...
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"__hbFontSize") ) { return ::hx::Val( _hx___hbFontSize ); }
...
::hx::Val TextLayout_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 11:
		...
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"__hbFontSize") ) { _hx___hbFontSize=inValue.Cast< int >(); return inValue; }
		break;
	case 13:
...
void TextLayout_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_("__hbFontSize",6a,da,c1,bf));
...
static ::hx::StorageInfo TextLayout_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsInt,(int)offsetof(TextLayout_obj,_hx___hbFontSize),HX_("__hbFontSize",6a,da,c1,bf)},
	{ ::hx::fsUnknown, 0, null()}
};
...
HXDLIN(  27)		__mClass->__meta__ =  ::Dynamic(::hx::Anon_obj::Create(2)
