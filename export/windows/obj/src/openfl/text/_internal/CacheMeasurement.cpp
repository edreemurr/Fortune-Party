...
HX_DEFINE_STACK_FRAME(_hx_pos_dc9064273ab91ee7_19_new,"openfl.text._internal.CacheMeasurement","new",0x1a9e32c1,"openfl.text._internal.CacheMeasurement.new","openfl/text/_internal/CacheMeasurement.hx",19,0xf3426c0e)
HX_LOCAL_STACK_FRAME(_hx_pos_dc9064273ab91ee7_29_set,"openfl.text._internal.CacheMeasurement","set",0x1aa1fe03,"openfl.text._internal.CacheMeasurement.set","openfl/text/_internal/CacheMeasurement.hx",29,0xf3426c0e)
HX_LOCAL_STACK_FRAME(_hx_pos_dc9064273ab91ee7_33_get,"openfl.text._internal.CacheMeasurement","get",0x1a98e2f7,"openfl.text._internal.CacheMeasurement.get","openfl/text/_internal/CacheMeasurement.hx",33,0xf3426c0e)
HX_LOCAL_STACK_FRAME(_hx_pos_dc9064273ab91ee7_45___addCollision,"openfl.text._internal.CacheMeasurement","__addCollision",0x02c4b470,"openfl.text._internal.CacheMeasurement.__addCollision","openfl/text/_internal/CacheMeasurement.hx",45,0xf3426c0e)
HX_LOCAL_STACK_FRAME(_hx_pos_dc9064273ab91ee7_52_exists,"openfl.text._internal.CacheMeasurement","exists",0xb6dcae1b,"openfl.text._internal.CacheMeasurement.exists","openfl/text/_internal/CacheMeasurement.hx",52,0xf3426c0e)
HX_LOCAL_STACK_FRAME(_hx_pos_dc9064273ab91ee7_11_boot,"openfl.text._internal.CacheMeasurement","boot",0x27e736b1,"openfl.text._internal.CacheMeasurement.boot","openfl/text/_internal/CacheMeasurement.hx",11,0xf3426c0e)
namespace openfl{
namespace text{
namespace _internal{

void CacheMeasurement_obj::__construct(::String wordKey,::Array< ::Dynamic> positions){
            	HX_GC_STACKFRAME(&_hx_pos_dc9064273ab91ee7_19_new)
HXLINE(  21)		this->_hx___collisions = ::Array_obj< ::String >::__new(0);
HXLINE(  22)		this->_hx___wordMap =  ::haxe::ds::IntMap_obj::__alloc( HX_CTX );
HXLINE(  24)		this->set(wordKey,positions);
            	}
...
void CacheMeasurement_obj::set(::String wordKey,::Array< ::Dynamic> positions){
            	HX_STACKFRAME(&_hx_pos_dc9064273ab91ee7_29_set)
HXDLIN(  29)		this->_hx___addCollision(wordKey,positions);
            	}
...
::Array< ::Dynamic> CacheMeasurement_obj::get(::String wordKey){
            	HX_STACKFRAME(&_hx_pos_dc9064273ab91ee7_33_get)
HXLINE(  35)		if ((this->_hx___collisions->length > 1)) {
HXLINE(  37)			 ::haxe::ds::IntMap _hx_tmp = this->_hx___wordMap;
HXDLIN(  37)			return ( (::Array< ::Dynamic>)(_hx_tmp->get(this->_hx___collisions->indexOf(wordKey,null()))) );
            		}
HXLINE(  39)		return ( (::Array< ::Dynamic>)(this->_hx___wordMap->get(0)) );
            	}
...
void CacheMeasurement_obj::_hx___addCollision(::String wordKey,::Array< ::Dynamic> positions){
            	HX_STACKFRAME(&_hx_pos_dc9064273ab91ee7_45___addCollision)
HXDLIN(  45)		if (!(this->exists(wordKey))) {
HXLINE(  47)			 ::haxe::ds::IntMap _hx_tmp = this->_hx___wordMap;
HXDLIN(  47)			_hx_tmp->set((this->_hx___collisions->push(wordKey) - 1),positions);
            		}
            	}
...
bool CacheMeasurement_obj::exists(::String wordKey){
            	HX_STACKFRAME(&_hx_pos_dc9064273ab91ee7_52_exists)
HXLINE(  53)		if ((this->_hx___collisions->length == 0)) {
HXLINE(  55)			return false;
            		}
HXLINE(  57)		return (this->_hx___collisions->indexOf(wordKey,null()) > -1);
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_dc9064273ab91ee7_11_boot)
