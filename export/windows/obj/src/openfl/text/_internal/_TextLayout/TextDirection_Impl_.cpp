...
HX_LOCAL_STACK_FRAME(_hx_pos_fecd85f16d8632f8_316_reverse,"openfl.text._internal._TextLayout.TextDirection_Impl_","reverse",0x2436bfd9,"openfl.text._internal._TextLayout.TextDirection_Impl_.reverse","openfl/text/_internal/TextLayout.hx",316,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_fecd85f16d8632f8_321_toString,"openfl.text._internal._TextLayout.TextDirection_Impl_","toString",0x426a2a15,"openfl.text._internal._TextLayout.TextDirection_Impl_.toString","openfl/text/_internal/TextLayout.hx",321,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_fecd85f16d8632f8_334_toHBDirection,"openfl.text._internal._TextLayout.TextDirection_Impl_","toHBDirection",0x47c8a441,"openfl.text._internal._TextLayout.TextDirection_Impl_.toHBDirection","openfl/text/_internal/TextLayout.hx",334,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_fecd85f16d8632f8_347_get_backward,"openfl.text._internal._TextLayout.TextDirection_Impl_","get_backward",0x1e6151d5,"openfl.text._internal._TextLayout.TextDirection_Impl_.get_backward","openfl/text/_internal/TextLayout.hx",347,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_fecd85f16d8632f8_352_get_forward,"openfl.text._internal._TextLayout.TextDirection_Impl_","get_forward",0xaa0ef013,"openfl.text._internal._TextLayout.TextDirection_Impl_.get_forward","openfl/text/_internal/TextLayout.hx",352,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_fecd85f16d8632f8_357_get_horizontal,"openfl.text._internal._TextLayout.TextDirection_Impl_","get_horizontal",0xc88b5356,"openfl.text._internal._TextLayout.TextDirection_Impl_.get_horizontal","openfl/text/_internal/TextLayout.hx",357,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_fecd85f16d8632f8_362_get_vertical,"openfl.text._internal._TextLayout.TextDirection_Impl_","get_vertical",0x615e3268,"openfl.text._internal._TextLayout.TextDirection_Impl_.get_vertical","openfl/text/_internal/TextLayout.hx",362,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_fecd85f16d8632f8_304_boot,"openfl.text._internal._TextLayout.TextDirection_Impl_","boot",0x0be1b51b,"openfl.text._internal._TextLayout.TextDirection_Impl_.boot","openfl/text/_internal/TextLayout.hx",304,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_fecd85f16d8632f8_305_boot,"openfl.text._internal._TextLayout.TextDirection_Impl_","boot",0x0be1b51b,"openfl.text._internal._TextLayout.TextDirection_Impl_.boot","openfl/text/_internal/TextLayout.hx",305,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_fecd85f16d8632f8_306_boot,"openfl.text._internal._TextLayout.TextDirection_Impl_","boot",0x0be1b51b,"openfl.text._internal._TextLayout.TextDirection_Impl_.boot","openfl/text/_internal/TextLayout.hx",306,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_fecd85f16d8632f8_307_boot,"openfl.text._internal._TextLayout.TextDirection_Impl_","boot",0x0be1b51b,"openfl.text._internal._TextLayout.TextDirection_Impl_.boot","openfl/text/_internal/TextLayout.hx",307,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_fecd85f16d8632f8_308_boot,"openfl.text._internal._TextLayout.TextDirection_Impl_","boot",0x0be1b51b,"openfl.text._internal._TextLayout.TextDirection_Impl_.boot","openfl/text/_internal/TextLayout.hx",308,0xf9c6f251)
namespace openfl{
namespace text{
namespace _internal{
...
void TextDirection_Impl__obj::reverse(int this1){
            	HX_STACKFRAME(&_hx_pos_fecd85f16d8632f8_316_reverse)
HXDLIN( 316)		this1 = (this1 ^ 1);
            	}
...
::String TextDirection_Impl__obj::toString(int this1){
            	HX_STACKFRAME(&_hx_pos_fecd85f16d8632f8_321_toString)
HXDLIN( 321)		switch((int)(this1)){
            			case (int)4: {
HXLINE( 323)				return HX_("leftToRight",1a,97,7b,b5);
            			}
            			break;
            			case (int)5: {
HXLINE( 324)				return HX_("rightToLeft",1e,40,ee,e6);
            			}
            			break;
            			case (int)6: {
HXLINE( 325)				return HX_("topToBottom",7b,ce,19,75);
            			}
            			break;
            			case (int)7: {
HXLINE( 326)				return HX_("bottomToTop",ef,ac,aa,79);
            			}
            			break;
            			default:{
...
int TextDirection_Impl__obj::toHBDirection(int this1){
            	HX_STACKFRAME(&_hx_pos_fecd85f16d8632f8_334_toHBDirection)
HXDLIN( 334)		switch((int)(this1)){
            			case (int)4: {
HXLINE( 336)				return 4;
            			}
            			break;
...
bool TextDirection_Impl__obj::get_backward(int this1){
            	HX_STACKFRAME(&_hx_pos_fecd85f16d8632f8_347_get_backward)
HXDLIN( 347)		return ((this1 & -3) == 5);
            	}
...
bool TextDirection_Impl__obj::get_forward(int this1){
            	HX_STACKFRAME(&_hx_pos_fecd85f16d8632f8_352_get_forward)
HXDLIN( 352)		return ((this1 & -3) == 4);
            	}
...
bool TextDirection_Impl__obj::get_horizontal(int this1){
            	HX_STACKFRAME(&_hx_pos_fecd85f16d8632f8_357_get_horizontal)
HXDLIN( 357)		return ((this1 & -2) == 4);
            	}
...
bool TextDirection_Impl__obj::get_vertical(int this1){
            	HX_STACKFRAME(&_hx_pos_fecd85f16d8632f8_362_get_vertical)
HXDLIN( 362)		return ((this1 & -2) == 6);
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_fecd85f16d8632f8_304_boot)
HXDLIN( 304)		INVALID = 0;
            	}
{
            	HX_STACKFRAME(&_hx_pos_fecd85f16d8632f8_305_boot)
HXDLIN( 305)		LEFT_TO_RIGHT = 4;
            	}
{
            	HX_STACKFRAME(&_hx_pos_fecd85f16d8632f8_306_boot)
HXDLIN( 306)		RIGHT_TO_LEFT = 5;
            	}
{
            	HX_STACKFRAME(&_hx_pos_fecd85f16d8632f8_307_boot)
HXDLIN( 307)		TOP_TO_BOTTOM = 6;
            	}
{
            	HX_STACKFRAME(&_hx_pos_fecd85f16d8632f8_308_boot)
HXDLIN( 308)		BOTTOM_TO_TOP = 7;
            	}
}
