...
HXDLIN( 122)				while((_g1 < rules->length)){
HXLINE( 122)					 ::haxe::ds::StringMap rule = rules->__get(_g1).StaticCast<  ::haxe::ds::StringMap >();
...
HXLINE( 130)							this->_hx___styles->set(styleName, ::Dynamic(::hx::Anon_obj::Create(0)));
...
HXDLIN( 138)							while((_g2 < declarations->length)){
HXLINE( 138)								 ::haxe::ds::StringMap declaration = declarations->__get(_g2).StaticCast<  ::haxe::ds::StringMap >();
...
HXLINE( 149)											 ::Dynamic this2 = object;
HXDLIN( 149)											if (::hx::IsNotNull( this2 )) {
HXLINE( 149)												::Reflect_obj::setProperty(this2,HX_("fontSize",30,be,d1,ce),value);
            											}
HXDLIN( 149)											goto _hx_goto_5;
            										}
            										if (  (_hx_switch_0==HX_("font-style",f3,04,ec,01)) ){
HXLINE( 151)											 ::Dynamic this3 = object;
HXDLIN( 151)											if (::hx::IsNotNull( this3 )) {
HXLINE( 151)												::Reflect_obj::setProperty(this3,HX_("fontStyle",e2,48,f9,2f),value);
            											}
HXDLIN( 151)											goto _hx_goto_5;
            										}
            										if (  (_hx_switch_0==HX_("font-weight",76,db,6b,98)) ){
HXLINE( 153)											 ::Dynamic this4 = object;
HXDLIN( 153)											if (::hx::IsNotNull( this4 )) {
HXLINE( 153)												::Reflect_obj::setProperty(this4,HX_("fontWeight",a7,08,fa,b5),value);
            											}
HXDLIN( 153)											goto _hx_goto_5;
            										}
            										if (  (_hx_switch_0==HX_("letter-spacing",dc,45,12,42)) ){
HXLINE( 155)											 ::Dynamic this5 = object;
HXDLIN( 155)											if (::hx::IsNotNull( this5 )) {
HXLINE( 155)												::Reflect_obj::setProperty(this5,HX_("letterSpacing",3d,b7,03,f5),value);
            											}
HXDLIN( 155)											goto _hx_goto_5;
            										}
            										if (  (_hx_switch_0==HX_("margin-left",c6,4b,ff,e7)) ){
HXLINE( 157)											 ::Dynamic this6 = object;
HXDLIN( 157)											if (::hx::IsNotNull( this6 )) {
HXLINE( 157)												::Reflect_obj::setProperty(this6,HX_("marginLeft",55,53,dd,84),value);
            											}
HXDLIN( 157)											goto _hx_goto_5;
            										}
            										if (  (_hx_switch_0==HX_("text-align",e5,9f,fc,21)) ){
HXLINE( 159)											 ::Dynamic this7 = object;
HXDLIN( 159)											if (::hx::IsNotNull( this7 )) {
HXLINE( 159)												::Reflect_obj::setProperty(this7,HX_("textAlign",d8,e6,7e,ba),value);
            											}
HXDLIN( 159)											goto _hx_goto_5;
            										}
            										if (  (_hx_switch_0==HX_("text-decoration",10,b8,a7,ac)) ){
HXLINE( 161)											 ::Dynamic this8 = object;
HXDLIN( 161)											if (::hx::IsNotNull( this8 )) {
HXLINE( 161)												::Reflect_obj::setProperty(this8,HX_("textDecoration",3d,60,e0,20),value);
            											}
HXDLIN( 161)											goto _hx_goto_5;
            										}
            										if (  (_hx_switch_0==HX_("text-indent",4c,bf,67,f1)) ){
HXLINE( 163)											 ::Dynamic this9 = object;
HXDLIN( 163)											if (::hx::IsNotNull( this9 )) {
HXLINE( 163)												::Reflect_obj::setProperty(this9,HX_("textIndent",f9,8c,e3,ca),value);
            											}
...
HXLINE( 201)			 ::Dynamic object =  ::Dynamic(::hx::Anon_obj::Create(0));
HXLINE( 202)			{
HXLINE( 202)				int _g = 0;
...
HXLINE( 240)				 ::Dynamic this2 = ::openfl::utils::_Object::Object_Impl__obj::__get(styleObject,HX_("color",63,71,5c,4a));
HXDLIN( 240)				::String _hx_tmp2;
HXDLIN( 240)				if (::hx::IsNull( this2 )) {
HXLINE( 240)					_hx_tmp2 = null();
            				}
            				else {
HXLINE( 240)					_hx_tmp2 = ::Std_obj::string(this2);
            				}
HXDLIN( 240)				_hx_tmp = hex->match(_hx_tmp2);
            			}
            			else {
...
HXLINE( 254)			 ::Dynamic this3 = styleObject;
HXDLIN( 254)			bool _hx_tmp3;
HXDLIN( 254)			if (::hx::IsNotNull( this3 )) {
HXLINE( 254)				_hx_tmp3 = ::Reflect_obj::hasField(this3,HX_("fontFamily",d3,f6,f4,9e));
            			}
            			else {
HXLINE( 254)				_hx_tmp3 = false;
            			}
HXDLIN( 254)			if (_hx_tmp3) {
HXLINE( 256)				 ::Dynamic this4 = ::openfl::utils::_Object::Object_Impl__obj::__get(styleObject,HX_("fontFamily",d3,f6,f4,9e));
HXDLIN( 256)				::String _hx_tmp4;
HXDLIN( 256)				if (::hx::IsNull( this4 )) {
HXLINE( 256)					_hx_tmp4 = null();
            				}
            				else {
HXLINE( 256)					_hx_tmp4 = ::Std_obj::string(this4);
            				}
HXDLIN( 256)				textFormat->font = this->_hx___parseFont(_hx_tmp4);
            			}
HXLINE( 258)			bool _hx_tmp5;
HXDLIN( 258)			 ::Dynamic this5 = styleObject;
HXDLIN( 258)			bool _hx_tmp6;
HXDLIN( 258)			if (::hx::IsNotNull( this5 )) {
HXLINE( 258)				_hx_tmp6 = ::Reflect_obj::hasField(this5,HX_("fontSize",30,be,d1,ce));
            			}
            			else {
HXLINE( 258)				_hx_tmp6 = false;
            			}
HXDLIN( 258)			if (_hx_tmp6) {
HXLINE( 258)				 ::Dynamic this6 = ::openfl::utils::_Object::Object_Impl__obj::__get(styleObject,HX_("fontSize",30,be,d1,ce));
HXDLIN( 258)				::String _hx_tmp7;
HXDLIN( 258)				if (::hx::IsNull( this6 )) {
HXLINE( 258)					_hx_tmp7 = null();
            				}
            				else {
HXLINE( 258)					_hx_tmp7 = ::Std_obj::string(this6);
            				}
HXDLIN( 258)				_hx_tmp5 = numeric->match(_hx_tmp7);
            			}
            			else {
...
HXLINE( 262)			 ::Dynamic this7 = styleObject;
HXDLIN( 262)			bool _hx_tmp8;
HXDLIN( 262)			if (::hx::IsNotNull( this7 )) {
HXLINE( 262)				_hx_tmp8 = ::Reflect_obj::hasField(this7,HX_("fontStyle",e2,48,f9,2f));
            			}
            			else {
HXLINE( 262)				_hx_tmp8 = false;
            			}
HXDLIN( 262)			if (_hx_tmp8) {
...
HXLINE( 273)			 ::Dynamic this8 = styleObject;
HXDLIN( 273)			bool _hx_tmp9;
HXDLIN( 273)			if (::hx::IsNotNull( this8 )) {
HXLINE( 273)				_hx_tmp9 = ::Reflect_obj::hasField(this8,HX_("fontWeight",a7,08,fa,b5));
            			}
            			else {
HXLINE( 273)				_hx_tmp9 = false;
            			}
...
HXDLIN( 287)			 ::Dynamic this9 = styleObject;
HXDLIN( 287)			bool _hx_tmp11;
HXDLIN( 287)			if (::hx::IsNotNull( this9 )) {
HXLINE( 287)				_hx_tmp11 = ::Reflect_obj::hasField(this9,HX_("leading",c6,32,61,09));
            			}
            			else {
HXLINE( 287)				_hx_tmp11 = false;
            			}
HXDLIN( 287)			if (_hx_tmp11) {
HXLINE( 287)				 ::Dynamic this10 = ::openfl::utils::_Object::Object_Impl__obj::__get(styleObject,HX_("leading",c6,32,61,09));
HXDLIN( 287)				::String _hx_tmp12;
HXDLIN( 287)				if (::hx::IsNull( this10 )) {
HXLINE( 287)					_hx_tmp12 = null();
            				}
            				else {
HXLINE( 287)					_hx_tmp12 = ::Std_obj::string(this10);
            				}
HXDLIN( 287)				_hx_tmp10 = numeric->match(_hx_tmp12);
            			}
            			else {
...
HXLINE( 291)			bool _hx_tmp13;
HXDLIN( 291)			 ::Dynamic this11 = styleObject;
HXDLIN( 291)			bool _hx_tmp14;
HXDLIN( 291)			if (::hx::IsNotNull( this11 )) {
HXLINE( 291)				_hx_tmp14 = ::Reflect_obj::hasField(this11,HX_("letterSpacing",3d,b7,03,f5));
            			}
            			else {
HXLINE( 291)				_hx_tmp14 = false;
            			}
HXDLIN( 291)			if (_hx_tmp14) {
HXLINE( 291)				 ::Dynamic this12 = ::openfl::utils::_Object::Object_Impl__obj::__get(styleObject,HX_("letterSpacing",3d,b7,03,f5));
HXDLIN( 291)				::String _hx_tmp15;
HXDLIN( 291)				if (::hx::IsNull( this12 )) {
HXLINE( 291)					_hx_tmp15 = null();
            				}
            				else {
HXLINE( 291)					_hx_tmp15 = ::Std_obj::string(this12);
            				}
HXDLIN( 291)				_hx_tmp13 = numeric->match(_hx_tmp15);
            			}
            			else {
HXLINE( 291)				_hx_tmp13 = false;
            			}
HXDLIN( 291)			if (_hx_tmp13) {
HXLINE( 293)				textFormat->letterSpacing = ::Std_obj::parseFloat(numeric->matched(0));
            			}
HXLINE( 295)			bool _hx_tmp16;
HXDLIN( 295)			 ::Dynamic this13 = styleObject;
HXDLIN( 295)			bool _hx_tmp17;
HXDLIN( 295)			if (::hx::IsNotNull( this13 )) {
HXLINE( 295)				_hx_tmp17 = ::Reflect_obj::hasField(this13,HX_("marginLeft",55,53,dd,84));
            			}
            			else {
HXLINE( 295)				_hx_tmp17 = false;
            			}
HXDLIN( 295)			if (_hx_tmp17) {
HXLINE( 295)				 ::Dynamic this14 = ::openfl::utils::_Object::Object_Impl__obj::__get(styleObject,HX_("marginLeft",55,53,dd,84));
HXDLIN( 295)				::String _hx_tmp18;
HXDLIN( 295)				if (::hx::IsNull( this14 )) {
HXLINE( 295)					_hx_tmp18 = null();
            				}
            				else {
HXLINE( 295)					_hx_tmp18 = ::Std_obj::string(this14);
            				}
HXDLIN( 295)				_hx_tmp16 = numeric->match(_hx_tmp18);
            			}
            			else {
HXLINE( 295)				_hx_tmp16 = false;
            			}
HXDLIN( 295)			if (_hx_tmp16) {
HXLINE( 297)				textFormat->leftMargin = ::Std_obj::parseInt(numeric->matched(0));
            			}
HXLINE( 299)			bool _hx_tmp19;
HXDLIN( 299)			 ::Dynamic this15 = styleObject;
HXDLIN( 299)			bool _hx_tmp20;
HXDLIN( 299)			if (::hx::IsNotNull( this15 )) {
HXLINE( 299)				_hx_tmp20 = ::Reflect_obj::hasField(this15,HX_("marginRight",ce,a4,d8,33));
            			}
            			else {
HXLINE( 299)				_hx_tmp20 = false;
            			}
HXDLIN( 299)			if (_hx_tmp20) {
HXLINE( 299)				 ::Dynamic this16 = ::openfl::utils::_Object::Object_Impl__obj::__get(styleObject,HX_("marginRight",ce,a4,d8,33));
HXDLIN( 299)				::String _hx_tmp21;
HXDLIN( 299)				if (::hx::IsNull( this16 )) {
HXLINE( 299)					_hx_tmp21 = null();
            				}
            				else {
HXLINE( 299)					_hx_tmp21 = ::Std_obj::string(this16);
            				}
HXDLIN( 299)				_hx_tmp19 = numeric->match(_hx_tmp21);
            			}
            			else {
HXLINE( 299)				_hx_tmp19 = false;
            			}
HXDLIN( 299)			if (_hx_tmp19) {
HXLINE( 301)				textFormat->rightMargin = ::Std_obj::parseInt(numeric->matched(0));
            			}
HXLINE( 303)			 ::Dynamic this17 = styleObject;
HXDLIN( 303)			bool _hx_tmp22;
HXDLIN( 303)			if (::hx::IsNotNull( this17 )) {
HXLINE( 303)				_hx_tmp22 = ::Reflect_obj::hasField(this17,HX_("textAlign",d8,e6,7e,ba));
            			}
            			else {
...
HXLINE( 318)			 ::Dynamic this18 = styleObject;
HXDLIN( 318)			bool _hx_tmp23;
HXDLIN( 318)			if (::hx::IsNotNull( this18 )) {
HXLINE( 318)				_hx_tmp23 = ::Reflect_obj::hasField(this18,HX_("textDecoration",3d,60,e0,20));
            			}
            			else {
HXLINE( 318)				_hx_tmp23 = false;
            			}
HXDLIN( 318)			if (_hx_tmp23) {
...
HXLINE( 329)			bool _hx_tmp24;
HXDLIN( 329)			 ::Dynamic this19 = styleObject;
HXDLIN( 329)			bool _hx_tmp25;
HXDLIN( 329)			if (::hx::IsNotNull( this19 )) {
HXLINE( 329)				_hx_tmp25 = ::Reflect_obj::hasField(this19,HX_("textIndent",f9,8c,e3,ca));
            			}
            			else {
HXLINE( 329)				_hx_tmp25 = false;
            			}
HXDLIN( 329)			if (_hx_tmp25) {
HXLINE( 329)				 ::Dynamic this20 = ::openfl::utils::_Object::Object_Impl__obj::__get(styleObject,HX_("textIndent",f9,8c,e3,ca));
HXDLIN( 329)				::String _hx_tmp26;
HXDLIN( 329)				if (::hx::IsNull( this20 )) {
HXLINE( 329)					_hx_tmp26 = null();
            				}
            				else {
HXLINE( 329)					_hx_tmp26 = ::Std_obj::string(this20);
            				}
HXDLIN( 329)				_hx_tmp24 = numeric->match(_hx_tmp26);
            			}
            			else {
