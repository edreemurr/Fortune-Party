...
HXLINE( 960)					_hx_tmp3 = (y <= (group1->offsetY + group1->height));
            				}
            				else {
HXLINE( 960)					_hx_tmp3 = false;
            				}
HXDLIN( 960)				if (_hx_tmp3) {
HXLINE( 962)					bool _hx_tmp4;
HXDLIN( 962)					if ((x >= group1->offsetX)) {
HXLINE( 962)						_hx_tmp4 = (x <= (group1->offsetX + group1->width));
            					}
            					else {
HXLINE( 962)						_hx_tmp4 = false;
            					}
HXDLIN( 962)					if (_hx_tmp4) {
HXLINE( 964)						Float advance = ((Float)0.0);
HXLINE( 966)						{
HXLINE( 966)							int _g2 = 0;
HXDLIN( 966)							int _g3 = group1->positions->length;
HXDLIN( 966)							while((_g2 < _g3)){
HXLINE( 966)								_g2 = (_g2 + 1);
HXDLIN( 966)								int i1 = (_g2 - 1);
HXLINE( 968)								Float advance1;
HXDLIN( 968)								bool advance2;
HXDLIN( 968)								if ((i1 >= 0)) {
HXLINE( 968)									advance2 = (i1 < group1->positions->length);
            								}
            								else {
HXLINE( 968)									advance2 = false;
            								}
HXDLIN( 968)								if (advance2) {
HXLINE( 968)									advance1 = group1->positions->__get(i1).StaticCast<  ::openfl::text::_internal::GlyphPosition >()->advance->x;
            								}
            								else {
...
HXLINE( 972)									return (group1->startIndex + i1);
            								}
            							}
            						}
...
HXLINE(1057)				bool _hx_tmp3;
HXDLIN(1057)				if ((y >= group1->offsetY)) {
HXLINE(1057)					_hx_tmp3 = (y <= (group1->offsetY + group1->height));
            				}
            				else {
HXLINE(1057)					_hx_tmp3 = false;
            				}
...
HXLINE(1084)				bool _hx_tmp1;
HXDLIN(1084)				if ((group1->startIndex <= charIndex)) {
HXLINE(1084)					_hx_tmp1 = (group1->endIndex >= charIndex);
            				}
            				else {
HXLINE(1084)					_hx_tmp1 = false;
            				}
...
HXLINE(1282)				bool _hx_tmp3;
HXDLIN(1282)				bool _hx_tmp4;
HXDLIN(1282)				if ((group1->start <= beginIndex)) {
HXLINE(1282)					_hx_tmp4 = (group1->end > beginIndex);
            				}
            				else {
...
HXLINE(1282)						_hx_tmp3 = (group1->end >= endIndex);
            					}
            					else {
HXLINE(1282)						_hx_tmp3 = false;
            					}
            				}
            				else {
HXLINE(1282)					_hx_tmp3 = true;
            				}
HXDLIN(1282)				if (_hx_tmp3) {
...
HXLINE(1533)						bool _hx_tmp5;
HXDLIN(1533)						if ((range->start <= beginIndex)) {
HXLINE(1533)							_hx_tmp5 = (range->end >= endIndex);
            						}
            						else {
HXLINE(1533)							_hx_tmp5 = false;
            						}
HXDLIN(1533)						if (_hx_tmp5) {
HXLINE(1535)							bool _hx_tmp6;
HXDLIN(1535)							if ((range->start == beginIndex)) {
HXLINE(1535)								_hx_tmp6 = (range->end == endIndex);
            							}
            							else {
HXLINE(1535)								_hx_tmp6 = false;
            							}
HXDLIN(1535)							if (_hx_tmp6) {
...
HXLINE(1575)							bool _hx_tmp7;
HXDLIN(1575)							if ((range->start >= beginIndex)) {
HXLINE(1575)								_hx_tmp7 = (range->end <= endIndex);
            							}
            							else {
HXLINE(1575)								_hx_tmp7 = false;
            							}
HXDLIN(1575)							if (_hx_tmp7) {
...
HXLINE(1591)								bool _hx_tmp8;
HXDLIN(1591)								if ((range->start > beginIndex)) {
HXLINE(1591)									_hx_tmp8 = (range->end > beginIndex);
            								}
            								else {
HXLINE(1591)									_hx_tmp8 = false;
            								}
HXDLIN(1591)								if (_hx_tmp8) {
HXLINE(1594)									range->start = endIndex;
HXLINE(1595)									goto _hx_goto_28;
            								}
            								else {
HXLINE(1597)									bool _hx_tmp9;
HXDLIN(1597)									if ((range->start < beginIndex)) {
HXLINE(1597)										_hx_tmp9 = (range->end <= endIndex);
            									}
            									else {
HXLINE(1597)										_hx_tmp9 = false;
            									}
HXDLIN(1597)									if (_hx_tmp9) {
...
HXLINE(1771)				bool _hx_tmp1;
HXDLIN(1771)				if (::hx::IsNotNull( url )) {
HXLINE(1771)					_hx_tmp1 = (url != HX_("",00,00,00,00));
            				}
            				else {
HXLINE(1771)					_hx_tmp1 = false;
            				}
HXDLIN(1771)				if (_hx_tmp1) {
...
HXLINE(1864)					_hx_tmp1 = (charIndex < group1->endIndex);
            				}
            				else {
...
HXLINE(1897)				bool _hx_tmp2;
HXDLIN(1897)				if ((charIndex >= group1->startIndex)) {
HXLINE(1897)					_hx_tmp2 = (charIndex <= group1->endIndex);
            				}
            				else {
HXLINE(1897)					_hx_tmp2 = false;
            				}
HXDLIN(1897)				if (_hx_tmp2) {
...
HXLINE(1913)					{
HXLINE(1913)						int _g2 = 0;
HXDLIN(1913)						int _g3 = (this->get_scrollV() - 1);
HXDLIN(1913)						while((_g2 < _g3)){
HXLINE(1913)							_g2 = (_g2 + 1);
HXDLIN(1913)							int i1 = (_g2 - 1);
HXLINE(1915)							y = (y - this->_hx___textEngine->lineHeights->get(i1));
            						}
            					}
...
HXDLIN(1958)				int i1 = (_g2 - 1);
HXLINE(1960)				group = this->_hx___textEngine->layoutGroups->get(i1).StaticCast<  ::openfl::text::_internal::TextLayoutGroup >();
HXLINE(1962)				if ((i1 < (this->_hx___textEngine->layoutGroups->get_length() - 1))) {
HXLINE(1964)					nextGroup = this->_hx___textEngine->layoutGroups->get((i1 + 1)).StaticCast<  ::openfl::text::_internal::TextLayoutGroup >();
            				}
            				else {
...
HXLINE(1978)				bool _hx_tmp1;
HXDLIN(1978)				bool _hx_tmp2;
HXDLIN(1978)				if ((y >= group->offsetY)) {
HXLINE(1978)					_hx_tmp2 = (y <= (group->offsetY + group->height));
            				}
            				else {
...
HXLINE(1978)						_hx_tmp1 = ::hx::IsNull( nextGroup );
            					}
            					else {
...
HXLINE(1978)					_hx_tmp1 = true;
            				}
HXDLIN(1978)				if (_hx_tmp1) {
HXLINE(1980)					bool _hx_tmp3;
HXDLIN(1980)					bool _hx_tmp4;
HXDLIN(1980)					if ((x >= group->offsetX)) {
HXLINE(1980)						_hx_tmp4 = (x <= (group->offsetX + group->width));
            					}
            					else {
HXLINE(1980)						_hx_tmp4 = false;
            					}
HXDLIN(1980)					if (!(_hx_tmp4)) {
HXLINE(1981)						if (!(precise)) {
HXLINE(1981)							if (::hx::IsNotNull( nextGroup )) {
HXLINE(1980)								_hx_tmp3 = (nextGroup->lineIndex != group->lineIndex);
            							}
            							else {
HXLINE(1980)								_hx_tmp3 = true;
            							}
            						}
            						else {
...
HXLINE(2037)				bool _hx_tmp1;
HXDLIN(2037)				if ((delimiters.indexOf(_hx_char,null()) == -1)) {
HXLINE(2037)					_hx_tmp1 = (position > 0);
            				}
            				else {
HXLINE(2037)					_hx_tmp1 = false;
            				}
HXDLIN(2037)				if (!(_hx_tmp1)) {
...
HXLINE(2068)				bool _hx_tmp1;
HXDLIN(2068)				if ((delimiters.indexOf(_hx_char,null()) == -1)) {
HXLINE(2068)					_hx_tmp1 = (position < this->_hx___text.length);
            				}
            				else {
HXLINE(2068)					_hx_tmp1 = false;
            				}
HXDLIN(2068)				if (!(_hx_tmp1)) {
...
HXLINE(2198)							 ::openfl::text::_internal::TextFormatRange range2 = range;
HXDLIN(2198)							range2->start = (range2->start + offset);
HXLINE(2199)							 ::openfl::text::_internal::TextFormatRange range3 = range;
HXDLIN(2199)							range3->end = (range3->end + offset);
            						}
            						else {
HXLINE(2201)							bool _hx_tmp4;
HXDLIN(2201)							if ((range->start < beginIndex)) {
HXLINE(2201)								_hx_tmp4 = (range->end >= endIndex);
            							}
            							else {
HXLINE(2201)								_hx_tmp4 = false;
            							}
HXDLIN(2201)							if (_hx_tmp4) {
HXLINE(2205)								 ::openfl::text::_internal::TextFormatRange range4 = range;
HXDLIN(2205)								range4->end = (range4->end + offset);
            							}
            						}
            					}
            				}
...
HXLINE(2217)						 ::openfl::text::_internal::TextFormatRange range5 = range;
HXDLIN(2217)						range5->start = (range5->start + offset);
HXLINE(2218)						 ::openfl::text::_internal::TextFormatRange range6 = range;
HXDLIN(2218)						range6->end = (range6->end + offset);
            					}
            					else {
HXLINE(2220)						bool _hx_tmp5;
HXDLIN(2220)						if ((range->start <= beginIndex)) {
HXLINE(2220)							_hx_tmp5 = (range->end > endIndex);
            						}
            						else {
HXLINE(2220)							_hx_tmp5 = false;
            						}
HXDLIN(2220)						if (_hx_tmp5) {
HXLINE(2223)							 ::openfl::text::_internal::TextFormatRange range7 = range;
HXDLIN(2223)							range7->end = (range7->end + offset);
            						}
            						else {
HXLINE(2225)							bool _hx_tmp6;
HXDLIN(2225)							if ((range->start >= beginIndex)) {
HXLINE(2225)								_hx_tmp6 = (range->end <= endIndex);
            							}
            							else {
HXLINE(2225)								_hx_tmp6 = false;
            							}
HXDLIN(2225)							if (_hx_tmp6) {
...
HXDLIN(2228)									::cpp::VirtualArray _g_args = ::cpp::VirtualArray_obj::__new(0);
...
HXLINE(2230)								bool _hx_tmp7;
HXDLIN(2230)								bool _hx_tmp8;
HXDLIN(2230)								if ((range->end > endIndex)) {
HXLINE(2230)									_hx_tmp8 = (range->start > beginIndex);
            								}
            								else {
HXLINE(2230)									_hx_tmp8 = false;
            								}
HXDLIN(2230)								if (_hx_tmp8) {
HXLINE(2230)									_hx_tmp7 = (range->start <= endIndex);
            								}
            								else {
HXLINE(2230)									_hx_tmp7 = false;
            								}
HXDLIN(2230)								if (_hx_tmp7) {
HXLINE(2234)									range->start = beginIndex;
HXLINE(2235)									 ::openfl::text::_internal::TextFormatRange range8 = range;
HXDLIN(2235)									range8->end = (range8->end + offset);
            								}
            								else {
HXLINE(2237)									bool _hx_tmp9;
HXDLIN(2237)									bool _hx_tmp10;
HXDLIN(2237)									if ((range->start < beginIndex)) {
HXLINE(2237)										_hx_tmp10 = (range->end > beginIndex);
            									}
            									else {
HXLINE(2237)										_hx_tmp10 = false;
            									}
HXDLIN(2237)									if (_hx_tmp10) {
HXLINE(2237)										_hx_tmp9 = (range->end <= endIndex);
            									}
            									else {
HXLINE(2237)										_hx_tmp9 = false;
            									}
HXDLIN(2237)									if (_hx_tmp9) {
...
HXLINE(2251)			::Dynamic this2 = this->_hx___textEngine->textFormatRanges;
HXDLIN(2251)			 ::openfl::text::TextFormat value = this->get_defaultTextFormat()->clone();
HXDLIN(2251)			( ( ::openfl::_Vector::ObjectVector)(this2) )->push( ::openfl::text::_internal::TextFormatRange_obj::__alloc( HX_CTX ,value,0,newText.length));
            		}
            		else {
HXLINE(2253)			bool _hx_tmp11;
HXDLIN(2253)			if ((beginIndex == endIndex)) {
HXLINE(2253)				_hx_tmp11 = (this->_hx___textEngine->textFormatRanges->get(0).StaticCast<  ::openfl::text::_internal::TextFormatRange >()->start > 0);
            			}
            			else {
HXLINE(2253)				_hx_tmp11 = false;
            			}
HXDLIN(2253)			if (_hx_tmp11) {
HXLINE(2256)				::Dynamic this3 = this->_hx___textEngine->textFormatRanges;
HXDLIN(2256)				 ::openfl::text::TextFormat value1 = this->get_defaultTextFormat()->clone();
HXDLIN(2256)				( ( ::openfl::_Vector::ObjectVector)(this3) )->unshift( ::openfl::text::_internal::TextFormatRange_obj::__alloc( HX_CTX ,value1,0,this->_hx___textEngine->textFormatRanges->get(0).StaticCast<  ::openfl::text::_internal::TextFormatRange >()->start));
            			}
            			else {
HXLINE(2258)				bool _hx_tmp12;
HXDLIN(2258)				if ((beginIndex != endIndex)) {
HXLINE(2258)					::Dynamic this4 = this->_hx___textEngine->textFormatRanges;
HXDLIN(2258)					 ::openfl::text::_internal::TextFormatRange _hx_tmp13 = ( ( ::openfl::_Vector::ObjectVector)(this4) )->get((this->_hx___textEngine->textFormatRanges->get_length() - 1)).StaticCast<  ::openfl::text::_internal::TextFormatRange >();
HXDLIN(2258)					_hx_tmp12 = (_hx_tmp13->end < this->_hx___text.length);
            				}
            				else {
HXLINE(2258)					_hx_tmp12 = false;
            				}
HXDLIN(2258)				if (_hx_tmp12) {
HXLINE(2261)					::Dynamic this5 = this->_hx___textEngine->textFormatRanges;
HXDLIN(2261)					 ::openfl::text::TextFormat value2 = this->get_defaultTextFormat()->clone();
HXLINE(2262)					::Dynamic this6 = this->_hx___textEngine->textFormatRanges;
HXDLIN(2262)					 ::openfl::text::_internal::TextFormatRange value3 = ( ( ::openfl::_Vector::ObjectVector)(this6) )->get((this->_hx___textEngine->textFormatRanges->get_length() - 1)).StaticCast<  ::openfl::text::_internal::TextFormatRange >();
HXLINE(2261)					( ( ::openfl::_Vector::ObjectVector)(this5) )->push( ::openfl::text::_internal::TextFormatRange_obj::__alloc( HX_CTX ,value2,value3->end,this->_hx___text.length));
            				}
            			}
            		}
...
HXDLIN(2350)						goto _hx_goto_74;
            					...
            					if (  (_hx_switch_0==3) ){
HXLINE(2347)						Float _hx_tmp1 = this->get_x();
HXDLIN(2347)						this->set_x((_hx_tmp1 + (cacheWidth - this->_hx___textEngine->width)));
...
HXLINE(2373)			int _hx_tmp1 = this->get_scrollH();
HXDLIN(2373)			Float _hx_tmp2 = this->get_mouseX();
HXDLIN(2373)			this->set_scrollH((_hx_tmp1 + ::Std_obj::_hx_int(::Math_obj::max(::Math_obj::min(((_hx_tmp2 - bounds->width) * ((Float).1)),( (Float)(10) )),( (Float)(1) )))));
            		}
            		else {
HXLINE(2375)			if ((this->get_mouseX() < 1)) {
HXLINE(2377)				int _hx_tmp3 = this->get_scrollH();
HXDLIN(2377)				this->set_scrollH((_hx_tmp3 - ::Std_obj::_hx_int(::Math_obj::max(::Math_obj::min((this->get_mouseX() * ((Float)-.1)),( (Float)(10) )),( (Float)(1) )))));
            			}
            		}
HXLINE(2380)		this->_hx___mouseScrollVCounter++;
HXLINE(2382)		int _hx_tmp4 = this->_hx___mouseScrollVCounter;
HXDLIN(2382)		if ((_hx_tmp4 > (this->stage->get_frameRate() / ( (Float)(10) )))) {
HXLINE(2384)			Float _hx_tmp5 = this->get_mouseY();
HXDLIN(2384)			if ((_hx_tmp5 > (bounds->height - ( (Float)(2) )))) {
HXLINE(2386)				int _hx_tmp6 = this->get_scrollV();
HXDLIN(2386)				Float _hx_tmp7 = this->get_mouseY();
HXDLIN(2386)				Float _hx_tmp8 = (_hx_tmp6 + ::Math_obj::max(::Math_obj::min(((_hx_tmp7 - bounds->height) * ((Float).03)),( (Float)(5) )),( (Float)(1) )));
HXDLIN(2386)				this->set_scrollV(::Std_obj::_hx_int(::Math_obj::min(_hx_tmp8,( (Float)(this->get_maxScrollV()) ))));
            			}
            			else {
HXLINE(2388)				if ((this->get_mouseY() < 2)) {
HXLINE(2390)					int _hx_tmp9 = this->get_scrollV();
HXDLIN(2390)					this->set_scrollV((_hx_tmp9 - ::Std_obj::_hx_int(::Math_obj::max(::Math_obj::min((this->get_mouseY() * ((Float)-.03)),( (Float)(5) )),( (Float)(1) )))));
            				}
            			}
...
HXLINE(2413)			int _hx_tmp2 = this->getLineOffset(this->getLineIndexOfChar(this->_hx___caretIndex));
HXDLIN(2413)			_hx_tmp1 = (_hx_tmp2 == this->_hx___caretIndex);
            		}
            		else {
...
HXLINE(2435)				bool _hx_tmp3;
HXDLIN(2435)				if ((caret->x < tempScrollH)) {
HXLINE(2435)					_hx_tmp3 = (tempScrollH > 0);
            				}
            				else {
HXLINE(2435)					_hx_tmp3 = false;
            				}
HXDLIN(2435)				if (!(_hx_tmp3)) {
...
HXLINE(2447)		bool _hx_tmp4;
HXDLIN(2447)		if ((tempScrollH > 0)) {
HXLINE(2447)			_hx_tmp4 = ::hx::IsNotEq( this->get_type(),1 );
            		}
            		else {
HXLINE(2447)			_hx_tmp4 = false;
            		}
HXDLIN(2447)		if (_hx_tmp4) {
HXLINE(2450)			int lineLength = this->getLineLength(this->getLineIndexOfChar(this->_hx___caretIndex));
HXLINE(2451)			int _hx_tmp5 = this->get_scrollH();
HXDLIN(2451)			if ((((_hx_tmp5 + bounds->width) - ( (Float)(4) )) > lineLength)) {
...
HXLINE(3014)				_hx_tmp1 = ::hx::IsInstanceEq( this->stage->get_focus(),::hx::ObjectPtr<OBJ_>(this) );
            			}
            			else {
...
HXLINE(3069)				bool _hx_tmp1;
HXDLIN(3069)				if (this->_hx___isHTML) {
HXLINE(3069)					_hx_tmp1 = ::hx::IsInstanceNotEq( value,this->_hx___styleSheet );
            				}
            				else {
HXLINE(3069)					_hx_tmp1 = false;
            				}
HXDLIN(3069)				if (_hx_tmp1) {
...
HXDLIN(3120)				::cpp::VirtualArray _g_args = ::cpp::VirtualArray_obj::__new(0);
...
HXLINE(3283)					Float position3 = this->get_mouseX();
HXDLIN(3283)					Float position4 = (position3 + this->get_scrollH());
HXLINE(3282)					position = this->_hx___getPositionByIdentifier(position4,this->get_mouseY(),false);
            				}
            				else {
HXLINE(3283)					Float position5 = this->get_mouseX();
HXDLIN(3283)					Float position6 = (position5 + this->get_scrollH());
HXLINE(3282)					position = this->_hx___getPosition(position6,this->get_mouseY());
            				}
            			}
HXLINE(3285)			if ((position != this->_hx___caretIndex)) {
HXLINE(3287)				this->_hx___caretIndex = position;
HXLINE(3288)				bool _hx_tmp1;
HXDLIN(3288)				if (!(this->_hx___wordSelection)) {
HXLINE(3288)					_hx_tmp1 = this->_hx___lineSelection;
            				}
            				else {
HXLINE(3288)					_hx_tmp1 = true;
            				}
HXDLIN(3288)				if (_hx_tmp1) {
...
HXLINE(3332)					Float upPos3 = this->get_mouseX();
HXDLIN(3332)					Float upPos4 = (upPos3 + this->get_scrollH());
HXLINE(3331)					upPos = this->_hx___getPositionByIdentifier(upPos4,this->get_mouseY(),false);
            				}
            				else {
HXLINE(3332)					Float upPos5 = this->get_mouseX();
HXDLIN(3332)					Float upPos6 = (upPos5 + this->get_scrollH());
HXLINE(3331)					upPos = this->_hx___getPosition(upPos6,this->get_mouseY());
            				}
            			}
...
HXLINE(3378)			bool _hx_tmp2;
HXDLIN(3378)			bool _hx_tmp3;
HXDLIN(3378)			bool _hx_tmp4;
HXDLIN(3378)			if (::hx::IsNotEq( this->get_type(),1 )) {
HXLINE(3378)				_hx_tmp4 = this->get_selectable();
            			}
            			else {
HXLINE(3378)				_hx_tmp4 = false;
            			}
HXDLIN(3378)			if (_hx_tmp4) {
HXLINE(3378)				_hx_tmp3 = ::hx::IsNotNull( this->stage );
            			}
            			else {
HXLINE(3378)				_hx_tmp3 = false;
            			}
HXDLIN(3378)			if (_hx_tmp3) {
HXLINE(3378)				_hx_tmp2 = ::hx::IsInstanceEq( this->stage->get_focus(),::hx::ObjectPtr<OBJ_>(this) );
            			}
            			else {
...
HXLINE(3405)			bool _hx_tmp3;
HXDLIN(3405)			if ((this->_hx___caretIndex != this->_hx___selectionIndex)) {
HXLINE(3405)				_hx_tmp3 = !(this->get_displayAsPassword());
            			}
            			else {
HXLINE(3405)				_hx_tmp3 = false;
            			}
HXDLIN(3405)			if (_hx_tmp3) {
...
HXDLIN(3424)			Float _hx_tmp1 = (event1 + this->get_scrollH());
HXDLIN(3424)			this->_hx___caretIndex = this->_hx___getPositionByIdentifier(_hx_tmp1,event->stageY,true);
...
HXLINE(3430)				int prevCaretIndex1 = this->_hx___caretIndex;
HXLINE(3431)				Float event2 = event->stageX;
HXDLIN(3431)				Float _hx_tmp2 = (event2 + this->get_scrollH());
HXDLIN(3431)				this->_hx___caretIndex = this->_hx___getPositionByIdentifier(_hx_tmp2,event->stageY,false);
HXLINE(3432)				this->_hx___selectionIndex = this->_hx___getOppositeIdentifierBound(prevCaretIndex1,false);
HXLINE(3433)				this->_hx___specialSelectionInitialIndex = prevCaretIndex1;
HXLINE(3434)				this->setSelection(this->_hx___caretIndex,this->_hx___selectionIndex);
            			}
            			else {
HXLINE(3438)				Float _hx_tmp3 = this->get_mouseX();
HXDLIN(3438)				Float _hx_tmp4 = (_hx_tmp3 + this->get_scrollH());
HXDLIN(3438)				this->_hx___caretIndex = this->_hx___getPosition(_hx_tmp4,this->get_mouseY());
...
HXLINE(3693)					bool _hx_tmp1;
HXDLIN(3693)					if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_ctrlKey(modifier)) {
HXLINE(3693)						_hx_tmp1 = !(::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_altKey(modifier));
            					}
            					else {
HXLINE(3693)						_hx_tmp1 = false;
            					}
HXDLIN(3693)					if (_hx_tmp1) {
HXLINE(3695)						this->setSelection(0,this->_hx___text.length);
            			...
            			break;
            			case (int)99: {
HXLINE(3642)				bool _hx_tmp2;
HXDLIN(3642)				if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_ctrlKey(modifier)) {
HXLINE(3642)					_hx_tmp2 = !(::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_altKey(modifier));
            				}
            				else {
HXLINE(3642)					_hx_tmp2 = false;
            				}
HXDLIN(3642)				if (_hx_tmp2) {
HXLINE(3644)					bool _hx_tmp3;
HXDLIN(3644)					if ((this->_hx___caretIndex != this->_hx___selectionIndex)) {
HXLINE(3644)						_hx_tmp3 = !(this->get_displayAsPassword());
            					}
            					else {
HXLINE(3644)						_hx_tmp3 = false;
            					}
HXDLIN(3644)					if (_hx_tmp3) {
HXLINE(3646)						::lime::_hx_system::Clipboard_obj::set_text(this->_hx___text.substring(this->_hx___caretIndex,this->_hx___selectionIndex));
            			...
            			break;
            			case (int)118: {
HXLINE(3668)				bool _hx_tmp4;
HXDLIN(3668)				if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_ctrlKey(modifier)) {
HXLINE(3668)					_hx_tmp4 = !(::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_altKey(modifier));
            				}
            				else {
HXLINE(3668)					_hx_tmp4 = false;
            				}
HXDLIN(3668)				if (_hx_tmp4) {
...
HXDLIN(3687)					( ( ::openfl::_Vector::ObjectVector)(this1) )->get((this->_hx___textEngine->textFormatRanges->get_length() - 1)).StaticCast<  ::openfl::text::_internal::TextFormatRange >()->end = this->_hx___text.length;
            			...
            			break;
            			case (int)120: {
HXLINE(3653)				bool _hx_tmp5;
HXDLIN(3653)				if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_ctrlKey(modifier)) {
HXLINE(3653)					_hx_tmp5 = !(::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_altKey(modifier));
            				}
            				else {
HXLINE(3653)					_hx_tmp5 = false;
            				}
HXDLIN(3653)				if (_hx_tmp5) {
HXLINE(3655)					bool _hx_tmp6;
HXDLIN(3655)					if ((this->_hx___caretIndex != this->_hx___selectionIndex)) {
HXLINE(3655)						_hx_tmp6 = !(this->get_displayAsPassword());
            					}
            					else {
HXLINE(3655)						_hx_tmp6 = false;
            					}
HXDLIN(3655)					if (_hx_tmp6) {
...
HXLINE(3660)						this->dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("change",70,91,72,b7),true,null()));
            			...
            			break;
            			case (int)127: {
HXLINE(3520)				bool _hx_tmp7;
HXDLIN(3520)				if ((this->_hx___selectionIndex == this->_hx___caretIndex)) {
HXLINE(3520)					_hx_tmp7 = (this->_hx___caretIndex < this->_hx___text.length);
            				}
            				else {
HXLINE(3520)					_hx_tmp7 = false;
            				}
HXDLIN(3520)				if (_hx_tmp7) {
...
HXLINE(3607)					bool _hx_tmp8;
HXDLIN(3607)					if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_ctrlKey(modifier)) {
HXLINE(3607)						_hx_tmp8 = !(::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_altKey(modifier));
            					}
            					else {
HXLINE(3607)						_hx_tmp8 = false;
            					}
HXDLIN(3607)					if (_hx_tmp8) {
...
HXLINE(3624)					bool _hx_tmp9;
HXDLIN(3624)					if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_ctrlKey(modifier)) {
HXLINE(3624)						_hx_tmp9 = !(::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_altKey(modifier));
            					}
            					else {
HXLINE(3624)						_hx_tmp9 = false;
            					}
HXDLIN(3624)					if (_hx_tmp9) {
...
HXLINE(3556)					bool _hx_tmp10;
HXDLIN(3556)					if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_ctrlKey(modifier)) {
HXLINE(3556)						_hx_tmp10 = !(::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_altKey(modifier));
            					}
            					else {
HXLINE(3556)						_hx_tmp10 = false;
            					}
HXDLIN(3556)					if (_hx_tmp10) {
...
HXLINE(3539)					bool _hx_tmp11;
HXDLIN(3539)					if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_ctrlKey(modifier)) {
HXLINE(3539)						_hx_tmp11 = !(::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_altKey(modifier));
            					}
            					else {
HXLINE(3539)						_hx_tmp11 = false;
            					}
HXDLIN(3539)					if (_hx_tmp11) {
...
HXLINE(3573)					bool _hx_tmp12;
HXDLIN(3573)					if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_ctrlKey(modifier)) {
HXLINE(3573)						_hx_tmp12 = !(::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_altKey(modifier));
            					}
            					else {
HXLINE(3573)						_hx_tmp12 = false;
            					}
HXDLIN(3573)					if (_hx_tmp12) {
...
HXLINE(3590)					bool _hx_tmp13;
HXDLIN(3590)					if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_ctrlKey(modifier)) {
HXLINE(3590)						_hx_tmp13 = !(::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_altKey(modifier));
            					}
            					else {
HXLINE(3590)						_hx_tmp13 = false;
            					}
HXDLIN(3590)					if (_hx_tmp13) {
...
HXLINE(3483)					 ::openfl::events::TextEvent te1 =  ::openfl::events::TextEvent_obj::__alloc( HX_CTX ,HX_("textInput",1d,54,0b,57),true,true,HX_("\n",0a,00,00,00));
HXLINE(3485)					this->dispatchEvent(te1);
HXLINE(3487)					if (!(te1->isDefaultPrevented())) {
