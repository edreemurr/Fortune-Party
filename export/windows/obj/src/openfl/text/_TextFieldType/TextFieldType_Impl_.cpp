...
HX_LOCAL_STACK_FRAME(_hx_pos_923930f61aa169d2_26_fromString,"openfl.text._TextFieldType.TextFieldType_Impl_","fromString",0x3beed305,"openfl.text._TextFieldType.TextFieldType_Impl_.fromString","openfl/text/TextFieldType.hx",26,0xaebfe8fa)
HX_LOCAL_STACK_FRAME(_hx_pos_923930f61aa169d2_36_toString,"openfl.text._TextFieldType.TextFieldType_Impl_","toString",0x7192f756,"openfl.text._TextFieldType.TextFieldType_Impl_.toString","openfl/text/TextFieldType.hx",36,0xaebfe8fa)
...
HX_LOCAL_STACK_FRAME(_hx_pos_923930f61aa169d2_22_boot,"openfl.text._TextFieldType.TextFieldType_Impl_","boot",0xd2688ddc,"openfl.text._TextFieldType.TextFieldType_Impl_.boot","openfl/text/TextFieldType.hx",22,0xaebfe8fa)
namespace openfl{
namespace text{
...
bool TextFieldType_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic TextFieldType_Impl__obj::fromString(::String value){
            	HX_STACKFRAME(&_hx_pos_923930f61aa169d2_26_fromString)
...
::String TextFieldType_Impl__obj::toString( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_923930f61aa169d2_36_toString)
HXDLIN(  36)		 ::Dynamic _hx_switch_0 = this1;
            		if (  (_hx_switch_0==0) ){
HXLINE(  38)			return HX_("dynamic",7f,9f,15,36);
HXDLIN(  38)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==1) ){
HXLINE(  39)			return HX_("input",0a,c4,1d,be);
...
{
            	HX_STACKFRAME(&_hx_pos_923930f61aa169d2_22_boot)
HXDLIN(  22)		INPUT = 1;
            	}
}
