...
HX_LOCAL_STACK_FRAME(_hx_pos_1587d256662a54fa_170_stopAll,"openfl.media.SoundMixer","stopAll",0x7ebb1d93,"openfl.media.SoundMixer.stopAll","openfl/media/SoundMixer.hx",170,0x17e3a43a)
...
HX_LOCAL_STACK_FRAME(_hx_pos_1587d256662a54fa_197___unregisterSoundChannelByBuffer,"openfl.media.SoundMixer","__unregisterSoundChannelByBuffer",0x73c61f33,"openfl.media.SoundMixer.__unregisterSoundChannelByBuffer","openfl/media/SoundMixer.hx",197,0x17e3a43a)
HX_LOCAL_STACK_FRAME(_hx_pos_1587d256662a54fa_212_set_soundTransform,"openfl.media.SoundMixer","set_soundTransform",0xa3536b06,"openfl.media.SoundMixer.set_soundTransform","openfl/media/SoundMixer.hx",212,0x17e3a43a)
...
void SoundMixer_obj::stopAll(){
            	HX_STACKFRAME(&_hx_pos_1587d256662a54fa_170_stopAll)
HXLINE( 171)		int i = ::openfl::media::SoundMixer_obj::_hx___soundChannels->length;
HXLINE( 172)		while((i > 0)){
HXLINE( 174)			i = (i - 1);
HXLINE( 175)			::openfl::media::SoundMixer_obj::_hx___soundChannels->__get(i).StaticCast<  ::openfl::media::SoundChannel >()->stop();
            		}
            	}
...
void SoundMixer_obj::_hx___unregisterSoundChannelByBuffer( ::lime::media::AudioBuffer buffer){
            	HX_STACKFRAME(&_hx_pos_1587d256662a54fa_197___unregisterSoundChannelByBuffer)
HXLINE( 198)		int i = ::openfl::media::SoundMixer_obj::_hx___soundChannels->length;
HXLINE( 199)		while((i > 0)){
HXLINE( 201)			i = (i - 1);
HXLINE( 202)			 ::openfl::media::SoundChannel channel = ::openfl::media::SoundMixer_obj::_hx___soundChannels->__get(i).StaticCast<  ::openfl::media::SoundChannel >();
HXLINE( 203)			if (::hx::IsInstanceEq( channel->_hx___audioSource->buffer,buffer )) {
HXLINE( 205)				channel->stop();
            			}
            		}
            	}


STATIC_HX_DEFINE_DYNAMIC_FUNC1(SoundMixer_obj,_hx___unregisterSoundChannelByBuffer,(void))

 ::openfl::media::SoundTransform SoundMixer_obj::set_soundTransform( ::openfl::media::SoundTransform value){
            	HX_STACKFRAME(&_hx_pos_1587d256662a54fa_212_set_soundTransform)
HXLINE( 213)		::openfl::media::SoundMixer_obj::_hx___soundTransform = value->clone();
HXLINE( 215)		{
HXLINE( 215)			int _g = 0;
HXDLIN( 215)			::Array< ::Dynamic> _g1 = ::openfl::media::SoundMixer_obj::_hx___soundChannels;
HXDLIN( 215)			while((_g < _g1->length)){
HXLINE( 215)				 ::openfl::media::SoundChannel channel = _g1->__get(_g).StaticCast<  ::openfl::media::SoundChannel >();
HXDLIN( 215)				_g = (_g + 1);
HXLINE( 217)				channel->_hx___updateTransform();
            			}
            		}
...
bool SoundMixer_obj::__GetStatic(const ::String &inName, Dynamic &outValue, ::hx::PropertyAccess inCallProp)
{
	...
	case 24:
		...
		break;
	case 32:
		if (HX_FIELD_EQ(inName,"__unregisterSoundChannelByBuffer") ) { outValue = _hx___unregisterSoundChannelByBuffer_dyn(); return true; }
	}
	return false;
}
...
static ::String SoundMixer_obj_sStaticFields[] = {
	...
	HX_("__unregisterSoundChannelByBuffer",07,81,95,c6),
