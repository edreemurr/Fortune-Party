...
HX_DEFINE_STACK_FRAME(_hx_pos_baeaab40d0a56ac0_146_new,"openfl.media.SoundLoaderContext","new",0xafd95147,"openfl.media.SoundLoaderContext.new","openfl/media/SoundLoaderContext.hx",146,0x79afda07)
namespace openfl{
namespace media{
...
HXLINE( 147)		this->bufferTime = bufferTime;
HXLINE( 148)		this->checkPolicyFile = checkPolicyFile;
            	}
