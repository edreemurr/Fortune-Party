...
HX_DEFINE_STACK_FRAME(_hx_pos_81bdcfb19984cb04_21_new,"openfl.errors.ArgumentError","new",0x72c6c578,"openfl.errors.ArgumentError.new","openfl/errors/ArgumentError.hx",21,0xb16d4318)
namespace openfl{
namespace errors{
...
void ArgumentError_obj::__construct(::String __o_message){
            	...
            	HX_STACKFRAME(&_hx_pos_81bdcfb19984cb04_21_new)
HXLINE(  22)		super::__construct(message,null());
HXLINE(  24)		this->name = HX_("ArgumentError",eb,77,4b,60);
            	}
