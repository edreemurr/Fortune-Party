...
HX_DEFINE_STACK_FRAME(_hx_pos_5bc3dc96f52a961d_15_new,"openfl.errors.TypeError","new",0x4857781b,"openfl.errors.TypeError.new","openfl/errors/TypeError.hx",15,0xef0d65d5)
namespace openfl{
namespace errors{
...
void TypeError_obj::__construct(::String __o_message){
            	...
            	HX_STACKFRAME(&_hx_pos_5bc3dc96f52a961d_15_new)
HXLINE(  16)		super::__construct(message,0);
HXLINE(  18)		this->name = HX_("TypeError",8e,06,d5,d9);
            	}
