...
HX_DEFINE_STACK_FRAME(_hx_pos_bc09bde916c21592_22_new,"openfl.errors.RangeError","new",0xae8f9562,"openfl.errors.RangeError.new","openfl/errors/RangeError.hx",22,0xfc04662e)
namespace openfl{
namespace errors{
...
void RangeError_obj::__construct(::String __o_message){
            	...
            	HX_STACKFRAME(&_hx_pos_bc09bde916c21592_22_new)
HXLINE(  23)		super::__construct(message,0);
HXLINE(  25)		this->name = HX_("RangeError",eb,ac,85,3c);
            	}
