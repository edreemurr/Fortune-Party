...
HX_LOCAL_STACK_FRAME(_hx_pos_7c7ee06d9b3544d2_115_toString,"openfl.errors.Error","toString",0x62f5b437,"openfl.errors.Error.toString","openfl/errors/Error.hx",115,0x5096467b)
...
::String Error_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_7c7ee06d9b3544d2_115_toString)
HXDLIN( 115)		if (::hx::IsNotNull( this->get_message() )) {
HXLINE( 117)			return this->get_message();
            		}
            		else {
HXLINE( 121)			return HX_("Error",a8,3b,57,06);
            		}
