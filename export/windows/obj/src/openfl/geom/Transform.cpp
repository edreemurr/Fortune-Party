...
HX_LOCAL_STACK_FRAME(_hx_pos_c4822148baac23ea_224_get_concatenatedMatrix,"openfl.geom.Transform","get_concatenatedMatrix",0x352d276f,"openfl.geom.Transform.get_concatenatedMatrix","openfl/geom/Transform.hx",224,0xf4f475e6)
HX_LOCAL_STACK_FRAME(_hx_pos_c4822148baac23ea_234_get_matrix,"openfl.geom.Transform","get_matrix",0x80c3ba80,"openfl.geom.Transform.get_matrix","openfl/geom/Transform.hx",234,0xf4f475e6)
HX_LOCAL_STACK_FRAME(_hx_pos_c4822148baac23ea_244_set_matrix,"openfl.geom.Transform","set_matrix",0x844158f4,"openfl.geom.Transform.set_matrix","openfl/geom/Transform.hx",244,0xf4f475e6)
HX_LOCAL_STACK_FRAME(_hx_pos_c4822148baac23ea_263_get_matrix3D,"openfl.geom.Transform","get_matrix3D",0x05078731,"openfl.geom.Transform.get_matrix3D","openfl/geom/Transform.hx",263,0xf4f475e6)
HX_LOCAL_STACK_FRAME(_hx_pos_c4822148baac23ea_276_set_matrix3D,"openfl.geom.Transform","set_matrix3D",0x1a00aaa5,"openfl.geom.Transform.set_matrix3D","openfl/geom/Transform.hx",276,0xf4f475e6)
HX_LOCAL_STACK_FRAME(_hx_pos_c4822148baac23ea_293___setTransform,"openfl.geom.Transform","__setTransform",0x9df9f800,"openfl.geom.Transform.__setTransform","openfl/geom/Transform.hx",293,0xf4f475e6)
namespace openfl{
namespace geom{
...
HX_DEFINE_DYNAMIC_FUNC1(Transform_obj,set_colorTransform,return )
 ...
 ::openfl::geom::Matrix Transform_obj::get_concatenatedMatrix(){
            	HX_STACKFRAME(&_hx_pos_c4822148baac23ea_224_get_concatenatedMatrix)
HXLINE( 225)		if (this->_hx___hasMatrix) {
HXLINE( 227)			return this->_hx___displayObject->_hx___getWorldTransform()->clone();
            		}
...
HX_DEFINE_DYNAMIC_FUNC0(Transform_obj,get_concatenatedMatrix,return )
 ...
 ::openfl::geom::Matrix Transform_obj::get_matrix(){
            	HX_STACKFRAME(&_hx_pos_c4822148baac23ea_234_get_matrix)
HXLINE( 235)		if (this->_hx___hasMatrix) {
HXLINE( 237)			return this->_hx___displayObject->_hx___transform->clone();
            		}
...
HX_DEFINE_DYNAMIC_FUNC0(Transform_obj,get_matrix,return )
 ...
 ::openfl::geom::Matrix Transform_obj::set_matrix( ::openfl::geom::Matrix value){
            	HX_STACKFRAME(&_hx_pos_c4822148baac23ea_244_set_matrix)
HXLINE( 245)		if (::hx::IsNull( value )) {
HXLINE( 247)			this->_hx___hasMatrix = false;
HXLINE( 248)			return null();
            		}
HXLINE( 251)		this->_hx___hasMatrix = true;
HXLINE( 252)		this->_hx___hasMatrix3D = false;
HXLINE( 254)		if (::hx::IsNotNull( this->_hx___displayObject )) {
HXLINE( 256)			this->_hx___setTransform(value->a,value->b,value->c,value->d,value->tx,value->ty);
            		}
...
HX_DEFINE_DYNAMIC_FUNC0(Transform_obj,get_matrix3D,return )
 ...
 ::openfl::geom::Matrix3D Transform_obj::set_matrix3D( ::openfl::geom::Matrix3D value){
            	HX_STACKFRAME(&_hx_pos_c4822148baac23ea_276_set_matrix3D)
HXLINE( 277)		if (::hx::IsNull( value )) {
HXLINE( 279)			this->_hx___hasMatrix3D = false;
HXLINE( 280)			return null();
            		}
HXLINE( 283)		this->_hx___hasMatrix = false;
HXLINE( 284)		this->_hx___hasMatrix3D = true;
HXLINE( 286)		Float _hx_tmp = value->rawData->get(0);
HXDLIN( 286)		Float _hx_tmp1 = value->rawData->get(1);
HXDLIN( 286)		Float _hx_tmp2 = value->rawData->get(4);
HXDLIN( 286)		Float _hx_tmp3 = value->rawData->get(5);
HXDLIN( 286)		Float _hx_tmp4 = value->rawData->get(12);
HXDLIN( 286)		this->_hx___setTransform(_hx_tmp,_hx_tmp1,_hx_tmp2,_hx_tmp3,_hx_tmp4,value->rawData->get(13));
...
void Transform_obj::_hx___setTransform(Float a,Float b,Float c,Float d,Float tx,Float ty){
            	HX_STACKFRAME(&_hx_pos_c4822148baac23ea_293___setTransform)
HXDLIN( 293)		if (::hx::IsNotNull( this->_hx___displayObject )) {
HXLINE( 295)			 ::openfl::geom::Matrix transform = this->_hx___displayObject->_hx___transform;
HXLINE( 296)			bool _hx_tmp;
HXDLIN( 296)			bool _hx_tmp1;
HXDLIN( 296)			bool _hx_tmp2;
HXDLIN( 296)			bool _hx_tmp3;
HXDLIN( 296)			bool _hx_tmp4;
HXDLIN( 296)			if ((transform->a == a)) {
HXLINE( 296)				_hx_tmp4 = (transform->b == b);
            			}
            			else {
HXLINE( 296)				_hx_tmp4 = false;
            			}
HXDLIN( 296)			if (_hx_tmp4) {
HXLINE( 296)				_hx_tmp3 = (transform->c == c);
            			}
            			else {
HXLINE( 296)				_hx_tmp3 = false;
            			}
HXDLIN( 296)			if (_hx_tmp3) {
HXLINE( 296)				_hx_tmp2 = (transform->d == d);
            			}
            			else {
HXLINE( 296)				_hx_tmp2 = false;
            			}
HXDLIN( 296)			if (_hx_tmp2) {
HXLINE( 296)				_hx_tmp1 = (transform->tx == tx);
            			}
            			else {
HXLINE( 296)				_hx_tmp1 = false;
            			}
HXDLIN( 296)			if (_hx_tmp1) {
HXLINE( 296)				_hx_tmp = (transform->ty == ty);
            			}
            			else {
...
HXLINE( 301)			Float scaleX = ((Float)0.0);
HXLINE( 302)			Float scaleY = ((Float)0.0);
HXLINE( 304)			if ((b == 0)) {
HXLINE( 306)				scaleX = a;
            			}
            			else {
HXLINE( 310)				scaleX = ::Math_obj::sqrt(((a * a) + (b * b)));
            			}
HXLINE( 313)			if ((c == 0)) {
HXLINE( 315)				scaleY = d;
            			}
            			else {
HXLINE( 319)				scaleY = ::Math_obj::sqrt(((c * c) + (d * d)));
            			}
HXLINE( 322)			this->_hx___displayObject->_hx___scaleX = scaleX;
HXLINE( 323)			this->_hx___displayObject->_hx___scaleY = scaleY;
HXLINE( 325)			Float rotation = (((( (Float)(180) ) / ::Math_obj::PI) * ::Math_obj::atan2(d,c)) - ( (Float)(90) ));
HXLINE( 327)			if ((rotation != this->_hx___displayObject->_hx___rotation)) {
HXLINE( 329)				this->_hx___displayObject->_hx___rotation = rotation;
HXLINE( 330)				Float radians = (rotation * (::Math_obj::PI / ( (Float)(180) )));
HXLINE( 331)				this->_hx___displayObject->_hx___rotationSine = ::Math_obj::sin(radians);
HXLINE( 332)				this->_hx___displayObject->_hx___rotationCosine = ::Math_obj::cos(radians);
            			}
HXLINE( 335)			transform->a = a;
HXLINE( 336)			transform->b = b;
HXLINE( 337)			transform->c = c;
HXLINE( 338)			transform->d = d;
HXLINE( 339)			transform->tx = tx;
HXLINE( 340)			transform->ty = ty;
HXLINE( 342)			this->_hx___displayObject->_hx___setTransformDirty();
            		}
            	}
