...
HX_LOCAL_STACK_FRAME(_hx_pos_410ccb691917537a_952___getKeyLocation,"openfl.ui.Keyboard","__getKeyLocation",0xfd1dd5a9,"openfl.ui.Keyboard.__getKeyLocation","openfl/ui/Keyboard.hx",952,0x5fb867bb)
...
HXLINE( 826)					return 9;
            				...
            				break;
            				case (int)13: {
HXLINE( 828)					return 13;
            				}
            				break;
            				case (int)27: {
HXLINE( 830)					return 27;
            				}
            				break;
            				case (int)32: {
HXLINE( 832)					return 32;
            				}
            				break;
            				case (int)186: {
HXLINE( 834)					return 59;
            				}
            				break;
            				case (int)187: {
HXLINE( 836)					return 61;
            				}
            				break;
            				case (int)188: {
HXLINE( 838)					return 44;
            				}
            				break;
            				case (int)189: {
HXLINE( 840)					return 45;
            				}
            				break;
            				case (int)190: {
HXLINE( 842)					return 46;
            				}
            				break;
            				case (int)191: {
HXLINE( 844)					return 47;
            				}
            				break;
            				case (int)192: {
HXLINE( 846)					return 96;
            				}
            				break;
            				case (int)219: {
HXLINE( 848)					return 91;
            				}
            				break;
            				case (int)220: {
HXLINE( 850)					return 92;
            				}
            				break;
            				case (int)221: {
HXLINE( 852)					return 93;
            				}
            				break;
            				case (int)222: {
HXLINE( 854)					return 39;
            				}
            				break;
            			}
HXLINE( 857)			bool _hx_tmp;
HXDLIN( 857)			if ((key >= 48)) {
HXLINE( 857)				_hx_tmp = (key <= 57);
            			}
            			else {
HXLINE( 857)				_hx_tmp = false;
            			}
HXDLIN( 857)			if (_hx_tmp) {
HXLINE( 859)				return ((key - 48) + 48);
            			}
HXLINE( 862)			bool _hx_tmp1;
HXDLIN( 862)			if ((key >= 65)) {
HXLINE( 862)				_hx_tmp1 = (key <= 90);
            			}
            			else {
HXLINE( 862)				_hx_tmp1 = false;
            			}
HXDLIN( 862)			if (_hx_tmp1) {
HXLINE( 864)				return ((key - 65) + 97);
            			}
            		}
            		else {
HXLINE( 869)			switch((int)(key)){
            				case (int)48: {
HXLINE( 872)					return 41;
            				}
            				break;
            				case (int)49: {
HXLINE( 874)					return 33;
            				}
            				break;
            				case (int)50: {
HXLINE( 876)					return 64;
            				}
            				break;
            				case (int)51: {
HXLINE( 878)					return 35;
            				}
            				break;
            				case (int)52: {
HXLINE( 880)					return 36;
            				}
            				break;
            				case (int)53: {
HXLINE( 882)					return 37;
            				}
            				break;
            				case (int)54: {
HXLINE( 884)					return 94;
            				}
            				break;
            				case (int)55: {
HXLINE( 886)					return 38;
            				}
            				break;
            				case (int)56: {
HXLINE( 888)					return 42;
            				}
            				break;
            				case (int)57: {
HXLINE( 890)					return 40;
            				}
            				break;
            				case (int)186: {
HXLINE( 892)					return 58;
            				}
            				break;
            				case (int)187: {
HXLINE( 894)					return 43;
            				}
            				break;
            				case (int)188: {
HXLINE( 896)					return 60;
            				}
            				break;
            				case (int)189: {
HXLINE( 898)					return 95;
            				}
            				break;
            				case (int)190: {
HXLINE( 900)					return 62;
            				}
            				break;
            				case (int)191: {
HXLINE( 902)					return 63;
            				}
            				break;
            				case (int)192: {
HXLINE( 904)					return 126;
            				}
            				break;
            				case (int)219: {
HXLINE( 906)					return 123;
            				}
            				break;
            				case (int)220: {
HXLINE( 908)					return 124;
            				}
            				break;
            				case (int)221: {
HXLINE( 910)					return 125;
            				}
            				break;
            				case (int)222: {
HXLINE( 912)					return 34;
            				}
            				break;
            			}
HXLINE( 915)			bool _hx_tmp2;
HXDLIN( 915)			if ((key >= 65)) {
HXLINE( 915)				_hx_tmp2 = (key <= 90);
            			}
            			else {
HXLINE( 915)				_hx_tmp2 = false;
            			}
HXDLIN( 915)			if (_hx_tmp2) {
HXLINE( 917)				return ((key - 65) + 65);
            			}
            		}
HXLINE( 921)		bool _hx_tmp3;
HXDLIN( 921)		if ((key >= 96)) {
HXLINE( 921)			_hx_tmp3 = (key <= 105);
            		}
            		else {
HXLINE( 921)			_hx_tmp3 = false;
            		}
HXDLIN( 921)		if (_hx_tmp3) {
HXLINE( 923)			return ((key - 96) + 48);
            		}
HXLINE( 926)		switch((int)(key)){
            			case (int)8: {
HXLINE( 943)				return 8;
            			}
            			break;
            			case (int)13: {
HXLINE( 941)				return 13;
            			}
            			break;
            			case (int)46: {
HXLINE( 939)				return 127;
            			}
            			break;
            			case (int)106: {
HXLINE( 929)				return 42;
            			}
            			break;
            			case (int)107: {
HXLINE( 931)				return 43;
            			}
            			break;
            			case (int)108: {
HXLINE( 933)				return 44;
            			}
            			break;
            			case (int)110: {
HXLINE( 935)				return 45;
            			}
            			break;
            			case (int)111: {
HXLINE( 937)				return 46;
            			}
            			break;
            		}
HXLINE( 946)		return 0;
...
int Keyboard_obj::_hx___getKeyLocation(int key){
            	HX_STACKFRAME(&_hx_pos_410ccb691917537a_952___getKeyLocation)
HXDLIN( 952)		switch((int)(key)){
