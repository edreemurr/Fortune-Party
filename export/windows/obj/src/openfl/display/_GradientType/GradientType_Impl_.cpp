...
HX_LOCAL_STACK_FRAME(_hx_pos_b8cb0a95bea7ff48_28_fromInt,"openfl.display._GradientType.GradientType_Impl_","fromInt",0xbb719b10,"openfl.display._GradientType.GradientType_Impl_.fromInt","openfl/display/GradientType.hx",28,0xadf6e848)
HX_LOCAL_STACK_FRAME(_hx_pos_b8cb0a95bea7ff48_33_fromString,"openfl.display._GradientType.GradientType_Impl_","fromString",0x32cb6550,"openfl.display._GradientType.GradientType_Impl_.fromString","openfl/display/GradientType.hx",33,0xadf6e848)
HX_LOCAL_STACK_FRAME(_hx_pos_b8cb0a95bea7ff48_43_toInt,"openfl.display._GradientType.GradientType_Impl_","toInt",0x5e8fbadf,"openfl.display._GradientType.GradientType_Impl_.toInt","openfl/display/GradientType.hx",43,0xadf6e848)
HX_LOCAL_STACK_FRAME(_hx_pos_b8cb0a95bea7ff48_48_toString,"openfl.display._GradientType.GradientType_Impl_","toString",0xdcddd0e1,"openfl.display._GradientType.GradientType_Impl_.toString","openfl/display/GradientType.hx",48,0xadf6e848)
HX_LOCAL_STACK_FRAME(_hx_pos_b8cb0a95bea7ff48_19_boot,"openfl.display._GradientType.GradientType_Impl_","boot",0xb7af05e7,"openfl.display._GradientType.GradientType_Impl_.boot","openfl/display/GradientType.hx",19,0xadf6e848)
HX_LOCAL_STACK_FRAME(_hx_pos_b8cb0a95bea7ff48_24_boot,"openfl.display._GradientType.GradientType_Impl_","boot",0xb7af05e7,"openfl.display._GradientType.GradientType_Impl_.boot","openfl/display/GradientType.hx",24,0xadf6e848)
namespace openfl{
namespace display{
...
bool GradientType_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic GradientType_Impl__obj::fromInt( ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_b8cb0a95bea7ff48_28_fromInt)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(GradientType_Impl__obj,fromInt,return )
 ...
 ::Dynamic GradientType_Impl__obj::fromString(::String value){
            	HX_STACKFRAME(&_hx_pos_b8cb0a95bea7ff48_33_fromString)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(GradientType_Impl__obj,fromString,return )
 ...
 ::Dynamic GradientType_Impl__obj::toInt( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_b8cb0a95bea7ff48_43_toInt)
...
::String GradientType_Impl__obj::toString( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_b8cb0a95bea7ff48_48_toString)
HXDLIN(  48)		 ::Dynamic _hx_switch_0 = this1;
            		if (  (_hx_switch_0==0) ){
HXLINE(  50)			return HX_("linear",e5,51,a0,ec);
HXDLIN(  50)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_0==1) ){
HXLINE(  51)			return HX_("radial",df,be,f6,b0);
...
{
{
            	HX_STACKFRAME(&_hx_pos_b8cb0a95bea7ff48_19_boot)
HXDLIN(  19)		LINEAR = 0;
            	}
{
            	HX_STACKFRAME(&_hx_pos_b8cb0a95bea7ff48_24_boot)
HXDLIN(  24)		RADIAL = 1;
            	}
}
