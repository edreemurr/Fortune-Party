...
HX_DEFINE_STACK_FRAME(_hx_pos_7b37310b03d9d57e_67_new,"openfl.display.GraphicsQuadPath","new",0x93697fd3,"openfl.display.GraphicsQuadPath.new","openfl/display/GraphicsQuadPath.hx",67,0x6ee01b3b)
namespace openfl{
namespace display{
...
void GraphicsQuadPath_obj::__construct( ::openfl::_Vector::FloatVector rects, ::openfl::_Vector::IntVector indices, ::openfl::_Vector::FloatVector transforms){
            	HX_STACKFRAME(&_hx_pos_7b37310b03d9d57e_67_new)
HXLINE(  68)		this->rects = rects;
HXLINE(  69)		this->indices = indices;
HXLINE(  70)		this->transforms = transforms;
HXLINE(  73)		this->_hx___graphicsDataType = 6;
            	}
