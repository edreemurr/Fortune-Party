...
HX_DEFINE_STACK_FRAME(_hx_pos_60eb5008390fcdf2_30_new,"openfl.display.GraphicsEndFill","new",0x1f8242bb,"openfl.display.GraphicsEndFill.new","openfl/display/GraphicsEndFill.hx",30,0x45937e97)
namespace openfl{
namespace display{

void GraphicsEndFill_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_60eb5008390fcdf2_30_new)
HXLINE(  31)		this->_hx___graphicsDataType = 5;
HXLINE(  32)		this->_hx___graphicsFillType = 3;
            	}
