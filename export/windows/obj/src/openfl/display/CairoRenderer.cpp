...
HXLINE(  88)			{
HXLINE(  88)				 ::lime::utils::ArrayBufferView this5 = this->_hx___matrix3;
HXDLIN(  88)				Float value4 = ( (Float)(::Math_obj::round(this->_hx___matrix->tx)) );
HXDLIN(  88)				 ::__hxcpp_memory_set_float(this5->buffer->b,(this5->byteOffset + 24),value4);
            			}
HXLINE(  89)			{
HXLINE(  89)				 ::lime::utils::ArrayBufferView this6 = this->_hx___matrix3;
HXDLIN(  89)				Float value5 = ( (Float)(::Math_obj::round(this->_hx___matrix->ty)) );
HXDLIN(  89)				 ::__hxcpp_memory_set_float(this6->buffer->b,(this6->byteOffset + 28),value5);
            			}
            		}
            		else {
HXLINE(  93)			{
HXLINE(  93)				 ::lime::utils::ArrayBufferView this7 = this->_hx___matrix3;
HXDLIN(  93)				Float value6 = this->_hx___matrix->tx;
HXDLIN(  93)				 ::__hxcpp_memory_set_float(this7->buffer->b,(this7->byteOffset + 24),value6);
            			}
HXLINE(  94)			{
HXLINE(  94)				 ::lime::utils::ArrayBufferView this8 = this->_hx___matrix3;
HXDLIN(  94)				Float value7 = this->_hx___matrix->ty;
HXDLIN(  94)				 ::__hxcpp_memory_set_float(this8->buffer->b,(this8->byteOffset + 28),value7);
            			}
            		}
