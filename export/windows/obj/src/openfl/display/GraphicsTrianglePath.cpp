...
HX_DEFINE_STACK_FRAME(_hx_pos_a26b1fc0d062e909_83_new,"openfl.display.GraphicsTrianglePath","new",0x6d94fd54,"openfl.display.GraphicsTrianglePath.new","openfl/display/GraphicsTrianglePath.hx",83,0x122c7fda)
namespace openfl{
namespace display{
...
void GraphicsTrianglePath_obj::__construct( ::openfl::_Vector::FloatVector vertices, ::openfl::_Vector::IntVector indices, ::openfl::_Vector::FloatVector uvtData, ::Dynamic __o_culling){
            	...
            	HX_STACKFRAME(&_hx_pos_a26b1fc0d062e909_83_new)
HXLINE(  84)		this->vertices = vertices;
HXLINE(  85)		this->indices = indices;
HXLINE(  86)		this->uvtData = uvtData;
HXLINE(  87)		this->culling = culling;
HXLINE(  88)		this->_hx___graphicsDataType = 7;
            	}
