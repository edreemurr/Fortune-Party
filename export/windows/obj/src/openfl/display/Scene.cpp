...
HX_DEFINE_STACK_FRAME(_hx_pos_4f3583535d08fb2f_46_new,"openfl.display.Scene","new",0x370a3e94,"openfl.display.Scene.new","openfl/display/Scene.hx",46,0x8c18ea5e)
namespace openfl{
namespace display{

void Scene_obj::__construct(::String name,::Array< ::Dynamic> labels,int numFrames){
            	HX_STACKFRAME(&_hx_pos_4f3583535d08fb2f_46_new)
HXLINE(  47)		this->name = name;
HXLINE(  48)		this->labels = labels;
HXLINE(  49)		this->numFrames = numFrames;
            	}
