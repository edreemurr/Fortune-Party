...
HX_LOCAL_STACK_FRAME(_hx_pos_528f7f21fd241d40_9_renderDrawable,"openfl.display._internal.DOMSimpleButton","renderDrawable",0xe7a92f18,"openfl.display._internal.DOMSimpleButton.renderDrawable","openfl/display/_internal/DOMSimpleButton.hx",9,0x036fd757)
HX_LOCAL_STACK_FRAME(_hx_pos_528f7f21fd241d40_38_renderDrawableClear,"openfl.display._internal.DOMSimpleButton","renderDrawableClear",0xedc5fb55,"openfl.display._internal.DOMSimpleButton.renderDrawableClear","openfl/display/_internal/DOMSimpleButton.hx",38,0x036fd757)
namespace openfl{
namespace display{
namespace _internal{
...
void DOMSimpleButton_obj::renderDrawable( ::openfl::display::SimpleButton simpleButton, ::openfl::display::DOMRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_528f7f21fd241d40_9_renderDrawable)
HXLINE(  11)		renderer->_hx___pushMaskObject(simpleButton,null());
HXLINE(  13)		{
HXLINE(  13)			 ::Dynamic previousState = simpleButton->_hx___previousStates->iterator();
HXDLIN(  13)			while(( (bool)(previousState->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(  13)				 ::openfl::display::DisplayObject previousState1 = ( ( ::openfl::display::DisplayObject)(previousState->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE(  15)				renderer->_hx___renderDrawable(previousState1);
            			}
            		}
HXLINE(  18)		simpleButton->_hx___previousStates->set_length(0);
HXLINE(  20)		if (::hx::IsNotNull( simpleButton->_hx___currentState )) {
HXLINE(  22)			if (::hx::IsInstanceNotEq( simpleButton->_hx___currentState->stage,simpleButton->stage )) {
HXLINE(  24)				simpleButton->_hx___currentState->_hx___setStageReference(simpleButton->stage);
            			}
HXLINE(  27)			renderer->_hx___renderDrawable(simpleButton->_hx___currentState);
            		}
HXLINE(  30)		renderer->_hx___popMaskObject(simpleButton,null());
HXLINE(  32)		renderer->_hx___renderEvent(simpleButton);
            	}
...
void DOMSimpleButton_obj::renderDrawableClear( ::openfl::display::SimpleButton simpleButton, ::openfl::display::DOMRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_528f7f21fd241d40_38_renderDrawableClear)
HXDLIN(  38)		::openfl::display::_internal::DOMDisplayObject_obj::renderDrawableClear(simpleButton,renderer);
            	}
