...
HXLINE( 542)							_hx_tmp4 = ::hx::IsNotNull( ::openfl::display::_internal::Context3DTilemap_obj::currentBitmapData );
            						}
            						else {
...
HXLINE( 542)						_hx_tmp4 = true;
            					}
HXDLIN( 542)					if (!(_hx_tmp4)) {
HXLINE( 542)						_hx_tmp3 = ::hx::IsNotEq( ::openfl::display::_internal::Context3DTilemap_obj::currentBlendMode,blendMode );
            					}
            					else {
