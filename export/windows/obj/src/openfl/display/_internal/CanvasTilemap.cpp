...
HX_LOCAL_STACK_FRAME(_hx_pos_12472103ca7965a0_29_render,"openfl.display._internal.CanvasTilemap","render",0x08904b8a,"openfl.display._internal.CanvasTilemap.render","openfl/display/_internal/CanvasTilemap.hx",29,0xe65c06c7)
HX_LOCAL_STACK_FRAME(_hx_pos_12472103ca7965a0_69_renderTileContainer,"openfl.display._internal.CanvasTilemap","renderTileContainer",0x0d75ca49,"openfl.display._internal.CanvasTilemap.renderTileContainer","openfl/display/_internal/CanvasTilemap.hx",69,0xe65c06c7)
HX_LOCAL_STACK_FRAME(_hx_pos_12472103ca7965a0_172_renderDrawable,"openfl.display._internal.CanvasTilemap","renderDrawable",0xcc208d48,"openfl.display._internal.CanvasTilemap.renderDrawable","openfl/display/_internal/CanvasTilemap.hx",172,0xe65c06c7)
HX_LOCAL_STACK_FRAME(_hx_pos_12472103ca7965a0_188_renderDrawableMask,"openfl.display._internal.CanvasTilemap","renderDrawableMask",0x83f43e54,"openfl.display._internal.CanvasTilemap.renderDrawableMask","openfl/display/_internal/CanvasTilemap.hx",188,0xe65c06c7)
HX_LOCAL_STACK_FRAME(_hx_pos_12472103ca7965a0_26_boot,"openfl.display._internal.CanvasTilemap","boot",0xc71a2f66,"openfl.display._internal.CanvasTilemap.boot","openfl/display/_internal/CanvasTilemap.hx",26,0xe65c06c7)
namespace openfl{
namespace display{
namespace _internal{
...
void CanvasTilemap_obj::render( ::openfl::display::Tilemap tilemap, ::openfl::display::CanvasRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_12472103ca7965a0_29_render)
            	}
...
void CanvasTilemap_obj::renderTileContainer( ::openfl::display::TileContainer group, ::openfl::display::CanvasRenderer renderer, ::openfl::geom::Matrix parentTransform, ::openfl::display::Tileset defaultTileset,bool smooth,bool alphaEnabled,Float worldAlpha,bool blendModeEnabled, ::Dynamic defaultBlendMode, ::openfl::display::BitmapData cacheBitmapData, ::Dynamic source, ::openfl::geom::Rectangle rect){
            	HX_STACKFRAME(&_hx_pos_12472103ca7965a0_69_renderTileContainer)
            	}
...
void CanvasTilemap_obj::renderDrawable( ::openfl::display::Tilemap tilemap, ::openfl::display::CanvasRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_12472103ca7965a0_172_renderDrawable)
HXLINE( 173)		renderer->_hx___updateCacheBitmap(tilemap,false);
HXLINE( 175)		bool _hx_tmp;
HXDLIN( 175)		if (::hx::IsNotNull( tilemap->_hx___cacheBitmap )) {
HXLINE( 175)			_hx_tmp = !(tilemap->_hx___isCacheBitmapRender);
            		}
            		else {
HXLINE( 175)			_hx_tmp = false;
            		}
HXLINE( 185)		renderer->_hx___renderEvent(tilemap);
            	}
...
void CanvasTilemap_obj::renderDrawableMask( ::openfl::display::Tilemap tilemap, ::openfl::display::CanvasRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_12472103ca7965a0_188_renderDrawableMask)
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_12472103ca7965a0_26_boot)
HXDLIN(  26)		__mClass->__meta__ =  ::Dynamic(::hx::Anon_obj::Create(2)
