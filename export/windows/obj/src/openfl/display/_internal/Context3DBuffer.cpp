...
HXLINE(  50)				_hx_tmp1 = ((length - start) < 10922);
            			}
            			else {
...
HXDLIN( 123)					_this->buffer = ::haxe::io::Bytes_obj::alloc(_this->byteLength);
HXDLIN( 123)					_this->copyFromArray(array,null());
HXDLIN( 123)					this1 = _this;
            				}
            				else {
HXLINE( 123)					if (::hx::IsNotNull( vector )) {
HXLINE( 123)						 ::lime::utils::ArrayBufferView _this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,8);
HXDLIN( 123)						::cpp::VirtualArray array1 = ( (::cpp::VirtualArray)(vector->__Field(HX_("__array",79,c6,ed,8f),::hx::paccDynamic)) );
HXDLIN( 123)						_this1->byteOffset = 0;
HXDLIN( 123)						_this1->length = array1->get_length();
HXDLIN( 123)						_this1->byteLength = (_this1->length * _this1->bytesPerElement);
HXDLIN( 123)						_this1->buffer = ::haxe::io::Bytes_obj::alloc(_this1->byteLength);
HXDLIN( 123)						_this1->copyFromArray(array1,null());
HXDLIN( 123)						this1 = _this1;
            					}
            					else {
HXLINE( 123)						if (::hx::IsNotNull( view )) {
HXLINE( 123)							 ::lime::utils::ArrayBufferView _this2 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,8);
...
HXDLIN( 123)							int elementSize = _this2->bytesPerElement;
HXDLIN( 123)							if ((view->type == _this2->type)) {
HXLINE( 123)								int srcLength1 = srcData->length;
HXDLIN( 123)								int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN( 123)								_this2->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN( 123)								_this2->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            							}
            							else {
HXLINE( 123)								HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            							}
HXDLIN( 123)							_this2->byteLength = (_this2->bytesPerElement * srcLength);
HXDLIN( 123)							_this2->byteOffset = 0;
HXDLIN( 123)							_this2->length = srcLength;
HXDLIN( 123)							this1 = _this2;
            						}
            						else {
HXLINE( 123)							if (::hx::IsNotNull( buffer )) {
HXLINE( 123)								 ::lime::utils::ArrayBufferView _this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,8);
...
HXLINE( 123)								HX_STACK_DO_THROW(HX_("Invalid constructor arguments for Float32Array",8e,c1,f4,d4));
            							}
            						}
            					}
            				}
...
HXLINE( 128)				 ::haxe::io::Bytes buffer1 = null();
HXDLIN( 128)				::cpp::VirtualArray array2 = null();
HXDLIN( 128)				 ::openfl::_Vector::FloatVector vector1 = null();
HXDLIN( 128)				 ::lime::utils::ArrayBufferView view1 = null();
HXDLIN( 128)				 ::Dynamic len1 = null();
HXDLIN( 128)				 ::lime::utils::ArrayBufferView this2;
HXDLIN( 128)				if (::hx::IsNotNull( vertexLength )) {
HXLINE( 128)					this2 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,vertexLength,8);
            				}
            				else {
HXLINE( 128)					if (::hx::IsNotNull( array2 )) {
HXLINE( 128)						 ::lime::utils::ArrayBufferView _this4 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,8);
HXDLIN( 128)						_this4->byteOffset = 0;
HXDLIN( 128)						_this4->length = array2->get_length();
HXDLIN( 128)						_this4->byteLength = (_this4->length * _this4->bytesPerElement);
HXDLIN( 128)						_this4->buffer = ::haxe::io::Bytes_obj::alloc(_this4->byteLength);
HXDLIN( 128)						_this4->copyFromArray(array2,null());
HXDLIN( 128)						this2 = _this4;
            					}
            					else {
HXLINE( 128)						if (::hx::IsNotNull( vector1 )) {
HXLINE( 128)							 ::lime::utils::ArrayBufferView _this5 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,8);
HXDLIN( 128)							::cpp::VirtualArray array3 = ( (::cpp::VirtualArray)(vector1->__Field(HX_("__array",79,c6,ed,8f),::hx::paccDynamic)) );
HXDLIN( 128)							_this5->byteOffset = 0;
HXDLIN( 128)							_this5->length = array3->get_length();
HXDLIN( 128)							_this5->byteLength = (_this5->length * _this5->bytesPerElement);
HXDLIN( 128)							_this5->buffer = ::haxe::io::Bytes_obj::alloc(_this5->byteLength);
HXDLIN( 128)							_this5->copyFromArray(array3,null());
HXDLIN( 128)							this2 = _this5;
            						}
            						else {
HXLINE( 128)							if (::hx::IsNotNull( view1 )) {
HXLINE( 128)								 ::lime::utils::ArrayBufferView _this6 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,8);
HXDLIN( 128)								 ::haxe::io::Bytes srcData1 = view1->buffer;
HXDLIN( 128)								int srcLength2 = view1->length;
HXDLIN( 128)								int srcByteOffset1 = view1->byteOffset;
HXDLIN( 128)								int srcElementSize1 = view1->bytesPerElement;
HXDLIN( 128)								int elementSize2 = _this6->bytesPerElement;
HXDLIN( 128)								if ((view1->type == _this6->type)) {
HXLINE( 128)									int srcLength3 = srcData1->length;
HXDLIN( 128)									int cloneLength1 = (srcLength3 - srcByteOffset1);
HXDLIN( 128)									_this6->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength1);
HXDLIN( 128)									_this6->buffer->blit(0,srcData1,srcByteOffset1,cloneLength1);
            								}
            								else {
HXLINE( 128)									HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            								}
HXDLIN( 128)								_this6->byteLength = (_this6->bytesPerElement * srcLength2);
HXDLIN( 128)								_this6->byteOffset = 0;
HXDLIN( 128)								_this6->length = srcLength2;
HXDLIN( 128)								this2 = _this6;
            							}
            							else {
HXLINE( 128)								if (::hx::IsNotNull( buffer1 )) {
HXLINE( 128)									 ::lime::utils::ArrayBufferView _this7 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,8);
HXDLIN( 128)									int in_byteOffset1 = 0;
HXDLIN( 128)									if ((in_byteOffset1 < 0)) {
HXLINE( 128)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
HXDLIN( 128)									if ((::hx::Mod(in_byteOffset1,_this7->bytesPerElement) != 0)) {
HXLINE( 128)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
HXDLIN( 128)									int bufferByteLength1 = buffer1->length;
HXDLIN( 128)									int elementSize3 = _this7->bytesPerElement;
HXDLIN( 128)									int newByteLength1 = bufferByteLength1;
HXDLIN( 128)									if (::hx::IsNull( len1 )) {
HXLINE( 128)										newByteLength1 = (bufferByteLength1 - in_byteOffset1);
HXDLIN( 128)										if ((::hx::Mod(bufferByteLength1,_this7->bytesPerElement) != 0)) {
HXLINE( 128)											HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            										}
HXDLIN( 128)										if ((newByteLength1 < 0)) {
HXLINE( 128)											HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            										}
            									}
            									else {
HXLINE( 128)										newByteLength1 = (( (int)(len1) ) * _this7->bytesPerElement);
HXDLIN( 128)										int newRange1 = (in_byteOffset1 + newByteLength1);
HXDLIN( 128)										if ((newRange1 > bufferByteLength1)) {
HXLINE( 128)											HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            										}
            									}
HXDLIN( 128)									_this7->buffer = buffer1;
HXDLIN( 128)									_this7->byteOffset = in_byteOffset1;
HXDLIN( 128)									_this7->byteLength = newByteLength1;
HXDLIN( 128)									_this7->length = ::Std_obj::_hx_int((( (Float)(newByteLength1) ) / ( (Float)(_this7->bytesPerElement) )));
HXDLIN( 128)									this2 = _this7;
            								}
            								else {
HXLINE( 128)									HX_STACK_DO_THROW(HX_("Invalid constructor arguments for Float32Array",8e,c1,f4,d4));
            								}
            							}
            						}
            					}
            				}
HXDLIN( 128)				this->vertexBufferData = this2;
HXLINE( 129)				{
HXLINE( 129)					 ::lime::utils::ArrayBufferView _this8 = this->vertexBufferData;
HXDLIN( 129)					::cpp::VirtualArray array4 = null();
HXDLIN( 129)					int offset = 0;
HXDLIN( 129)					bool _hx_tmp;
HXDLIN( 129)					if (::hx::IsNotNull( cacheBufferData )) {
HXLINE( 129)						_hx_tmp = ::hx::IsNull( array4 );
            					}
            					else {
HXLINE( 129)						_hx_tmp = false;
            					}
HXDLIN( 129)					if (_hx_tmp) {
HXLINE( 129)						_this8->buffer->blit((offset * _this8->bytesPerElement),cacheBufferData->buffer,cacheBufferData->byteOffset,cacheBufferData->byteLength);
            					}
            					else {
HXLINE( 129)						bool _hx_tmp1;
HXDLIN( 129)						if (::hx::IsNotNull( array4 )) {
HXLINE( 129)							_hx_tmp1 = ::hx::IsNull( cacheBufferData );
            						}
            						else {
HXLINE( 129)							_hx_tmp1 = false;
            						}
HXDLIN( 129)						if (_hx_tmp1) {
HXLINE( 129)							_this8->copyFromArray(array4,offset);
            						}
            						else {
HXLINE( 129)							HX_STACK_DO_THROW(HX_("Invalid .set call. either view, or array must be not-null.",64,ba,b7,6c));
            						}
            					}
            				}
            			}
