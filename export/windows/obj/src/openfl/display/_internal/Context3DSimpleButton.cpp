...
HX_LOCAL_STACK_FRAME(_hx_pos_11fef1fbd1a45aea_12_renderDrawable,"openfl.display._internal.Context3DSimpleButton","renderDrawable",0x62dbb2fa,"openfl.display._internal.Context3DSimpleButton.renderDrawable","openfl/display/_internal/Context3DSimpleButton.hx",12,0xea7aa479)
HX_LOCAL_STACK_FRAME(_hx_pos_11fef1fbd1a45aea_23_renderDrawableMask,"openfl.display._internal.Context3DSimpleButton","renderDrawableMask",0xe4f92506,"openfl.display._internal.Context3DSimpleButton.renderDrawableMask","openfl/display/_internal/Context3DSimpleButton.hx",23,0xea7aa479)
namespace openfl{
namespace display{
namespace _internal{
...
void Context3DSimpleButton_obj::renderDrawable( ::openfl::display::SimpleButton simpleButton, ::openfl::display::OpenGLRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_11fef1fbd1a45aea_12_renderDrawable)
HXLINE(  13)		bool _hx_tmp;
HXDLIN(  13)		bool _hx_tmp1;
HXDLIN(  13)		if (simpleButton->_hx___renderable) {
HXLINE(  13)			_hx_tmp1 = (simpleButton->_hx___worldAlpha <= 0);
            		}
            		else {
HXLINE(  13)			_hx_tmp1 = true;
            		}
HXDLIN(  13)		if (!(_hx_tmp1)) {
HXLINE(  13)			_hx_tmp = ::hx::IsNull( simpleButton->_hx___currentState );
            		}
            		else {
...
HXLINE(  15)		renderer->_hx___pushMaskObject(simpleButton,null());
HXLINE(  16)		renderer->_hx___renderDrawable(simpleButton->_hx___currentState);
HXLINE(  17)		renderer->_hx___popMaskObject(simpleButton,null());
HXLINE(  19)		renderer->_hx___renderEvent(simpleButton);
            	}
...
void Context3DSimpleButton_obj::renderDrawableMask( ::openfl::display::SimpleButton simpleButton, ::openfl::display::OpenGLRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_11fef1fbd1a45aea_23_renderDrawableMask)
HXLINE(  24)		if (::hx::IsNull( simpleButton->_hx___currentState )) {
HXLINE(  24)			return;
            		}
HXLINE(  26)		renderer->_hx___renderDrawableMask(simpleButton->_hx___currentState);
            	}
