...
HX_LOCAL_STACK_FRAME(_hx_pos_d34f8755a1b4262c_21_clear,"openfl.display._internal.DOMBitmap","clear",0xbe3441f4,"openfl.display._internal.DOMBitmap.clear","openfl/display/_internal/DOMBitmap.hx",21,0xcb448c4c)
HX_LOCAL_STACK_FRAME(_hx_pos_d34f8755a1b4262c_42_render,"openfl.display._internal.DOMBitmap","render",0xad06f50f,"openfl.display._internal.DOMBitmap.render","openfl/display/_internal/DOMBitmap.hx",42,0xcb448c4c)
HX_LOCAL_STACK_FRAME(_hx_pos_d34f8755a1b4262c_76_renderCanvas,"openfl.display._internal.DOMBitmap","renderCanvas",0x9cc57347,"openfl.display._internal.DOMBitmap.renderCanvas","openfl/display/_internal/DOMBitmap.hx",76,0xcb448c4c)
HX_LOCAL_STACK_FRAME(_hx_pos_d34f8755a1b4262c_118_renderDrawable,"openfl.display._internal.DOMBitmap","renderDrawable",0xcc53c3cd,"openfl.display._internal.DOMBitmap.renderDrawable","openfl/display/_internal/DOMBitmap.hx",118,0xcb448c4c)
HX_LOCAL_STACK_FRAME(_hx_pos_d34f8755a1b4262c_139_renderDrawableClear,"openfl.display._internal.DOMBitmap","renderDrawableClear",0x10db3680,"openfl.display._internal.DOMBitmap.renderDrawableClear","openfl/display/_internal/DOMBitmap.hx",139,0xcb448c4c)
HX_LOCAL_STACK_FRAME(_hx_pos_d34f8755a1b4262c_143_renderImage,"openfl.display._internal.DOMBitmap","renderImage",0x1c91e3cc,"openfl.display._internal.DOMBitmap.renderImage","openfl/display/_internal/DOMBitmap.hx",143,0xcb448c4c)
HX_LOCAL_STACK_FRAME(_hx_pos_d34f8755a1b4262c_18_boot,"openfl.display._internal.DOMBitmap","boot",0x8e8cfdab,"openfl.display._internal.DOMBitmap.boot","openfl/display/_internal/DOMBitmap.hx",18,0xcb448c4c)
namespace openfl{
namespace display{
namespace _internal{
...
void DOMBitmap_obj::clear( ::openfl::display::Bitmap bitmap, ::openfl::display::DOMRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_d34f8755a1b4262c_21_clear)
            	}
...
void DOMBitmap_obj::render( ::openfl::display::Bitmap bitmap, ::openfl::display::DOMRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_d34f8755a1b4262c_42_render)
            	}
...
void DOMBitmap_obj::renderCanvas( ::openfl::display::Bitmap bitmap, ::openfl::display::DOMRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_d34f8755a1b4262c_76_renderCanvas)
            	}
...
void DOMBitmap_obj::renderDrawable( ::openfl::display::Bitmap bitmap, ::openfl::display::DOMRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_d34f8755a1b4262c_118_renderDrawable)
HXLINE( 119)		renderer->_hx___updateCacheBitmap(bitmap,false);
HXLINE( 121)		bool _hx_tmp;
HXDLIN( 121)		if (::hx::IsNotNull( bitmap->_hx___cacheBitmap )) {
HXLINE( 121)			_hx_tmp = !(bitmap->_hx___isCacheBitmapRender);
            		}
            		else {
HXLINE( 121)			_hx_tmp = false;
            		}
HXDLIN( 121)		if (_hx_tmp) {
HXLINE( 123)			renderer->_hx___renderDrawableClear(bitmap);
HXLINE( 124)			bitmap->_hx___cacheBitmap->stage = bitmap->stage;
            		}
HXLINE( 134)		renderer->_hx___renderEvent(bitmap);
            	}
...
void DOMBitmap_obj::renderDrawableClear( ::openfl::display::Bitmap bitmap, ::openfl::display::DOMRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_d34f8755a1b4262c_139_renderDrawableClear)
HXDLIN( 139)		::openfl::display::_internal::DOMBitmap_obj::clear(bitmap,renderer);
            	}
...
void DOMBitmap_obj::renderImage( ::openfl::display::Bitmap bitmap, ::openfl::display::DOMRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_d34f8755a1b4262c_143_renderImage)
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_d34f8755a1b4262c_18_boot)
