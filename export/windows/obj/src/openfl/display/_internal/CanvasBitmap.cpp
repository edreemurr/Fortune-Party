...
HX_LOCAL_STACK_FRAME(_hx_pos_b6ae860a04406516_16_render,"openfl.display._internal.CanvasBitmap","render",0x396f6081,"openfl.display._internal.CanvasBitmap.render","openfl/display/_internal/CanvasBitmap.hx",16,0x24e40a98)
HX_LOCAL_STACK_FRAME(_hx_pos_b6ae860a04406516_62_renderDrawable,"openfl.display._internal.CanvasBitmap","renderDrawable",0xd71ff13f,"openfl.display._internal.CanvasBitmap.renderDrawable","openfl/display/_internal/CanvasBitmap.hx",62,0x24e40a98)
HX_LOCAL_STACK_FRAME(_hx_pos_b6ae860a04406516_85_renderDrawableMask,"openfl.display._internal.CanvasBitmap","renderDrawableMask",0x5dda69cb,"openfl.display._internal.CanvasBitmap.renderDrawableMask","openfl/display/_internal/CanvasBitmap.hx",85,0x24e40a98)
HX_LOCAL_STACK_FRAME(_hx_pos_b6ae860a04406516_13_boot,"openfl.display._internal.CanvasBitmap","boot",0x0b97489d,"openfl.display._internal.CanvasBitmap.boot","openfl/display/_internal/CanvasBitmap.hx",13,0x24e40a98)
namespace openfl{
namespace display{
namespace _internal{
...
void CanvasBitmap_obj::render( ::openfl::display::Bitmap bitmap, ::openfl::display::CanvasRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_b6ae860a04406516_16_render)
            	}
...
void CanvasBitmap_obj::renderDrawable( ::openfl::display::Bitmap bitmap, ::openfl::display::CanvasRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_b6ae860a04406516_62_renderDrawable)
...
void CanvasBitmap_obj::renderDrawableMask( ::openfl::display::Bitmap bitmap, ::openfl::display::CanvasRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_b6ae860a04406516_85_renderDrawableMask)
HXDLIN(  85)		 ::Dynamic renderer1 =  ::Dynamic(renderer->context->__Field(HX_("rect",24,4d,a7,4b),::hx::paccDynamic));
HXDLIN(  85)		Float _hx_tmp = bitmap->get_width();
HXDLIN(  85)		renderer1(0,0,_hx_tmp,bitmap->get_height());
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_b6ae860a04406516_13_boot)
