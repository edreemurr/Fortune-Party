...
HX_LOCAL_STACK_FRAME(_hx_pos_8213b8275afd3eb5_12_renderDrawable,"openfl.display._internal.CairoSimpleButton","renderDrawable",0xce0881d2,"openfl.display._internal.CairoSimpleButton.renderDrawable","openfl/display/_internal/CairoSimpleButton.hx",12,0x901d51d1)
HX_LOCAL_STACK_FRAME(_hx_pos_8213b8275afd3eb5_24_renderDrawableMask,"openfl.display._internal.CairoSimpleButton","renderDrawableMask",0x40323fde,"openfl.display._internal.CairoSimpleButton.renderDrawableMask","openfl/display/_internal/CairoSimpleButton.hx",24,0x901d51d1)
namespace openfl{
namespace display{
namespace _internal{
...
void CairoSimpleButton_obj::renderDrawable( ::openfl::display::SimpleButton simpleButton, ::openfl::display::CairoRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_8213b8275afd3eb5_12_renderDrawable)
...
void CairoSimpleButton_obj::renderDrawableMask( ::openfl::display::SimpleButton simpleButton, ::openfl::display::CairoRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_8213b8275afd3eb5_24_renderDrawableMask)
HXDLIN(  24)		renderer->_hx___renderDrawableMask(simpleButton->_hx___currentState);
            	}
