...
HXLINE( 205)					{
HXLINE( 205)						 ::lime::utils::ArrayBufferView view2 = this->paramData;
...
HXLINE( 205)							data->buffer->blit((offset * data->bytesPerElement),view2->buffer,view2->byteOffset,view2->byteLength);
            						}
            						else {
...
HXLINE( 205)								data->copyFromArray(array4,offset);
            							}
            							else {
...
HXLINE( 216)		 ::openfl::display::ShaderParameter_Float floatParam;
HXLINE( 217)		 ::openfl::display::ShaderParameter_Int intParam;
HXLINE( 218)		int length1;
HXLINE( 220)		{
HXLINE( 220)			int _g8 = 0;
HXDLIN( 220)			int _g9 = this->paramCount;
HXDLIN( 220)			while((_g8 < _g9)){
HXLINE( 220)				_g8 = (_g8 + 1);
HXDLIN( 220)				int i4 = (_g8 - 1);
HXLINE( 222)				length1 = this->paramLengths->__get(i4);
HXLINE( 224)				if ((i4 < boolCount)) {
HXLINE( 226)					boolParam = this->paramRefs_Bool->__get(boolIndex).StaticCast<  ::openfl::display::ShaderParameter_Bool >();
HXLINE( 227)					boolIndex = (boolIndex + 1);
HXLINE( 229)					{
HXLINE( 229)						int _g10 = 0;
HXDLIN( 229)						int _g11 = length1;
HXDLIN( 229)						while((_g10 < _g11)){
HXLINE( 229)							_g10 = (_g10 + 1);
HXDLIN( 229)							int j = (_g10 - 1);
HXLINE( 231)							{
HXLINE( 231)								 ::lime::utils::ArrayBufferView this3 = this->paramData;
HXDLIN( 231)								Float val;
HXDLIN( 231)								if (boolParam->value->__get(j)) {
HXLINE( 231)									val = ( (Float)(1) );
            								}
            								else {
HXLINE( 231)									val = ( (Float)(0) );
            								}
HXDLIN( 231)								 ::__hxcpp_memory_set_float(this3->buffer->b,(this3->byteOffset + (paramPosition * 4)),val);
            							}
HXLINE( 232)							paramPosition = (paramPosition + 1);
            						}
            					}
            				}
            				else {
HXLINE( 235)					if ((i4 < (boolCount + floatCount))) {
HXLINE( 237)						floatParam = this->paramRefs_Float->__get(floatIndex).StaticCast<  ::openfl::display::ShaderParameter_Float >();
HXLINE( 238)						floatIndex = (floatIndex + 1);
HXLINE( 240)						{
HXLINE( 240)							int _g12 = 0;
HXDLIN( 240)							int _g13 = length1;
HXDLIN( 240)							while((_g12 < _g13)){
HXLINE( 240)								_g12 = (_g12 + 1);
HXDLIN( 240)								int j1 = (_g12 - 1);
HXLINE( 242)								{
HXLINE( 242)									 ::lime::utils::ArrayBufferView this4 = this->paramData;
HXDLIN( 242)									Float val1 = floatParam->value->__get(j1);
HXDLIN( 242)									 ::__hxcpp_memory_set_float(this4->buffer->b,(this4->byteOffset + (paramPosition * 4)),val1);
            								}
HXLINE( 243)								paramPosition = (paramPosition + 1);
            							}
            						}
            					}
            					else {
HXLINE( 248)						intParam = this->paramRefs_Int->__get(intIndex).StaticCast<  ::openfl::display::ShaderParameter_Int >();
HXLINE( 249)						intIndex = (intIndex + 1);
HXLINE( 251)						{
HXLINE( 251)							int _g14 = 0;
HXDLIN( 251)							int _g15 = length1;
HXDLIN( 251)							while((_g14 < _g15)){
HXLINE( 251)								_g14 = (_g14 + 1);
HXDLIN( 251)								int j2 = (_g14 - 1);
HXLINE( 253)								{
HXLINE( 253)									 ::lime::utils::ArrayBufferView this5 = this->paramData;
HXDLIN( 253)									Float val2 = ( (Float)(intParam->value->__get(j2)) );
HXDLIN( 253)									 ::__hxcpp_memory_set_float(this5->buffer->b,(this5->byteOffset + (paramPosition * 4)),val2);
            								}
HXLINE( 254)								paramPosition = (paramPosition + 1);
            							}
            						}
            					}
            				}
