...
HX_LOCAL_STACK_FRAME(_hx_pos_f4efa2cf556ee2e7_8_renderDrawable,"openfl.display._internal.CanvasSimpleButton","renderDrawable",0xdde3fe0a,"openfl.display._internal.CanvasSimpleButton.renderDrawable","openfl/display/_internal/CanvasSimpleButton.hx",8,0xc72116a3)
HX_LOCAL_STACK_FRAME(_hx_pos_f4efa2cf556ee2e7_28_renderDrawableMask,"openfl.display._internal.CanvasSimpleButton","renderDrawableMask",0xc7ec3816,"openfl.display._internal.CanvasSimpleButton.renderDrawableMask","openfl/display/_internal/CanvasSimpleButton.hx",28,0xc72116a3)
namespace openfl{
namespace display{
namespace _internal{
...
void CanvasSimpleButton_obj::renderDrawable( ::openfl::display::SimpleButton simpleButton, ::openfl::display::CanvasRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_f4efa2cf556ee2e7_8_renderDrawable)
HXLINE(   9)		bool _hx_tmp;
HXDLIN(   9)		bool _hx_tmp1;
HXDLIN(   9)		if (simpleButton->_hx___renderable) {
HXLINE(   9)			_hx_tmp1 = (simpleButton->_hx___worldAlpha <= 0);
            		}
            		else {
HXLINE(   9)			_hx_tmp1 = true;
            		}
HXDLIN(   9)		if (!(_hx_tmp1)) {
HXLINE(   9)			_hx_tmp = ::hx::IsNull( simpleButton->_hx___currentState );
            		}
            		else {
...
HXLINE(  12)		renderer->_hx___pushMaskObject(simpleButton,null());
HXLINE(  13)		renderer->_hx___renderDrawable(simpleButton->_hx___currentState);
HXLINE(  14)		renderer->_hx___popMaskObject(simpleButton,null());
HXLINE(  16)		renderer->_hx___renderEvent(simpleButton);
            	}
...
void CanvasSimpleButton_obj::renderDrawableMask( ::openfl::display::SimpleButton simpleButton, ::openfl::display::CanvasRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_f4efa2cf556ee2e7_28_renderDrawableMask)
HXDLIN(  28)		renderer->_hx___renderDrawableMask(simpleButton->_hx___currentState);
            	}
