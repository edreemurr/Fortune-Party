...
HX_LOCAL_STACK_FRAME(_hx_pos_737ece1df218ad42_28_clear,"openfl.display._internal.DOMTextField","clear",0x58a798c6,"openfl.display._internal.DOMTextField.clear","openfl/display/_internal/DOMTextField.hx",28,0xc7d4d214)
HX_LOCAL_STACK_FRAME(_hx_pos_737ece1df218ad42_42_measureText,"openfl.display._internal.DOMTextField","measureText",0xa92bd324,"openfl.display._internal.DOMTextField.measureText","openfl/display/_internal/DOMTextField.hx",42,0xc7d4d214)
HX_LOCAL_STACK_FRAME(_hx_pos_737ece1df218ad42_78_render,"openfl.display._internal.DOMTextField","render",0x377f95fd,"openfl.display._internal.DOMTextField.render","openfl/display/_internal/DOMTextField.hx",78,0xc7d4d214)
HX_LOCAL_STACK_FRAME(_hx_pos_737ece1df218ad42_408_renderDrawable,"openfl.display._internal.DOMTextField","renderDrawable",0x8cdc02bb,"openfl.display._internal.DOMTextField.renderDrawable","openfl/display/_internal/DOMTextField.hx",408,0xc7d4d214)
HX_LOCAL_STACK_FRAME(_hx_pos_737ece1df218ad42_446_renderDrawableClear,"openfl.display._internal.DOMTextField","renderDrawableClear",0xaca218d2,"openfl.display._internal.DOMTextField.renderDrawableClear","openfl/display/_internal/DOMTextField.hx",446,0xc7d4d214)
HX_LOCAL_STACK_FRAME(_hx_pos_737ece1df218ad42_451___getAttributeMatch,"openfl.display._internal.DOMTextField","__getAttributeMatch",0x43d53498,"openfl.display._internal.DOMTextField.__getAttributeMatch","openfl/display/_internal/DOMTextField.hx",451,0xc7d4d214)
...
HX_LOCAL_STACK_FRAME(_hx_pos_737ece1df218ad42_25_boot,"openfl.display._internal.DOMTextField","boot",0xe1e5e719,"openfl.display._internal.DOMTextField.boot","openfl/display/_internal/DOMTextField.hx",25,0xc7d4d214)
namespace openfl{
namespace display{
namespace _internal{
...
void DOMTextField_obj::clear( ::openfl::text::TextField textField, ::openfl::display::DOMRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_737ece1df218ad42_28_clear)
            	}
...
void DOMTextField_obj::measureText( ::openfl::text::TextField textField){
            	HX_STACKFRAME(&_hx_pos_737ece1df218ad42_42_measureText)
            	}
...
void DOMTextField_obj::render( ::openfl::text::TextField textField, ::openfl::display::DOMRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_737ece1df218ad42_78_render)
            	}
...
void DOMTextField_obj::renderDrawable( ::openfl::text::TextField textField, ::openfl::display::DOMRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_737ece1df218ad42_408_renderDrawable)
            	}
...
void DOMTextField_obj::renderDrawableClear( ::openfl::text::TextField textField, ::openfl::display::DOMRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_737ece1df218ad42_446_renderDrawableClear)
HXDLIN( 446)		::openfl::display::_internal::DOMTextField_obj::clear(textField,renderer);
            	}
...
::String DOMTextField_obj::_hx___getAttributeMatch( ::EReg regex){
            	HX_STACKFRAME(&_hx_pos_737ece1df218ad42_451___getAttributeMatch)
HXDLIN( 451)		if (::hx::IsNotNull( regex->matched(2) )) {
HXDLIN( 451)			return regex->matched(2);
            		}
            		else {
HXDLIN( 451)			return regex->matched(3);
            		}
...
{
{
            	HX_STACKFRAME(&_hx_pos_737ece1df218ad42_19_boot)
...
HXDLIN(  21)		_hx___regexColor =  ::EReg_obj::__alloc( HX_CTX ,HX_("color=(\"#([^\"]+)\"|'#([^']+)')",36,15,0f,76),HX_("i",69,00,00,00));
            	}
{
...
HXDLIN(  23)		_hx___regexFont =  ::EReg_obj::__alloc( HX_CTX ,HX_("<font ([^>]+)>",eb,24,d0,0a),HX_("gi",22,5a,00,00));
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_737ece1df218ad42_24_boot)
HXDLIN(  24)		_hx___regexCloseFont =  ::EReg_obj::__alloc( HX_CTX ,HX_("</font>",3c,82,5f,8e),HX_("gi",22,5a,00,00));
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_737ece1df218ad42_25_boot)
HXDLIN(  25)		_hx___regexSize =  ::EReg_obj::__alloc( HX_CTX ,HX_("size=(\"([^\"]+)\"|'([^']+)')",42,27,be,87),HX_("i",69,00,00,00));
            	}
}
