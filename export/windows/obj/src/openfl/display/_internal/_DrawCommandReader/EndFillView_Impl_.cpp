...
HX_LOCAL_STACK_FRAME(_hx_pos_572e3c225e42227a_773__new,"openfl.display._internal._DrawCommandReader.EndFillView_Impl_","_new",0xf87baa33,"openfl.display._internal._DrawCommandReader.EndFillView_Impl_._new","openfl/display/_internal/DrawCommandReader.hx",773,0x29f77eb3)
namespace openfl{
namespace display{
namespace _internal{
...
bool EndFillView_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::display::_internal::DrawCommandReader EndFillView_Impl__obj::_new( ::openfl::display::_internal::DrawCommandReader d){
            	HX_STACKFRAME(&_hx_pos_572e3c225e42227a_773__new)
HXDLIN( 773)		return d;
            	}
