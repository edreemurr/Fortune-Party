...
HX_LOCAL_STACK_FRAME(_hx_pos_fd1c4d1c82edf2db_72_closePath,"openfl.display._internal.CanvasGraphics","closePath",0x4bc7f60e,"openfl.display._internal.CanvasGraphics.closePath","openfl/display/_internal/CanvasGraphics.hx",72,0x5a71bf7c)
HX_LOCAL_STACK_FRAME(_hx_pos_fd1c4d1c82edf2db_103_createBitmapFill,"openfl.display._internal.CanvasGraphics","createBitmapFill",0x4b43bfbd,"openfl.display._internal.CanvasGraphics.createBitmapFill","openfl/display/_internal/CanvasGraphics.hx",103,0x5a71bf7c)
HX_LOCAL_STACK_FRAME(_hx_pos_fd1c4d1c82edf2db_110_createGradientPattern,"openfl.display._internal.CanvasGraphics","createGradientPattern",0x550b94b5,"openfl.display._internal.CanvasGraphics.createGradientPattern","openfl/display/_internal/CanvasGraphics.hx",110,0x5a71bf7c)
HX_LOCAL_STACK_FRAME(_hx_pos_fd1c4d1c82edf2db_272_getRGBA,"openfl.display._internal.CanvasGraphics","getRGBA",0xcee2b69b,"openfl.display._internal.CanvasGraphics.getRGBA","openfl/display/_internal/CanvasGraphics.hx",272,0x5a71bf7c)
HX_LOCAL_STACK_FRAME(_hx_pos_fd1c4d1c82edf2db_281_getDimensions,"openfl.display._internal.CanvasGraphics","getDimensions",0x00dbc794,"openfl.display._internal.CanvasGraphics.getDimensions","openfl/display/_internal/CanvasGraphics.hx",281,0x5a71bf7c)
HX_LOCAL_STACK_FRAME(_hx_pos_fd1c4d1c82edf2db_299_createTempPatternCanvas,"openfl.display._internal.CanvasGraphics","createTempPatternCanvas",0x6ada6549,"openfl.display._internal.CanvasGraphics.createTempPatternCanvas","openfl/display/_internal/CanvasGraphics.hx",299,0x5a71bf7c)
HX_LOCAL_STACK_FRAME(_hx_pos_fd1c4d1c82edf2db_323_drawRoundRect,"openfl.display._internal.CanvasGraphics","drawRoundRect",0xaa7470ff,"openfl.display._internal.CanvasGraphics.drawRoundRect","openfl/display/_internal/CanvasGraphics.hx",323,0x5a71bf7c)
HX_LOCAL_STACK_FRAME(_hx_pos_fd1c4d1c82edf2db_357_endFill,"openfl.display._internal.CanvasGraphics","endFill",0xd6b0224f,"openfl.display._internal.CanvasGraphics.endFill","openfl/display/_internal/CanvasGraphics.hx",357,0x5a71bf7c)
HX_LOCAL_STACK_FRAME(_hx_pos_fd1c4d1c82edf2db_366_endStroke,"openfl.display._internal.CanvasGraphics","endStroke",0x88be9284,"openfl.display._internal.CanvasGraphics.endStroke","openfl/display/_internal/CanvasGraphics.hx",366,0x5a71bf7c)
HX_LOCAL_STACK_FRAME(_hx_pos_fd1c4d1c82edf2db_608_hitTest,"openfl.display._internal.CanvasGraphics","hitTest",0x934efa96,"openfl.display._internal.CanvasGraphics.hitTest","openfl/display/_internal/CanvasGraphics.hx",608,0x5a71bf7c)
HX_LOCAL_STACK_FRAME(_hx_pos_fd1c4d1c82edf2db_613_isCCW,"openfl.display._internal.CanvasGraphics","isCCW",0x9437381e,"openfl.display._internal.CanvasGraphics.isCCW","openfl/display/_internal/CanvasGraphics.hx",613,0x5a71bf7c)
HX_LOCAL_STACK_FRAME(_hx_pos_fd1c4d1c82edf2db_617_normalizeUVT,"openfl.display._internal.CanvasGraphics","normalizeUVT",0xa0796975,"openfl.display._internal.CanvasGraphics.normalizeUVT","openfl/display/_internal/CanvasGraphics.hx",617,0x5a71bf7c)
HX_LOCAL_STACK_FRAME(_hx_pos_fd1c4d1c82edf2db_658_playCommands,"openfl.display._internal.CanvasGraphics","playCommands",0xa3390eeb,"openfl.display._internal.CanvasGraphics.playCommands","openfl/display/_internal/CanvasGraphics.hx",658,0x5a71bf7c)
HX_LOCAL_STACK_FRAME(_hx_pos_fd1c4d1c82edf2db_1332_render,"openfl.display._internal.CanvasGraphics","render",0xc2394625,"openfl.display._internal.CanvasGraphics.render","openfl/display/_internal/CanvasGraphics.hx",1332,0x5a71bf7c)
HX_LOCAL_STACK_FRAME(_hx_pos_fd1c4d1c82edf2db_1658_renderMask,"openfl.display._internal.CanvasGraphics","renderMask",0x605729b1,"openfl.display._internal.CanvasGraphics.renderMask","openfl/display/_internal/CanvasGraphics.hx",1658,0x5a71bf7c)
HX_LOCAL_STACK_FRAME(_hx_pos_fd1c4d1c82edf2db_1772_setSmoothing,"openfl.display._internal.CanvasGraphics","setSmoothing",0x137bf581,"openfl.display._internal.CanvasGraphics.setSmoothing","openfl/display/_internal/CanvasGraphics.hx",1772,0x5a71bf7c)
...
HX_LOCAL_STACK_FRAME(_hx_pos_fd1c4d1c82edf2db_47_boot,"openfl.display._internal.CanvasGraphics","boot",0x19dfbd41,"openfl.display._internal.CanvasGraphics.boot","openfl/display/_internal/CanvasGraphics.hx",47,0x5a71bf7c)
...
void CanvasGraphics_obj::closePath(::hx::Null< bool >  __o_strokeBefore){
            	...
            	HX_STACKFRAME(&_hx_pos_fd1c4d1c82edf2db_72_closePath)
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(CanvasGraphics_obj,closePath,(void))
 ...
 ::Dynamic CanvasGraphics_obj::createBitmapFill( ::openfl::display::BitmapData bitmap,bool bitmapRepeat,bool smooth){
            	HX_STACKFRAME(&_hx_pos_fd1c4d1c82edf2db_103_createBitmapFill)
...
void CanvasGraphics_obj::createGradientPattern( ::Dynamic type,::Array< int > colors,::Array< Float > alphas,::Array< int > ratios, ::openfl::geom::Matrix matrix, ::Dynamic spreadMethod, ::Dynamic interpolationMethod,Float focalPointRatio){
            	HX_STACKFRAME(&_hx_pos_fd1c4d1c82edf2db_110_createGradientPattern)
            	}
...
::String CanvasGraphics_obj::getRGBA(int color,Float alpha){
            	HX_STACKFRAME(&_hx_pos_fd1c4d1c82edf2db_272_getRGBA)
HXLINE( 273)		int r = ::hx::UShr((color & 16711680),16);
HXLINE( 274)		int g = ::hx::UShr((color & 65280),8);
HXLINE( 275)		int b = (color & 255);
HXLINE( 277)		int _hx_int = r;
HXDLIN( 277)		Float _hx_tmp;
HXDLIN( 277)		if ((_hx_int < 0)) {
HXLINE( 277)			_hx_tmp = (((Float)4294967296.0) + _hx_int);
            		}
            		else {
HXLINE( 277)			_hx_tmp = (_hx_int + ((Float)0.0));
            		}
HXDLIN( 277)		::String _hx_tmp1 = ((HX_("rgba(",f4,cc,0d,e8) + ::Std_obj::string(_hx_tmp)) + HX_(", ",74,26,00,00));
HXDLIN( 277)		int int1 = g;
HXDLIN( 277)		Float _hx_tmp2;
HXDLIN( 277)		if ((int1 < 0)) {
HXLINE( 277)			_hx_tmp2 = (((Float)4294967296.0) + int1);
            		}
            		else {
HXLINE( 277)			_hx_tmp2 = (int1 + ((Float)0.0));
            		}
HXDLIN( 277)		::String _hx_tmp3 = ((_hx_tmp1 + ::Std_obj::string(_hx_tmp2)) + HX_(", ",74,26,00,00));
HXDLIN( 277)		int int2 = b;
HXDLIN( 277)		Float _hx_tmp4;
HXDLIN( 277)		if ((int2 < 0)) {
HXLINE( 277)			_hx_tmp4 = (((Float)4294967296.0) + int2);
            		}
            		else {
HXLINE( 277)			_hx_tmp4 = (int2 + ((Float)0.0));
            		}
HXDLIN( 277)		return ((((_hx_tmp3 + ::Std_obj::string(_hx_tmp4)) + HX_(", ",74,26,00,00)) + alpha) + HX_(")",29,00,00,00));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(CanvasGraphics_obj,getRGBA,return )
 ...
 ::Dynamic CanvasGraphics_obj::getDimensions( ::openfl::geom::Matrix matrix){
            	HX_STACKFRAME(&_hx_pos_fd1c4d1c82edf2db_281_getDimensions)
HXLINE( 282)		Float angle = ::Math_obj::atan2(matrix->c,matrix->a);
HXLINE( 283)		Float cos = ::Math_obj::cos(angle);
HXLINE( 285)		Float w = ((matrix->a / cos) * ((Float)1638.4));
HXLINE( 286)		Float h = ((matrix->d / cos) * ((Float)1638.4));
HXLINE( 288)		bool _hx_tmp;
HXDLIN( 288)		if ((w == 0)) {
HXLINE( 288)			_hx_tmp = (h == 0);
            		}
            		else {
HXLINE( 288)			_hx_tmp = false;
            		}
HXDLIN( 288)		if (_hx_tmp) {
HXLINE( 290)			h = ((Float)819.2);
HXDLIN( 290)			w = h;
            		}
HXLINE( 292)		return  ::Dynamic(::hx::Anon_obj::Create(2)
...
void CanvasGraphics_obj::createTempPatternCanvas( ::openfl::display::BitmapData bitmap,bool repeat,int width,int height){
            	HX_STACKFRAME(&_hx_pos_fd1c4d1c82edf2db_299_createTempPatternCanvas)
            	}
...
void CanvasGraphics_obj::drawRoundRect(Float x,Float y,Float width,Float height,Float ellipseWidth, ::Dynamic ellipseHeight){
            	HX_STACKFRAME(&_hx_pos_fd1c4d1c82edf2db_323_drawRoundRect)
            	}
...
void CanvasGraphics_obj::endFill(){
            	HX_STACKFRAME(&_hx_pos_fd1c4d1c82edf2db_357_endFill)
            	}
...
void CanvasGraphics_obj::endStroke(){
            	HX_STACKFRAME(&_hx_pos_fd1c4d1c82edf2db_366_endStroke)
            	}
...
bool CanvasGraphics_obj::hitTest( ::openfl::display::Graphics graphics,Float x,Float y){
            	HX_STACKFRAME(&_hx_pos_fd1c4d1c82edf2db_608_hitTest)
...
bool CanvasGraphics_obj::isCCW(Float x1,Float y1,Float x2,Float y2,Float x3,Float y3){
            	HX_STACKFRAME(&_hx_pos_fd1c4d1c82edf2db_613_isCCW)
HXDLIN( 613)		return ((((x2 - x1) * (y3 - y1)) - ((y2 - y1) * (x3 - x1))) < 0);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC6(CanvasGraphics_obj,isCCW,return )
 ...
 ::Dynamic CanvasGraphics_obj::normalizeUVT( ::openfl::_Vector::FloatVector uvt,::hx::Null< bool >  __o_skipT){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_fd1c4d1c82edf2db_617_normalizeUVT)
HXLINE( 618)		Float max = ::Math_obj::NEGATIVE_INFINITY;
HXLINE( 619)		Float tmp = ::Math_obj::NEGATIVE_INFINITY;
HXLINE( 620)		int len = uvt->get_length();
HXLINE( 622)		{
HXLINE( 622)			int _g = 1;
HXDLIN( 622)			int _g1 = (len + 1);
HXDLIN( 622)			while((_g < _g1)){
HXLINE( 622)				_g = (_g + 1);
HXDLIN( 622)				int t = (_g - 1);
HXLINE( 624)				bool _hx_tmp;
HXDLIN( 624)				if (skipT) {
HXLINE( 624)					_hx_tmp = (::hx::Mod(t,3) == 0);
            				}
            				else {
...
HXLINE( 629)				tmp = uvt->get((t - 1));
HXLINE( 631)				if ((max < tmp)) {
HXLINE( 633)					max = tmp;
            				}
            			}
            		}
HXLINE( 637)		if (!(skipT)) {
HXLINE( 639)			return  ::Dynamic(::hx::Anon_obj::Create(2)
            				->setFixed(0,HX_("max",a4,0a,53,00),max)
            				->setFixed(1,HX_("uvt",f3,2e,59,00),uvt));
            		}
HXLINE( 642)		int length = null();
HXDLIN( 642)		bool fixed = null();
HXDLIN( 642)		::Array< Float > array = null();
HXDLIN( 642)		 ::openfl::_Vector::FloatVector result =  ::openfl::_Vector::FloatVector_obj::__alloc( HX_CTX ,length,fixed,array,true);
HXLINE( 644)		{
HXLINE( 644)			int _g2 = 1;
HXDLIN( 644)			int _g3 = (len + 1);
HXDLIN( 644)			while((_g2 < _g3)){
HXLINE( 644)				_g2 = (_g2 + 1);
HXDLIN( 644)				int t1 = (_g2 - 1);
HXLINE( 646)				bool _hx_tmp1;
HXDLIN( 646)				if (skipT) {
HXLINE( 646)					_hx_tmp1 = (::hx::Mod(t1,3) == 0);
            				}
            				else {
...
HXLINE( 651)				result->push(uvt->get((t1 - 1)));
            			}
            		}
HXLINE( 654)		return  ::Dynamic(::hx::Anon_obj::Create(2)
            			->setFixed(0,HX_("max",a4,0a,53,00),max)
...
void CanvasGraphics_obj::playCommands( ::openfl::display::_internal::DrawCommandBuffer commands,::hx::Null< bool >  __o_stroke){
            	...
            	HX_STACKFRAME(&_hx_pos_fd1c4d1c82edf2db_658_playCommands)
            	}
...
void CanvasGraphics_obj::render( ::openfl::display::Graphics graphics, ::openfl::display::CanvasRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_fd1c4d1c82edf2db_1332_render)
            	}
...
void CanvasGraphics_obj::renderMask( ::openfl::display::Graphics graphics, ::openfl::display::CanvasRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_fd1c4d1c82edf2db_1658_renderMask)
            	}
...
void CanvasGraphics_obj::setSmoothing(bool smooth){
            	HX_STACKFRAME(&_hx_pos_fd1c4d1c82edf2db_1772_setSmoothing)
            	}
...
{
            	HX_GC_STACKFRAME(&_hx_pos_fd1c4d1c82edf2db_47_boot)
