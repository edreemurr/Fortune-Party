...
HX_LOCAL_STACK_FRAME(_hx_pos_b5919670cea5e831_13_clear,"openfl.display._internal.DOMVideo","clear",0x14b329f4,"openfl.display._internal.DOMVideo.clear","openfl/display/_internal/DOMVideo.hx",13,0x240265a6)
HX_LOCAL_STACK_FRAME(_hx_pos_b5919670cea5e831_26_render,"openfl.display._internal.DOMVideo","render",0x05930d0f,"openfl.display._internal.DOMVideo.render","openfl/display/_internal/DOMVideo.hx",26,0x240265a6)
HX_LOCAL_STACK_FRAME(_hx_pos_b5919670cea5e831_55_renderDrawable,"openfl.display._internal.DOMVideo","renderDrawable",0x32b7dbcd,"openfl.display._internal.DOMVideo.renderDrawable","openfl/display/_internal/DOMVideo.hx",55,0x240265a6)
HX_LOCAL_STACK_FRAME(_hx_pos_b5919670cea5e831_62_renderDrawableClear,"openfl.display._internal.DOMVideo","renderDrawableClear",0x90a01e80,"openfl.display._internal.DOMVideo.renderDrawableClear","openfl/display/_internal/DOMVideo.hx",62,0x240265a6)
HX_LOCAL_STACK_FRAME(_hx_pos_b5919670cea5e831_10_boot,"openfl.display._internal.DOMVideo","boot",0x736315ab,"openfl.display._internal.DOMVideo.boot","openfl/display/_internal/DOMVideo.hx",10,0x240265a6)
namespace openfl{
namespace display{
namespace _internal{
...
void DOMVideo_obj::clear( ::openfl::media::Video video, ::openfl::display::DOMRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_b5919670cea5e831_13_clear)
            	}
...
void DOMVideo_obj::render( ::openfl::media::Video video, ::openfl::display::DOMRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_b5919670cea5e831_26_render)
            	}
...
void DOMVideo_obj::renderDrawable( ::openfl::media::Video video, ::openfl::display::DOMRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_b5919670cea5e831_55_renderDrawable)
HXLINE(  56)		::openfl::display::_internal::DOMVideo_obj::render(video,renderer);
HXLINE(  57)		renderer->_hx___renderEvent(video);
            	}
...
void DOMVideo_obj::renderDrawableClear( ::openfl::media::Video video, ::openfl::display::DOMRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_b5919670cea5e831_62_renderDrawableClear)
HXDLIN(  62)		::openfl::display::_internal::DOMDisplayObject_obj::renderDrawableClear(video,renderer);
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_b5919670cea5e831_10_boot)
