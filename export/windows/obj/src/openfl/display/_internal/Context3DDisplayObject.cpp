...
HXLINE(  39)			Float _hx_tmp5 = displayObject->get_width();
HXDLIN(  39)			rect->setTo(( (Float)(0) ),( (Float)(0) ),_hx_tmp5,displayObject->get_height());
...
HXLINE(  69)				_hx_tmp1 = ::hx::IsNull( displayObject->_hx___graphics );
            			}
            			else {
...
HXLINE(  69)					_hx_tmp2 = (displayObject->_hx___worldAlpha <= 0);
            				}
            				else {
...
HXLINE(  69)						_hx_tmp5 = !(displayObject->_hx___isCacheBitmapRender);
            					}
            					else {
HXLINE(  69)						_hx_tmp5 = false;
            					}
HXDLIN(  69)					if (_hx_tmp5) {
HXLINE(  69)						_hx_tmp4 = (displayObject->get_width() > 0);
            					}
            					else {
HXLINE(  69)						_hx_tmp4 = false;
            					}
HXDLIN(  69)					if (_hx_tmp4) {
HXLINE(  69)						_hx_tmp3 = (displayObject->get_height() > 0);
            					}
            					else {
...
HXDLIN(  69)						Float _hx_tmp6 = displayObject->get_width();
HXDLIN(  69)						rect->setTo(( (Float)(0) ),( (Float)(0) ),_hx_tmp6,displayObject->get_height());
