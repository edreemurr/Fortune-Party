...
HX_LOCAL_STACK_FRAME(_hx_pos_2f59d7e567bca573_856___renderDrawable,"openfl.display.OpenGLRenderer","__renderDrawable",0x47336226,"openfl.display.OpenGLRenderer.__renderDrawable","openfl/display/OpenGLRenderer.hx",856,0x89bd8a40)
HX_LOCAL_STACK_FRAME(_hx_pos_2f59d7e567bca573_882___renderDrawableMask,"openfl.display.OpenGLRenderer","__renderDrawableMask",0xb5f5da32,"openfl.display.OpenGLRenderer.__renderDrawableMask","openfl/display/OpenGLRenderer.hx",882,0x89bd8a40)
HX_LOCAL_STACK_FRAME(_hx_pos_2f59d7e567bca573_908___renderFilterPass,"openfl.display.OpenGLRenderer","__renderFilterPass",0xd0419531,"openfl.display.OpenGLRenderer.__renderFilterPass","openfl/display/OpenGLRenderer.hx",908,0x89bd8a40)
HX_LOCAL_STACK_FRAME(_hx_pos_2f59d7e567bca573_951___resize,"openfl.display.OpenGLRenderer","__resize",0x27660106,"openfl.display.OpenGLRenderer.__resize","openfl/display/OpenGLRenderer.hx",951,0x89bd8a40)
HX_LOCAL_STACK_FRAME(_hx_pos_2f59d7e567bca573_968___resumeClipAndMask,"openfl.display.OpenGLRenderer","__resumeClipAndMask",0x7bcaa3f4,"openfl.display.OpenGLRenderer.__resumeClipAndMask","openfl/display/OpenGLRenderer.hx",968,0x89bd8a40)
HX_LOCAL_STACK_FRAME(_hx_pos_2f59d7e567bca573_992___scissorRect,"openfl.display.OpenGLRenderer","__scissorRect",0xbdd8570e,"openfl.display.OpenGLRenderer.__scissorRect","openfl/display/OpenGLRenderer.hx",992,0x89bd8a40)
HX_LOCAL_STACK_FRAME(_hx_pos_2f59d7e567bca573_1023___setBlendMode,"openfl.display.OpenGLRenderer","__setBlendMode",0xc7ebe4e4,"openfl.display.OpenGLRenderer.__setBlendMode","openfl/display/OpenGLRenderer.hx",1023,0x89bd8a40)
HX_LOCAL_STACK_FRAME(_hx_pos_2f59d7e567bca573_1060___setRenderTarget,"openfl.display.OpenGLRenderer","__setRenderTarget",0xe23db0b7,"openfl.display.OpenGLRenderer.__setRenderTarget","openfl/display/OpenGLRenderer.hx",1060,0x89bd8a40)
HX_LOCAL_STACK_FRAME(_hx_pos_2f59d7e567bca573_1071___setShaderBuffer,"openfl.display.OpenGLRenderer","__setShaderBuffer",0x2c781375,"openfl.display.OpenGLRenderer.__setShaderBuffer","openfl/display/OpenGLRenderer.hx",1071,0x89bd8a40)
HX_LOCAL_STACK_FRAME(_hx_pos_2f59d7e567bca573_1077___suspendClipAndMask,"openfl.display.OpenGLRenderer","__suspendClipAndMask",0x40692e69,"openfl.display.OpenGLRenderer.__suspendClipAndMask","openfl/display/OpenGLRenderer.hx",1077,0x89bd8a40)
HX_LOCAL_STACK_FRAME(_hx_pos_2f59d7e567bca573_1092___updateShaderBuffer,"openfl.display.OpenGLRenderer","__updateShaderBuffer",0x07dc8fc0,"openfl.display.OpenGLRenderer.__updateShaderBuffer","openfl/display/OpenGLRenderer.hx",1092,0x89bd8a40)
...
HXLINE( 759)			if (this->_hx___context3D->_hx___backBufferWantsBestResolution) {
HXLINE( 761)				::openfl::display::OpenGLRenderer_obj::_hx___scissorRectangle->setTo((( (Float)(this->_hx___offsetX) ) / this->_hx___pixelRatio),(( (Float)(this->_hx___offsetY) ) / this->_hx___pixelRatio),(( (Float)(this->_hx___displayWidth) ) / this->_hx___pixelRatio),(( (Float)(this->_hx___displayHeight) ) / this->_hx___pixelRatio));
            			}
            			else {
HXLINE( 765)				::openfl::display::OpenGLRenderer_obj::_hx___scissorRectangle->setTo(( (Float)(this->_hx___offsetX) ),( (Float)(this->_hx___offsetY) ),( (Float)(this->_hx___displayWidth) ),( (Float)(this->_hx___displayHeight) ));
            			}
...
HXDLIN( 769)			if ((this->_hx___worldTransform->a == 1)) {
HXLINE( 769)				_hx_tmp = (this->_hx___worldTransform->d != 1);
            			}
            			else {
HXLINE( 769)				_hx_tmp = true;
            			}
HXDLIN( 769)			this->_hx___upscaled = _hx_tmp;
HXLINE( 771)			this->_hx___renderDrawable(object);
HXLINE( 775)			bool _hx_tmp1;
HXDLIN( 775)			if ((this->_hx___offsetX <= 0)) {
HXLINE( 775)				_hx_tmp1 = (this->_hx___offsetY > 0);
            			}
            			else {
HXLINE( 775)				_hx_tmp1 = true;
            			}
HXDLIN( 775)			if (_hx_tmp1) {
HXLINE( 779)				if ((this->_hx___offsetX > 0)) {
HXLINE( 782)					::openfl::display::OpenGLRenderer_obj::_hx___scissorRectangle->setTo(( (Float)(0) ),( (Float)(0) ),( (Float)(this->_hx___offsetX) ),( (Float)(this->_hx___height) ));
HXLINE( 783)					this->_hx___context3D->setScissorRectangle(::openfl::display::OpenGLRenderer_obj::_hx___scissorRectangle);
HXLINE( 785)					this->_hx___context3D->_hx___flushGL();
HXLINE( 786)					this->_hx___gl->clearColor(( (Float)(0) ),( (Float)(0) ),( (Float)(0) ),( (Float)(1) ));
HXLINE( 787)					this->_hx___gl->clear(this->_hx___gl->COLOR_BUFFER_BIT);
HXLINE( 791)					::openfl::display::OpenGLRenderer_obj::_hx___scissorRectangle->setTo(( (Float)((this->_hx___offsetX + this->_hx___displayWidth)) ),( (Float)(0) ),( (Float)(this->_hx___width) ),( (Float)(this->_hx___height) ));
HXLINE( 792)					this->_hx___context3D->setScissorRectangle(::openfl::display::OpenGLRenderer_obj::_hx___scissorRectangle);
HXLINE( 794)					this->_hx___context3D->_hx___flushGL();
HXLINE( 795)					this->_hx___gl->clearColor(( (Float)(0) ),( (Float)(0) ),( (Float)(0) ),( (Float)(1) ));
HXLINE( 796)					this->_hx___gl->clear(this->_hx___gl->COLOR_BUFFER_BIT);
            				}
HXLINE( 800)				if ((this->_hx___offsetY > 0)) {
HXLINE( 803)					::openfl::display::OpenGLRenderer_obj::_hx___scissorRectangle->setTo(( (Float)(0) ),( (Float)(0) ),( (Float)(this->_hx___width) ),( (Float)(this->_hx___offsetY) ));
...
HXLINE( 812)					::openfl::display::OpenGLRenderer_obj::_hx___scissorRectangle->setTo(( (Float)(0) ),( (Float)((this->_hx___offsetY + this->_hx___displayHeight)) ),( (Float)(this->_hx___width) ),( (Float)(this->_hx___height) ));
HXLINE( 813)					this->_hx___context3D->setScissorRectangle(::openfl::display::OpenGLRenderer_obj::_hx___scissorRectangle);
HXLINE( 815)					this->_hx___context3D->_hx___flushGL();
HXLINE( 816)					this->_hx___gl->clearColor(( (Float)(0) ),( (Float)(0) ),( (Float)(0) ),( (Float)(1) ));
HXLINE( 817)					this->_hx___gl->clear(this->_hx___gl->COLOR_BUFFER_BIT);
            				}
HXLINE( 821)				this->_hx___context3D->setScissorRectangle(null());
            			}
            		}
            		else {
HXLINE( 826)			if (this->_hx___context3D->_hx___backBufferWantsBestResolution) {
HXLINE( 828)				::openfl::display::OpenGLRenderer_obj::_hx___scissorRectangle->setTo((( (Float)(this->_hx___offsetX) ) / this->_hx___pixelRatio),(( (Float)(this->_hx___offsetY) ) / this->_hx___pixelRatio),(( (Float)(this->_hx___displayWidth) ) / this->_hx___pixelRatio),(( (Float)(this->_hx___displayHeight) ) / this->_hx___pixelRatio));
            			}
            			else {
HXLINE( 832)				::openfl::display::OpenGLRenderer_obj::_hx___scissorRectangle->setTo(( (Float)(this->_hx___offsetX) ),( (Float)(this->_hx___offsetY) ),( (Float)(this->_hx___displayWidth) ),( (Float)(this->_hx___displayHeight) ));
            			}
HXLINE( 834)			this->_hx___context3D->setScissorRectangle(::openfl::display::OpenGLRenderer_obj::_hx___scissorRectangle);
HXLINE( 841)			 ::openfl::display::DisplayObject cacheMask = ( ( ::openfl::display::DisplayObject)(object->__Field(HX_("__mask",0c,a4,4e,f7),::hx::paccDynamic)) );
HXLINE( 842)			 ::openfl::geom::Rectangle cacheScrollRect = ( ( ::openfl::geom::Rectangle)(object->__Field(HX_("__scrollRect",f1,56,fa,41),::hx::paccDynamic)) );
HXLINE( 843)			object->__SetField(HX_("__mask",0c,a4,4e,f7),null(),::hx::paccDynamic);
HXLINE( 844)			object->__SetField(HX_("__scrollRect",f1,56,fa,41),null(),::hx::paccDynamic);
HXLINE( 846)			this->_hx___renderDrawable(object);
HXLINE( 848)			object->__SetField(HX_("__mask",0c,a4,4e,f7),cacheMask,::hx::paccDynamic);
HXLINE( 849)			object->__SetField(HX_("__scrollRect",f1,56,fa,41),cacheScrollRect,::hx::paccDynamic);
            		}
HXLINE( 852)		this->_hx___context3D->present();
            	}


void OpenGLRenderer_obj::_hx___renderDrawable(::Dynamic object){
            	HX_STACKFRAME(&_hx_pos_2f59d7e567bca573_856___renderDrawable)
HXLINE( 857)		if (::hx::IsNull( object )) {
HXLINE( 857)			return;
            		}
HXLINE( 859)		switch((int)(( (int)(object->__Field(HX_("__drawableType",98,b4,3c,42),::hx::paccDynamic)) ))){
            			case (int)0: {
HXLINE( 862)				::openfl::display::_internal::Context3DBitmapData_obj::renderDrawable(( ( ::openfl::display::BitmapData)(object) ),::hx::ObjectPtr<OBJ_>(this));
            			}
            			break;
            			case (int)2: {
HXLINE( 866)				::openfl::display::_internal::Context3DBitmap_obj::renderDrawable(( ( ::openfl::display::Bitmap)(object) ),::hx::ObjectPtr<OBJ_>(this));
            			}
            			break;
            			case (int)3: {
HXLINE( 868)				::openfl::display::_internal::Context3DDisplayObject_obj::renderDrawable(( ( ::openfl::display::DisplayObject)(object) ),::hx::ObjectPtr<OBJ_>(this));
            			}
            			break;
            			case (int)4: case (int)5: {
HXLINE( 864)				::openfl::display::_internal::Context3DDisplayObjectContainer_obj::renderDrawable(( ( ::openfl::display::DisplayObjectContainer)(object) ),::hx::ObjectPtr<OBJ_>(this));
            			}
            			break;
            			case (int)6: {
HXLINE( 870)				::openfl::display::_internal::Context3DSimpleButton_obj::renderDrawable(( ( ::openfl::display::SimpleButton)(object) ),::hx::ObjectPtr<OBJ_>(this));
            			}
            			break;
            			case (int)7: {
HXLINE( 872)				::openfl::display::_internal::Context3DTextField_obj::renderDrawable(( ( ::openfl::text::TextField)(object) ),::hx::ObjectPtr<OBJ_>(this));
            			}
            			break;
            			case (int)8: {
HXLINE( 874)				::openfl::display::_internal::Context3DVideo_obj::renderDrawable(( ( ::openfl::media::Video)(object) ),::hx::ObjectPtr<OBJ_>(this));
            			}
            			break;
            			case (int)9: {
HXLINE( 876)				::openfl::display::_internal::Context3DTilemap_obj::renderDrawable(( ( ::openfl::display::Tilemap)(object) ),::hx::ObjectPtr<OBJ_>(this));
            			}
            			break;
            			default:{
            			}
...
void OpenGLRenderer_obj::_hx___renderDrawableMask(::Dynamic object){
            	HX_STACKFRAME(&_hx_pos_2f59d7e567bca573_882___renderDrawableMask)
HXLINE( 883)		if (::hx::IsNull( object )) {
HXLINE( 883)			return;
            		}
HXLINE( 885)		switch((int)(( (int)(object->__Field(HX_("__drawableType",98,b4,3c,42),::hx::paccDynamic)) ))){
            			case (int)0: {
HXLINE( 888)				::openfl::display::_internal::Context3DBitmapData_obj::renderDrawableMask(( ( ::openfl::display::BitmapData)(object) ),::hx::ObjectPtr<OBJ_>(this));
            			}
            			break;
            			case (int)2: {
HXLINE( 892)				::openfl::display::_internal::Context3DBitmap_obj::renderDrawableMask(( ( ::openfl::display::Bitmap)(object) ),::hx::ObjectPtr<OBJ_>(this));
            			}
            			break;
            			case (int)3: {
HXLINE( 894)				::openfl::display::_internal::Context3DDisplayObject_obj::renderDrawableMask(( ( ::openfl::display::DisplayObject)(object) ),::hx::ObjectPtr<OBJ_>(this));
            			}
            			break;
            			case (int)4: case (int)5: {
HXLINE( 890)				::openfl::display::_internal::Context3DDisplayObjectContainer_obj::renderDrawableMask(( ( ::openfl::display::DisplayObjectContainer)(object) ),::hx::ObjectPtr<OBJ_>(this));
            			}
            			break;
            			case (int)6: {
HXLINE( 896)				::openfl::display::_internal::Context3DSimpleButton_obj::renderDrawableMask(( ( ::openfl::display::SimpleButton)(object) ),::hx::ObjectPtr<OBJ_>(this));
            			}
            			break;
            			case (int)7: {
HXLINE( 898)				::openfl::display::_internal::Context3DTextField_obj::renderDrawableMask(( ( ::openfl::text::TextField)(object) ),::hx::ObjectPtr<OBJ_>(this));
            			}
            			break;
            			case (int)8: {
HXLINE( 900)				::openfl::display::_internal::Context3DVideo_obj::renderDrawableMask(( ( ::openfl::media::Video)(object) ),::hx::ObjectPtr<OBJ_>(this));
            			}
            			break;
            			case (int)9: {
HXLINE( 902)				::openfl::display::_internal::Context3DTilemap_obj::renderDrawableMask(( ( ::openfl::display::Tilemap)(object) ),::hx::ObjectPtr<OBJ_>(this));
            			}
            			break;
            			default:{
            			}
...
void OpenGLRenderer_obj::_hx___renderFilterPass( ::openfl::display::BitmapData source, ::openfl::display::Shader shader,bool smooth,::hx::Null< bool >  __o_clear){
            	...
            	HX_STACKFRAME(&_hx_pos_2f59d7e567bca573_908___renderFilterPass)
HXLINE( 909)		bool _hx_tmp;
HXDLIN( 909)		if (::hx::IsNotNull( source )) {
HXLINE( 909)			_hx_tmp = ::hx::IsNull( shader );
            		}
            		else {
...
HXLINE( 910)		if (::hx::IsNull( this->_hx___defaultRenderTarget )) {
HXLINE( 910)			return;
            		}
HXLINE( 912)		 ::openfl::display3D::textures::TextureBase cacheRTT = this->_hx___context3D->_hx___state->renderToTexture;
HXLINE( 913)		bool cacheRTTDepthStencil = this->_hx___context3D->_hx___state->renderToTextureDepthStencil;
HXLINE( 914)		int cacheRTTAntiAlias = this->_hx___context3D->_hx___state->renderToTextureAntiAlias;
HXLINE( 915)		int cacheRTTSurfaceSelector = this->_hx___context3D->_hx___state->renderToTextureSurfaceSelector;
HXLINE( 917)		 ::openfl::display3D::Context3D _hx_tmp1 = this->_hx___context3D;
HXDLIN( 917)		_hx_tmp1->setRenderToTexture(this->_hx___defaultRenderTarget->getTexture(this->_hx___context3D),false,null(),null());
HXLINE( 919)		if (clear) {
HXLINE( 921)			this->_hx___context3D->clear(0,0,0,0,0,0,1);
            		}
HXLINE( 924)		 ::openfl::display::Shader shader1 = this->_hx___initShader(shader);
HXLINE( 925)		this->setShader(shader1);
HXLINE( 926)		this->applyAlpha(( (Float)(1) ));
HXLINE( 927)		this->applyBitmapData(source,smooth,null());
HXLINE( 928)		this->applyColorTransform(null());
HXLINE( 929)		this->applyMatrix(this->_hx___getMatrix(source->_hx___renderTransform,1));
HXLINE( 930)		this->updateShader();
HXLINE( 932)		 ::openfl::display3D::VertexBuffer3D vertexBuffer = source->getVertexBuffer(this->_hx___context3D,null(),null());
HXLINE( 933)		if (::hx::IsNotNull( shader1->_hx___position )) {
HXLINE( 933)			this->_hx___context3D->setVertexBufferAt(( (int)(shader1->_hx___position->index) ),vertexBuffer,0,3);
            		}
HXLINE( 934)		if (::hx::IsNotNull( shader1->_hx___textureCoord )) {
HXLINE( 934)			this->_hx___context3D->setVertexBufferAt(( (int)(shader1->_hx___textureCoord->index) ),vertexBuffer,3,2);
            		}
HXLINE( 935)		 ::openfl::display3D::IndexBuffer3D indexBuffer = source->getIndexBuffer(this->_hx___context3D,null());
HXLINE( 936)		this->_hx___context3D->drawTriangles(indexBuffer,null(),null());
HXLINE( 938)		if (::hx::IsNotNull( cacheRTT )) {
HXLINE( 940)			this->_hx___context3D->setRenderToTexture(cacheRTT,cacheRTTDepthStencil,cacheRTTAntiAlias,cacheRTTSurfaceSelector);
            		}
            		else {
HXLINE( 944)			this->_hx___context3D->setRenderToBackBuffer();
            		}
HXLINE( 947)		this->_hx___clearShader();
            	}
...
void OpenGLRenderer_obj::_hx___resize(int width,int height){
            	HX_STACKFRAME(&_hx_pos_2f59d7e567bca573_951___resize)
HXLINE( 952)		this->_hx___width = width;
HXLINE( 953)		this->_hx___height = height;
HXLINE( 955)		int w;
HXDLIN( 955)		if (::hx::IsNull( this->_hx___defaultRenderTarget )) {
HXLINE( 955)			w = this->_hx___stage->stageWidth;
            		}
            		else {
HXLINE( 955)			w = this->_hx___defaultRenderTarget->width;
            		}
HXLINE( 956)		int h;
HXDLIN( 956)		if (::hx::IsNull( this->_hx___defaultRenderTarget )) {
HXLINE( 956)			h = this->_hx___stage->stageHeight;
            		}
            		else {
HXLINE( 956)			h = this->_hx___defaultRenderTarget->height;
            		}
HXLINE( 958)		int _hx_tmp;
HXDLIN( 958)		if (::hx::IsNull( this->_hx___defaultRenderTarget )) {
HXLINE( 958)			 ::openfl::geom::Matrix _this = this->_hx___worldTransform;
HXDLIN( 958)			_hx_tmp = ::Math_obj::round((((( (Float)(0) ) * _this->a) + (( (Float)(0) ) * _this->c)) + _this->tx));
            		}
            		else {
HXLINE( 958)			_hx_tmp = 0;
            		}
HXDLIN( 958)		this->_hx___offsetX = _hx_tmp;
HXLINE( 959)		int _hx_tmp1;
HXDLIN( 959)		if (::hx::IsNull( this->_hx___defaultRenderTarget )) {
HXLINE( 959)			 ::openfl::geom::Matrix _this1 = this->_hx___worldTransform;
HXDLIN( 959)			_hx_tmp1 = ::Math_obj::round((((( (Float)(0) ) * _this1->b) + (( (Float)(0) ) * _this1->d)) + _this1->ty));
            		}
            		else {
HXLINE( 959)			_hx_tmp1 = 0;
            		}
HXDLIN( 959)		this->_hx___offsetY = _hx_tmp1;
HXLINE( 960)		int _hx_tmp2;
HXDLIN( 960)		if (::hx::IsNull( this->_hx___defaultRenderTarget )) {
HXLINE( 960)			 ::openfl::geom::Matrix _this2 = this->_hx___worldTransform;
HXDLIN( 960)			_hx_tmp2 = ::Math_obj::round(((((( (Float)(w) ) * _this2->a) + (( (Float)(0) ) * _this2->c)) + _this2->tx) - ( (Float)(this->_hx___offsetX) )));
            		}
            		else {
HXLINE( 960)			_hx_tmp2 = w;
            		}
HXDLIN( 960)		this->_hx___displayWidth = _hx_tmp2;
HXLINE( 961)		int _hx_tmp3;
HXDLIN( 961)		if (::hx::IsNull( this->_hx___defaultRenderTarget )) {
HXLINE( 961)			 ::openfl::geom::Matrix _this3 = this->_hx___worldTransform;
HXDLIN( 961)			_hx_tmp3 = ::Math_obj::round(((((( (Float)(0) ) * _this3->b) + (( (Float)(h) ) * _this3->d)) + _this3->ty) - ( (Float)(this->_hx___offsetY) )));
            		}
            		else {
HXLINE( 961)			_hx_tmp3 = h;
            		}
HXDLIN( 961)		this->_hx___displayHeight = _hx_tmp3;
HXLINE( 963)		::lime::math::_Matrix4::Matrix4_Impl__obj::createOrtho(this->_hx___projection,( (Float)(0) ),( (Float)((this->_hx___displayWidth + (this->_hx___offsetX * 2))) ),( (Float)(0) ),( (Float)((this->_hx___displayHeight + (this->_hx___offsetY * 2))) ),( (Float)(-1000) ),( (Float)(1000) ));
HXLINE( 964)		::lime::math::_Matrix4::Matrix4_Impl__obj::createOrtho(this->_hx___projectionFlipped,( (Float)(0) ),( (Float)((this->_hx___displayWidth + (this->_hx___offsetX * 2))) ),( (Float)((this->_hx___displayHeight + (this->_hx___offsetY * 2))) ),( (Float)(0) ),( (Float)(-1000) ),( (Float)(1000) ));
            	}


void OpenGLRenderer_obj::_hx___resumeClipAndMask( ::openfl::display::OpenGLRenderer childRenderer){
            	HX_STACKFRAME(&_hx_pos_2f59d7e567bca573_968___resumeClipAndMask)
HXLINE( 969)		if ((this->_hx___stencilReference > 0)) {
HXLINE( 971)			this->_hx___context3D->setStencilActions(2,1,5,5,5);
HXLINE( 972)			this->_hx___context3D->setStencilReferenceValue(this->_hx___stencilReference,255,0);
            		}
            		else {
HXLINE( 976)			this->_hx___context3D->setStencilActions(null(),null(),null(),null(),null());
HXLINE( 977)			this->_hx___context3D->setStencilReferenceValue(0,0,0);
            		}
HXLINE( 980)		if ((this->_hx___numClipRects > 0)) {
HXLINE( 982)			this->_hx___scissorRect(this->_hx___clipRects->__get((this->_hx___numClipRects - 1)).StaticCast<  ::openfl::geom::Rectangle >());
            		}
            		else {
HXLINE( 986)			this->_hx___scissorRect(null());
            		}
            	}
...
void OpenGLRenderer_obj::_hx___scissorRect( ::openfl::geom::Rectangle clipRect){
            	HX_STACKFRAME(&_hx_pos_2f59d7e567bca573_992___scissorRect)
HXDLIN( 992)		if (::hx::IsNotNull( clipRect )) {
HXLINE( 994)			Float x = ::Math_obj::ffloor(clipRect->x);
HXLINE( 995)			Float y = ::Math_obj::ffloor(clipRect->y);
HXLINE( 996)			Float width;
HXDLIN( 996)			if ((clipRect->width > 0)) {
HXLINE( 996)				width = (::Math_obj::fceil(clipRect->get_right()) - x);
            			}
            			else {
HXLINE( 996)				width = ( (Float)(0) );
            			}
HXLINE( 997)			Float height;
HXDLIN( 997)			if ((clipRect->height > 0)) {
HXLINE( 997)				height = (::Math_obj::fceil(clipRect->get_bottom()) - y);
            			}
            			else {
HXLINE( 997)				height = ( (Float)(0) );
            			}
HXLINE( 999)			if (this->_hx___context3D->_hx___backBufferWantsBestResolution) {
HXLINE(1001)				Float uv = (((Float)1.5) / this->_hx___pixelRatio);
HXLINE(1002)				x = (clipRect->x / this->_hx___pixelRatio);
HXLINE(1003)				y = (clipRect->y / this->_hx___pixelRatio);
HXLINE(1004)				if ((clipRect->width > 0)) {
HXLINE(1004)					Float width1 = clipRect->get_right();
HXDLIN(1004)					width = (((width1 / this->_hx___pixelRatio) - x) + uv);
            				}
            				else {
HXLINE(1004)					width = ( (Float)(0) );
            				}
HXLINE(1005)				if ((clipRect->height > 0)) {
HXLINE(1005)					Float height1 = clipRect->get_bottom();
HXDLIN(1005)					height = (((height1 / this->_hx___pixelRatio) - y) + uv);
            				}
            				else {
HXLINE(1005)					height = ( (Float)(0) );
            				}
            			}
HXLINE(1009)			if ((width < 0)) {
HXLINE(1009)				width = ( (Float)(0) );
            			}
HXLINE(1010)			if ((height < 0)) {
HXLINE(1010)				height = ( (Float)(0) );
            			}
HXLINE(1013)			::openfl::display::OpenGLRenderer_obj::_hx___scissorRectangle->setTo(x,y,width,height);
HXLINE(1014)			this->_hx___context3D->setScissorRectangle(::openfl::display::OpenGLRenderer_obj::_hx___scissorRectangle);
            		}
            		else {
HXLINE(1018)			this->_hx___context3D->setScissorRectangle(null());
            		}
            	}
...
void OpenGLRenderer_obj::_hx___setBlendMode( ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_2f59d7e567bca573_1023___setBlendMode)
HXLINE(1024)		if (::hx::IsNotNull( this->_hx___overrideBlendMode )) {
HXLINE(1024)			value = this->_hx___overrideBlendMode;
            		}
HXLINE(1025)		if (::hx::IsEq( this->_hx___blendMode,value )) {
HXLINE(1025)			return;
            		}
HXLINE(1027)		this->_hx___blendMode = value;
HXLINE(1029)		 ::Dynamic _hx_switch_0 = value;
            		if (  (_hx_switch_0==0) ){
HXLINE(1032)			this->_hx___context3D->setBlendFactors(2,2);
HXDLIN(1032)			goto _hx_goto_35;
            		}
            		if (  (_hx_switch_0==2) ){
HXLINE(1046)			this->_hx___context3D->setBlendFactors(2,2);
HXLINE(1047)			this->_hx___context3D->_hx___setGLBlendEquation(32775);
HXLINE(1045)			goto _hx_goto_35;
            		}
            		if (  (_hx_switch_0==8) ){
HXLINE(1050)			this->_hx___context3D->setBlendFactors(2,2);
HXLINE(1051)			this->_hx___context3D->_hx___setGLBlendEquation(32776);
HXLINE(1049)			goto _hx_goto_35;
            		}
            		if (  (_hx_switch_0==9) ){
HXLINE(1035)			this->_hx___context3D->setBlendFactors(1,5);
HXDLIN(1035)			goto _hx_goto_35;
            		}
            		if (  (_hx_switch_0==12) ){
HXLINE(1038)			this->_hx___context3D->setBlendFactors(2,6);
HXDLIN(1038)			goto _hx_goto_35;
            		}
            		if (  (_hx_switch_0==14) ){
HXLINE(1041)			this->_hx___context3D->setBlendFactors(2,2);
HXLINE(1042)			this->_hx___context3D->_hx___setGLBlendEquation(this->_hx___gl->FUNC_REVERSE_SUBTRACT);
HXLINE(1040)			goto _hx_goto_35;
            		}
            		/* default */{
HXLINE(1055)			this->_hx___context3D->setBlendFactors(2,5);
            		}
            		_hx_goto_35:;
            	}
...
void OpenGLRenderer_obj::_hx___setRenderTarget( ::openfl::display::BitmapData renderTarget){
            	HX_STACKFRAME(&_hx_pos_2f59d7e567bca573_1060___setRenderTarget)
HXLINE(1061)		this->_hx___defaultRenderTarget = renderTarget;
HXLINE(1062)		this->_hx___flipped = ::hx::IsNull( renderTarget );
HXLINE(1064)		if (::hx::IsNotNull( renderTarget )) {
HXLINE(1066)			this->_hx___resize(renderTarget->width,renderTarget->height);
            		}
            	}
...
void OpenGLRenderer_obj::_hx___setShaderBuffer( ::openfl::display::_internal::ShaderBuffer shaderBuffer){
            	HX_STACKFRAME(&_hx_pos_2f59d7e567bca573_1071___setShaderBuffer)
HXLINE(1072)		this->setShader(shaderBuffer->shader);
HXLINE(1073)		this->_hx___currentShaderBuffer = shaderBuffer;
            	}
...
void OpenGLRenderer_obj::_hx___suspendClipAndMask(){
            	HX_STACKFRAME(&_hx_pos_2f59d7e567bca573_1077___suspendClipAndMask)
HXLINE(1078)		if ((this->_hx___stencilReference > 0)) {
HXLINE(1080)			this->_hx___context3D->setStencilActions(null(),null(),null(),null(),null());
HXLINE(1081)			this->_hx___context3D->setStencilReferenceValue(0,0,0);
            		}
HXLINE(1084)		if ((this->_hx___numClipRects > 0)) {
HXLINE(1086)			this->_hx___scissorRect(null());
            		}
            	}
...
void OpenGLRenderer_obj::_hx___updateShaderBuffer(int bufferOffset){
            	HX_STACKFRAME(&_hx_pos_2f59d7e567bca573_1092___updateShaderBuffer)
HXDLIN(1092)		bool _hx_tmp;
HXDLIN(1092)		if (::hx::IsNotNull( this->_hx___currentShader )) {
HXDLIN(1092)			_hx_tmp = ::hx::IsNotNull( this->_hx___currentShaderBuffer );
            		}
            		else {
HXDLIN(1092)			_hx_tmp = false;
            		}
HXDLIN(1092)		if (_hx_tmp) {
HXLINE(1094)			this->_hx___currentShader->_hx___updateFromBuffer(this->_hx___currentShaderBuffer,bufferOffset);
            		}
            	}
