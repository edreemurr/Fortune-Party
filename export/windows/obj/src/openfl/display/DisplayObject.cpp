...
HXLINE(1669)			 ::openfl::geom::Matrix _this1 = this->_hx___renderTransform;
HXDLIN(1669)			Float norm1 = ((_this1->a * _this1->d) - (_this1->b * _this1->c));
HXDLIN(1669)			Float _hx_tmp;
HXDLIN(1669)			if ((norm1 == 0)) {
HXLINE(1669)				_hx_tmp = -(_this1->tx);
            			}
            			else {
HXLINE(1669)				_hx_tmp = ((((Float)1.0) / norm1) * ((_this1->c * (_this1->ty - global->y)) + (_this1->d * (global->x - _this1->tx))));
            			}
HXDLIN(1669)			local->x = _hx_tmp;
HXLINE(1670)			 ::openfl::geom::Matrix _this2 = this->_hx___renderTransform;
HXDLIN(1670)			Float norm2 = ((_this2->a * _this2->d) - (_this2->b * _this2->c));
HXDLIN(1670)			Float _hx_tmp1;
HXDLIN(1670)			if ((norm2 == 0)) {
HXLINE(1670)				_hx_tmp1 = -(_this2->ty);
            			}
            			else {
HXLINE(1670)				_hx_tmp1 = ((((Float)1.0) / norm2) * ((_this2->a * (global->y - _this2->ty)) + (_this2->b * (_this2->tx - global->x))));
            			}
...
HXLINE(1685)				bool _hx_tmp3;
HXDLIN(1685)				if (::hx::IsNotNull( stack )) {
HXLINE(1685)					_hx_tmp3 = !(interactiveOnly);
            				}
            				else {
HXLINE(1685)					_hx_tmp3 = false;
            				}
HXDLIN(1685)				if (_hx_tmp3) {
...
HXLINE(1844)				bool _hx_tmp5;
HXDLIN(1844)				if (::hx::IsNotNull( this->_hx___blendMode )) {
HXLINE(1844)					_hx_tmp5 = ::hx::IsEq( this->_hx___blendMode,10 );
            				}
            				else {
HXLINE(1844)					_hx_tmp5 = true;
            				}
HXDLIN(1844)				if (_hx_tmp5) {
...
HXLINE(1881)				Float _hx_tmp6 = this->_hx___worldAlpha;
HXDLIN(1881)				this->_hx___worldAlphaChanged = (_hx_tmp6 != this->get_alpha());
...
HXLINE(1904)		bool _hx_tmp7;
HXDLIN(1904)		if (updateChildren) {
HXLINE(1904)			_hx_tmp7 = ::hx::IsNotNull( this->get_mask() );
            		}
            		else {
HXLINE(1904)			_hx_tmp7 = false;
            		}
HXDLIN(1904)		if (_hx_tmp7) {
...
HXLINE(1938)			 ::openfl::geom::Matrix parentTransform1 = renderParent->_hx___renderTransform;
HXDLIN(1938)			 ::openfl::geom::Matrix target1 = this->_hx___renderTransform;
HXDLIN(1938)			target1->a = ((local->a * parentTransform1->a) + (local->b * parentTransform1->c));
HXDLIN(1938)			target1->b = ((local->a * parentTransform1->b) + (local->b * parentTransform1->d));
HXDLIN(1938)			target1->c = ((local->c * parentTransform1->a) + (local->d * parentTransform1->c));
HXDLIN(1938)			target1->d = ((local->c * parentTransform1->b) + (local->d * parentTransform1->d));
HXDLIN(1938)			target1->tx = (((local->tx * parentTransform1->a) + (local->ty * parentTransform1->c)) + parentTransform1->tx);
HXDLIN(1938)			target1->ty = (((local->tx * parentTransform1->b) + (local->ty * parentTransform1->d)) + parentTransform1->ty);
            		}
            		else {
...
HXLINE(2372)			 ::openfl::geom::ColorTransform _hx_tmp2 = this->_hx___objectTransform->_hx___colorTransform;
HXDLIN(2372)			_hx_tmp2->_hx___copyFrom(value->get_colorTransform());
