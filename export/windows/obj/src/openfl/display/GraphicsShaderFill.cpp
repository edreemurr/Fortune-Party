...
HX_DEFINE_STACK_FRAME(_hx_pos_79031d3822cc8bac_69_new,"openfl.display.GraphicsShaderFill","new",0x84d6634f,"openfl.display.GraphicsShaderFill.new","openfl/display/GraphicsShaderFill.hx",69,0xed3e46bf)
namespace openfl{
namespace display{

void GraphicsShaderFill_obj::__construct( ::openfl::display::Shader shader, ::openfl::geom::Matrix matrix){
            	HX_STACKFRAME(&_hx_pos_79031d3822cc8bac_69_new)
HXLINE(  70)		this->shader = shader;
HXLINE(  71)		this->matrix = matrix;
HXLINE(  73)		this->_hx___graphicsDataType = 8;
HXLINE(  74)		this->_hx___graphicsFillType = 4;
            	}
