...
HX_DEFINE_STACK_FRAME(_hx_pos_55614d7317440053_217_new,"openfl.display.GraphicsStroke","new",0x5684f03f,"openfl.display.GraphicsStroke.new","openfl/display/GraphicsStroke.hx",217,0x5e4870cf)
namespace openfl{
namespace display{
...
void GraphicsStroke_obj::__construct( ::Dynamic thickness,::hx::Null< bool >  __o_pixelHinting, ::Dynamic __o_scaleMode, ::Dynamic __o_caps, ::Dynamic __o_joints,::hx::Null< Float >  __o_miterLimit,::Dynamic fill){
            	...
            	HX_STACKFRAME(&_hx_pos_55614d7317440053_217_new)
HXLINE( 218)		if (::hx::IsNull( thickness )) {
HXLINE( 218)			thickness = ::Math_obj::NaN;
            		}
HXLINE( 220)		this->caps = caps;
HXLINE( 221)		this->fill = fill;
HXLINE( 222)		this->joints = joints;
HXLINE( 223)		this->miterLimit = miterLimit;
HXLINE( 224)		this->pixelHinting = pixelHinting;
HXLINE( 225)		this->scaleMode = scaleMode;
HXLINE( 226)		this->thickness = ( (Float)(thickness) );
HXLINE( 227)		this->_hx___graphicsDataType = 0;
            	}
