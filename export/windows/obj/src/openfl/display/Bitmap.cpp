...
HXLINE( 175)			bool _hx_tmp6;
HXDLIN( 175)			if (::hx::IsNotNull( this->_hx___scrollRect )) {
HXLINE( 175)				_hx_tmp6 = !(this->_hx___scrollRect->contains(px,py));
            			}
            			else {
...
HXLINE( 180)			bool _hx_tmp7;
HXDLIN( 180)			if (::hx::IsNotNull( stack )) {
HXLINE( 180)				_hx_tmp7 = !(interactiveOnly);
            			}
            			else {
HXLINE( 180)				_hx_tmp7 = false;
            			}
