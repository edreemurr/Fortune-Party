...
HXLINE( 650)						 ::openfl::display::BitmapData cacheBitmap;
HXLINE( 652)						{
HXLINE( 652)							int _g4 = 0;
HXDLIN( 652)							::Array< ::Dynamic> _g5 = displayObject->_hx___filters;
HXDLIN( 652)							while((_g4 < _g5->length)){
HXLINE( 652)								 ::openfl::filters::BitmapFilter filter2 = _g5->__get(_g4).StaticCast<  ::openfl::filters::BitmapFilter >();
HXDLIN( 652)								_g4 = (_g4 + 1);
HXLINE( 654)								if (filter2->_hx___preserveObject) {
HXLINE( 656)									childRenderer->_hx___setRenderTarget(bitmap3);
HXLINE( 657)									childRenderer->_hx___renderFilterPass(bitmap1,childRenderer->_hx___defaultDisplayShader,filter2->_hx___smooth,null());
            								}
HXLINE( 660)								{
HXLINE( 660)									int _g6 = 0;
HXDLIN( 660)									int _g7 = filter2->_hx___numShaderPasses;
HXDLIN( 660)									while((_g6 < _g7)){
HXLINE( 660)										_g6 = (_g6 + 1);
HXDLIN( 660)										int i = (_g6 - 1);
HXLINE( 662)										 ::openfl::display::BitmapData shader1;
HXDLIN( 662)										if (filter2->_hx___preserveObject) {
HXLINE( 662)											shader1 = bitmap3;
            										}
            										else {
HXLINE( 662)											shader1 = null();
            										}
HXDLIN( 662)										shader = filter2->_hx___initShader(childRenderer,i,shader1);
HXLINE( 663)										childRenderer->_hx___setBlendMode(filter2->_hx___shaderBlendMode);
HXLINE( 664)										childRenderer->_hx___setRenderTarget(bitmap2);
HXLINE( 665)										childRenderer->_hx___renderFilterPass(bitmap1,shader,filter2->_hx___smooth,null());
HXLINE( 667)										cacheBitmap = bitmap1;
HXLINE( 668)										bitmap1 = bitmap2;
HXLINE( 669)										bitmap2 = cacheBitmap;
            									}
            								}
HXLINE( 672)								filter2->_hx___renderDirty = false;
            							}
            						}
HXLINE( 675)						displayObject->_hx___cacheBitmap->_hx___bitmapData = bitmap1;
            					}
HXLINE( 678)					parentRenderer->_hx___blendMode = 10;
HXLINE( 679)					parentRenderer->_hx___setBlendMode(cacheBlendMode);
HXLINE( 680)					parentRenderer->_hx___copyShader(childRenderer);
HXLINE( 682)					if (::hx::IsNotNull( cacheRTT )) {
HXLINE( 684)						context->setRenderToTexture(cacheRTT,cacheRTTDepthStencil,cacheRTTAntiAlias,cacheRTTSurfaceSelector);
            					}
            					else {
HXLINE( 688)						context->setRenderToBackBuffer();
            					}
HXLINE( 694)					parentRenderer->_hx___resumeClipAndMask(childRenderer);
HXLINE( 695)					parentRenderer->setViewport();
HXLINE( 697)					displayObject->_hx___cacheBitmapColorTransform->_hx___copyFrom(colorTransform);
            				}
            				else {
HXLINE( 704)					displayObject->_hx___cacheBitmapData->_hx___drawCairo(displayObject,( ( ::openfl::display::CairoRenderer)(displayObject->_hx___cacheBitmapRenderer) ));
HXLINE( 707)					if (hasFilters) {
HXLINE( 709)						bool needSecondBitmapData1 = false;
HXLINE( 710)						bool needCopyOfOriginal1 = false;
HXLINE( 712)						{
HXLINE( 712)							int _g8 = 0;
HXDLIN( 712)							::Array< ::Dynamic> _g9 = displayObject->_hx___filters;
HXDLIN( 712)							while((_g8 < _g9->length)){
HXLINE( 712)								 ::openfl::filters::BitmapFilter filter3 = _g9->__get(_g8).StaticCast<  ::openfl::filters::BitmapFilter >();
HXDLIN( 712)								_g8 = (_g8 + 1);
HXLINE( 714)								if (filter3->_hx___needSecondBitmapData) {
HXLINE( 716)									needSecondBitmapData1 = true;
            								}
HXLINE( 718)								if (filter3->_hx___preserveObject) {
HXLINE( 720)									needCopyOfOriginal1 = true;
            								}
            							}
            						}
HXLINE( 724)						 ::openfl::display::BitmapData bitmap4 = displayObject->_hx___cacheBitmapData;
HXLINE( 725)						 ::openfl::display::BitmapData bitmap21 = null();
HXLINE( 726)						 ::openfl::display::BitmapData bitmap31 = null();
HXLINE( 728)						if (needSecondBitmapData1) {
HXLINE( 730)							bool _hx_tmp31;
HXDLIN( 730)							bool _hx_tmp32;
HXDLIN( 730)							bool _hx_tmp33;
HXDLIN( 730)							if (::hx::IsNotNull( displayObject->_hx___cacheBitmapData2 )) {
HXLINE( 730)								_hx_tmp33 = ::hx::IsNull( displayObject->_hx___cacheBitmapData2->image );
            							}
            							else {
HXLINE( 730)								_hx_tmp33 = true;
            							}
HXDLIN( 730)							if (!(_hx_tmp33)) {
HXLINE( 730)								_hx_tmp32 = (bitmapWidth > displayObject->_hx___cacheBitmapData2->width);
            							}
            							else {
HXLINE( 730)								_hx_tmp32 = true;
            							}
HXDLIN( 730)							if (!(_hx_tmp32)) {
HXLINE( 730)								_hx_tmp31 = (bitmapHeight > displayObject->_hx___cacheBitmapData2->height);
            							}
            							else {
HXLINE( 730)								_hx_tmp31 = true;
            							}
HXDLIN( 730)							if (_hx_tmp31) {
HXLINE( 735)								displayObject->_hx___cacheBitmapData2 =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,bitmapWidth,bitmapHeight,true,0);
            							}
            							else {
HXLINE( 739)								displayObject->_hx___cacheBitmapData2->fillRect(displayObject->_hx___cacheBitmapData2->rect,0);
            							}
HXLINE( 741)							bitmap21 = displayObject->_hx___cacheBitmapData2;
            						}
            						else {
HXLINE( 745)							bitmap21 = bitmap4;
            						}
HXLINE( 748)						if (needCopyOfOriginal1) {
HXLINE( 750)							bool _hx_tmp34;
HXDLIN( 750)							bool _hx_tmp35;
HXDLIN( 750)							bool _hx_tmp36;
HXDLIN( 750)							if (::hx::IsNotNull( displayObject->_hx___cacheBitmapData3 )) {
HXLINE( 750)								_hx_tmp36 = ::hx::IsNull( displayObject->_hx___cacheBitmapData3->image );
            							}
            							else {
HXLINE( 750)								_hx_tmp36 = true;
            							}
HXDLIN( 750)							if (!(_hx_tmp36)) {
HXLINE( 750)								_hx_tmp35 = (bitmapWidth > displayObject->_hx___cacheBitmapData3->width);
            							}
            							else {
HXLINE( 750)								_hx_tmp35 = true;
            							}
HXDLIN( 750)							if (!(_hx_tmp35)) {
HXLINE( 750)								_hx_tmp34 = (bitmapHeight > displayObject->_hx___cacheBitmapData3->height);
            							}
            							else {
HXLINE( 750)								_hx_tmp34 = true;
            							}
HXDLIN( 750)							if (_hx_tmp34) {
HXLINE( 755)								displayObject->_hx___cacheBitmapData3 =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,bitmapWidth,bitmapHeight,true,0);
            							}
            							else {
HXLINE( 759)								displayObject->_hx___cacheBitmapData3->fillRect(displayObject->_hx___cacheBitmapData3->rect,0);
            							}
HXLINE( 761)							bitmap31 = displayObject->_hx___cacheBitmapData3;
            						}
HXLINE( 764)						if (::hx::IsNull( displayObject->_hx___tempPoint )) {
HXLINE( 764)							displayObject->_hx___tempPoint =  ::openfl::geom::Point_obj::__alloc( HX_CTX ,null(),null());
            						}
HXLINE( 765)						 ::openfl::geom::Point destPoint = displayObject->_hx___tempPoint;
HXLINE( 766)						 ::openfl::display::BitmapData cacheBitmap1;
HXLINE( 767)						 ::openfl::display::BitmapData lastBitmap;
HXLINE( 769)						{
HXLINE( 769)							int _g10 = 0;
HXDLIN( 769)							::Array< ::Dynamic> _g11 = displayObject->_hx___filters;
HXDLIN( 769)							while((_g10 < _g11->length)){
HXLINE( 769)								 ::openfl::filters::BitmapFilter filter4 = _g11->__get(_g10).StaticCast<  ::openfl::filters::BitmapFilter >();
HXDLIN( 769)								_g10 = (_g10 + 1);
HXLINE( 771)								if (filter4->_hx___preserveObject) {
HXLINE( 773)									bitmap31->copyPixels(bitmap4,bitmap4->rect,destPoint,null(),null(),null());
            								}
HXLINE( 776)								lastBitmap = filter4->_hx___applyFilter(bitmap21,bitmap4,bitmap4->rect,destPoint);
HXLINE( 778)								if (filter4->_hx___preserveObject) {
HXLINE( 781)									 ::openfl::geom::ColorTransform _hx_tmp37;
HXDLIN( 781)									if (::hx::IsNotNull( displayObject->_hx___objectTransform )) {
HXLINE( 781)										_hx_tmp37 = displayObject->_hx___objectTransform->_hx___colorTransform;
            									}
            									else {
HXLINE( 781)										_hx_tmp37 = null();
            									}
HXLINE( 780)									lastBitmap->draw(bitmap31,null(),_hx_tmp37,null(),null(),null());
            								}
HXLINE( 783)								filter4->_hx___renderDirty = false;
HXLINE( 785)								bool _hx_tmp38;
HXDLIN( 785)								if (needSecondBitmapData1) {
HXLINE( 785)									_hx_tmp38 = ::hx::IsInstanceEq( lastBitmap,bitmap21 );
            								}
            								else {
HXLINE( 785)									_hx_tmp38 = false;
            								}
HXDLIN( 785)								if (_hx_tmp38) {
HXLINE( 787)									cacheBitmap1 = bitmap4;
HXLINE( 788)									bitmap4 = bitmap21;
HXLINE( 789)									bitmap21 = cacheBitmap1;
            								}
            							}
            						}
HXLINE( 793)						if (::hx::IsInstanceNotEq( displayObject->_hx___cacheBitmapData,bitmap4 )) {
HXLINE( 799)							cacheBitmap1 = displayObject->_hx___cacheBitmapData;
HXLINE( 800)							displayObject->_hx___cacheBitmapData = bitmap4;
HXLINE( 801)							displayObject->_hx___cacheBitmapData2 = cacheBitmap1;
HXLINE( 802)							displayObject->_hx___cacheBitmap->_hx___bitmapData = displayObject->_hx___cacheBitmapData;
HXLINE( 803)							displayObject->_hx___cacheBitmapRenderer = null();
            						}
HXLINE( 806)						displayObject->_hx___cacheBitmap->_hx___imageVersion = displayObject->_hx___cacheBitmapData->_hx___textureVersion;
            					}
HXLINE( 809)					displayObject->_hx___cacheBitmapColorTransform->_hx___copyFrom(colorTransform);
HXLINE( 811)					if (!(displayObject->_hx___cacheBitmapColorTransform->_hx___isDefault(true))) {
HXLINE( 813)						displayObject->_hx___cacheBitmapColorTransform->alphaMultiplier = ( (Float)(1) );
HXLINE( 814)						displayObject->_hx___cacheBitmapData->colorTransform(displayObject->_hx___cacheBitmapData->rect,displayObject->_hx___cacheBitmapColorTransform);
            					}
            				}
HXLINE( 818)				displayObject->_hx___isCacheBitmapRender = false;
            			}
HXLINE( 821)			bool _hx_tmp39;
HXDLIN( 821)			if (!(updateTransform)) {
HXLINE( 821)				_hx_tmp39 = needRender;
            			}
            			else {
HXLINE( 821)				_hx_tmp39 = true;
            			}
HXDLIN( 821)			if (_hx_tmp39) {
HXLINE( 823)				::openfl::geom::Rectangle_obj::_hx___pool->release(rect);
            			}
HXLINE( 826)			updated = updateTransform;
            		}
            		else {
HXLINE( 828)			if (::hx::IsNotNull( displayObject->_hx___cacheBitmap )) {
HXLINE( 830)				if ((renderer->_hx___type == HX_("dom",82,42,4c,00))) {
HXLINE( 832)					 ::openfl::display::DOMRenderer domRenderer = ( ( ::openfl::display::DOMRenderer)(renderer) );
HXLINE( 833)					domRenderer->_hx___renderDrawableClear(displayObject->_hx___cacheBitmap);
            				}
HXLINE( 836)				displayObject->_hx___cacheBitmap = null();
HXLINE( 837)				displayObject->_hx___cacheBitmapData = null();
HXLINE( 838)				displayObject->_hx___cacheBitmapData2 = null();
HXLINE( 839)				displayObject->_hx___cacheBitmapData3 = null();
HXLINE( 840)				displayObject->_hx___cacheBitmapColorTransform = null();
HXLINE( 841)				displayObject->_hx___cacheBitmapRenderer = null();
HXLINE( 843)				updated = true;
            			}
            		}
HXLINE( 846)		::openfl::geom::ColorTransform_obj::_hx___pool->release(colorTransform);
HXLINE( 848)		bool _hx_tmp40;
HXDLIN( 848)		if (updated) {
HXLINE( 848)			_hx_tmp40 = (displayObject->_hx___drawableType == 7);
            		}
            		else {
HXLINE( 848)			_hx_tmp40 = false;
            		}
HXDLIN( 848)		if (_hx_tmp40) {
HXLINE( 850)			 ::openfl::text::TextField textField2 = ( ( ::openfl::text::TextField)(displayObject) );
HXLINE( 851)			if (::hx::IsNotNull( textField2->_hx___cacheBitmap )) {
HXLINE( 853)				 ::openfl::geom::Matrix fh8 = textField2->_hx___cacheBitmap->_hx___renderTransform;
HXDLIN( 853)				fh8->tx = (fh8->tx - textField2->_hx___offsetX);
HXLINE( 854)				 ::openfl::geom::Matrix fh9 = textField2->_hx___cacheBitmap->_hx___renderTransform;
HXDLIN( 854)				fh9->ty = (fh9->ty - textField2->_hx___offsetY);
            			}
            		}
HXLINE( 858)		return updated;
            	}
