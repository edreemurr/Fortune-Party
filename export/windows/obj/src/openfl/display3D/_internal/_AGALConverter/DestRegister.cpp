...
HX_DEFINE_STACK_FRAME(_hx_pos_6dbd7f0b2c3dcc1e_542_new,"openfl.display3D._internal._AGALConverter.DestRegister","new",0xe1484e6a,"openfl.display3D._internal._AGALConverter.DestRegister.new","openfl/display3D/_internal/AGALConverter.hx",542,0x4de1651d)
HX_LOCAL_STACK_FRAME(_hx_pos_6dbd7f0b2c3dcc1e_545_getWriteMask,"openfl.display3D._internal._AGALConverter.DestRegister","getWriteMask",0xead542ab,"openfl.display3D._internal._AGALConverter.DestRegister.getWriteMask","openfl/display3D/_internal/AGALConverter.hx",545,0x4de1651d)
HX_LOCAL_STACK_FRAME(_hx_pos_6dbd7f0b2c3dcc1e_565_toGLSL,"openfl.display3D._internal._AGALConverter.DestRegister","toGLSL",0xf912bd2f,"openfl.display3D._internal._AGALConverter.DestRegister.toGLSL","openfl/display3D/_internal/AGALConverter.hx",565,0x4de1651d)
HX_LOCAL_STACK_FRAME(_hx_pos_6dbd7f0b2c3dcc1e_555_parse,"openfl.display3D._internal._AGALConverter.DestRegister","parse",0x22ed24bd,"openfl.display3D._internal._AGALConverter.DestRegister.parse","openfl/display3D/_internal/AGALConverter.hx",555,0x4de1651d)
HX_LOCAL_STACK_FRAME(_hx_pos_6dbd7f0b2c3dcc1e_535_boot,"openfl.display3D._internal._AGALConverter.DestRegister","boot",0x36154ee8,"openfl.display3D._internal._AGALConverter.DestRegister.boot","openfl/display3D/_internal/AGALConverter.hx",535,0x4de1651d)
namespace openfl{
namespace display3D{
namespace _internal{
...
void DestRegister_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_6dbd7f0b2c3dcc1e_542_new)
            	}
...
::String DestRegister_obj::getWriteMask(){
            	HX_STACKFRAME(&_hx_pos_6dbd7f0b2c3dcc1e_545_getWriteMask)
HXLINE( 546)		::String str = HX_(".",2e,00,00,00);
HXLINE( 547)		if (((this->mask & 1) != 0)) {
HXLINE( 547)			str = (str + HX_("x",78,00,00,00));
            		}
HXLINE( 548)		if (((this->mask & 2) != 0)) {
HXLINE( 548)			str = (str + HX_("y",79,00,00,00));
            		}
HXLINE( 549)		if (((this->mask & 4) != 0)) {
HXLINE( 549)			str = (str + HX_("z",7a,00,00,00));
            		}
HXLINE( 550)		if (((this->mask & 8) != 0)) {
HXLINE( 550)			str = (str + HX_("w",77,00,00,00));
            		}
HXLINE( 551)		return str;
            	}
...
::String DestRegister_obj::toGLSL(::hx::Null< bool >  __o_useMask){
            	...
            	HX_STACKFRAME(&_hx_pos_6dbd7f0b2c3dcc1e_565_toGLSL)
HXLINE( 566)		::String str;
HXLINE( 568)		if ((this->type == 3)) {
HXLINE( 570)			if (::hx::IsPointerEq( this->programType,::openfl::display3D::_internal::_AGALConverter::ProgramType_obj::VERTEX_dyn() )) {
HXLINE( 570)				str = HX_("gl_Position",63,0d,2a,e5);
            			}
            			else {
HXLINE( 570)				str = HX_("gl_FragColor",d7,68,e4,21);
            			}
            		}
            		else {
HXLINE( 574)			::String str1 = ::openfl::display3D::_internal::AGALConverter_obj::prefixFromType(this->type,this->programType);
HXDLIN( 574)			str = (str1 + this->n);
            		}
HXLINE( 577)		bool _hx_tmp;
HXDLIN( 577)		if (useMask) {
HXLINE( 577)			_hx_tmp = (this->mask != 15);
            		}
            		else {
HXLINE( 577)			_hx_tmp = false;
            		}
HXDLIN( 577)		if (_hx_tmp) {
HXLINE( 579)			str = (str + this->getWriteMask());
            		}
HXLINE( 582)		return str;
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(DestRegister_obj,toGLSL,return )
 ...
 ::openfl::display3D::_internal::_AGALConverter::DestRegister DestRegister_obj::parse(int v, ::openfl::display3D::_internal::_AGALConverter::ProgramType programType){
            	HX_GC_STACKFRAME(&_hx_pos_6dbd7f0b2c3dcc1e_555_parse)
HXLINE( 556)		 ::openfl::display3D::_internal::_AGALConverter::DestRegister dr =  ::openfl::display3D::_internal::_AGALConverter::DestRegister_obj::__alloc( HX_CTX );
HXLINE( 557)		dr->programType = programType;
HXLINE( 558)		dr->type = (::hx::UShr(v,24) & 15);
HXLINE( 559)		dr->mask = (::hx::UShr(v,16) & 15);
HXLINE( 560)		dr->n = (v & 65535);
HXLINE( 561)		return dr;
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_6dbd7f0b2c3dcc1e_535_boot)
HXDLIN( 535)		__mClass->__meta__ =  ::Dynamic(::hx::Anon_obj::Create(1)
