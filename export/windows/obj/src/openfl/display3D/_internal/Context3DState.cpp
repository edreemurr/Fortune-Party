...
HX_DEFINE_STACK_FRAME(_hx_pos_2647a1a4499da7d5_77_new,"openfl.display3D._internal.Context3DState","new",0x6082feae,"openfl.display3D._internal.Context3DState.new","openfl/display3D/_internal/Context3DState.hx",77,0x706df35f)
HX_LOCAL_STACK_FRAME(_hx_pos_2647a1a4499da7d5_22_boot,"openfl.display3D._internal.Context3DState","boot",0x0a34da24,"openfl.display3D._internal.Context3DState.boot","openfl/display3D/_internal/Context3DState.hx",22,0x706df35f)
namespace openfl{
namespace display3D{
namespace _internal{

void Context3DState_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_2647a1a4499da7d5_77_new)
HXLINE(  78)		this->backBufferEnableDepthAndStencil = false;
HXLINE(  79)		this->blendDestinationAlphaFactor = 9;
HXLINE(  80)		this->blendSourceAlphaFactor = 2;
HXLINE(  81)		this->blendDestinationRGBFactor = 9;
HXLINE(  82)		this->blendSourceRGBFactor = 2;
HXLINE(  83)		this->colorMaskRed = true;
HXLINE(  84)		this->colorMaskGreen = true;
HXLINE(  85)		this->colorMaskBlue = true;
HXLINE(  86)		this->colorMaskAlpha = true;
HXLINE(  87)		this->culling = 3;
HXLINE(  88)		this->depthCompareMode = 4;
HXLINE(  89)		this->depthMask = true;
HXLINE(  90)		this->samplerStates = ::Array_obj< ::Dynamic>::__new();
HXLINE(  91)		this->scissorRectangle =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,null(),null(),null(),null());
HXLINE(  92)		this->stencilCompareMode = 0;
HXLINE(  93)		this->stencilDepthFail = 5;
HXLINE(  94)		this->stencilFail = 5;
HXLINE(  95)		this->stencilPass = 5;
HXLINE(  96)		this->stencilReadMask = 255;
HXLINE(  97)		this->stencilReferenceValue = 0;
HXLINE(  98)		this->stencilTriangleFace = 2;
HXLINE(  99)		this->stencilWriteMask = 255;
HXLINE( 100)		this->textures = ::Array_obj< ::Dynamic>::__new();
HXLINE( 101)		this->_hx___frontFaceGLCCW = true;
HXLINE( 104)		this->_hx___glBlendEquation = 32774;
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_2647a1a4499da7d5_22_boot)
