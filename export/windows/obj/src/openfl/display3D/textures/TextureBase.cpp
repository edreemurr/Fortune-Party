...
HXLINE( 385)		int format;
HXLINE( 387)		if ((this->_hx___textureTarget != gl->TEXTURE_2D)) {
HXLINE( 387)			return;
            		}
HXLINE( 389)		if ((image->buffer->bitsPerPixel == 1)) {
HXLINE( 391)			internalFormat = gl->ALPHA;
HXLINE( 392)			format = gl->ALPHA;
            		}
            		else {
HXLINE( 396)			internalFormat = ::openfl::display3D::textures::TextureBase_obj::_hx___textureInternalFormat;
HXLINE( 397)			format = ::openfl::display3D::textures::TextureBase_obj::_hx___textureFormat;
            		}
HXLINE( 400)		this->_hx___context->_hx___bindGLTexture2D(this->_hx___textureID);
HXLINE( 424)		{
HXLINE( 424)			int target = gl->TEXTURE_2D;
HXDLIN( 424)			int width = image->buffer->width;
HXDLIN( 424)			int height = image->buffer->height;
HXDLIN( 424)			int type = gl->UNSIGNED_BYTE;
HXDLIN( 424)			 ::lime::utils::ArrayBufferView srcData = image->get_data();
HXDLIN( 424)			{
HXLINE( 424)				::lime::utils::_BytePointer::BytePointer_Impl__obj::set(::lime::graphics::_WebGL2RenderContext::WebGL2RenderContext_Impl__obj::_hx___tempPointer,null(),srcData,null(),0);
HXDLIN( 424)				gl->texImage2D(target,0,internalFormat,width,height,0,format,type,::lime::utils::_DataPointer::DataPointer_Impl__obj::fromBytesPointer(::lime::graphics::_WebGL2RenderContext::WebGL2RenderContext_Impl__obj::_hx___tempPointer));
            			}
            		}
HXLINE( 427)		this->_hx___context->_hx___bindGLTexture2D(null());
            	}
