...
HX_LOCAL_STACK_FRAME(_hx_pos_4176bcd8576208c2_260_getMusic,"openfl.utils.Assets","getMusic",0x2e0c01bf,"openfl.utils.Assets.getMusic","openfl/utils/Assets.hx",260,0x4e64919e)
...
HXLINE( 122)			 ::openfl::display::BitmapData bitmapData1 = ::openfl::display::BitmapData_obj::fromImage(image,null());
HXLINE( 125)			bool _hx_tmp2;
HXDLIN( 125)			if (useCache) {
HXLINE( 125)				_hx_tmp2 = ::openfl::utils::IAssetCache_obj::get_enabled(::openfl::utils::Assets_obj::cache);
            			}
            			else {
HXLINE( 125)				_hx_tmp2 = false;
            			}
HXDLIN( 125)			if (_hx_tmp2) {
HXLINE( 127)				::openfl::utils::IAssetCache_obj::setBitmapData(::openfl::utils::Assets_obj::cache,id,bitmapData1);
            			}
HXLINE( 130)			return bitmapData1;
            		}
...
HXDLIN( 152)		return ::openfl::utils::_ByteArray::ByteArray_Impl__obj::fromLimeBytes(::lime::utils::Assets_obj::getBytes(id));
            	}
...
HXLINE( 190)				_hx_tmp2 = ::openfl::utils::IAssetCache_obj::get_enabled(::openfl::utils::Assets_obj::cache);
            			}
            			else {
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Assets_obj,getMovieClip,return )
 ...
 ::openfl::media::Sound Assets_obj::getMusic(::String id,::hx::Null< bool >  __o_useCache){
            		bool useCache = __o_useCache.Default(true);
            	HX_STACKFRAME(&_hx_pos_4176bcd8576208c2_260_getMusic)
HXLINE( 262)		::String path = ::openfl::utils::Assets_obj::getPath(id);
HXLINE( 264)		 ::lime::media::vorbis::VorbisFile vorbisFile = ::lime::media::vorbis::VorbisFile_obj::fromFile(path);
HXLINE( 265)		 ::lime::media::AudioBuffer buffer = ::lime::media::AudioBuffer_obj::fromVorbisFile(vorbisFile);
HXLINE( 266)		return ::openfl::media::Sound_obj::fromAudioBuffer(buffer);
            	}
...
HXLINE( 325)			 ::openfl::media::Sound sound1 = ::openfl::media::Sound_obj::fromAudioBuffer(buffer);
HXLINE( 328)			bool _hx_tmp2;
HXDLIN( 328)			if (useCache) {
HXLINE( 328)				_hx_tmp2 = ::openfl::utils::IAssetCache_obj::get_enabled(::openfl::utils::Assets_obj::cache);
            			}
            			else {
HXLINE( 328)				_hx_tmp2 = false;
            			}
HXDLIN( 328)			if (_hx_tmp2) {
HXLINE( 330)				::openfl::utils::IAssetCache_obj::setSound(::openfl::utils::Assets_obj::cache,id,sound1);
            			}
HXLINE( 333)			return sound1;
            		}
...
HXLINE( 424)				_hx_tmp1 = ::hx::IsNull( type );
            			}
            			else {
...
HXLINE( 429)				_hx_tmp2 = ::hx::IsNull( type );
            			}
            			else {
...
HXLINE( 434)				_hx_tmp4 = (type == HX_("MUSIC",85,08,49,8e));
            			}
            			else {
HXLINE( 434)				_hx_tmp4 = true;
            			}
HXDLIN( 434)			if (!(_hx_tmp4)) {
HXLINE( 434)				_hx_tmp3 = ::hx::IsNull( type );
            			}
            			else {
...
HXDLIN( 539)				if (( (bool)(useCache1->__get(0)) )) {
...
HXDLIN( 512)		::Array< ::Dynamic> useCache1 = ::Array_obj< ::Dynamic>::__new(1)->init(0,useCache);
HXLINE( 513)		if (::hx::IsNull( useCache1->__get(0) )) {
HXLINE( 513)			useCache1[0] = true;
            		}
...
HXDLIN( 518)		if (( (bool)(useCache1->__get(0)) )) {
...
HXLINE( 529)		::lime::utils::Assets_obj::loadImage(id,false)->onComplete( ::Dynamic(new _hx_Closure_0(id,useCache1,promise)))->onError(promise->error_dyn())->onProgress(promise->progress_dyn());
...
HXDLIN( 576)			promise1->complete(::openfl::utils::_ByteArray::ByteArray_Impl__obj::fromLimeBytes(bytes));
            		}
            		HX_END_LOCAL_FUNC1((void))
...
HXDLIN( 622)			if (( (bool)(useCache1->__get(0)) )) {
...
HXDLIN( 600)		::Array< ::Dynamic> useCache1 = ::Array_obj< ::Dynamic>::__new(1)->init(0,useCache);
HXLINE( 601)		if (::hx::IsNull( useCache1->__get(0) )) {
HXLINE( 601)			useCache1[0] = true;
            		}
...
HXDLIN( 606)		if (( (bool)(useCache1->__get(0)) )) {
...
HXLINE( 612)		::lime::utils::Assets_obj::loadFont(id,null())->onComplete( ::Dynamic(new _hx_Closure_0(id,useCache1,promise)))->onError(promise->error_dyn())->onProgress(promise->progress_dyn());
...
HXDLIN( 705)				if (( (bool)(useCache1->__get(0)) )) {
...
HXDLIN( 687)		::Array< ::Dynamic> useCache1 = ::Array_obj< ::Dynamic>::__new(1)->init(0,useCache);
HXLINE( 688)		if (::hx::IsNull( useCache1->__get(0) )) {
HXLINE( 688)			useCache1[0] = true;
            		}
HXLINE( 692)		 ::lime::app::Promise_openfl_media_Sound promise =  ::lime::app::Promise_openfl_media_Sound_obj::__alloc( HX_CTX );
HXLINE( 694)		::lime::utils::Assets_obj::loadAudioBuffer(id,useCache1->__get(0))->onComplete( ::Dynamic(new _hx_Closure_0(id,useCache1,promise)))->onError(promise->error_dyn())->onProgress(promise->progress_dyn());
...
HXDLIN( 806)				if (( (bool)(useCache1->__get(0)) )) {
...
HXDLIN( 789)		::Array< ::Dynamic> useCache1 = ::Array_obj< ::Dynamic>::__new(1)->init(0,useCache);
HXLINE( 790)		if (::hx::IsNull( useCache1->__get(0) )) {
HXLINE( 790)			useCache1[0] = true;
            		}
HXLINE( 793)		 ::lime::app::Promise_openfl_media_Sound promise =  ::lime::app::Promise_openfl_media_Sound_obj::__alloc( HX_CTX );
HXLINE( 795)		::lime::utils::Assets_obj::loadAudioBuffer(id,useCache1->__get(0))->onComplete( ::Dynamic(new _hx_Closure_0(id,useCache1,promise)))->onError(promise->error_dyn())->onProgress(promise->progress_dyn());
...
HXDLIN( 907)			_hx_tmp = ::hx::IsInstanceEq( ::openfl::utils::Assets_obj::libraryBindings->get(className),library );
            		}
            		else {
