...
HXLINE( 211)			::Array< ::Dynamic> list1 = ( (::Array< ::Dynamic>)(this->_hx___eventMap->get(type)) );
HXLINE( 213)			{
HXLINE( 213)				int _g = 0;
HXDLIN( 213)				int _g1 = list1->length;
HXDLIN( 213)				while((_g < _g1)){
HXLINE( 213)					_g = (_g + 1);
HXDLIN( 213)					int i = (_g - 1);
HXLINE( 215)					if (list1->__get(i).StaticCast<  ::openfl::events::_EventDispatcher::Listener >()->match(listener,useCapture)) {
HXLINE( 215)						return;
            					}
            				}
            			}
...
HXLINE( 220)					 ::openfl::events::_EventDispatcher::DispatchIterator iterator1 = iterators->__get(_g2).StaticCast<  ::openfl::events::_EventDispatcher::DispatchIterator >();
HXDLIN( 220)					_g2 = (_g2 + 1);
HXLINE( 222)					if (iterator1->active) {
HXLINE( 224)						iterator1->copy();
            					}
            				}
            			}
HXLINE( 228)			this->_hx___addListenerByPriority(list1, ::openfl::events::_EventDispatcher::Listener_obj::__alloc( HX_CTX ,listener,useCapture,priority,useWeakReference));
            		}
            	}
...
HXDLIN( 316)						while((_g2 < iterators->length)){
HXLINE( 316)							 ::openfl::events::_EventDispatcher::DispatchIterator iterator = iterators->__get(_g2).StaticCast<  ::openfl::events::_EventDispatcher::DispatchIterator >();
HXDLIN( 316)							_g2 = (_g2 + 1);
...
HXLINE( 462)						_hx_tmp2 = ::hx::IsNotNull( ::openfl::Lib_obj::get_current()->stage );
            					}
            					else {
HXLINE( 462)						_hx_tmp2 = false;
            					}
HXDLIN( 462)					if (_hx_tmp2) {
HXLINE( 462)						_hx_tmp1 = ::openfl::Lib_obj::get_current()->stage->_hx___uncaughtErrorEvents->_hx___enabled;
            					}
            					else {
