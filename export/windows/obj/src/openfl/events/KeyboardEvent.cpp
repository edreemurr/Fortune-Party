...
HX_DEFINE_STACK_FRAME(_hx_pos_c70c2341539e31f3_174_new,"openfl.events.KeyboardEvent","new",0xa9982e4e,"openfl.events.KeyboardEvent.new","openfl/events/KeyboardEvent.hx",174,0xce5f4702)
HX_LOCAL_STACK_FRAME(_hx_pos_c70c2341539e31f3_193_clone,"openfl.events.KeyboardEvent","clone",0x11ed48cb,"openfl.events.KeyboardEvent.clone","openfl/events/KeyboardEvent.hx",193,0xce5f4702)
HX_LOCAL_STACK_FRAME(_hx_pos_c70c2341539e31f3_205_toString,"openfl.events.KeyboardEvent","toString",0xd22933fe,"openfl.events.KeyboardEvent.toString","openfl/events/KeyboardEvent.hx",205,0xce5f4702)
...
HX_LOCAL_STACK_FRAME(_hx_pos_c70c2341539e31f3_224_updateAfterEvent,"openfl.events.KeyboardEvent","updateAfterEvent",0xf3710119,"openfl.events.KeyboardEvent.updateAfterEvent","openfl/events/KeyboardEvent.hx",224,0xce5f4702)
HX_LOCAL_STACK_FRAME(_hx_pos_c70c2341539e31f3_228___init,"openfl.events.KeyboardEvent","__init",0x84182902,"openfl.events.KeyboardEvent.__init","openfl/events/KeyboardEvent.hx",228,0xce5f4702)
HX_LOCAL_STACK_FRAME(_hx_pos_c70c2341539e31f3_47_boot,"openfl.events.KeyboardEvent","boot",0xb3a95684,"openfl.events.KeyboardEvent.boot","openfl/events/KeyboardEvent.hx",47,0xce5f4702)
HX_LOCAL_STACK_FRAME(_hx_pos_c70c2341539e31f3_68_boot,"openfl.events.KeyboardEvent","boot",0xb3a95684,"openfl.events.KeyboardEvent.boot","openfl/events/KeyboardEvent.hx",68,0xce5f4702)
namespace openfl{
namespace events{
...
void KeyboardEvent_obj::__construct(::String type,::hx::Null< bool >  __o_bubbles,::hx::Null< bool >  __o_cancelable,::hx::Null< int >  __o_charCodeValue,::hx::Null< int >  __o_keyCodeValue, ::Dynamic keyLocationValue,::hx::Null< bool >  __o_ctrlKeyValue,::hx::Null< bool >  __o_altKeyValue,::hx::Null< bool >  __o_shiftKeyValue,::hx::Null< bool >  __o_controlKeyValue,::hx::Null< bool >  __o_commandKeyValue){
            	...
            	HX_STACKFRAME(&_hx_pos_c70c2341539e31f3_174_new)
HXLINE( 175)		super::__construct(type,bubbles,cancelable);
HXLINE( 177)		this->charCode = charCodeValue;
HXLINE( 178)		this->keyCode = keyCodeValue;
HXLINE( 179)		int _hx_tmp;
HXDLIN( 179)		if (::hx::IsNotNull( keyLocationValue )) {
HXLINE( 179)			_hx_tmp = ( (int)(keyLocationValue) );
            		}
            		else {
HXLINE( 179)			_hx_tmp = 0;
            		}
HXDLIN( 179)		this->keyLocation = _hx_tmp;
HXLINE( 180)		this->ctrlKey = ctrlKeyValue;
HXLINE( 181)		this->altKey = altKeyValue;
HXLINE( 182)		this->shiftKey = shiftKeyValue;
HXLINE( 185)		this->controlKey = controlKeyValue;
HXLINE( 186)		this->commandKey = commandKeyValue;
HXLINE( 189)		this->_hx___updateAfterEventFlag = false;
            	}
...
bool KeyboardEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event KeyboardEvent_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_c70c2341539e31f3_193_clone)
HXLINE( 194)		 ::openfl::events::KeyboardEvent event =  ::openfl::events::KeyboardEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->charCode,this->keyCode,this->keyLocation,this->ctrlKey,this->altKey,this->shiftKey,this->controlKey,this->commandKey);
HXLINE( 197)		event->target = this->target;
HXLINE( 198)		event->currentTarget = this->currentTarget;
HXLINE( 199)		event->eventPhase = this->eventPhase;
HXLINE( 200)		return event;
            	}


::String KeyboardEvent_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_c70c2341539e31f3_205_toString)
HXDLIN( 205)		return this->_hx___formatToString(HX_("KeyboardEvent",d3,8d,88,91),::Array_obj< ::String >::fromData( _hx_array_data_d8fbaf5c_3,9));
            	}


void KeyboardEvent_obj::updateAfterEvent(){
            	HX_STACKFRAME(&_hx_pos_c70c2341539e31f3_224_updateAfterEvent)
HXDLIN( 224)		this->_hx___updateAfterEventFlag = true;
            	}
...
void KeyboardEvent_obj::_hx___init(){
            	HX_STACKFRAME(&_hx_pos_c70c2341539e31f3_228___init)
HXLINE( 229)		this->super::_hx___init();
HXLINE( 230)		this->charCode = 0;
HXLINE( 231)		this->keyCode = 0;
HXLINE( 232)		this->keyLocation = 0;
HXLINE( 233)		this->ctrlKey = false;
HXLINE( 234)		this->altKey = false;
HXLINE( 235)		this->shiftKey = false;
HXLINE( 238)		this->controlKey = false;
HXLINE( 239)		this->commandKey = false;
HXLINE( 242)		this->_hx___updateAfterEventFlag = false;
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_c70c2341539e31f3_47_boot)
HXDLIN(  47)		KEY_DOWN = HX_("keyDown",a1,69,47,9c);
            	}
{
            	HX_STACKFRAME(&_hx_pos_c70c2341539e31f3_68_boot)
HXDLIN(  68)		KEY_UP = HX_("keyUp",da,b9,fe,de);
            	}
}
