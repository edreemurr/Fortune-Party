...
HX_DEFINE_STACK_FRAME(_hx_pos_7a0f0e2b2707adbe_68_new,"openfl.events.SecurityErrorEvent","new",0x42af717b,"openfl.events.SecurityErrorEvent.new","openfl/events/SecurityErrorEvent.hx",68,0x4f4e3035)
HX_LOCAL_STACK_FRAME(_hx_pos_7a0f0e2b2707adbe_72_clone,"openfl.events.SecurityErrorEvent","clone",0x91bd7138,"openfl.events.SecurityErrorEvent.clone","openfl/events/SecurityErrorEvent.hx",72,0x4f4e3035)
HX_LOCAL_STACK_FRAME(_hx_pos_7a0f0e2b2707adbe_82_toString,"openfl.events.SecurityErrorEvent","toString",0xccee4db1,"openfl.events.SecurityErrorEvent.toString","openfl/events/SecurityErrorEvent.hx",82,0x4f4e3035)
...
HX_LOCAL_STACK_FRAME(_hx_pos_7a0f0e2b2707adbe_41_boot,"openfl.events.SecurityErrorEvent","boot",0x0eecdab7,"openfl.events.SecurityErrorEvent.boot","openfl/events/SecurityErrorEvent.hx",41,0x4f4e3035)
namespace openfl{
namespace events{
...
void SecurityErrorEvent_obj::__construct(::String type,::hx::Null< bool >  __o_bubbles,::hx::Null< bool >  __o_cancelable,::String __o_text,::hx::Null< int >  __o_id){
            	...
            	HX_STACKFRAME(&_hx_pos_7a0f0e2b2707adbe_68_new)
...
bool SecurityErrorEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event SecurityErrorEvent_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_7a0f0e2b2707adbe_72_clone)
HXLINE(  73)		 ::openfl::events::SecurityErrorEvent event =  ::openfl::events::SecurityErrorEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->text,this->errorID);
...
::String SecurityErrorEvent_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_7a0f0e2b2707adbe_82_toString)
HXDLIN(  82)		return this->_hx___formatToString(HX_("SecurityErrorEvent",32,ea,b2,a1),::Array_obj< ::String >::fromData( _hx_array_data_072c9809_3,5));
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_7a0f0e2b2707adbe_41_boot)
HXDLIN(  41)		SECURITY_ERROR = HX_("securityError",e8,28,7c,a2);
            	}
}
