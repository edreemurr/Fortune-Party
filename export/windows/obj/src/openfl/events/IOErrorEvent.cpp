...
HX_DEFINE_STACK_FRAME(_hx_pos_c1a0d6ee9eb05388_105_new,"openfl.events.IOErrorEvent","new",0x69722dc1,"openfl.events.IOErrorEvent.new","openfl/events/IOErrorEvent.hx",105,0x9ba976af)
HX_LOCAL_STACK_FRAME(_hx_pos_c1a0d6ee9eb05388_109_clone,"openfl.events.IOErrorEvent","clone",0xfbdc4afe,"openfl.events.IOErrorEvent.clone","openfl/events/IOErrorEvent.hx",109,0x9ba976af)
HX_LOCAL_STACK_FRAME(_hx_pos_c1a0d6ee9eb05388_119_toString,"openfl.events.IOErrorEvent","toString",0xfbbd53ab,"openfl.events.IOErrorEvent.toString","openfl/events/IOErrorEvent.hx",119,0x9ba976af)
...
HX_LOCAL_STACK_FRAME(_hx_pos_c1a0d6ee9eb05388_36_boot,"openfl.events.IOErrorEvent","boot",0xd28edbb1,"openfl.events.IOErrorEvent.boot","openfl/events/IOErrorEvent.hx",36,0x9ba976af)
HX_LOCAL_STACK_FRAME(_hx_pos_c1a0d6ee9eb05388_55_boot,"openfl.events.IOErrorEvent","boot",0xd28edbb1,"openfl.events.IOErrorEvent.boot","openfl/events/IOErrorEvent.hx",55,0x9ba976af)
HX_LOCAL_STACK_FRAME(_hx_pos_c1a0d6ee9eb05388_73_boot,"openfl.events.IOErrorEvent","boot",0xd28edbb1,"openfl.events.IOErrorEvent.boot","openfl/events/IOErrorEvent.hx",73,0x9ba976af)
namespace openfl{
namespace events{
...
void IOErrorEvent_obj::__construct(::String type,::hx::Null< bool >  __o_bubbles,::hx::Null< bool >  __o_cancelable,::String __o_text,::hx::Null< int >  __o_id){
            	...
            	HX_STACKFRAME(&_hx_pos_c1a0d6ee9eb05388_105_new)
HXDLIN( 105)		super::__construct(type,bubbles,cancelable,text,id);
            	}
...
bool IOErrorEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event IOErrorEvent_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_c1a0d6ee9eb05388_109_clone)
HXLINE( 110)		 ::openfl::events::IOErrorEvent event =  ::openfl::events::IOErrorEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->text,this->errorID);
HXLINE( 111)		event->target = this->target;
HXLINE( 112)		event->currentTarget = this->currentTarget;
HXLINE( 113)		event->eventPhase = this->eventPhase;
HXLINE( 114)		return event;
            	}


::String IOErrorEvent_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_c1a0d6ee9eb05388_119_toString)
HXDLIN( 119)		return this->_hx___formatToString(HX_("IOErrorEvent",b8,16,b3,65),::Array_obj< ::String >::fromData( _hx_array_data_1ffe394f_3,5));
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_c1a0d6ee9eb05388_36_boot)
HXDLIN(  36)		IO_ERROR = HX_("ioError",02,fe,41,76);
            	}
{
            	HX_STACKFRAME(&_hx_pos_c1a0d6ee9eb05388_55_boot)
HXDLIN(  55)		STANDARD_OUTPUT_IO_ERROR = HX_("standardOutputIoError",84,ff,c2,39);
            	}
{
            	HX_STACKFRAME(&_hx_pos_c1a0d6ee9eb05388_73_boot)
HXDLIN(  73)		STANDARD_ERROR_IO_ERROR = HX_("standardErrorIoError",f7,cd,d0,a7);
            	}
}
