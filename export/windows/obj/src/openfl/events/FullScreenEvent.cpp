...
HX_DEFINE_STACK_FRAME(_hx_pos_9acd580c71eb88b0_84_new,"openfl.events.FullScreenEvent","new",0x08c8725a,"openfl.events.FullScreenEvent.new","openfl/events/FullScreenEvent.hx",84,0x5d391076)
HX_LOCAL_STACK_FRAME(_hx_pos_9acd580c71eb88b0_94_clone,"openfl.events.FullScreenEvent","clone",0xd0bfa7d7,"openfl.events.FullScreenEvent.clone","openfl/events/FullScreenEvent.hx",94,0x5d391076)
HX_LOCAL_STACK_FRAME(_hx_pos_9acd580c71eb88b0_104_toString,"openfl.events.FullScreenEvent","toString",0x75cac472,"openfl.events.FullScreenEvent.toString","openfl/events/FullScreenEvent.hx",104,0x5d391076)
...
HX_LOCAL_STACK_FRAME(_hx_pos_9acd580c71eb88b0_108___init,"openfl.events.FullScreenEvent","__init",0xbd58f476,"openfl.events.FullScreenEvent.__init","openfl/events/FullScreenEvent.hx",108,0x5d391076)
HX_LOCAL_STACK_FRAME(_hx_pos_9acd580c71eb88b0_30_boot,"openfl.events.FullScreenEvent","boot",0x9eb49cf8,"openfl.events.FullScreenEvent.boot","openfl/events/FullScreenEvent.hx",30,0x5d391076)
HX_LOCAL_STACK_FRAME(_hx_pos_9acd580c71eb88b0_46_boot,"openfl.events.FullScreenEvent","boot",0x9eb49cf8,"openfl.events.FullScreenEvent.boot","openfl/events/FullScreenEvent.hx",46,0x5d391076)
namespace openfl{
namespace events{
...
void FullScreenEvent_obj::__construct(::String type,::hx::Null< bool >  __o_bubbles,::hx::Null< bool >  __o_cancelable,::hx::Null< bool >  __o_fullScreen,::hx::Null< bool >  __o_interactive){
            	...
            	HX_STACKFRAME(&_hx_pos_9acd580c71eb88b0_84_new)
HXLINE(  87)		super::__construct(type,bubbles,cancelable,null());
HXLINE(  89)		this->fullScreen = fullScreen;
HXLINE(  90)		this->interactive = interactive;
            	}
...
bool FullScreenEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event FullScreenEvent_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_9acd580c71eb88b0_94_clone)
HXLINE(  95)		 ::openfl::events::FullScreenEvent event =  ::openfl::events::FullScreenEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->fullScreen,this->interactive);
HXLINE(  96)		event->target = this->target;
HXLINE(  97)		event->currentTarget = this->currentTarget;
HXLINE(  98)		event->eventPhase = this->eventPhase;
HXLINE(  99)		return event;
            	}


::String FullScreenEvent_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_9acd580c71eb88b0_104_toString)
HXDLIN( 104)		return this->_hx___formatToString(HX_("FullscreenEvent",bf,0f,46,0d),::Array_obj< ::String >::fromData( _hx_array_data_551dfd68_3,5));
            	}


void FullScreenEvent_obj::_hx___init(){
            	HX_STACKFRAME(&_hx_pos_9acd580c71eb88b0_108___init)
HXLINE( 109)		this->super::_hx___init();
HXLINE( 110)		this->fullScreen = false;
HXLINE( 111)		this->interactive = false;
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_9acd580c71eb88b0_30_boot)
HXDLIN(  30)		FULL_SCREEN = HX_("fullScreen",5b,ae,48,2e);
            	}
{
            	HX_STACKFRAME(&_hx_pos_9acd580c71eb88b0_46_boot)
HXDLIN(  46)		FULL_SCREEN_INTERACTIVE_ACCEPTED = HX_("fullScreenInteractiveAccepted",ce,77,06,29);
            	}
}
