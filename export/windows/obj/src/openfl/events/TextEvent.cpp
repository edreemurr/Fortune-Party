...
HX_DEFINE_STACK_FRAME(_hx_pos_a9542994cee360f6_81_new,"openfl.events.TextEvent","new",0x29e58508,"openfl.events.TextEvent.new","openfl/events/TextEvent.hx",81,0x23b91588)
HX_LOCAL_STACK_FRAME(_hx_pos_a9542994cee360f6_88_clone,"openfl.events.TextEvent","clone",0x41494205,"openfl.events.TextEvent.clone","openfl/events/TextEvent.hx",88,0x23b91588)
HX_LOCAL_STACK_FRAME(_hx_pos_a9542994cee360f6_98_toString,"openfl.events.TextEvent","toString",0x2a253b04,"openfl.events.TextEvent.toString","openfl/events/TextEvent.hx",98,0x23b91588)
...
HX_LOCAL_STACK_FRAME(_hx_pos_a9542994cee360f6_102___init,"openfl.events.TextEvent","__init",0xc5364288,"openfl.events.TextEvent.__init","openfl/events/TextEvent.hx",102,0x23b91588)
HX_LOCAL_STACK_FRAME(_hx_pos_a9542994cee360f6_29_boot,"openfl.events.TextEvent","boot",0x7707e28a,"openfl.events.TextEvent.boot","openfl/events/TextEvent.hx",29,0x23b91588)
HX_LOCAL_STACK_FRAME(_hx_pos_a9542994cee360f6_47_boot,"openfl.events.TextEvent","boot",0x7707e28a,"openfl.events.TextEvent.boot","openfl/events/TextEvent.hx",47,0x23b91588)
namespace openfl{
namespace events{
...
void TextEvent_obj::__construct(::String type,::hx::Null< bool >  __o_bubbles,::hx::Null< bool >  __o_cancelable,::String __o_text){
            	...
            	HX_STACKFRAME(&_hx_pos_a9542994cee360f6_81_new)
HXLINE(  82)		super::__construct(type,bubbles,cancelable);
HXLINE(  84)		this->text = text;
            	}
...
bool TextEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event TextEvent_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_a9542994cee360f6_88_clone)
HXLINE(  89)		 ::openfl::events::TextEvent event =  ::openfl::events::TextEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->text);
HXLINE(  90)		event->target = this->target;
HXLINE(  91)		event->currentTarget = this->currentTarget;
HXLINE(  92)		event->eventPhase = this->eventPhase;
HXLINE(  93)		return event;
            	}


::String TextEvent_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_a9542994cee360f6_98_toString)
HXDLIN(  98)		return this->_hx___formatToString(HX_("TextEvent",0d,38,85,b0),::Array_obj< ::String >::fromData( _hx_array_data_52f4a116_3,4));
            	}


void TextEvent_obj::_hx___init(){
            	HX_STACKFRAME(&_hx_pos_a9542994cee360f6_102___init)
HXLINE( 103)		this->super::_hx___init();
HXLINE( 104)		this->text = HX_("",00,00,00,00);
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_a9542994cee360f6_29_boot)
HXDLIN(  29)		LINK = HX_("link",fa,17,b3,47);
            	}
{
            	HX_STACKFRAME(&_hx_pos_a9542994cee360f6_47_boot)
HXDLIN(  47)		TEXT_INPUT = HX_("textInput",1d,54,0b,57);
            	}
}
