...
HX_DEFINE_STACK_FRAME(_hx_pos_27135fd1b85393b6_149_new,"openfl.events.NetStatusEvent","new",0x7499fa94,"openfl.events.NetStatusEvent.new","openfl/events/NetStatusEvent.hx",149,0xf85a9d3c)
HX_LOCAL_STACK_FRAME(_hx_pos_27135fd1b85393b6_156_clone,"openfl.events.NetStatusEvent","clone",0xfa2f3291,"openfl.events.NetStatusEvent.clone","openfl/events/NetStatusEvent.hx",156,0xf85a9d3c)
HX_LOCAL_STACK_FRAME(_hx_pos_27135fd1b85393b6_166_toString,"openfl.events.NetStatusEvent","toString",0x4e1f29f8,"openfl.events.NetStatusEvent.toString","openfl/events/NetStatusEvent.hx",166,0xf85a9d3c)
...
HX_LOCAL_STACK_FRAME(_hx_pos_27135fd1b85393b6_170___init,"openfl.events.NetStatusEvent","__init",0xd582cc7c,"openfl.events.NetStatusEvent.__init","openfl/events/NetStatusEvent.hx",170,0xf85a9d3c)
HX_LOCAL_STACK_FRAME(_hx_pos_27135fd1b85393b6_30_boot,"openfl.events.NetStatusEvent","boot",0x8a3a477e,"openfl.events.NetStatusEvent.boot","openfl/events/NetStatusEvent.hx",30,0xf85a9d3c)
namespace openfl{
namespace events{
...
void NetStatusEvent_obj::__construct(::String type,::hx::Null< bool >  __o_bubbles,::hx::Null< bool >  __o_cancelable, ::Dynamic info){
            	...
            	HX_STACKFRAME(&_hx_pos_27135fd1b85393b6_149_new)
HXLINE( 150)		this->info = info;
HXLINE( 152)		super::__construct(type,bubbles,cancelable);
            	}
...
bool NetStatusEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event NetStatusEvent_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_27135fd1b85393b6_156_clone)
HXLINE( 157)		 ::openfl::events::NetStatusEvent event =  ::openfl::events::NetStatusEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->info);
...
HXLINE( 161)		return event;
            	}


::String NetStatusEvent_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_27135fd1b85393b6_166_toString)
HXDLIN( 166)		return this->_hx___formatToString(HX_("NetStatusEvent",4b,2a,fa,67),::Array_obj< ::String >::fromData( _hx_array_data_a54460a2_3,4));
            	}


void NetStatusEvent_obj::_hx___init(){
            	HX_STACKFRAME(&_hx_pos_27135fd1b85393b6_170___init)
HXLINE( 171)		this->super::_hx___init();
HXLINE( 172)		this->info = null();
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_27135fd1b85393b6_30_boot)
HXDLIN(  30)		NET_STATUS = HX_("netStatus",6f,4f,ec,46);
            	}
}
