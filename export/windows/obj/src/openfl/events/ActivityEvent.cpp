...
HX_DEFINE_STACK_FRAME(_hx_pos_07ba67a8dcdbfa28_62_new,"openfl.events.ActivityEvent","new",0x259c5826,"openfl.events.ActivityEvent.new","openfl/events/ActivityEvent.hx",62,0x98f9202a)
HX_LOCAL_STACK_FRAME(_hx_pos_07ba67a8dcdbfa28_69_clone,"openfl.events.ActivityEvent","clone",0xb6b198a3,"openfl.events.ActivityEvent.clone","openfl/events/ActivityEvent.hx",69,0x98f9202a)
HX_LOCAL_STACK_FRAME(_hx_pos_07ba67a8dcdbfa28_79_toString,"openfl.events.ActivityEvent","toString",0x46865b26,"openfl.events.ActivityEvent.toString","openfl/events/ActivityEvent.hx",79,0x98f9202a)
...
HX_LOCAL_STACK_FRAME(_hx_pos_07ba67a8dcdbfa28_83___init,"openfl.events.ActivityEvent","__init",0x0b19b62a,"openfl.events.ActivityEvent.__init","openfl/events/ActivityEvent.hx",83,0x98f9202a)
HX_LOCAL_STACK_FRAME(_hx_pos_07ba67a8dcdbfa28_30_boot,"openfl.events.ActivityEvent","boot",0xbb49c9ac,"openfl.events.ActivityEvent.boot","openfl/events/ActivityEvent.hx",30,0x98f9202a)
namespace openfl{
namespace events{
...
void ActivityEvent_obj::__construct(::String type,::hx::Null< bool >  __o_bubbles,::hx::Null< bool >  __o_cancelable,::hx::Null< bool >  __o_activating){
            	...
            	HX_STACKFRAME(&_hx_pos_07ba67a8dcdbfa28_62_new)
HXLINE(  63)		super::__construct(type,bubbles,cancelable);
HXLINE(  65)		this->activating = activating;
            	}
...
bool ActivityEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event ActivityEvent_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_07ba67a8dcdbfa28_69_clone)
HXLINE(  70)		 ::openfl::events::ActivityEvent event =  ::openfl::events::ActivityEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->activating);
HXLINE(  71)		event->target = this->target;
HXLINE(  72)		event->currentTarget = this->currentTarget;
HXLINE(  73)		event->eventPhase = this->eventPhase;
HXLINE(  74)		return event;
            	}


::String ActivityEvent_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_07ba67a8dcdbfa28_79_toString)
HXDLIN(  79)		return this->_hx___formatToString(HX_("ActivityEvent",ab,eb,0c,59),::Array_obj< ::String >::fromData( _hx_array_data_a0800d34_3,4));
            	}


void ActivityEvent_obj::_hx___init(){
            	HX_STACKFRAME(&_hx_pos_07ba67a8dcdbfa28_83___init)
HXLINE(  84)		this->super::_hx___init();
HXLINE(  85)		this->activating = false;
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_07ba67a8dcdbfa28_30_boot)
HXDLIN(  30)		ACTIVITY = HX_("activity",cf,2d,b2,e5);
            	}
}
