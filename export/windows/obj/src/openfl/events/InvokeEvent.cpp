...
HX_DEFINE_STACK_FRAME(_hx_pos_bfb5fdf2d9e4c469_126_new,"openfl.events.InvokeEvent","new",0x6db4951d,"openfl.events.InvokeEvent.new","openfl/events/InvokeEvent.hx",126,0xf42f2713)
HX_LOCAL_STACK_FRAME(_hx_pos_bfb5fdf2d9e4c469_140_clone,"openfl.events.InvokeEvent","clone",0x630c415a,"openfl.events.InvokeEvent.clone","openfl/events/InvokeEvent.hx",140,0xf42f2713)
HX_LOCAL_STACK_FRAME(_hx_pos_bfb5fdf2d9e4c469_42_boot,"openfl.events.InvokeEvent","boot",0x8866e4d5,"openfl.events.InvokeEvent.boot","openfl/events/InvokeEvent.hx",42,0xf42f2713)
namespace openfl{
namespace events{
...
void InvokeEvent_obj::__construct(::String type,::hx::Null< bool >  __o_bubbles,::hx::Null< bool >  __o_cancelable, ::openfl::filesystem::File dir,::cpp::VirtualArray argv, ::Dynamic __o_reason){
            	...
            	HX_STACKFRAME(&_hx_pos_bfb5fdf2d9e4c469_126_new)
HXLINE( 127)		super::__construct(type,bubbles,cancelable);
HXLINE( 128)		this->currentDirectory = dir;
HXLINE( 129)		::Array< ::String > stringArgs = ::Array_obj< ::String >::__new(0);
HXLINE( 130)		{
HXLINE( 130)			int _g = 0;
HXDLIN( 130)			while((_g < argv->get_length())){
HXLINE( 130)				 ::Dynamic arg = argv->__get(_g);
HXDLIN( 130)				_g = (_g + 1);
HXLINE( 132)				stringArgs->push(::Std_obj::string(arg));
            			}
            		}
HXLINE( 134)		this->arguments = stringArgs;
HXLINE( 135)		this->reason = reason;
            	}
...
bool InvokeEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event InvokeEvent_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_bfb5fdf2d9e4c469_140_clone)
HXDLIN( 140)		return  ::openfl::events::InvokeEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->currentDirectory,this->arguments,this->reason);
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_bfb5fdf2d9e4c469_42_boot)
HXDLIN(  42)		INVOKE = HX_("invoke",78,77,e0,9f);
            	}
}
