...
HX_DEFINE_STACK_FRAME(_hx_pos_3e9f49414be9df9e_29_new,"openfl.events.HTTPStatusEvent","new",0x992d4c1b,"openfl.events.HTTPStatusEvent.new","openfl/events/HTTPStatusEvent.hx",29,0x9d0269d5)
...
void HTTPStatusEvent_obj::__construct(::String type,::hx::Null< bool >  __o_bubbles,::hx::Null< bool >  __o_cancelable,::hx::Null< int >  __o_status,::hx::Null< bool >  __o_redirected){
            	...
            	HX_STACKFRAME(&_hx_pos_3e9f49414be9df9e_29_new)
HXLINE(  79)		this->responseHeaders = ::Array_obj< ::Dynamic>::__new(0);
