...
HX_DEFINE_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_458_new,"openfl.events.TouchEvent","new",0xe223a0c4,"openfl.events.TouchEvent.new","openfl/events/TouchEvent.hx",458,0x2fe85d0c)
HX_LOCAL_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_482_clone,"openfl.events.TouchEvent","clone",0x1a12c4c1,"openfl.events.TouchEvent.clone","openfl/events/TouchEvent.hx",482,0x2fe85d0c)
HX_LOCAL_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_493_toString,"openfl.events.TouchEvent","toString",0x9efd15c8,"openfl.events.TouchEvent.toString","openfl/events/TouchEvent.hx",493,0x2fe85d0c)
...
HX_LOCAL_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_505_updateAfterEvent,"openfl.events.TouchEvent","updateAfterEvent",0xeb0abce3,"openfl.events.TouchEvent.updateAfterEvent","openfl/events/TouchEvent.hx",505,0x2fe85d0c)
HX_LOCAL_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_520___init,"openfl.events.TouchEvent","__init",0x9cbf244c,"openfl.events.TouchEvent.__init","openfl/events/TouchEvent.hx",520,0x2fe85d0c)
HX_LOCAL_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_510___create,"openfl.events.TouchEvent","__create",0x8acd1738,"openfl.events.TouchEvent.__create","openfl/events/TouchEvent.hx",510,0x2fe85d0c)
HX_LOCAL_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_42_boot,"openfl.events.TouchEvent","boot",0xf5220b4e,"openfl.events.TouchEvent.boot","openfl/events/TouchEvent.hx",42,0x2fe85d0c)
HX_LOCAL_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_80_boot,"openfl.events.TouchEvent","boot",0xf5220b4e,"openfl.events.TouchEvent.boot","openfl/events/TouchEvent.hx",80,0x2fe85d0c)
HX_LOCAL_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_110_boot,"openfl.events.TouchEvent","boot",0xf5220b4e,"openfl.events.TouchEvent.boot","openfl/events/TouchEvent.hx",110,0x2fe85d0c)
HX_LOCAL_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_140_boot,"openfl.events.TouchEvent","boot",0xf5220b4e,"openfl.events.TouchEvent.boot","openfl/events/TouchEvent.hx",140,0x2fe85d0c)
HX_LOCAL_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_170_boot,"openfl.events.TouchEvent","boot",0xf5220b4e,"openfl.events.TouchEvent.boot","openfl/events/TouchEvent.hx",170,0x2fe85d0c)
HX_LOCAL_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_200_boot,"openfl.events.TouchEvent","boot",0xf5220b4e,"openfl.events.TouchEvent.boot","openfl/events/TouchEvent.hx",200,0x2fe85d0c)
HX_LOCAL_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_230_boot,"openfl.events.TouchEvent","boot",0xf5220b4e,"openfl.events.TouchEvent.boot","openfl/events/TouchEvent.hx",230,0x2fe85d0c)
HX_LOCAL_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_260_boot,"openfl.events.TouchEvent","boot",0xf5220b4e,"openfl.events.TouchEvent.boot","openfl/events/TouchEvent.hx",260,0x2fe85d0c)
HX_LOCAL_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_290_boot,"openfl.events.TouchEvent","boot",0xf5220b4e,"openfl.events.TouchEvent.boot","openfl/events/TouchEvent.hx",290,0x2fe85d0c)
namespace openfl{
namespace events{
...
void TouchEvent_obj::__construct(::String type,::hx::Null< bool >  __o_bubbles,::hx::Null< bool >  __o_cancelable,::hx::Null< int >  __o_touchPointID,::hx::Null< bool >  __o_isPrimaryTouchPoint,::hx::Null< Float >  __o_localX,::hx::Null< Float >  __o_localY,::hx::Null< Float >  __o_sizeX,::hx::Null< Float >  __o_sizeY,::hx::Null< Float >  __o_pressure, ::openfl::display::InteractiveObject relatedObject,::hx::Null< bool >  __o_ctrlKey,::hx::Null< bool >  __o_altKey,::hx::Null< bool >  __o_shiftKey,::hx::Null< bool >  __o_commandKey,::hx::Null< bool >  __o_controlKey,::hx::Null< Float >  __o_timestamp,::String touchIntent, ::openfl::utils::ByteArrayData samples,::hx::Null< bool >  __o_isTouchPointCanceled){
            	...
            	HX_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_458_new)
HXLINE( 459)		super::__construct(type,bubbles,cancelable);
HXLINE( 461)		this->touchPointID = touchPointID;
HXLINE( 462)		this->isPrimaryTouchPoint = isPrimaryTouchPoint;
HXLINE( 463)		this->localX = localX;
HXLINE( 464)		this->localY = localY;
HXLINE( 465)		this->sizeX = sizeX;
HXLINE( 466)		this->sizeY = sizeY;
HXLINE( 467)		this->pressure = pressure;
HXLINE( 468)		this->relatedObject = relatedObject;
HXLINE( 469)		this->ctrlKey = ctrlKey;
HXLINE( 470)		this->altKey = altKey;
HXLINE( 471)		this->shiftKey = shiftKey;
HXLINE( 472)		this->commandKey = commandKey;
HXLINE( 473)		this->controlKey = controlKey;
HXLINE( 475)		this->stageX = ::Math_obj::NaN;
HXLINE( 476)		this->stageY = ::Math_obj::NaN;
HXLINE( 478)		this->_hx___updateAfterEventFlag = false;
            	}
...
bool TouchEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event TouchEvent_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_482_clone)
HXLINE( 483)		 ::openfl::events::TouchEvent event =  ::openfl::events::TouchEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->touchPointID,this->isPrimaryTouchPoint,this->localX,this->localY,this->sizeX,this->sizeY,this->pressure,this->relatedObject,this->ctrlKey,this->altKey,this->shiftKey,this->commandKey,this->controlKey,null(),null(),null(),null());
HXLINE( 485)		event->target = this->target;
HXLINE( 486)		event->currentTarget = this->currentTarget;
HXLINE( 487)		event->eventPhase = this->eventPhase;
HXLINE( 488)		return event;
            	}


::String TouchEvent_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_493_toString)
HXDLIN( 493)		return this->_hx___formatToString(HX_("TouchEvent",fb,af,06,66),::Array_obj< ::String >::fromData( _hx_array_data_e5132ed2_3,16));
            	}


void TouchEvent_obj::updateAfterEvent(){
            	HX_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_505_updateAfterEvent)
HXDLIN( 505)		this->_hx___updateAfterEventFlag = true;
            	}
...
void TouchEvent_obj::_hx___init(){
            	HX_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_520___init)
HXLINE( 521)		this->super::_hx___init();
HXLINE( 522)		this->touchPointID = 0;
HXLINE( 523)		this->isPrimaryTouchPoint = false;
HXLINE( 524)		this->localX = ( (Float)(0) );
HXLINE( 525)		this->localY = ( (Float)(0) );
HXLINE( 526)		this->sizeX = ( (Float)(0) );
HXLINE( 527)		this->sizeY = ( (Float)(0) );
HXLINE( 528)		this->pressure = ( (Float)(0) );
HXLINE( 529)		this->relatedObject = null();
HXLINE( 530)		this->ctrlKey = false;
HXLINE( 531)		this->altKey = false;
HXLINE( 532)		this->shiftKey = false;
HXLINE( 533)		this->commandKey = false;
HXLINE( 534)		this->controlKey = false;
HXLINE( 536)		this->stageX = ::Math_obj::NaN;
HXLINE( 537)		this->stageY = ::Math_obj::NaN;
HXLINE( 539)		this->_hx___updateAfterEventFlag = false;
            	}
...
::String TouchEvent_obj::TOUCH_TAP;
 ...
 ::openfl::events::TouchEvent TouchEvent_obj::_hx___create(::String type, ::Dynamic touch,Float stageX,Float stageY, ::openfl::geom::Point local, ::openfl::display::InteractiveObject target){
            	HX_GC_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_510___create)
HXLINE( 511)		 ::openfl::events::TouchEvent evt =  ::openfl::events::TouchEvent_obj::__alloc( HX_CTX ,type,true,false,0,true,local->x,local->y,1,1,1,null(),null(),null(),null(),null(),null(),null(),null(),null(),null());
HXLINE( 512)		evt->stageX = stageX;
HXLINE( 513)		evt->stageY = stageY;
HXLINE( 514)		evt->target = target;
HXLINE( 516)		return evt;
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_42_boot)
...
{
            	HX_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_80_boot)
HXDLIN(  80)		TOUCH_BEGIN = HX_("touchBegin",ea,cd,e6,a9);
            	}
{
            	HX_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_110_boot)
HXDLIN( 110)		TOUCH_END = HX_("touchEnd",5c,c5,09,00);
            	}
{
            	HX_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_140_boot)
HXDLIN( 140)		TOUCH_MOVE = HX_("touchMove",70,72,cd,0d);
            	}
{
            	HX_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_170_boot)
HXDLIN( 170)		TOUCH_OUT = HX_("touchOut",0f,62,11,00);
            	}
{
            	HX_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_200_boot)
HXDLIN( 200)		TOUCH_OVER = HX_("touchOver",b3,20,25,0f);
            	}
{
            	HX_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_230_boot)
HXDLIN( 230)		TOUCH_ROLL_OUT = HX_("touchRollOut",12,0f,74,87);
            	}
{
            	HX_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_260_boot)
HXDLIN( 260)		TOUCH_ROLL_OVER = HX_("touchRollOver",50,d6,19,fe);
            	}
{
            	HX_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_290_boot)
HXDLIN( 290)		TOUCH_TAP = HX_("touchTap",e4,1b,15,00);
            	}
}
