...
HX_LOCAL_STACK_FRAME(_hx_pos_cd8fe9e91aca1c90_765_get_versionString,"lime.graphics.cairo.Cairo","get_versionString",0xb090f14a,"lime.graphics.cairo.Cairo.get_versionString","lime/graphics/cairo/Cairo.hx",765,0x0918a4c7)
namespace lime{
namespace graphics{
namespace cairo{
...
void Cairo_obj::transform( ::lime::utils::ArrayBufferView matrix){
            	HX_GC_STACKFRAME(&_hx_pos_cd8fe9e91aca1c90_428_transform)
HXDLIN( 428)		::cpp::Function< void  ( ::hx::Object *, ::hx::Object *) > _hx_tmp = ::lime::_internal::backend::native::NativeCFFI_obj::lime_cairo_transform;
HXDLIN( 428)		 ::Dynamic _hx_tmp1 = this->handle;
HXDLIN( 428)		Float _hx_tmp2 =  ::__hxcpp_memory_get_float(matrix->buffer->b,matrix->byteOffset);
HXDLIN( 428)		Float _hx_tmp3 =  ::__hxcpp_memory_get_float(matrix->buffer->b,(matrix->byteOffset + 4));
HXDLIN( 428)		Float _hx_tmp4 =  ::__hxcpp_memory_get_float(matrix->buffer->b,(matrix->byteOffset + 12));
HXDLIN( 428)		Float _hx_tmp5 =  ::__hxcpp_memory_get_float(matrix->buffer->b,(matrix->byteOffset + 16));
HXDLIN( 428)		Float _hx_tmp6 =  ::__hxcpp_memory_get_float(matrix->buffer->b,(matrix->byteOffset + 24));
HXDLIN( 428)		_hx_tmp(::hx::DynamicPtr(_hx_tmp1),::hx::DynamicPtr( ::lime::math::CairoMatrix3_obj::__alloc( HX_CTX ,_hx_tmp2,_hx_tmp3,_hx_tmp4,_hx_tmp5,_hx_tmp6, ::__hxcpp_memory_get_float(matrix->buffer->b,(matrix->byteOffset + 28)))));
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(Cairo_obj,set_lineWidth,return )
 ...
 ::lime::utils::ArrayBufferView Cairo_obj::get_matrix(){
            	HX_STACKFRAME(&_hx_pos_cd8fe9e91aca1c90_643_get_matrix)
...
HXLINE( 649)		return ::lime::math::_Matrix3::Matrix3_Impl__obj::_new(m->__Field(HX_("a",61,00,00,00),::hx::paccDynamic),m->__Field(HX_("b",62,00,00,00),::hx::paccDynamic),m->__Field(HX_("c",63,00,00,00),::hx::paccDynamic),m->__Field(HX_("d",64,00,00,00),::hx::paccDynamic),m->__Field(HX_("tx",84,65,00,00),::hx::paccDynamic),m->__Field(HX_("ty",85,65,00,00),::hx::paccDynamic));
            	}


HX_DEFINE_DYNAMIC_FUNC0(Cairo_obj,get_matrix,return )

 ::lime::utils::ArrayBufferView Cairo_obj::set_matrix( ::lime::utils::ArrayBufferView value){
            	HX_STACKFRAME(&_hx_pos_cd8fe9e91aca1c90_657_set_matrix)
HXLINE( 662)		::cpp::Function< void  ( ::hx::Object *,Float,Float,Float,Float,Float,Float) > _hx_tmp = ::lime::_internal::backend::native::NativeCFFI_obj::lime_cairo_set_matrix;
HXDLIN( 662)		 ::Dynamic _hx_tmp1 = this->handle;
HXDLIN( 662)		Float _hx_tmp2 =  ::__hxcpp_memory_get_float(value->buffer->b,value->byteOffset);
HXDLIN( 662)		Float _hx_tmp3 =  ::__hxcpp_memory_get_float(value->buffer->b,(value->byteOffset + 4));
HXDLIN( 662)		Float _hx_tmp4 =  ::__hxcpp_memory_get_float(value->buffer->b,(value->byteOffset + 12));
HXDLIN( 662)		Float _hx_tmp5 =  ::__hxcpp_memory_get_float(value->buffer->b,(value->byteOffset + 16));
HXDLIN( 662)		Float _hx_tmp6 =  ::__hxcpp_memory_get_float(value->buffer->b,(value->byteOffset + 24));
HXDLIN( 662)		_hx_tmp(::hx::DynamicPtr(_hx_tmp1),_hx_tmp2,_hx_tmp3,_hx_tmp4,_hx_tmp5,_hx_tmp6, ::__hxcpp_memory_get_float(value->buffer->b,(value->byteOffset + 28)));
...
::String Cairo_obj::get_versionString(){
            	HX_STACKFRAME(&_hx_pos_cd8fe9e91aca1c90_765_get_versionString)
HXDLIN( 765)		return ::lime::_internal::backend::native::NativeCFFI_obj::lime_cairo_version_string();
            	}
...
::hx::Val Cairo_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 4:
		...
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"matrix") ) { if (inCallProp == ::hx::paccAlways) return ::hx::Val( set_matrix(inValue.Cast<  ::lime::utils::ArrayBufferView >()) ); }
