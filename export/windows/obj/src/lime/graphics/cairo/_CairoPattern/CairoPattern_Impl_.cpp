...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(CairoPattern_Impl__obj,set_filter,return )
 ...
 ::lime::utils::ArrayBufferView CairoPattern_Impl__obj::get_matrix( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_1e7711c525853e66_127_get_matrix)
...
HXLINE( 133)		return ::lime::math::_Matrix3::Matrix3_Impl__obj::_new(m->__Field(HX_("a",61,00,00,00),::hx::paccDynamic),m->__Field(HX_("b",62,00,00,00),::hx::paccDynamic),m->__Field(HX_("c",63,00,00,00),::hx::paccDynamic),m->__Field(HX_("d",64,00,00,00),::hx::paccDynamic),m->__Field(HX_("tx",84,65,00,00),::hx::paccDynamic),m->__Field(HX_("ty",85,65,00,00),::hx::paccDynamic));
            	}


STATIC_HX_DEFINE_DYNAMIC_FUNC1(CairoPattern_Impl__obj,get_matrix,return )

 ::lime::utils::ArrayBufferView CairoPattern_Impl__obj::set_matrix( ::Dynamic this1, ::lime::utils::ArrayBufferView value){
            	HX_GC_STACKFRAME(&_hx_pos_1e7711c525853e66_141_set_matrix)
HXLINE( 143)		::cpp::Function< void  ( ::hx::Object *, ::hx::Object *) > _hx_tmp = ::lime::_internal::backend::native::NativeCFFI_obj::lime_cairo_pattern_set_matrix;
HXDLIN( 143)		Float _hx_tmp1 =  ::__hxcpp_memory_get_float(value->buffer->b,value->byteOffset);
HXDLIN( 143)		Float _hx_tmp2 =  ::__hxcpp_memory_get_float(value->buffer->b,(value->byteOffset + 4));
HXDLIN( 143)		Float _hx_tmp3 =  ::__hxcpp_memory_get_float(value->buffer->b,(value->byteOffset + 12));
HXDLIN( 143)		Float _hx_tmp4 =  ::__hxcpp_memory_get_float(value->buffer->b,(value->byteOffset + 16));
HXDLIN( 143)		Float _hx_tmp5 =  ::__hxcpp_memory_get_float(value->buffer->b,(value->byteOffset + 24));
HXDLIN( 143)		_hx_tmp(::hx::DynamicPtr(this1),::hx::DynamicPtr( ::lime::math::CairoMatrix3_obj::__alloc( HX_CTX ,_hx_tmp1,_hx_tmp2,_hx_tmp3,_hx_tmp4,_hx_tmp5, ::__hxcpp_memory_get_float(value->buffer->b,(value->byteOffset + 28)))));
