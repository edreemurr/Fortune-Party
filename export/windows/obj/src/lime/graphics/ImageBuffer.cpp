...
HX_LOCAL_STACK_FRAME(_hx_pos_890299056ccc780d_195_get_src,"lime.graphics.ImageBuffer","get_src",0x9748e67e,"lime.graphics.ImageBuffer.get_src","lime/graphics/ImageBuffer.hx",195,0x6475c2cd)
HX_LOCAL_STACK_FRAME(_hx_pos_890299056ccc780d_200_set_src,"lime.graphics.ImageBuffer","set_src",0x8a4a778a,"lime.graphics.ImageBuffer.set_src","lime/graphics/ImageBuffer.hx",200,0x6475c2cd)
HX_LOCAL_STACK_FRAME(_hx_pos_890299056ccc780d_222_get_stride,"lime.graphics.ImageBuffer","get_stride",0xb11b1cbf,"lime.graphics.ImageBuffer.get_stride","lime/graphics/ImageBuffer.hx",222,0x6475c2cd)
namespace lime{
namespace graphics{
...
HXLINE( 171)		if (::hx::IsNotNull( this->data )) {
HXLINE( 173)			 ::haxe::io::Bytes bytes = ::haxe::io::Bytes_obj::alloc(this->data->byteLength);
HXLINE( 174)			bytes->blit(0,buffer->data->buffer,0,this->data->byteLength);
HXLINE( 175)			 ::Dynamic elements = null();
HXDLIN( 175)			::cpp::VirtualArray array = null();
HXDLIN( 175)			 ::openfl::_Vector::IntVector vector = null();
HXDLIN( 175)			 ::lime::utils::ArrayBufferView view = null();
HXDLIN( 175)			 ::Dynamic len = null();
HXDLIN( 175)			 ::lime::utils::ArrayBufferView this1;
HXDLIN( 175)			if (::hx::IsNotNull( elements )) {
HXLINE( 175)				this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,elements,4);
            			}
            			else {
HXLINE( 175)				if (::hx::IsNotNull( array )) {
HXLINE( 175)					 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 175)					_this->byteOffset = 0;
HXDLIN( 175)					_this->length = array->get_length();
HXDLIN( 175)					_this->byteLength = (_this->length * _this->bytesPerElement);
HXDLIN( 175)					_this->buffer = ::haxe::io::Bytes_obj::alloc(_this->byteLength);
HXDLIN( 175)					_this->copyFromArray(array,null());
HXDLIN( 175)					this1 = _this;
            				}
            				else {
HXLINE( 175)					if (::hx::IsNotNull( vector )) {
HXLINE( 175)						 ::lime::utils::ArrayBufferView _this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 175)						::cpp::VirtualArray array1 = ( (::cpp::VirtualArray)(vector->__Field(HX_("__array",79,c6,ed,8f),::hx::paccDynamic)) );
HXDLIN( 175)						_this1->byteOffset = 0;
HXDLIN( 175)						_this1->length = array1->get_length();
HXDLIN( 175)						_this1->byteLength = (_this1->length * _this1->bytesPerElement);
HXDLIN( 175)						_this1->buffer = ::haxe::io::Bytes_obj::alloc(_this1->byteLength);
HXDLIN( 175)						_this1->copyFromArray(array1,null());
HXDLIN( 175)						this1 = _this1;
            					}
            					else {
HXLINE( 175)						if (::hx::IsNotNull( view )) {
HXLINE( 175)							 ::lime::utils::ArrayBufferView _this2 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 175)							 ::haxe::io::Bytes srcData = view->buffer;
HXDLIN( 175)							int srcLength = view->length;
HXDLIN( 175)							int srcByteOffset = view->byteOffset;
HXDLIN( 175)							int srcElementSize = view->bytesPerElement;
HXDLIN( 175)							int elementSize = _this2->bytesPerElement;
HXDLIN( 175)							if ((view->type == _this2->type)) {
HXLINE( 175)								int srcLength1 = srcData->length;
HXDLIN( 175)								int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN( 175)								_this2->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN( 175)								_this2->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            							}
            							else {
HXLINE( 175)								HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            							}
HXDLIN( 175)							_this2->byteLength = (_this2->bytesPerElement * srcLength);
HXDLIN( 175)							_this2->byteOffset = 0;
HXDLIN( 175)							_this2->length = srcLength;
HXDLIN( 175)							this1 = _this2;
            						}
            						else {
HXLINE( 175)							if (::hx::IsNotNull( bytes )) {
HXLINE( 175)								 ::lime::utils::ArrayBufferView _this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 175)								int in_byteOffset = 0;
HXDLIN( 175)								if ((in_byteOffset < 0)) {
HXLINE( 175)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
HXDLIN( 175)								if ((::hx::Mod(in_byteOffset,_this3->bytesPerElement) != 0)) {
HXLINE( 175)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
HXDLIN( 175)								int bufferByteLength = bytes->length;
HXDLIN( 175)								int elementSize1 = _this3->bytesPerElement;
...
HXDLIN( 175)									if ((::hx::Mod(bufferByteLength,_this3->bytesPerElement) != 0)) {
HXLINE( 175)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
HXDLIN( 175)									if ((newByteLength < 0)) {
HXLINE( 175)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
            								}
            								else {
HXLINE( 175)									newByteLength = (( (int)(len) ) * _this3->bytesPerElement);
HXDLIN( 175)									int newRange = (in_byteOffset + newByteLength);
HXDLIN( 175)									if ((newRange > bufferByteLength)) {
HXLINE( 175)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
            								}
HXDLIN( 175)								_this3->buffer = bytes;
HXDLIN( 175)								_this3->byteOffset = in_byteOffset;
HXDLIN( 175)								_this3->byteLength = newByteLength;
HXDLIN( 175)								_this3->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this3->bytesPerElement) )));
HXDLIN( 175)								this1 = _this3;
            							}
            							else {
...
HXDLIN( 175)			buffer->data = this1;
            		}
HXLINE( 179)		buffer->bitsPerPixel = this->bitsPerPixel;
HXLINE( 180)		buffer->format = this->format;
HXLINE( 181)		buffer->premultiplied = this->premultiplied;
HXLINE( 182)		buffer->transparent = this->transparent;
HXLINE( 183)		return buffer;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(ImageBuffer_obj,clone,return )
 ...
 ::Dynamic ImageBuffer_obj::get_src(){
            	HX_STACKFRAME(&_hx_pos_890299056ccc780d_195_get_src)
HXDLIN( 195)		return this->_hx___srcCustom;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(ImageBuffer_obj,get_src,return )
 ...
 ::Dynamic ImageBuffer_obj::set_src( ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_890299056ccc780d_200_set_src)
HXLINE( 214)		this->_hx___srcCustom = value;
...
int ImageBuffer_obj::get_stride(){
            	HX_STACKFRAME(&_hx_pos_890299056ccc780d_222_get_stride)
HXDLIN( 222)		int _hx_tmp = this->width;
HXDLIN( 222)		return (_hx_tmp * ::Std_obj::_hx_int((( (Float)(this->bitsPerPixel) ) / ( (Float)(8) ))));
            	}
