...
HX_DEFINE_STACK_FRAME(_hx_pos_60e5fd49cce3a06e_853_new,"lime._internal.backend.native.SensorEventInfo","new",0xcd81dd2e,"lime._internal.backend.native.SensorEventInfo.new","lime/_internal/backend/native/NativeApplication.hx",853,0xc1eba895)
HX_LOCAL_STACK_FRAME(_hx_pos_60e5fd49cce3a06e_863_clone,"lime._internal.backend.native.SensorEventInfo","clone",0x46c86fab,"lime._internal.backend.native.SensorEventInfo.clone","lime/_internal/backend/native/NativeApplication.hx",863,0xc1eba895)
namespace lime{
namespace _internal{
namespace backend{
namespace native{
...
HXLINE( 854)		this->type = ( (int)(type) );
HXLINE( 855)		this->id = id;
HXLINE( 856)		this->x = x;
HXLINE( 857)		this->y = y;
HXLINE( 858)		this->z = z;
            	}
...
bool SensorEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_internal::backend::native::SensorEventInfo SensorEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_60e5fd49cce3a06e_863_clone)
HXDLIN( 863)		return  ::lime::_internal::backend::native::SensorEventInfo_obj::__alloc( HX_CTX ,this->type,this->id,this->x,this->y,this->z);
            	}
