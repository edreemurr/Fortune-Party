...
HX_DEFINE_STACK_FRAME(_hx_pos_3eb566585b06ea2e_797_new,"lime._internal.backend.native.MouseEventInfo","new",0x46fd57c7,"lime._internal.backend.native.MouseEventInfo.new","lime/_internal/backend/native/NativeApplication.hx",797,0xc1eba895)
HX_LOCAL_STACK_FRAME(_hx_pos_3eb566585b06ea2e_810_clone,"lime._internal.backend.native.MouseEventInfo","clone",0xb20a8284,"lime._internal.backend.native.MouseEventInfo.clone","lime/_internal/backend/native/NativeApplication.hx",810,0xc1eba895)
namespace lime{
namespace _internal{
namespace backend{
namespace native{
...
HXLINE( 798)		this->type = ( (int)(type) );
HXLINE( 799)		this->windowID = 0;
HXLINE( 800)		this->x = x;
HXLINE( 801)		this->y = y;
HXLINE( 802)		this->button = button;
HXLINE( 803)		this->movementX = movementX;
HXLINE( 804)		this->movementY = movementY;
HXLINE( 805)		this->clickCount = clickCount;
            	}
...
bool MouseEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_internal::backend::native::MouseEventInfo MouseEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_3eb566585b06ea2e_810_clone)
HXDLIN( 810)		return  ::lime::_internal::backend::native::MouseEventInfo_obj::__alloc( HX_CTX ,this->type,this->windowID,this->x,this->y,this->button,this->movementX,this->movementY,this->clickCount);
            	}
