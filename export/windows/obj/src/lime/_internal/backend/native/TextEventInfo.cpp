...
HX_DEFINE_STACK_FRAME(_hx_pos_48b909785036aaec_882_new,"lime._internal.backend.native.TextEventInfo","new",0x7aff2f5b,"lime._internal.backend.native.TextEventInfo.new","lime/_internal/backend/native/NativeApplication.hx",882,0xc1eba895)
HX_LOCAL_STACK_FRAME(_hx_pos_48b909785036aaec_892_clone,"lime._internal.backend.native.TextEventInfo","clone",0x4be06718,"lime._internal.backend.native.TextEventInfo.clone","lime/_internal/backend/native/NativeApplication.hx",892,0xc1eba895)
namespace lime{
namespace _internal{
namespace backend{
namespace native{
...
HXLINE( 883)		this->type = ( (int)(type) );
HXLINE( 884)		this->windowID = windowID;
HXLINE( 885)		this->text = text;
HXLINE( 886)		this->start = start;
HXLINE( 887)		this->length = length;
            	}
...
bool TextEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_internal::backend::native::TextEventInfo TextEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_48b909785036aaec_892_clone)
HXDLIN( 892)		return  ::lime::_internal::backend::native::TextEventInfo_obj::__alloc( HX_CTX ,this->type,this->windowID,this->text,this->start,this->length);
            	}
