...
HX_DEFINE_STACK_FRAME(_hx_pos_281fad3e86f1efa8_604_new,"lime.utils._Assets.LibrarySymbol","new",0x85584603,"lime.utils._Assets.LibrarySymbol.new","lime/utils/Assets.hx",604,0x95055f23)
HX_LOCAL_STACK_FRAME(_hx_pos_281fad3e86f1efa8_612_isLocal,"lime.utils._Assets.LibrarySymbol","isLocal",0x28a9f044,"lime.utils._Assets.LibrarySymbol.isLocal","lime/utils/Assets.hx",612,0x95055f23)
HX_LOCAL_STACK_FRAME(_hx_pos_281fad3e86f1efa8_615_exists,"lime.utils._Assets.LibrarySymbol","exists",0xf7109019,"lime.utils._Assets.LibrarySymbol.exists","lime/utils/Assets.hx",615,0x95055f23)
namespace lime{
namespace utils{
namespace _Assets{

void LibrarySymbol_obj::__construct(::String id){
            	HX_STACKFRAME(&_hx_pos_281fad3e86f1efa8_604_new)
HXLINE( 605)		int colonIndex = id.indexOf(HX_(":",3a,00,00,00),null());
HXLINE( 606)		this->libraryName = id.substring(0,colonIndex);
HXLINE( 607)		this->symbolName = id.substring((colonIndex + 1),null());
HXLINE( 608)		this->library = ::lime::utils::Assets_obj::getLibrary(this->libraryName);
            	}
...
bool LibrarySymbol_obj::isLocal(::String type){
            	HX_STACKFRAME(&_hx_pos_281fad3e86f1efa8_612_isLocal)
HXDLIN( 612)		return this->library->isLocal(this->symbolName,type);
            	}
...
bool LibrarySymbol_obj::exists(::String type){
            	HX_STACKFRAME(&_hx_pos_281fad3e86f1efa8_615_exists)
HXDLIN( 615)		return this->library->exists(this->symbolName,type);
            	}
