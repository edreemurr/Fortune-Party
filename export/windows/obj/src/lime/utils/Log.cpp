...
HX_LOCAL_STACK_FRAME(_hx_pos_9de1e3bb9bd9260d_109___init__,"::lime::utils::Log_obj","__init__",0xc6d9689e,"::lime::utils::Log_obj.__init__","lime/utils/Log.hx",109,0x300eb2b2)
...
HX_LOCAL_STACK_FRAME(_hx_pos_66fab05f10e06d2c_52_info,"lime.utils.Log","info",0xefdb33ce,"lime.utils.Log.info","lime/utils/Log.hx",52,0x300eb2b2)
...
HX_LOCAL_STACK_FRAME(_hx_pos_66fab05f10e06d2c_78_println,"lime.utils.Log","println",0xdf773c8f,"lime.utils.Log.println","lime/utils/Log.hx",78,0x300eb2b2)
HX_LOCAL_STACK_FRAME(_hx_pos_66fab05f10e06d2c_90_verbose,"lime.utils.Log","verbose",0xccfd3822,"lime.utils.Log.verbose","lime/utils/Log.hx",90,0x300eb2b2)
HX_LOCAL_STACK_FRAME(_hx_pos_66fab05f10e06d2c_98_warn,"lime.utils.Log","warn",0xf9125da6,"lime.utils.Log.warn","lime/utils/Log.hx",98,0x300eb2b2)
...
void Log_obj::__init__(){
            	HX_STACKFRAME(&_hx_pos_9de1e3bb9bd9260d_109___init__)
HXLINE( 116)		::Array< ::String > args = ::Sys_obj::args();
HXLINE( 117)		bool _hx_tmp;
HXDLIN( 117)		if (!((args->indexOf(HX_("-v",a9,27,00,00),null()) > -1))) {
HXLINE( 117)			_hx_tmp = (args->indexOf(HX_("-verbose",f5,e6,97,7f),null()) > -1);
            		}
            		else {
HXLINE( 117)			_hx_tmp = true;
            		}
HXDLIN( 117)		if (_hx_tmp) {
HXLINE( 119)			::lime::utils::Log_obj::level = 5;
            		}
            		else {
HXLINE( 127)			::lime::utils::Log_obj::level = 3;
            		}
            	}
...
HXLINE(  37)				HX_STACK_DO_THROW(message2);
            			}
            			else {
HXLINE(  44)				::Sys_obj::println(::Std_obj::string(message2));
            			}
            		}
            	}
...
void Log_obj::info( ::Dynamic message, ::Dynamic info){
            	HX_STACKFRAME(&_hx_pos_66fab05f10e06d2c_52_info)
HXDLIN(  52)		if ((::lime::utils::Log_obj::level >= 3)) {
HXLINE(  57)			::String message1 = ( (::String)(((HX_("[",5b,00,00,00) + info->__Field(HX_("className",a3,92,3d,dc),::hx::paccDynamic)) + HX_("] ",23,51,00,00))) );
HXDLIN(  57)			::Sys_obj::println(::Std_obj::string((message1 + ::Std_obj::string(message))));
            		}
            	}
...
HXDLIN(  65)		::Sys_obj::print(::Std_obj::string(message));
            	}
...
void Log_obj::println( ::Dynamic message){
            	HX_STACKFRAME(&_hx_pos_66fab05f10e06d2c_78_println)
HXDLIN(  78)		::Sys_obj::println(::Std_obj::string(message));
            	}
...
void Log_obj::verbose( ::Dynamic message, ::Dynamic info){
            	HX_STACKFRAME(&_hx_pos_66fab05f10e06d2c_90_verbose)
HXDLIN(  90)		if ((::lime::utils::Log_obj::level >= 5)) {
HXLINE(  92)			::String message1 = ( (::String)(((HX_("[",5b,00,00,00) + info->__Field(HX_("className",a3,92,3d,dc),::hx::paccDynamic)) + HX_("] ",23,51,00,00))) );
HXDLIN(  92)			::Sys_obj::println(::Std_obj::string((message1 + ::Std_obj::string(message))));
            		}
            	}
...
void Log_obj::warn( ::Dynamic message, ::Dynamic info){
            	HX_STACKFRAME(&_hx_pos_66fab05f10e06d2c_98_warn)
HXDLIN(  98)		if ((::lime::utils::Log_obj::level >= 2)) {
HXLINE( 103)			::String message1 = ( (::String)(((HX_("[",5b,00,00,00) + info->__Field(HX_("className",a3,92,3d,dc),::hx::paccDynamic)) + HX_("] WARNING: ",5f,da,b0,cd))) );
HXDLIN( 103)			::Sys_obj::println(::Std_obj::string((message1 + ::Std_obj::string(message))));
            		}
            	}
