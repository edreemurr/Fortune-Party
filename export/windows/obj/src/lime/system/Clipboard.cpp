...
HX_LOCAL_STACK_FRAME(_hx_pos_21630ac4203d4998_38___update,"lime.system.Clipboard","__update",0x48c84c67,"lime.system.Clipboard.__update","lime/system/Clipboard.hx",38,0x9490b5ee)
HX_LOCAL_STACK_FRAME(_hx_pos_21630ac4203d4998_62_get_text,"lime.system.Clipboard","get_text",0xe647e374,"lime.system.Clipboard.get_text","lime/system/Clipboard.hx",62,0x9490b5ee)
HX_LOCAL_STACK_FRAME(_hx_pos_21630ac4203d4998_93_set_text,"lime.system.Clipboard","set_text",0x94a53ce8,"lime.system.Clipboard.set_text","lime/system/Clipboard.hx",93,0x9490b5ee)
HX_LOCAL_STACK_FRAME(_hx_pos_21630ac4203d4998_27_boot,"lime.system.Clipboard","boot",0x8554e870,"lime.system.Clipboard.boot","lime/system/Clipboard.hx",27,0x9490b5ee)
HX_LOCAL_STACK_FRAME(_hx_pos_21630ac4203d4998_35_boot,"lime.system.Clipboard","boot",0x8554e870,"lime.system.Clipboard.boot","lime/system/Clipboard.hx",35,0x9490b5ee)
namespace lime{
...
void Clipboard_obj::_hx___update(){
            	HX_STACKFRAME(&_hx_pos_21630ac4203d4998_38___update)
HXLINE(  39)		::String cacheText = ::lime::_hx_system::Clipboard_obj::_text;
HXLINE(  40)		::lime::_hx_system::Clipboard_obj::_text = null();
HXLINE(  43)		::lime::_hx_system::Clipboard_obj::_text = ( (::String)(( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_clipboard_get_text()) )) );
HXLINE(  52)		::lime::_hx_system::Clipboard_obj::_hx___updated = true;
HXLINE(  54)		if ((::lime::_hx_system::Clipboard_obj::_text != cacheText)) {
HXLINE(  56)			::lime::_hx_system::Clipboard_obj::onUpdate->dispatch();
            		}
            	}
...
::String Clipboard_obj::get_text(){
            	HX_STACKFRAME(&_hx_pos_21630ac4203d4998_62_get_text)
HXLINE(  80)		if (!(::lime::_hx_system::Clipboard_obj::_hx___updated)) {
HXLINE(  85)			::lime::_hx_system::Clipboard_obj::_hx___update();
            		}
HXLINE(  89)		return ::lime::_hx_system::Clipboard_obj::_text;
            	}
...
::String Clipboard_obj::set_text(::String value){
            	HX_STACKFRAME(&_hx_pos_21630ac4203d4998_93_set_text)
HXLINE(  94)		::String cacheText = ::lime::_hx_system::Clipboard_obj::_text;
HXLINE(  95)		::lime::_hx_system::Clipboard_obj::_text = value;
HXLINE(  98)		::lime::_internal::backend::native::NativeCFFI_obj::lime_clipboard_set_text(value);
HXLINE( 109)		if ((::lime::_hx_system::Clipboard_obj::_text != cacheText)) {
HXLINE( 111)			::lime::_hx_system::Clipboard_obj::onUpdate->dispatch();
            		}
...
{
{
            	HX_GC_STACKFRAME(&_hx_pos_21630ac4203d4998_27_boot)
HXDLIN(  27)		onUpdate =  ::lime::app::_Event_Void_Void_obj::__alloc( HX_CTX );
            	}
{
            	HX_STACKFRAME(&_hx_pos_21630ac4203d4998_35_boot)
HXDLIN(  35)		_hx___updated = false;
            	}
}
