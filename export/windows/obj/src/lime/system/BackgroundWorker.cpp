...
HX_DEFINE_STACK_FRAME(_hx_pos_c68e02a08e78766b_35_new,"lime.system.BackgroundWorker","new",0x36e47924,"lime.system.BackgroundWorker.new","lime/system/BackgroundWorker.hx",35,0x4a0958ac)
HX_LOCAL_STACK_FRAME(_hx_pos_c68e02a08e78766b_87_cancel,"lime.system.BackgroundWorker","cancel",0x890a1736,"lime.system.BackgroundWorker.cancel","lime/system/BackgroundWorker.hx",87,0x4a0958ac)
HX_LOCAL_STACK_FRAME(_hx_pos_c68e02a08e78766b_100_run,"lime.system.BackgroundWorker","run",0x36e7900f,"lime.system.BackgroundWorker.run","lime/system/BackgroundWorker.hx",100,0x4a0958ac)
HX_LOCAL_STACK_FRAME(_hx_pos_c68e02a08e78766b_125_sendComplete,"lime.system.BackgroundWorker","sendComplete",0x4fa2f0dd,"lime.system.BackgroundWorker.sendComplete","lime/system/BackgroundWorker.hx",125,0x4a0958ac)
HX_LOCAL_STACK_FRAME(_hx_pos_c68e02a08e78766b_145_sendError,"lime.system.BackgroundWorker","sendError",0xa2871d24,"lime.system.BackgroundWorker.sendError","lime/system/BackgroundWorker.hx",145,0x4a0958ac)
HX_LOCAL_STACK_FRAME(_hx_pos_c68e02a08e78766b_165_sendProgress,"lime.system.BackgroundWorker","sendProgress",0x5605e7d1,"lime.system.BackgroundWorker.sendProgress","lime/system/BackgroundWorker.hx",165,0x4a0958ac)
HX_LOCAL_STACK_FRAME(_hx_pos_c68e02a08e78766b_176___doWork,"lime.system.BackgroundWorker","__doWork",0x193122d8,"lime.system.BackgroundWorker.__doWork","lime/system/BackgroundWorker.hx",176,0x4a0958ac)
HX_LOCAL_STACK_FRAME(_hx_pos_c68e02a08e78766b_195___update,"lime.system.BackgroundWorker","__update",0x813601e5,"lime.system.BackgroundWorker.__update","lime/system/BackgroundWorker.hx",195,0x4a0958ac)
HX_LOCAL_STACK_FRAME(_hx_pos_c68e02a08e78766b_37_boot,"lime.system.BackgroundWorker","boot",0xc91e86ee,"lime.system.BackgroundWorker.boot","lime/system/BackgroundWorker.hx",37,0x4a0958ac)
HX_LOCAL_STACK_FRAME(_hx_pos_c68e02a08e78766b_38_boot,"lime.system.BackgroundWorker","boot",0xc91e86ee,"lime.system.BackgroundWorker.boot","lime/system/BackgroundWorker.hx",38,0x4a0958ac)
namespace lime{
namespace _hx_system{

void BackgroundWorker_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_c68e02a08e78766b_35_new)
HXLINE(  69)		this->onProgress =  ::lime::app::_Event_Dynamic_Void_obj::__alloc( HX_CTX );
HXLINE(  64)		this->onError =  ::lime::app::_Event_Dynamic_Void_obj::__alloc( HX_CTX );
HXLINE(  59)		this->onComplete =  ::lime::app::_Event_Dynamic_Void_obj::__alloc( HX_CTX );
HXLINE(  54)		this->doWork =  ::lime::app::_Event_Dynamic_Void_obj::__alloc( HX_CTX );
            	}
...
void BackgroundWorker_obj::cancel(){
            	HX_STACKFRAME(&_hx_pos_c68e02a08e78766b_87_cancel)
HXLINE(  88)		this->canceled = true;
HXLINE(  91)		this->_hx___workerThread = null();
            	}
...
void BackgroundWorker_obj::run( ::Dynamic message){
            	HX_GC_STACKFRAME(&_hx_pos_c68e02a08e78766b_100_run)
HXLINE( 101)		this->canceled = false;
HXLINE( 102)		this->completed = false;
HXLINE( 103)		this->_hx___runMessage = message;
HXLINE( 106)		this->_hx___messageQueue =  ::sys::thread::Deque_obj::__alloc( HX_CTX );
HXLINE( 107)		this->_hx___workerThread = ::sys::thread::_Thread::HaxeThread_obj::create(this->_hx___doWork_dyn(),false);
HXLINE( 111)		if (::hx::IsNotNull( ::lime::app::Application_obj::current )) {
HXLINE( 113)			::lime::app::Application_obj::current->onUpdate->add(this->_hx___update_dyn(),null(),null());
            		}
            	}
...
void BackgroundWorker_obj::sendComplete( ::Dynamic message){
            	HX_STACKFRAME(&_hx_pos_c68e02a08e78766b_125_sendComplete)
HXLINE( 126)		this->completed = true;
HXLINE( 129)		this->_hx___messageQueue->add(::lime::_hx_system::BackgroundWorker_obj::MESSAGE_COMPLETE);
HXLINE( 130)		this->_hx___messageQueue->add(message);
            	}
...
void BackgroundWorker_obj::sendError( ::Dynamic message){
            	HX_STACKFRAME(&_hx_pos_c68e02a08e78766b_145_sendError)
HXLINE( 147)		this->_hx___messageQueue->add(::lime::_hx_system::BackgroundWorker_obj::MESSAGE_ERROR);
HXLINE( 148)		this->_hx___messageQueue->add(message);
            	}
...
void BackgroundWorker_obj::sendProgress( ::Dynamic message){
            	HX_STACKFRAME(&_hx_pos_c68e02a08e78766b_165_sendProgress)
HXDLIN( 165)		this->_hx___messageQueue->add(message);
            	}
...
void BackgroundWorker_obj::_hx___doWork(){
            	HX_STACKFRAME(&_hx_pos_c68e02a08e78766b_176___doWork)
HXDLIN( 176)		this->doWork->dispatch(this->_hx___runMessage);
            	}
...
void BackgroundWorker_obj::_hx___update(int deltaTime){
            	HX_STACKFRAME(&_hx_pos_c68e02a08e78766b_195___update)
HXLINE( 197)		 ::Dynamic message = this->_hx___messageQueue->pop(false);
HXLINE( 199)		if (::hx::IsNotNull( message )) {
HXLINE( 201)			if (::hx::IsEq( message,::lime::_hx_system::BackgroundWorker_obj::MESSAGE_ERROR )) {
HXLINE( 203)				::lime::app::Application_obj::current->onUpdate->remove(this->_hx___update_dyn());
HXLINE( 205)				if (!(this->canceled)) {
HXLINE( 207)					this->canceled = true;
HXLINE( 208)					 ::lime::app::_Event_Dynamic_Void _hx_tmp = this->onError;
HXDLIN( 208)					_hx_tmp->dispatch(this->_hx___messageQueue->pop(false));
            				}
            			}
            			else {
HXLINE( 211)				if (::hx::IsEq( message,::lime::_hx_system::BackgroundWorker_obj::MESSAGE_COMPLETE )) {
HXLINE( 213)					::lime::app::Application_obj::current->onUpdate->remove(this->_hx___update_dyn());
HXLINE( 215)					if (!(this->canceled)) {
HXLINE( 217)						this->canceled = true;
HXLINE( 218)						 ::lime::app::_Event_Dynamic_Void _hx_tmp1 = this->onComplete;
HXDLIN( 218)						_hx_tmp1->dispatch(this->_hx___messageQueue->pop(false));
            					}
            				}
            				else {
HXLINE( 223)					if (!(this->canceled)) {
HXLINE( 225)						this->onProgress->dispatch(message);
            					}
            				}
            			}
            		}
...
{
{
            	HX_STACKFRAME(&_hx_pos_c68e02a08e78766b_37_boot)
HXDLIN(  37)		MESSAGE_COMPLETE = HX_("__COMPLETE__",39,bf,f1,2c);
            	}
{
            	HX_STACKFRAME(&_hx_pos_c68e02a08e78766b_38_boot)
HXDLIN(  38)		MESSAGE_ERROR = HX_("__ERROR__",a8,e1,2c,eb);
            	}
}
