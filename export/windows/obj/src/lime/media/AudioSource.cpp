...
HX_DEFINE_STACK_FRAME(_hx_pos_4f77a643dd1d25a9_21_new,"lime.media.AudioSource","new",0xf0422400,"lime.media.AudioSource.new","lime/media/AudioSource.hx",21,0xae7961b2)
HX_LOCAL_STACK_FRAME(_hx_pos_4f77a643dd1d25a9_102_dispose,"lime.media.AudioSource","dispose",0x9c7d243f,"lime.media.AudioSource.dispose","lime/media/AudioSource.hx",102,0xae7961b2)
HX_LOCAL_STACK_FRAME(_hx_pos_4f77a643dd1d25a9_107_init,"lime.media.AudioSource","init",0x46561370,"lime.media.AudioSource.init","lime/media/AudioSource.hx",107,0xae7961b2)
HX_LOCAL_STACK_FRAME(_hx_pos_4f77a643dd1d25a9_115_play,"lime.media.AudioSource","play",0x4af50654,"lime.media.AudioSource.play","lime/media/AudioSource.hx",115,0xae7961b2)
HX_LOCAL_STACK_FRAME(_hx_pos_4f77a643dd1d25a9_123_pause,"lime.media.AudioSource","pause",0x443a5296,"lime.media.AudioSource.pause","lime/media/AudioSource.hx",123,0xae7961b2)
HX_LOCAL_STACK_FRAME(_hx_pos_4f77a643dd1d25a9_131_stop,"lime.media.AudioSource","stop",0x4cf6c862,"lime.media.AudioSource.stop","lime/media/AudioSource.hx",131,0xae7961b2)
HX_LOCAL_STACK_FRAME(_hx_pos_4f77a643dd1d25a9_137_get_currentTime,"lime.media.AudioSource","get_currentTime",0x645da01d,"lime.media.AudioSource.get_currentTime","lime/media/AudioSource.hx",137,0xae7961b2)
HX_LOCAL_STACK_FRAME(_hx_pos_4f77a643dd1d25a9_142_set_currentTime,"lime.media.AudioSource","set_currentTime",0x60291d29,"lime.media.AudioSource.set_currentTime","lime/media/AudioSource.hx",142,0xae7961b2)
HX_LOCAL_STACK_FRAME(_hx_pos_4f77a643dd1d25a9_147_get_gain,"lime.media.AudioSource","get_gain",0xed783468,"lime.media.AudioSource.get_gain","lime/media/AudioSource.hx",147,0xae7961b2)
HX_LOCAL_STACK_FRAME(_hx_pos_4f77a643dd1d25a9_152_set_gain,"lime.media.AudioSource","set_gain",0x9bd58ddc,"lime.media.AudioSource.set_gain","lime/media/AudioSource.hx",152,0xae7961b2)
HX_LOCAL_STACK_FRAME(_hx_pos_4f77a643dd1d25a9_157_get_length,"lime.media.AudioSource","get_length",0xb3e8650f,"lime.media.AudioSource.get_length","lime/media/AudioSource.hx",157,0xae7961b2)
HX_LOCAL_STACK_FRAME(_hx_pos_4f77a643dd1d25a9_162_set_length,"lime.media.AudioSource","set_length",0xb7660383,"lime.media.AudioSource.set_length","lime/media/AudioSource.hx",162,0xae7961b2)
HX_LOCAL_STACK_FRAME(_hx_pos_4f77a643dd1d25a9_167_get_loops,"lime.media.AudioSource","get_loops",0xc5fc1986,"lime.media.AudioSource.get_loops","lime/media/AudioSource.hx",167,0xae7961b2)
HX_LOCAL_STACK_FRAME(_hx_pos_4f77a643dd1d25a9_172_set_loops,"lime.media.AudioSource","set_loops",0xa94d0592,"lime.media.AudioSource.set_loops","lime/media/AudioSource.hx",172,0xae7961b2)
HX_LOCAL_STACK_FRAME(_hx_pos_4f77a643dd1d25a9_177_get_pitch,"lime.media.AudioSource","get_pitch",0x0fa2e3b7,"lime.media.AudioSource.get_pitch","lime/media/AudioSource.hx",177,0xae7961b2)
HX_LOCAL_STACK_FRAME(_hx_pos_4f77a643dd1d25a9_182_set_pitch,"lime.media.AudioSource","set_pitch",0xf2f3cfc3,"lime.media.AudioSource.set_pitch","lime/media/AudioSource.hx",182,0xae7961b2)
HX_LOCAL_STACK_FRAME(_hx_pos_4f77a643dd1d25a9_187_get_position,"lime.media.AudioSource","get_position",0x75ce8d12,"lime.media.AudioSource.get_position","lime/media/AudioSource.hx",187,0xae7961b2)
HX_LOCAL_STACK_FRAME(_hx_pos_4f77a643dd1d25a9_192_set_position,"lime.media.AudioSource","set_position",0x8ac7b086,"lime.media.AudioSource.set_position","lime/media/AudioSource.hx",192,0xae7961b2)
namespace lime{
namespace media{
...
void AudioSource_obj::__construct( ::lime::media::AudioBuffer buffer,::hx::Null< int >  __o_offset, ::Dynamic length,::hx::Null< int >  __o_loops){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_4f77a643dd1d25a9_21_new)
HXLINE(  26)		this->onComplete =  ::lime::app::_Event_Void_Void_obj::__alloc( HX_CTX );
HXLINE(  79)		this->buffer = buffer;
HXLINE(  80)		this->offset = offset;
HXLINE(  82)		this->_hx___backend =  ::lime::_internal::backend::native::NativeAudioSource_obj::__alloc( HX_CTX ,::hx::ObjectPtr<OBJ_>(this));
HXLINE(  84)		bool _hx_tmp;
HXDLIN(  84)		if (::hx::IsNotNull( length )) {
HXLINE(  84)			_hx_tmp = ::hx::IsNotEq( length,0 );
            		}
            		else {
HXLINE(  84)			_hx_tmp = false;
            		}
HXDLIN(  84)		if (_hx_tmp) {
HXLINE(  86)			this->set_length(( (int)(length) ));
            		}
HXLINE(  89)		this->set_loops(loops);
HXLINE(  91)		if (::hx::IsNotNull( buffer )) {
HXLINE(  93)			this->init();
            		}
            	}
...
void AudioSource_obj::dispose(){
            	HX_STACKFRAME(&_hx_pos_4f77a643dd1d25a9_102_dispose)
HXDLIN( 102)		this->_hx___backend->dispose();
            	}
...
void AudioSource_obj::init(){
            	HX_STACKFRAME(&_hx_pos_4f77a643dd1d25a9_107_init)
HXDLIN( 107)		this->_hx___backend->init();
            	}
...
void AudioSource_obj::play(){
            	HX_STACKFRAME(&_hx_pos_4f77a643dd1d25a9_115_play)
HXDLIN( 115)		this->_hx___backend->play();
            	}
...
void AudioSource_obj::pause(){
            	HX_STACKFRAME(&_hx_pos_4f77a643dd1d25a9_123_pause)
HXDLIN( 123)		this->_hx___backend->pause();
            	}
...
void AudioSource_obj::stop(){
            	HX_STACKFRAME(&_hx_pos_4f77a643dd1d25a9_131_stop)
HXDLIN( 131)		this->_hx___backend->stop();
            	}
...
int AudioSource_obj::get_currentTime(){
            	HX_STACKFRAME(&_hx_pos_4f77a643dd1d25a9_137_get_currentTime)
HXDLIN( 137)		return this->_hx___backend->getCurrentTime();
            	}
...
int AudioSource_obj::set_currentTime(int value){
            	HX_STACKFRAME(&_hx_pos_4f77a643dd1d25a9_142_set_currentTime)
HXDLIN( 142)		return this->_hx___backend->setCurrentTime(value);
            	}
...
Float AudioSource_obj::get_gain(){
            	HX_STACKFRAME(&_hx_pos_4f77a643dd1d25a9_147_get_gain)
HXDLIN( 147)		return this->_hx___backend->getGain();
            	}
...
Float AudioSource_obj::set_gain(Float value){
            	HX_STACKFRAME(&_hx_pos_4f77a643dd1d25a9_152_set_gain)
HXDLIN( 152)		return this->_hx___backend->setGain(value);
            	}
...
int AudioSource_obj::get_length(){
            	HX_STACKFRAME(&_hx_pos_4f77a643dd1d25a9_157_get_length)
HXDLIN( 157)		return this->_hx___backend->getLength();
            	}
...
int AudioSource_obj::set_length(int value){
            	HX_STACKFRAME(&_hx_pos_4f77a643dd1d25a9_162_set_length)
HXDLIN( 162)		return this->_hx___backend->setLength(value);
            	}
...
int AudioSource_obj::get_loops(){
            	HX_STACKFRAME(&_hx_pos_4f77a643dd1d25a9_167_get_loops)
HXDLIN( 167)		return this->_hx___backend->getLoops();
            	}
...
int AudioSource_obj::set_loops(int value){
            	HX_STACKFRAME(&_hx_pos_4f77a643dd1d25a9_172_set_loops)
HXDLIN( 172)		return this->_hx___backend->setLoops(value);
            	}
...
Float AudioSource_obj::get_pitch(){
            	HX_STACKFRAME(&_hx_pos_4f77a643dd1d25a9_177_get_pitch)
HXDLIN( 177)		return this->_hx___backend->getPitch();
            	}
...
Float AudioSource_obj::set_pitch(Float value){
            	HX_STACKFRAME(&_hx_pos_4f77a643dd1d25a9_182_set_pitch)
HXDLIN( 182)		return this->_hx___backend->setPitch(value);
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(AudioSource_obj,set_pitch,return )
 ...
 ::lime::math::Vector4 AudioSource_obj::get_position(){
            	HX_STACKFRAME(&_hx_pos_4f77a643dd1d25a9_187_get_position)
HXDLIN( 187)		return this->_hx___backend->getPosition();
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(AudioSource_obj,get_position,return )
 ...
 ::lime::math::Vector4 AudioSource_obj::set_position( ::lime::math::Vector4 value){
            	HX_STACKFRAME(&_hx_pos_4f77a643dd1d25a9_192_set_position)
HXDLIN( 192)		return this->_hx___backend->setPosition(value);
            	}
