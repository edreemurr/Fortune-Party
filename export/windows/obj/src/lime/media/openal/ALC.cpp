...
HX_LOCAL_STACK_FRAME(_hx_pos_3ab4d7f5cd522c83_108_getError,"lime.media.openal.ALC","getError",0xb0a3653e,"lime.media.openal.ALC.getError","lime/media/openal/ALC.hx",108,0x4354dabb)
HX_LOCAL_STACK_FRAME(_hx_pos_3ab4d7f5cd522c83_116_getErrorString,"lime.media.openal.ALC","getErrorString",0x9cb484af,"lime.media.openal.ALC.getErrorString","lime/media/openal/ALC.hx",116,0x4354dabb)
HX_LOCAL_STACK_FRAME(_hx_pos_3ab4d7f5cd522c83_128_getIntegerv,"lime.media.openal.ALC","getIntegerv",0x44f57d42,"lime.media.openal.ALC.getIntegerv","lime/media/openal/ALC.hx",128,0x4354dabb)
HX_LOCAL_STACK_FRAME(_hx_pos_3ab4d7f5cd522c83_146_getString,"lime.media.openal.ALC","getString",0x9e1cd69b,"lime.media.openal.ALC.getString","lime/media/openal/ALC.hx",146,0x4354dabb)
...
int ALC_obj::getError( ::Dynamic device){
            	HX_STACKFRAME(&_hx_pos_3ab4d7f5cd522c83_108_getError)
HXDLIN( 108)		return ::lime::_internal::backend::native::NativeCFFI_obj::lime_alc_get_error(::hx::DynamicPtr(device));
            	}
...
::String ALC_obj::getErrorString( ::Dynamic device){
            	HX_STACKFRAME(&_hx_pos_3ab4d7f5cd522c83_116_getErrorString)
HXDLIN( 116)		switch((int)(::lime::media::openal::ALC_obj::getError(device))){
            			case (int)40961: {
HXLINE( 118)				return HX_("INVALID_DEVICE: Invalid device (or no device?)",8d,16,8a,9d);
            			}
            			break;
            			case (int)40962: {
HXLINE( 119)				return HX_("INVALID_CONTEXT: Invalid context (or no context?)",56,39,91,8b);
            			}
            			break;
            			case (int)40963: {
HXLINE( 120)				return HX_("INVALID_ENUM: Invalid enum value",0a,d7,df,59);
            			}
            			break;
            			case (int)40964: {
HXLINE( 121)				return HX_("INVALID_VALUE: Invalid param value",a6,0e,30,55);
            			...
            			break;
            			case (int)40965: {
HXLINE( 122)				return HX_("OUT_OF_MEMORY: OpenAL has run out of memory",b0,dd,fb,0a);
            			}
            			break;
            			default:{
HXLINE( 123)				return HX_("",00,00,00,00);
            			}
            		}
...
::Array< int > ALC_obj::getIntegerv( ::Dynamic device,int param,int size){
            	HX_STACKFRAME(&_hx_pos_3ab4d7f5cd522c83_128_getIntegerv)
HXLINE( 130)		 ::hx::Object * result = ::lime::_internal::backend::native::NativeCFFI_obj::lime_alc_get_integerv(::hx::DynamicPtr(device),param,size);
HXLINE( 138)		return ( ( ::Dynamic)(result) );
            	}
...
::String ALC_obj::getString( ::Dynamic device,int param){
            	HX_STACKFRAME(&_hx_pos_3ab4d7f5cd522c83_146_getString)
HXLINE( 148)		 ::hx::Object * result = ::lime::_internal::backend::native::NativeCFFI_obj::lime_alc_get_string(::hx::DynamicPtr(device),param);
HXLINE( 149)		return ( (::String)(( ( ::Dynamic)(result) )) );
            	}
...
HXDLIN(  17)		FREQUENCY = 4103;
            	}
{
            	HX_STACKFRAME(&_hx_pos_3ab4d7f5cd522c83_18_boot)
HXDLIN(  18)		REFRESH = 4104;
            	}
{
