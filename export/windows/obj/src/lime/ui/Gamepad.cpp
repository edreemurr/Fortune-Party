...
HX_DEFINE_STACK_FRAME(_hx_pos_b33f1f9ffbdc366b_13_new,"lime.ui.Gamepad","new",0xd780a212,"lime.ui.Gamepad.new","lime/ui/Gamepad.hx",13,0x36bc843e)
HX_LOCAL_STACK_FRAME(_hx_pos_b33f1f9ffbdc366b_68_get_guid,"lime.ui.Gamepad","get_guid",0x2f6ca220,"lime.ui.Gamepad.get_guid","lime/ui/Gamepad.hx",68,0x36bc843e)
HX_LOCAL_STACK_FRAME(_hx_pos_b33f1f9ffbdc366b_80_get_name,"lime.ui.Gamepad","get_name",0x33fdf6e2,"lime.ui.Gamepad.get_name","lime/ui/Gamepad.hx",80,0x36bc843e)
HX_LOCAL_STACK_FRAME(_hx_pos_b33f1f9ffbdc366b_42_addMappings,"lime.ui.Gamepad","addMappings",0x7dce3c98,"lime.ui.Gamepad.addMappings","lime/ui/Gamepad.hx",42,0x36bc843e)
HX_LOCAL_STACK_FRAME(_hx_pos_b33f1f9ffbdc366b_48___connect,"lime.ui.Gamepad","__connect",0x06daaffc,"lime.ui.Gamepad.__connect","lime/ui/Gamepad.hx",48,0x36bc843e)
HX_LOCAL_STACK_FRAME(_hx_pos_b33f1f9ffbdc366b_57___disconnect,"lime.ui.Gamepad","__disconnect",0x04d0478a,"lime.ui.Gamepad.__disconnect","lime/ui/Gamepad.hx",57,0x36bc843e)
...
HX_LOCAL_STACK_FRAME(_hx_pos_b33f1f9ffbdc366b_16_boot,"lime.ui.Gamepad","boot",0xb1262e40,"lime.ui.Gamepad.boot","lime/ui/Gamepad.hx",16,0x36bc843e)
namespace lime{
namespace ui{

void Gamepad_obj::__construct(int id){
            	HX_GC_STACKFRAME(&_hx_pos_b33f1f9ffbdc366b_13_new)
HXLINE(  25)		this->onDisconnect =  ::lime::app::_Event_Void_Void_obj::__alloc( HX_CTX );
HXLINE(  24)		this->onButtonUp =  ::lime::app::_Event_lime_ui_GamepadButton_Void_obj::__alloc( HX_CTX );
HXLINE(  23)		this->onButtonDown =  ::lime::app::_Event_lime_ui_GamepadButton_Void_obj::__alloc( HX_CTX );
HXLINE(  22)		this->onAxisMove =  ::lime::app::_Event_lime_ui_GamepadAxis_Float_Void_obj::__alloc( HX_CTX );
HXLINE(  29)		this->id = id;
HXLINE(  30)		this->connected = true;
            	}
...
::String Gamepad_obj::get_guid(){
            	HX_STACKFRAME(&_hx_pos_b33f1f9ffbdc366b_68_get_guid)
HXDLIN(  68)		return ( (::String)(( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_gamepad_get_device_guid(this->id)) )) );
            	}
...
::String Gamepad_obj::get_name(){
            	HX_STACKFRAME(&_hx_pos_b33f1f9ffbdc366b_80_get_name)
HXDLIN(  80)		return ( (::String)(( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_gamepad_get_device_name(this->id)) )) );
            	}
...
void Gamepad_obj::addMappings(::Array< ::String > mappings){
            	HX_STACKFRAME(&_hx_pos_b33f1f9ffbdc366b_42_addMappings)
HXDLIN(  42)		::lime::_internal::backend::native::NativeCFFI_obj::lime_gamepad_add_mappings(::hx::DynamicPtr(mappings));
            	}
...
void Gamepad_obj::_hx___connect(int id){
            	HX_GC_STACKFRAME(&_hx_pos_b33f1f9ffbdc366b_48___connect)
HXDLIN(  48)		if (!(::lime::ui::Gamepad_obj::devices->exists(id))) {
HXLINE(  50)			 ::lime::ui::Gamepad gamepad =  ::lime::ui::Gamepad_obj::__alloc( HX_CTX ,id);
...
void Gamepad_obj::_hx___disconnect(int id){
            	HX_STACKFRAME(&_hx_pos_b33f1f9ffbdc366b_57___disconnect)
HXLINE(  58)		 ::lime::ui::Gamepad gamepad = ( ( ::lime::ui::Gamepad)(::lime::ui::Gamepad_obj::devices->get(id)) );
HXLINE(  59)		if (::hx::IsNotNull( gamepad )) {
HXLINE(  59)			gamepad->connected = false;
            		}
HXLINE(  60)		::lime::ui::Gamepad_obj::devices->remove(id);
HXLINE(  61)		if (::hx::IsNotNull( gamepad )) {
HXLINE(  61)			gamepad->onDisconnect->dispatch();
            		}
            	}
...
HXDLIN(  15)		devices =  ::haxe::ds::IntMap_obj::__alloc( HX_CTX );
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_b33f1f9ffbdc366b_16_boot)
HXDLIN(  16)		onConnect =  ::lime::app::_Event_lime_ui_Gamepad_Void_obj::__alloc( HX_CTX );
            	}
}
