...
HXLINE( 155)					callback1(_gthis,dltotal,dlnow,ultotal,ulnow);
            				}
            				HX_END_LOCAL_FUNC4((void))

HXLINE( 152)				 ::Dynamic callback1 = parameter;
HXLINE( 153)				parameter =  ::Dynamic(new _hx_Closure_1(_gthis,callback1));
            			}
            			break;
            			case (int)20079: {
...
HXLINE( 190)					callback2(_gthis,header);
            				}
            				HX_END_LOCAL_FUNC1((void))

HXLINE( 187)				 ::Dynamic callback2 = parameter;
HXLINE( 188)				parameter =  ::Dynamic(new _hx_Closure_2(_gthis,callback2));
            			}
            			break;
            			case (int)20219: {
...
HXLINE( 162)					return ( (int)(callback3(_gthis,dltotal,dlnow,ultotal,ulnow)) );
            				}
            				HX_END_LOCAL_FUNC4(return)

HXLINE( 159)				 ::Dynamic callback3 = parameter;
HXLINE( 160)				parameter =  ::Dynamic(new _hx_Closure_3(_gthis,callback3));
            			}
            			break;
            			default:{
            			}
