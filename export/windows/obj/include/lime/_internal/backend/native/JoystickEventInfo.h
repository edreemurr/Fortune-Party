...
HX_DECLARE_STACK_FRAME(_hx_pos_21cd05885e6e0032_733_new)
...
HXLINE( 734)		( ( ::lime::_internal::backend::native::JoystickEventInfo)(__this) )->type = ( (int)(type) );
HXLINE( 735)		( ( ::lime::_internal::backend::native::JoystickEventInfo)(__this) )->id = id;
HXLINE( 736)		( ( ::lime::_internal::backend::native::JoystickEventInfo)(__this) )->index = index;
HXLINE( 737)		( ( ::lime::_internal::backend::native::JoystickEventInfo)(__this) )->eventValue = value;
HXLINE( 738)		( ( ::lime::_internal::backend::native::JoystickEventInfo)(__this) )->x = x;
HXLINE( 739)		( ( ::lime::_internal::backend::native::JoystickEventInfo)(__this) )->y = y;
            	}
