...
HX_DECLARE_STACK_FRAME(_hx_pos_d0c0bd38b1c3a1bc_700_new)
...
HXLINE( 701)		( ( ::lime::_internal::backend::native::GamepadEventInfo)(__this) )->type = ( (int)(type) );
HXLINE( 702)		( ( ::lime::_internal::backend::native::GamepadEventInfo)(__this) )->id = id;
HXLINE( 703)		( ( ::lime::_internal::backend::native::GamepadEventInfo)(__this) )->button = button;
HXLINE( 704)		( ( ::lime::_internal::backend::native::GamepadEventInfo)(__this) )->axis = axis;
HXLINE( 705)		( ( ::lime::_internal::backend::native::GamepadEventInfo)(__this) )->axisValue = value;
            	}
