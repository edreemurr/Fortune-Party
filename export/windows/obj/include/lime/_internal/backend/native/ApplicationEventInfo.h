...
HX_DECLARE_STACK_FRAME(_hx_pos_1a94701d58bd3d3e_632_new)
...
HXLINE( 633)		( ( ::lime::_internal::backend::native::ApplicationEventInfo)(__this) )->type = ( (int)(type) );
HXLINE( 634)		( ( ::lime::_internal::backend::native::ApplicationEventInfo)(__this) )->deltaTime = deltaTime;
            	}
