...
HX_DECLARE_STACK_FRAME(_hx_pos_a21879e7650910f2_675_new)
...
HXLINE( 676)		( ( ::lime::_internal::backend::native::DropEventInfo)(__this) )->type = ( (int)(type) );
HXLINE( 677)		( ( ::lime::_internal::backend::native::DropEventInfo)(__this) )->file = file;
            	}
