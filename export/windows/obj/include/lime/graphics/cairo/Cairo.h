...
class HXCPP_CLASS_ATTRIBUTES Cairo_obj : public ::hx::Object
{
	...
	public:
		...
		void transform( ::lime::utils::ArrayBufferView matrix);
		...
		::Dynamic set_lineWidth_dyn();
		 ...
		 ::lime::utils::ArrayBufferView get_matrix();
		::Dynamic get_matrix_dyn();

		 ::lime::utils::ArrayBufferView set_matrix( ::lime::utils::ArrayBufferView value);
