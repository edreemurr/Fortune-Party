...
class HXCPP_CLASS_ATTRIBUTES Matrix4_Impl__obj : public ::hx::Object
{
	...
	public:
		...
		static void createPerspective( ::lime::utils::ArrayBufferView this1,Float fov,Float aspect,Float zNear,Float zFar);
		...
		static  ::lime::utils::ArrayBufferView fromMatrix3( ::lime::utils::ArrayBufferView matrix3);
