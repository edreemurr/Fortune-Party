...
#define INCLUDED_openfl_display_TileData
...
HX_DECLARE_CLASS2(openfl,display,TileData)
...
class HXCPP_CLASS_ATTRIBUTES TileData_obj : public ::hx::Object
{
	...
	public:
		enum { _hx_ClassId = 0x48653d0a };

		void __construct( ::openfl::geom::Rectangle rect);
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="openfl.display.TileData")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"openfl.display.TileData"); }
...
#endif /* INCLUDED_openfl_display_TileData */ 
