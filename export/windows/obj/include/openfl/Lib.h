...
class HXCPP_CLASS_ATTRIBUTES Lib_obj : public ::hx::Object
{
	...
	public:
		...
		static  ::openfl::utils::_Dictionary::UtilsObjectMap _hx___registeredClasses;
		...
		static  ::Xml describeType( ::Dynamic value);
		static ::Dynamic describeType_dyn();
		...
		static ::Dynamic encodeURIComponent_dyn();

		static ::String decodeURIComponent(::String value);
		static ::Dynamic decodeURIComponent_dyn();
