...
HX_DECLARE_STACK_FRAME(_hx_pos_8cde7e51a6201b8b_109_new)
...
HXLINE( 110)		( ( ::openfl::net::URLRequestHeader)(__this) )->name = name;
HXLINE( 111)		( ( ::openfl::net::URLRequestHeader)(__this) )->value = value;
            	}
