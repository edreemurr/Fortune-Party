...
class HXCPP_CLASS_ATTRIBUTES MouseEvent_obj : public  ::openfl::events::Event_obj
{
	...
	public:
		...
		static  ::openfl::events::MouseEvent _hx___create(::String type,int button,int clickCount,Float stageX,Float stageY, ::openfl::geom::Point local, ::openfl::display::InteractiveObject target,::hx::Null< int >  delta);
