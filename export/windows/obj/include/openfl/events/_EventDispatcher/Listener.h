...
class HXCPP_CLASS_ATTRIBUTES Listener_obj : public ::hx::Object
{
	...
	public:
		...
		void __construct( ::Dynamic callback,bool useCapture,int priority,bool useWeakReference);
		...
		static ::hx::ObjectPtr< Listener_obj > __new( ::Dynamic callback,bool useCapture,int priority,bool useWeakReference);
		static ::hx::ObjectPtr< Listener_obj > __alloc(::hx::Ctx *_hx_ctx, ::Dynamic callback,bool useCapture,int priority,bool useWeakReference);
