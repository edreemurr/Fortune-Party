...
class HXCPP_CLASS_ATTRIBUTES Matrix3D_obj : public ::hx::Object
{
	...
	public:
		...
		static  ::openfl::geom::Matrix3D interpolateToOutput( ::openfl::geom::Matrix3D thisMat, ::openfl::geom::Matrix3D toMat,Float percent, ::openfl::geom::Matrix3D output);
		static ::Dynamic interpolateToOutput_dyn();
		...
		::Dynamic decompose_dyn();
		 ...
		 ::openfl::_Vector::ObjectVector decomposeToOutput( ::Dynamic orientationStyle, ::openfl::_Vector::ObjectVector output);
		::Dynamic decomposeToOutput_dyn();

		 ::openfl::geom::Vector3D deltaTransformVector( ::openfl::geom::Vector3D v);
		::Dynamic deltaTransformVector_dyn();

		 ::openfl::geom::Vector3D deltaTransformVectorToOutput( ::openfl::geom::Vector3D v, ::openfl::geom::Vector3D output);
		::Dynamic deltaTransformVectorToOutput_dyn();
		...
		::Dynamic transformVector_dyn();
		 ...
		 ::openfl::geom::Vector3D transformVectorToOutput( ::openfl::geom::Vector3D v, ::openfl::geom::Vector3D output);
		::Dynamic transformVectorToOutput_dyn();
