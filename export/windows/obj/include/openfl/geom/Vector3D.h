...
class HXCPP_CLASS_ATTRIBUTES Vector3D_obj : public ::hx::Object
{
	...
	public:
		...
		::Dynamic add_dyn();
		 ...
		 ::openfl::geom::Vector3D addToOutput( ::openfl::geom::Vector3D a, ::openfl::geom::Vector3D output);
		...
		::Dynamic crossProduct_dyn();
		 ...
		 ::openfl::geom::Vector3D crossProductToOutput( ::openfl::geom::Vector3D a, ::openfl::geom::Vector3D output);
		::Dynamic crossProductToOutput_dyn();
		...
		::Dynamic subtract_dyn();
		 ...
		 ::openfl::geom::Vector3D subtractToOutput( ::openfl::geom::Vector3D a, ::openfl::geom::Vector3D output);
