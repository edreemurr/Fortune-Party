...
class HXCPP_CLASS_ATTRIBUTES Point_obj : public ::hx::Object
{
	...
	public:
		...
		static  ::openfl::geom::Point interpolateToOutput( ::openfl::geom::Point pt1, ::openfl::geom::Point pt2,Float f, ::openfl::geom::Point output);
		static ::Dynamic interpolateToOutput_dyn();

		static  ::openfl::geom::Point polar(Float len,Float angle);
		static ::Dynamic polar_dyn();

		static  ::openfl::geom::Point polarToOutput(Float len,Float angle, ::openfl::geom::Point output);
		static ::Dynamic polarToOutput_dyn();
		...
		::Dynamic add_dyn();
		 ...
		 ::openfl::geom::Point addToOutput( ::openfl::geom::Point v, ::openfl::geom::Point output);
		::Dynamic addToOutput_dyn();
		...
		::Dynamic subtract_dyn();
		 ...
		 ::openfl::geom::Point subtractToOutput( ::openfl::geom::Point v, ::openfl::geom::Point output);
		::Dynamic subtractToOutput_dyn();
