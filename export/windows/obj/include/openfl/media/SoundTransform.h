...
HX_DECLARE_STACK_FRAME(_hx_pos_b69a1b3bd673fa32_100_new)
...
HXLINE( 101)		( ( ::openfl::media::SoundTransform)(__this) )->volume = vol;
HXLINE( 102)		( ( ::openfl::media::SoundTransform)(__this) )->pan = panning;
HXLINE( 103)		( ( ::openfl::media::SoundTransform)(__this) )->leftToLeft = ( (Float)(0) );
HXLINE( 104)		( ( ::openfl::media::SoundTransform)(__this) )->leftToRight = ( (Float)(0) );
HXLINE( 105)		( ( ::openfl::media::SoundTransform)(__this) )->rightToLeft = ( (Float)(0) );
HXLINE( 106)		( ( ::openfl::media::SoundTransform)(__this) )->rightToRight = ( (Float)(0) );
            	}
