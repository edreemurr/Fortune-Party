...
class HXCPP_CLASS_ATTRIBUTES TextField_obj : public  ::openfl::display::InteractiveObject_obj
{
	...
	public:
		...
		bool condenseWhite;
		bool _hx___wordSelection;
		bool _hx___lineSelection;
		int _hx___specialSelectionInitialIndex;
		...
		int _hx___getPositionByIdentifier(Float x,Float y,bool line);
		::Dynamic _hx___getPositionByIdentifier_dyn();

		int _hx___getOppositeIdentifierBound(int charIndex,bool line);
		::Dynamic _hx___getOppositeIdentifierBound_dyn();
