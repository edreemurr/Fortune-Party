...
HX_DECLARE_STACK_FRAME(_hx_pos_f056212be7ec3995_452_new)
...
{
            	HX_STACKFRAME(&_hx_pos_f056212be7ec3995_452_new)
HXLINE( 461)		( ( ::flixel::path::FlxPathDrawData)(__this) )->endSize = 5;
HXLINE( 460)		( ( ::flixel::path::FlxPathDrawData)(__this) )->startSize = 5;
HXLINE( 459)		( ( ::flixel::path::FlxPathDrawData)(__this) )->nodeSize = 3;
HXLINE( 458)		( ( ::flixel::path::FlxPathDrawData)(__this) )->lineSize = 1;
HXLINE( 457)		( ( ::flixel::path::FlxPathDrawData)(__this) )->endColor = -65536;
HXLINE( 456)		( ( ::flixel::path::FlxPathDrawData)(__this) )->startColor = -16744448;
HXLINE( 455)		( ( ::flixel::path::FlxPathDrawData)(__this) )->nodeColor = -1;
HXLINE( 454)		( ( ::flixel::path::FlxPathDrawData)(__this) )->lineColor = -1;
HXLINE( 452)		if (::hx::IsNotNull( lineColor )) {
HXDLIN( 452)			( ( ::flixel::path::FlxPathDrawData)(__this) )->lineColor = ( (int)(lineColor) );
            		}
HXDLIN( 452)		if (::hx::IsNotNull( nodeColor )) {
HXDLIN( 452)			( ( ::flixel::path::FlxPathDrawData)(__this) )->nodeColor = ( (int)(nodeColor) );
            		}
HXDLIN( 452)		if (::hx::IsNotNull( startColor )) {
HXDLIN( 452)			( ( ::flixel::path::FlxPathDrawData)(__this) )->startColor = ( (int)(startColor) );
            		}
HXDLIN( 452)		if (::hx::IsNotNull( endColor )) {
HXDLIN( 452)			( ( ::flixel::path::FlxPathDrawData)(__this) )->endColor = ( (int)(endColor) );
            		}
HXDLIN( 452)		if (::hx::IsNotNull( lineSize )) {
HXDLIN( 452)			( ( ::flixel::path::FlxPathDrawData)(__this) )->lineSize = ( (int)(lineSize) );
            		}
HXDLIN( 452)		if (::hx::IsNotNull( nodeSize )) {
HXDLIN( 452)			( ( ::flixel::path::FlxPathDrawData)(__this) )->nodeSize = ( (int)(nodeSize) );
            		}
HXDLIN( 452)		if (::hx::IsNotNull( startSize )) {
HXDLIN( 452)			( ( ::flixel::path::FlxPathDrawData)(__this) )->startSize = ( (int)(startSize) );
            		}
HXDLIN( 452)		if (::hx::IsNotNull( endSize )) {
HXDLIN( 452)			( ( ::flixel::path::FlxPathDrawData)(__this) )->endSize = ( (int)(endSize) );
            		}
            	}
