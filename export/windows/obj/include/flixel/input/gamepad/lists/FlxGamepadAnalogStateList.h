...
class HXCPP_CLASS_ATTRIBUTES FlxGamepadAnalogStateList_obj : public ::hx::Object
{
	...
	public:
		...
		static ::hx::ObjectPtr< FlxGamepadAnalogStateList_obj > __alloc(::hx::Ctx *_hx_ctx,int status, ::flixel::input::gamepad::FlxGamepad gamepad);
		...
		::String __ToString() const { return HX_("FlxGamepadAnalogStateList",10,e1,b0,bc); }
