...
class HXCPP_CLASS_ATTRIBUTES FlxGamepadManager_obj : public ::hx::Object
{
	...
	public:
		...
		static  ::openfl::ui::GameInput _gameInput;
		 ...
		 ::flixel::input::gamepad::FlxGamepadAcceptMode acceptMode;
		...
		Float anyMovedXAxis( ::flixel::input::gamepad::FlxTypedGamepadAnalogStick RawAxisID);
		::Dynamic anyMovedXAxis_dyn();

		Float anyMovedYAxis( ::flixel::input::gamepad::FlxTypedGamepadAnalogStick RawAxisID);
