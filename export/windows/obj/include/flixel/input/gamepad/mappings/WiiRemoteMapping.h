...
class HXCPP_CLASS_ATTRIBUTES WiiRemoteMapping_obj : public  ::flixel::input::gamepad::mappings::FlxTypedGamepadMapping_obj
{
	public:
		typedef  ::flixel::input::gamepad::mappings::FlxTypedGamepadMapping_obj super;
	...
	public:
		...
		bool isAxisForMotion( ::Dynamic _tmp_ID);

		bool isAxisFlipped( ::Dynamic _tmp_axisID);
