...
class HXCPP_CLASS_ATTRIBUTES FlxGamepad_obj : public ::hx::Object
{
	...
	public:
		...
		int id;
		 ...
		 ::flixel::input::gamepad::mappings::FlxTypedGamepadMapping mapping;
		bool connected;
		...
		::Dynamic isAxisForAnalogStick_dyn();
		 ...
		 ::flixel::input::gamepad::FlxTypedGamepadAnalogStick getAnalogStickByAxis(int AxisIndex);
		::Dynamic getAnalogStickByAxis_dyn();

		Float getXAxis(int AxesButtonID);
		::Dynamic getXAxis_dyn();

		Float getXAxisRaw( ::flixel::input::gamepad::FlxTypedGamepadAnalogStick Stick);
		::Dynamic getXAxisRaw_dyn();

		Float getYAxis(int AxesButtonID);
		::Dynamic getYAxis_dyn();

		Float getYAxisRaw( ::flixel::input::gamepad::FlxTypedGamepadAnalogStick Stick);
		...
		Float getAnalogXAxisValue( ::flixel::input::gamepad::FlxTypedGamepadAnalogStick stick);
		::Dynamic getAnalogXAxisValue_dyn();

		Float getAnalogYAxisValue( ::flixel::input::gamepad::FlxTypedGamepadAnalogStick stick);
		::Dynamic getAnalogYAxisValue_dyn();

		Float getAnalogAxisValueCircular( ::flixel::input::gamepad::FlxTypedGamepadAnalogStick stick,int axisID);
		...
		void handleAxisMoveSub( ::flixel::input::gamepad::FlxTypedGamepadAnalogStick stick,int axis,Float value,Float oldValue,::hx::Null< Float >  sign);
		::Dynamic handleAxisMoveSub_dyn();

		 ::flixel::input::gamepad::mappings::FlxTypedGamepadMapping createMappingForModel( ::flixel::input::gamepad::FlxGamepadModel model);
		...
		::Dynamic getInputLabel_dyn();
		 ...
		 ::flixel::input::gamepad::FlxGamepadMappedInput getMappedInput(int id);
