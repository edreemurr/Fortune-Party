...
class HXCPP_CLASS_ATTRIBUTES GraphicDrawDebug_obj : public  ::openfl::display::BitmapData_obj
{
	...
	public:
		...
		static ::hx::ObjectPtr< GraphicDrawDebug_obj > __new(int width,int height, ::Dynamic transparent, ::Dynamic fillColor);
		static ::hx::ObjectPtr< GraphicDrawDebug_obj > __alloc(::hx::Ctx *_hx_ctx,int width,int height, ::Dynamic transparent, ::Dynamic fillColor);
