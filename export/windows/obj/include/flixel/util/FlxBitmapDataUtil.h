...
class HXCPP_CLASS_ATTRIBUTES FlxBitmapDataUtil_obj : public ::hx::Object
{
	...
	public:
		...
		static  ::openfl::display::BitmapData addSpacesAndBorders( ::openfl::display::BitmapData bitmapData, ::flixel::math::FlxBasePoint frameSize, ::flixel::math::FlxBasePoint spacing, ::flixel::math::FlxBasePoint border, ::flixel::math::FlxRect region);
