...
class HXCPP_CLASS_ATTRIBUTES FlxTween_obj : public ::hx::Object
{
	...
	public:
		...
		static  ::flixel::tweens::misc::FlickerTween flicker( ::flixel::FlxBasic basic,::hx::Null< Float >  duration,::hx::Null< Float >  period, ::Dynamic options);
		static ::Dynamic flicker_dyn();

		static bool isFlickering( ::flixel::FlxBasic basic);
		static ::Dynamic isFlickering_dyn();

		static void stopFlickering( ::flixel::FlxBasic basic);
